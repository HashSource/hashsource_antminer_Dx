int __fastcall stratum_handle_response_zec(int a1, int a2, int a3)
{
  ...
  if ( v4 )
  {
    ...
    if ( v14 || *v12 != 3 )
    {
      V_LOCK();
      LOWORD(v15) = 22260;
      HIWORD(v15) = (unsigned int)&unk_1357FC >> 16;
      logfmt_raw(v30, 0x1000u, 0, v15, "stratum_handle_response_zec");
      V_UNLOCK();
      LOWORD(v16) = 21780;
      HIWORD(v16) = (unsigned int)"%s" >> 16;
      v17 = 0;
      zlog(g_zc, v16, 163, "stratum_handle_response_zec", 27, 279, 20, v30);
    }
    else
    {
      v22 = *v8;
  ...
  else
  {
    V_LOCK();
    LOWORD(v24) = 14540;
    HIWORD(v24) = (unsigned int)"e\", \"params\": [\"ckbminer-v1.0.0\", null]}" >> 16;
    logfmt_raw(v30, 0x1000u, 0, v24, *(_DWORD *)v28, v29);
    V_UNLOCK();
    LOWORD(v25) = 21780;
    HIWORD(v25) = (unsigned int)"%s" >> 16;
    zlog(g_zc, v25, 163, "stratum_handle_response_zec", 27, 269, 40, v30);
    return 0;
  }
}
