double *__fastcall json_loadf(int a1, int a2, char *a3)
{
  ...
  if ( stdin == a1 )
  {
    HIWORD(v3) = (unsigned int)"erator_thread" >> 16;
    v8 = v3;
  }
  else
  {
    HIWORD(v4) = (unsigned int)"hread" >> 16;
    v8 = v4;
  }
  ...
  if ( a1 )
  {
    LOWORD(v9) = 14328;
    v10 = 0;
    HIWORD(v9) = (unsigned int)"d_eeprom_device" >> 16;
    v13[1] = a1;
    v13[0] = v9;
    v14 = 0;
    v15 = 0;
