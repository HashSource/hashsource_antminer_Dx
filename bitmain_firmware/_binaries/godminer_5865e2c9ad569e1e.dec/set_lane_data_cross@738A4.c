int __fastcall set_lane_data_cross(int a1)
{
  ...
  LOWORD(a1) = -11848;
  HIWORD(a1) = (unsigned int)"ist0 err cnt: %08x" >> 16;
  logfmt_raw(v8, 0x1000u, 0, v7, v6[0], v6[1], v6[2], v6[3], v6[4], v6[5], v6[6], v7, a1, v2 + 1196);
  V_UNLOCK();
  LOWORD(v4) = -12340;
  HIWORD(v4) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
  zlog(g_zc, v4, 170, v2 + 1216, 19, 470, 60, v8);
  return 0;
}
