int __fastcall sub_B8304(pthread_mutex_t *a1, int a2, int a3, int *a4, unsigned __int64 a5)
{
  ...
  v16[0] = sub_12F324(a5, 0x3E8u);
  while ( a2 > v10 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(a1[35].__lock, v17, 0xAu, v16) == 110 )
      {
        v9 = 3;
        goto LABEL_11;
      }
