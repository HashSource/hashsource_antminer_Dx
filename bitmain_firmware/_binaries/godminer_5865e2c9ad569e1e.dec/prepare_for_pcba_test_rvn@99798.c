int __fastcall prepare_for_pcba_test_rvn(int a1, int *a2)
{
  ...
  V_LOCK();
  LOWORD(v4) = -11840;
  HIWORD(v4) = (unsigned int)" cnt: %08x" >> 16;
  logfmt_raw((char *)v13, 0x1000u, 0, v4, "prepare_for_pcba_test_rvn");
  V_UNLOCK();
  LOWORD(v5) = 6248;
  HIWORD(v5) = (unsigned int)"final pattern %08x" >> 16;
  zlog(g_zc, v5, 170, "prepare_for_pcba_test_rvn", 25, 2237, 60, v13);
  v6 = *a2;
  if ( (unsigned int)*a2 > 0xA )
  {
    LOWORD(v12) = -10512;
    HIWORD(v12) = (unsigned int)"handshake" >> 16;
  ...
  {
    LOWORD(v7) = -10468;
    HIWORD(v7) = (unsigned int)"nal_loop_ate_init" >> 16;
    ...
    *(_BYTE *)(a1 + 237) = 1;
    *(_BYTE *)(a1 + 238) = 1;
    HIWORD(v10) = (unsigned int)"_ate_init" >> 16;
