int __fastcall phy_eq_main_set(int a1, int a2)
{
  ...
  if ( v5 )
  {
    ...
    sub_765C8(a1, 111, bswap32(*v6) | v3);
  }
LABEL_7:
  v8 = sub_76660(a1, 0, 111, v4);
  if ( v8 )
  {
    v9 = v4;
    v10 = 0;
    ...
    V_UNLOCK();
    LOWORD(v13) = -9688;
    HIWORD(v13) = (unsigned int)"%02x sram ext load done" >> 16;
    zlog(g_zc, v13, 173, "phy_eq_main_set", 15, 1492, 60, v28);
  }
LABEL_13:
  v14 = sub_76660(a1, 0, 112, v4);
  if ( v14 )
  {
    v15 = v4;
    v16 = 0;
    ...
    sub_765C8(a1, 112, bswap32(*v15) | v3);
  }
LABEL_19:
  v17 = sub_76660(a1, 0, 112, v4);
  if ( v17 )
  {
    v18 = v4;
    v19 = 0;
    ...
    V_UNLOCK();
    LOWORD(v22) = -9688;
    HIWORD(v22) = (unsigned int)"%02x sram ext load done" >> 16;
    zlog(g_zc, v22, 173, "phy_eq_main_set", 15, 1512, 60, v28);
  }
LABEL_25:
  free(v4);
  return 0;
