int __fastcall set_baud_base(int a1, int a2)
{
  ...
  if ( a2 > 3000000 )
  {
    ...
    LOWORD(v11) = 25748;
    HIWORD(v11) = (unsigned int)"create failed" >> 16;
    logfmt_raw(v24, 0x1000u, 0, v11, chain_domain_num);
    V_UNLOCK();
    LOWORD(v12) = 25580;
    HIWORD(v12) = (unsigned int)"or_addr %02x, J0:6" >> 16;
    zlog(g_zc, v12, 165, "set_baud_base", 13, 149, 20, v24);
    V_LOCK();
    domain_asic_num = platform_get_domain_asic_num();
    LOWORD(v14) = 25768;
    HIWORD(v14) = (unsigned int)"t_voltage_monitor" >> 16;
    logfmt_raw(v24, 0x1000u, 0, v14, domain_asic_num);
    V_UNLOCK();
    LOWORD(v15) = 25580;
    HIWORD(v15) = (unsigned int)"or_addr %02x, J0:6" >> 16;
    zlog(g_zc, v15, 165, "set_baud_base", 13, 150, 20, v24);
