int __fastcall check_nonce_kda(int a1, int a2)
{
  ...
  if ( v13 <= 0x27 )
  {
    V_LOCK();
    LOWORD(v40) = -544;
    HIWORD(v40) = (unsigned int)"ux_LTC_1489" >> 16;
    logfmt_raw((char *)v51, 0x1000u, 0, v40, v14, *(unsigned __int8 *)(a2 + 88), 40, v43, src, v45);
    V_UNLOCK();
    LOWORD(v41) = -804;
    HIWORD(v41) = (unsigned int)"%d ans diff %d ticket_mask %d" >> 16;
    zlog(g_zc, v41, 170, "check_nonce_kda", 15, 609, 20, v51);
    return 2;
  }
...
LABEL_21:
      ...
      V_UNLOCK();
      LOWORD(v37) = -804;
      HIWORD(v37) = (unsigned int)"%d ans diff %d ticket_mask %d" >> 16;
      zlog(g_zc, v37, 170, "check_nonce_kda", 15, 623, 20, v51);
      return 1;
    }
LABEL_9:
  ...
  V_LOCK();
  LOWORD(v38) = -19780;
  HIWORD(v38) = (unsigned int)"ce crc error calc value %04x expected value %04x" >> 16;
  logfmt_raw((char *)v51, 0x1000u, 0, v38, v14, *(unsigned __int8 *)(a2 + 88), v5, v43, src, v45);
  V_UNLOCK();
  LOWORD(v39) = -804;
  HIWORD(v39) = (unsigned int)"%d ans diff %d ticket_mask %d" >> 16;
  zlog(g_zc, v39, 170, "check_nonce_kda", 15, 618, 20, v51);
  return 3;
}
