  ...
  while ( 2 )
  {
    ...
    do
    {
      ...
      if ( v10 - 800 <= 0x640 )
      {
        ...
        v13 = sub_12EA40(25 * (v10 / 0x19), v7);
        v11 = (float)sub_12EA40(v13, v8);
        goto LABEL_12;
      }
...
LABEL_12:
  V_LOCK();
  LOWORD(v14) = -19208;
  HIWORD(v14) = (unsigned int)"software_reset_DASH_1766" >> 16;
  logfmt_raw(v22, 0x1000u, 0, v14, v11, v3, v12, v19, v20, v21);
  V_UNLOCK();
  LOWORD(v15) = 2084;
  HIWORD(v15) = (unsigned int)"d core %d " >> 16;
  zlog(g_zc, v15, 175, "chip_setting_freq_ltc", 21, 135, 60, v22);
  v16 = (*(int (__fastcall **)(int, int *))(a1 + 248))(a1, &v18);
  usleep(0x2710u);
  return v16;
}
