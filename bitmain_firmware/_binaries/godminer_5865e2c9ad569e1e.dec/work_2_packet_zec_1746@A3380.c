int __fastcall work_2_packet_zec_1746(int a1, _QWORD *a2, _BYTE *a3, _DWORD *a4)
{
  ...
  *(_BYTE *)(v6 + 27648) = (v18 + 1) & 0x7F;
  if ( !memcmp(&last_header_zec, v9, 0x8Cu) )
  {
    V_LOCK();
    LOWORD(v22) = -21200;
    HIWORD(v22) = (unsigned int)"analog value %08x" >> 16;
    logfmt_raw(v25, 0x1000u, 0, v22);
    V_UNLOCK();
    LOWORD(v23) = 14720;
    HIWORD(v23) = (unsigned int)"ailed after retry %d times" >> 16;
    zlog(g_zc, v23, 170, "work_2_packet_zec_1746", 22, 260, 80, v25);
  }
  else
  {
