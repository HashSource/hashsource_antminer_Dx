int __fastcall work_2_packet_ckb(int a1, int a2, _BYTE *a3, _DWORD *a4)
{
  ...
  *(_BYTE *)(v7 + 3584) = (v24 + 1) & 0x7F;
  ...
  if ( !v30 )
  {
    V_LOCK();
    LOWORD(v41) = -21200;
    HIWORD(v41) = (unsigned int)"analog value %08x" >> 16;
    logfmt_raw((char *)v57, 0x1000u, 0, v41);
    V_UNLOCK();
    LOWORD(v42) = -21180;
    HIWORD(v42) = (unsigned int)"got uneffective temp, sensor[%d], addr:%02x" >> 16;
    LOWORD(v43) = -21008;
    v44 = a2 + 39;
    zlog(g_zc, v42, 170, "work_2_packet_ckb", 17, 119, 80, v57);
    v45 = a2 + 87;
    v55 = (unsigned __int8)a3[3];
    do
    {
      v46 = *(unsigned __int8 *)++v44;
      HIWORD(v43) = (unsigned int)" %02x, reg %02x, clk_delay %08x" >> 16;
    ...
    V_LOCK();
    LOWORD(v47) = -21000;
    HIWORD(v47) = (unsigned int)"eg %02x, clk_delay %08x" >> 16;
    logfmt_raw((char *)v57, 0x1000u, 0, v47, v54, v55);
    V_UNLOCK();
    LOWORD(v48) = -21180;
    HIWORD(v48) = (unsigned int)"got uneffective temp, sensor[%d], addr:%02x" >> 16;
    zlog(g_zc, v48, 170, "dump_work_ckb", 13, 86, 20, v57);
    V_LOCK();
    LOWORD(v49) = -20960;
    HIWORD(v49) = (unsigned int)"expected reg %02x, but %02x, data %08x" >> 16;
    logfmt_raw((char *)v57, 0x1000u, 0, v49, v56);
    V_UNLOCK();
    LOWORD(v50) = -21180;
    HIWORD(v50) = (unsigned int)"got uneffective temp, sensor[%d], addr:%02x" >> 16;
    zlog(g_zc, v50, 170, "dump_work_ckb", 13, 87, 20, v57);
  }
  v31 = s2;
  v32 = &last_header_ckb;
  do
  ...
  *a4 = 54;
  ...
  V_LOCK();
  LOWORD(v38) = -20944;
  HIWORD(v38) = (unsigned int)"x, but %02x, data %08x" >> 16;
  logfmt_raw((char *)v57, 0x1000u, 0, v38, "ChipSetting_bridge_reset_CKB_2042", 68);
  V_UNLOCK();
  LOWORD(v39) = -21416;
  HIWORD(v39) = (unsigned int)"_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/backend_ckb_2042/backend_ckb_2042.c" >> 16;
  zlog(g_zc, v39, 149, "ChipSetting_bridge_reset_CKB_2042", 33, 112, 20, v57);
  v57[1] = 0;
  v57[2] = 4456449;
  v57[3] = 0;
  v57[0] = 2;
