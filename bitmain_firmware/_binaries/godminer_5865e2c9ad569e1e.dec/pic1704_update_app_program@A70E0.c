int __fastcall pic1704_update_app_program(int a1)
{
  ...
  *(_DWORD *)&s[3] = 0;
  ...
  v21 = 0;
  v22 = 0;
  v2 = (FILE *)fopen64("/etc/config/dsPIC33EP16GS202_app.txt", 1367516);
  if ( !v2 )
  {
    snprintf(
      (char *)v23,
  ...
  if ( !v3 )
  {
    ...
    zlog(
      ...
      v24);
    V_LOCK();
    logfmt_raw(v24, 0x1000u, 0, 1249968, 1253008);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
...
LABEL_12:
    ...
    do
    {
      ...
      v25 = 0;
      v17[0] = -1;
      if ( !sub_A6B2C(v23[0], (int)&v19, (int)v24, v17) )
      {
        v6 = 0;
    ...
    zlog(
      ...
      v24);
    V_LOCK();
    logfmt_raw(v24, 0x1000u, 0, 1393036, a1);
    V_UNLOCK();
    v15 = g_zc;
    v16 = 348;
  }
