...
LABEL_3:
    ...
    default:
      V_LOCK();
      LOWORD(v6) = 19476;
      HIWORD(v6) = (unsigned int)"tranonce_kas" >> 16;
      v4 = 0;
      logfmt_raw(v9, 0x1000u, 0, v6, a2);
      V_UNLOCK();
      LOWORD(v7) = 19420;
      LOWORD(v8) = 19516;
      HIWORD(v7) = (unsigned int)" runtime type not set" >> 16;
      HIWORD(v8) = (unsigned int)"tum_handle_response_kas" >> 16;
      zlog(g_zc, v8, 156, v7, 25, 58, 100, v9);
      break;
  }
  return v4;
}
