...
LABEL_40:
  ...
  LOWORD(v21) = 6704;
  HIWORD(v21) = (unsigned int)"rate" >> 16;
  v22 = *v21;
  freq_scan_status = 2;
...
LABEL_11:
  ...
  do
  {
    ...
    v12 = *v8;
    LOWORD(v13) = 6712;
    HIWORD(v13) = (unsigned int)"/max_rate" >> 16;
    freq_scan_status = 2;
...
LABEL_15:
  ...
  format_hashrate_double(*(const char **)(*(_DWORD *)(v14 + 72) + 16), v25, v26);
  v15 = v24;
  result = sub_12EA40((int)v25[0], v24) * v15;
  switch ( opt_algo )
  {
    case 6:
      result -= 50;
...
LABEL_26:
      ...
      if ( (unsigned int)(result - 3130) <= 0x63 )
        return 3180;
      return sub_12EA40(result, v15) * v15;
    case 7:
      result = sub_12EA40(result, v15) * v15 - 50;
      if ( result > 3729 )
        return 3780;
      goto LABEL_26;
    case 9:
