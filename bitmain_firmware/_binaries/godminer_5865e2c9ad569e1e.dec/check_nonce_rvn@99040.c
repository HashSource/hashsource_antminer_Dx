int __fastcall check_nonce_rvn(int a1, _DWORD *a2)
{
  ...
  v38[6] = v17;
  v38[7] = v18;
  ethash_get_expected_difficulty(v39, *(_DWORD *)(a1 + 408));
  ...
  if ( v25 )
  {
    V_LOCK();
    LOWORD(v35) = 6732;
    HIWORD(v35) = (unsigned int)"Setting_get_single_chip_core_status_RVN" >> 16;
    logfmt_raw((char *)v41, 0x1000u, 0, v35);
    V_UNLOCK();
    LOWORD(v36) = 6248;
    HIWORD(v36) = (unsigned int)"final pattern %08x" >> 16;
    zlog(g_zc, v36, 170, "check_nonce_rvn", 15, 1572, 40, v41);
    return 2;
  }
LABEL_4:
  ethash_quick_hash(v41, (int)v37, *(_DWORD *)((char *)a2 + 26), *(_DWORD *)((char *)a2 + 30), v38);
  ...
  V_LOCK();
  LOWORD(v33) = 6744;
  HIWORD(v33) = (unsigned int)"single_chip_core_status_RVN" >> 16;
  logfmt_raw((char *)v41, 0x1000u, 0, v33);
  V_UNLOCK();
  LOWORD(v34) = 6248;
  HIWORD(v34) = (unsigned int)"final pattern %08x" >> 16;
  zlog(g_zc, v34, 170, "check_nonce_rvn", 15, 1577, 40, v41);
  return 1;
}
