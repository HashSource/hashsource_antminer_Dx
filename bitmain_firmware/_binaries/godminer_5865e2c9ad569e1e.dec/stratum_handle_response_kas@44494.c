int __fastcall stratum_handle_response_kas(int a1, int a2, int a3)
{
  ...
  if ( !v4 )
  {
    V_LOCK();
    LOWORD(v23) = 14540;
    HIWORD(v23) = (unsigned int)"e\", \"params\": [\"ckbminer-v1.0.0\", null]}" >> 16;
    logfmt_raw(v31, 0x1000u, 0, v23, *(_DWORD *)v29, v30);
    V_UNLOCK();
    LOWORD(v24) = 19864;
    HIWORD(v24) = (unsigned int)"thod\":\"mining.submit\", \"params\":[\"%s\",\"%s\",\"0x%s\"]}" >> 16;
    zlog(g_zc, v24, 163, "stratum_handle_response_kas", 27, 294, 40, v31);
    return 0;
  }
  v6 = json_object_get(v4, "result");
  LOWORD(v7) = 4756;
  v8 = (_DWORD *)v6;
  HIWORD(v7) = (unsigned int)"ot be here" >> 16;
  v9 = json_object_get(v5, v7);
  LOWORD(v10) = 5244;
  v11 = (_DWORD *)v9;
  HIWORD(v10) = (unsigned int)"e time: %s type: %s" >> 16;
...
LABEL_28:
    V_LOCK();
    LOWORD(v17) = 15224;
    HIWORD(v17) = (unsigned int)"rontend/frontend_ckb/frontend_ckb.c" >> 16;
    logfmt_raw(v31, 0x1000u, 0, v17, "stratum_handle_response_kas");
    V_UNLOCK();
    LOWORD(v18) = 19864;
    HIWORD(v18) = (unsigned int)"thod\":\"mining.submit\", \"params\":[\"%s\",\"%s\",\"0x%s\"]}" >> 16;
    v16 = 0;
    zlog(g_zc, v18, 163, "stratum_handle_response_kas", 27, 326, 20, v31);
    goto LABEL_29;
  }
LABEL_18:
  if ( *v12 == 7 )
