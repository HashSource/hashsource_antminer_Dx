...
LABEL_8:
    ...
    (*(void (__fastcall **)(const char *))(v7 + 16))("json_delete");
    usleep(0x2710u);
    return 0;
  }
  else
...
LABEL_9:
      LOWORD(v8) = 24356;
      LOWORD(v9) = 5892;
      HIWORD(v8) = (unsigned int)"r_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/frontend/frontend_ltc/fronted_ltc.c" >> 16;
      HIWORD(v9) = (unsigned int)"ereg" >> 16;
      printf(v9, v8);
      return 3;
    }
  }
