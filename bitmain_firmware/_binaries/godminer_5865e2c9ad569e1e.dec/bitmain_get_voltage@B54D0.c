void bitmain_get_voltage()
{
  ...
  if ( dword_18A85C || sub_B44D4() >= 0 )
  {
    ...
    {
      LOWORD(v2) = 27032;
      HIWORD(v2) = (unsigned int)"ut chain is %d" >> 16;
      v3 = *v2;
      v4 = v2[1];
      v5 = v2[2];
      v6 = v2[3];
      ...
      V_UNLOCK();
      LOWORD(v9) = 26388;
      HIWORD(v9) = (unsigned int)" failed" >> 16;
      zlog(g_zc, v9, 172, "_bitmain_get_AD_conversion_N", 28, 360, 100, v28);
      LOWORD(v10) = 27060;
      HIWORD(v10) = (unsigned int)"enkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/device/hal/tsensor/bitmain_tsensor.c" >> 16;
      v11 = *v10;
      v12 = v10[1];
      v13 = v10[2];
      v14 = v10[3];
      ...
      zlog(g_zc, v16, 172, "bitmain_get_voltage", 19, 696, 100, v28);
    }
    else
    {
  ...
  {
    LOWORD(v0) = 26740;
    HIWORD(v0) = (unsigned int)"atchdog" >> 16;
    snprintf((char *)&s, 0x800u, v0, "bitmain_get_voltage");
    V_LOCK();
    logfmt_raw(v28, 0x1000u, 0, &s);
    V_UNLOCK();
    LOWORD(v1) = 26388;
    HIWORD(v1) = (unsigned int)" failed" >> 16;
    zlog(g_zc, v1, 172, "bitmain_get_voltage", 19, 692, 100, v28);
  }
}
