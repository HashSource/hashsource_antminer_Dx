int __fastcall set_core_reg(int a1, char a2, int a3, int a4)
{
  ...
  LOWORD(v4) = -19020;
  HIWORD(v4) = (unsigned int)"freq_DASH_1766" >> 16;
  V_LOCK();
  LOWORD(v9) = -16912;
  HIWORD(v9) = (unsigned int)"_DCR_1727" >> 16;
  logfmt_raw(v18, 0x1000u, 0, v9, v4 + 1312 + 0xC, a3, a4, v12, 0, 0, 0, 0);
  V_UNLOCK();
  LOWORD(v10) = -17536;
  HIWORD(v10) = (unsigned int)"info error" >> 16;
  zlog(g_zc, v10, 172, v4 + 1328 + 0xC, 0xCu, 344, 20, v18);
  v16 = a2;
  v14 = 1;
  v15 = a3;
  v13 = a4;
