int __fastcall sub_AD2F4(int a1)
{
  ...
  v1 = (pthread_mutex_t *)((char *)&unk_18A454 + 24 * a1);
  v7 = 0;
  v8 = 0;
  v9 = 0;
  v10 = 0;
...
LABEL_7:
    zlog(
      ...
      "godminer-new/backend/device/hal/platform/7007/7007_uart.c",
      171,
      "clear_uart_tx_fifo",
      18,
      v6,
