int __fastcall dhash_start_hns(int a1)
{
  ...
  LOWORD(v3) = -4384;
  HIWORD(v3) = (unsigned int)" calc value %04x expected value %04x" >> 16;
  logfmt_raw(v9, 0x1000u, 0, v8, v7[0], v7[1], v7[2], v7[3], v7[4], v7[5], v7[6], v8, v3);
  V_UNLOCK();
  LOWORD(v4) = -4556;
  HIWORD(v4) = (unsigned int)"n temperature between two readings(%d, %d), trimming remote temp(%d, %d)" >> 16;
  zlog(g_zc, v4, 170, "dhash_start_hns", 15, 567, 40, v9);
