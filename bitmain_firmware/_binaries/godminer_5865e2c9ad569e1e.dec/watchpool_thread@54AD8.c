void __noreturn watchpool_thread()
{
  ...
  LOWORD(v2) = 4236;
  HIWORD(v2) = (unsigned int)"job has come" >> 16;
  v3 = v1;
  ...
  HIWORD(v7) = (unsigned int)"m." >> 16;
  HIWORD(v8) = (unsigned int)"pted" >> 16;
  v25 = v7;
  s = v8;
  zlog(g_zc, v6, 150, "watchpool_thread", 16, 31, 40, v32);
  v24 = &v21;
  prctl(15, v3);
  while ( 1 )
  {
    ...
    if ( total_pools > 0 )
    {
      ...
      do
      {
        ...
        *((_DWORD *)v15 + 3) = v18;
        ...
        V_UNLOCK();
        LOWORD(v19) = 32120;
        HIWORD(v19) = (unsigned int)"Password: %s" >> 16;
        zlog(g_zc, v19, 150, "watchpool_thread", 16, 50, 80, v32);
        switch_pools();
      }
