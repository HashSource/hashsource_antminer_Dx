int __fastcall high_speed_tx_check(int a1)
{
  ...
  zlog(g_zc, v5, 170, "high_speed_tx_check", 19, 321, 60, v43);
  do
  {
    ...
    *v9 = 0;
    ...
    if ( v36 )
    {
      ...
      do
      {
        ...
        HIWORD(v18) = (unsigned int)"iled, resp_num: %d\n" >> 16;
        logfmt_raw((char *)v43, 0x1000u, 0, v18, v8, v22);
        V_UNLOCK();
        HIWORD(v19) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
        zlog(g_zc, v19, 170, "high_speed_tx_check", 19, 379, 20, v43);
        LOWORD(v23) = -11740;
        ...
        if ( v27 )
          v34 = ++v24;
        HIWORD(v23) = (unsigned int)"chip %02x core %02x membist0 lost cnt: %08x" >> 16;
        sprintf(v25, v23, v26, v24);
      }
      while ( v20 != &v41 );
      V_LOCK();
      LOWORD(v28) = -11732;
      HIWORD(v28) = (unsigned int)"x core %02x membist0 lost cnt: %08x" >> 16;
      logfmt_raw((char *)v43, 0x1000u, 0, v28, v34, v8, v42);
      V_UNLOCK();
      LOWORD(v29) = -12340;
      HIWORD(v29) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
      zlog(g_zc, v29, 170, "high_speed_tx_check", 19, 385, 60, v43);
      if ( v34 == 64 )
      {
        V_LOCK();
        LOWORD(v30) = -11696;
        HIWORD(v30) = (unsigned int)"chip %02x core %02x membist cnt not done!" >> 16;
        logfmt_raw((char *)v43, 0x1000u, 0, v30);
        V_UNLOCK();
        LOWORD(v31) = -12340;
        HIWORD(v31) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
        zlog(g_zc, v31, 170, "high_speed_tx_check", 19, 388, 60, v43);
        while ( 1 )
          ;
      }
    }
