int __fastcall sync_get_core_reg_base_3(pthread_mutex_t *a1, int a2, int a3, int a4, int *a5, unsigned __int64 a6)
{
  ...
  sub_12F324(a6, 0x3E8u);
  v29[1] = 1000000 * v16;
  v24 = 0;
  v29[0] = sub_12F324(a6, 0x3E8u);
  while ( v24 < a3 )
  {
    LOWORD(v17) = 28876;
    while ( 1 )
    {
      if ( queue_dequeue_for(a1[35].__lock, (char *)&v30, 9u, v29) == 110 )
      {
        v7 = 3;
        goto LABEL_14;
      }
      V_LOCK();
      HIWORD(v17) = (unsigned int)"ase/build/godminer-origin_godminer-new/backend/chip_reg_io_interface.c" >> 16;
      logfmt_raw(v39, 0x1000u, 0, v17, v30, v31, v36, v37, v33, v34, v35);
      V_UNLOCK();
      LOWORD(v18) = 28720;
      HIWORD(v18) = (unsigned int)":%02x" >> 16;
      zlog(g_zc, v18, 153, "sync_get_core_reg_base_3", 24, 544, 20, v39);
