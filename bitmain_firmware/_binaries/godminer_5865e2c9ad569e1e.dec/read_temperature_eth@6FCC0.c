  ...
  if ( v2 > 0 )
  {
    ...
    for ( i = a2; v20 != i; i += 2 )
    {
      ...
      if ( v23 )
      {
        ...
        HIWORD(v17) = (unsigned int)" reg %02x, core_mode %08x" >> 16;
      ...
      LOWORD(v14) = -12340;
      HIWORD(v14) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
      zlog(g_zc, v14, 170, "read_temperature_eth", 20, v13, 100, v33);
      v6 = v21;
LABEL_4:
      *i = v6;
      v7 = v3[1];
...
LABEL_11:
        ...
        zlog(g_zc, v16, 170, "read_temperature_eth", 20, v15, 100, v33);
        v12 = v22;
        goto LABEL_6;
      }
      v12 = v22;
      if ( v22 < -63 )
      {
        ...
        HIWORD(v18) = (unsigned int)" reg %02x, core_mode %08x" >> 16;
