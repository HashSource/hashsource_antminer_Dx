int __fastcall hardware_init(int a1)
{
  ...
  if ( result )
    return result;
  LOWORD(v3) = 25076;
  HIWORD(v3) = (unsigned int)"t" >> 16;
  v4 = *(const char **)(v3 + 4 * a1 + 380);
  ...
  if ( v89[0] > 0 )
  {
    ...
    do
    {
      v15 = *((_DWORD *)v14 + 1);
      v14 += 4;
      strcpy((char *)(v15 + 296), v5);
      *(_DWORD *)(*(_DWORD *)v14 + 304) = (unsigned __int16)__rev16(LOWORD(v88[0]));
      is_adjustable_power = platform_is_adjustable_power();
      v17 = *(_DWORD *)v14;
      *(_DWORD *)(*(_DWORD *)v14 + 968) = is_adjustable_power;
      ...
      *(_DWORD *)(v25 + 388) = platform_get_sensor_max_uneffective_count(v12++);
    }
    while ( v12 < v89[0] );
  }
  free(v5);
  ...
  if ( v30 )
  {
    V_LOCK();
    LOWORD(v57) = 26468;
    HIWORD(v57) = (unsigned int)"M data corrupted. pls check it" >> 16;
  ...
  if ( (int)device_num <= 0 )
  {
    V_LOCK();
    LOWORD(v76) = 26488;
    HIWORD(v76) = (unsigned int)"s check it" >> 16;
...
LABEL_30:
    LOWORD(v58) = 25580;
    HIWORD(v58) = (unsigned int)"or_addr %02x, J0:6" >> 16;
    zlog(g_zc, v58, 165, "hardware_init", 13, v78, v77, v89);
    return 31;
  }
  v33 = 0;
  do
  {
    ...
    if ( !device_num )
    {
      V_LOCK();
      LOWORD(v63) = 26536;
      HIWORD(v63) = (unsigned int)"n[%d] %s" >> 16;
  ...
  do
  {
    v37 = V_LOCK();
    v38 = dev_ctrl(v37);
    v39 = (*(int (__fastcall **)(int))(v38 + 48))(v30);
    HIWORD(v35) = (unsigned int)"] %x" >> 16;
    logfmt_raw((char *)v89, 0x1000u, 0, v35, v39);
    V_UNLOCK();
    HIWORD(v36) = (unsigned int)"or_addr %02x, J0:6" >> 16;
    v40 = zlog(g_zc, v36, 165, "hardware_init", 13, 1054, 60, v89);
    v41 = dev_ctrl(v40);
    v42 = ((__int64 (__fastcall *)(int))*(_DWORD *)(v41 + 48))(v30++);
  ...
  if ( v43 )
  {
    V_LOCK();
    LOWORD(v79) = 26580;
    HIWORD(v79) = (unsigned int)"E1V01B1C1 BIN2" >> 16;
    logfmt_raw((char *)v89, 0x1000u, 0, v79);
    V_UNLOCK();
    LOWORD(v80) = 25580;
    HIWORD(v80) = (unsigned int)"or_addr %02x, J0:6" >> 16;
    zlog(g_zc, v80, 165, "hardware_init", 13, 1086, 100, v89);
    V_LOCK();
    LOWORD(v81) = 26616;
    LOWORD(v82) = 4784;
    HIWORD(v81) = (unsigned int)"1B1C1 BIN4" >> 16;
    HIWORD(v82) = (unsigned int)"ch" >> 16;
    logfmt_raw((char *)v89, 0x1000u, 0, v82, v81);
    V_UNLOCK();
    LOWORD(v83) = 25580;
    HIWORD(v83) = (unsigned int)"or_addr %02x, J0:6" >> 16;
    zlog(g_zc, v83, 165, "hardware_init", 13, 1087, 100, v89);
    return 32;
  }
  LOWORD(v44) = 26664;
  LOWORD(v45) = 25580;
  HIWORD(v44) = (unsigned int)"1B2C1 BIN2" >> 16;
  v85 = v44;
  HIWORD(v45) = (unsigned int)"or_addr %02x, J0:6" >> 16;
  v46 = 0;
  do
  {
    ...
    if ( eeprom_chain_load_state == -1 )
    {
      v59 = V_LOCK();
      v60 = dev_ctrl(v59);
      v61 = (*(int (__fastcall **)(int))(v60 + 48))(v46);
      LOWORD(v62) = 26624;
      HIWORD(v62) = (unsigned int)"N4" >> 16;
      logfmt_raw((char *)v89, 0x1000u, 0, v62, v61);
      V_UNLOCK();
      ++v43;
      zlog(g_zc, v45, 165, "hardware_init", 13, 1104, 100, v89);
    }
    else if ( !eeprom_chain_load_state )
    {
      v49 = V_LOCK();
      v50 = dev_ctrl(v49);
      v51 = (*(int (__fastcall **)(int))(v50 + 48))(v46);
      ++v43;
      logfmt_raw((char *)v89, 0x1000u, v48, v85, v51);
      V_UNLOCK();
      zlog(g_zc, v45, 165, "hardware_init", 13, 1107, 100, v89);
      v52 = V_LOCK();
      v53 = dev_ctrl(v52);
      v54 = (*(int (__fastcall **)(int))(v53 + 48))(v46);
      LOWORD(v55) = 26692;
      HIWORD(v55) = (unsigned int)"E1V01B2C1 BIN4" >> 16;
      logfmt_raw((char *)v89, 0x1000u, v48, v55, v54);
      V_UNLOCK();
      zlog(g_zc, v45, 165, "hardware_init", 13, 1108, 100, v89);
    }
    ++v46;
  }
  ...
  if ( v43 )
  {
    V_LOCK();
    LOWORD(v71) = 26720;
    HIWORD(v71) = (unsigned int)"N5" >> 16;
    logfmt_raw((char *)v89, 0x1000u, 0, v71);
    V_UNLOCK();
    LOWORD(v72) = 25580;
    HIWORD(v72) = (unsigned int)"or_addr %02x, J0:6" >> 16;
    zlog(g_zc, v72, 165, "hardware_init", 13, 1132, 100, v89);
    V_LOCK();
    LOWORD(v73) = 26616;
    LOWORD(v74) = 4784;
    HIWORD(v73) = (unsigned int)"1B1C1 BIN4" >> 16;
    HIWORD(v74) = (unsigned int)"ch" >> 16;
    logfmt_raw((char *)v89, 0x1000u, 0, v74, v73);
    V_UNLOCK();
    LOWORD(v75) = 25580;
    HIWORD(v75) = (unsigned int)"or_addr %02x, J0:6" >> 16;
    zlog(g_zc, v75, 165, "hardware_init", 13, 1133, 100, v89);
    return 32;
  }
  ...
  V_UNLOCK();
  LOWORD(v64) = 25580;
  HIWORD(v64) = (unsigned int)"or_addr %02x, J0:6" >> 16;
  zlog(g_zc, v64, 165, "hardware_init", 13, 1176, 40, v89);
  V_LOCK();
  logfmt_raw((char *)v89, 0x1000u, 0, "MIN freq: %d", opt_custom_freq);
  V_UNLOCK();
  LOWORD(v65) = 25580;
  HIWORD(v65) = (unsigned int)"or_addr %02x, J0:6" >> 16;
  zlog(g_zc, v65, 165, "hardware_init", 13, 1177, 40, v89);
  v87 = 0;
  ...
  if ( v87 > 0 )
  {
    ...
    LOWORD(v67) = 26796;
    v68 = v66 - 4;
    HIWORD(v69) = (unsigned int)"or_addr %02x, J0:6" >> 16;
    HIWORD(v67) = (unsigned int)"1 BIN5" >> 16;
    v86 = v67;
    do
    {
      V_LOCK();
      v70 = *((_DWORD *)v68 + 1);
      v68 += 4;
      logfmt_raw((char *)v89, 0x1000u, 0, v86, v43, v70 + 296);
      V_UNLOCK();
      zlog(g_zc, v69, 165, "show_backend_info", 17, 78, 20, v89);
      V_LOCK();
      v84 = v43++;
      logfmt_raw((char *)v89, 0x1000u, 0, "chain[%d] %x", v84, *(_DWORD *)(*(_DWORD *)v68 + 304));
      V_UNLOCK();
      zlog(g_zc, v69, 165, "show_backend_info", 17, 79, 20, v89);
    }
    while ( v43 < v87 );
  }
  return 0;
