int __fastcall check_nonce_ckb(int a1, int a2)
{
  ...
  if ( v24 <= 0x26 )
  {
    V_LOCK();
    LOWORD(v40) = 620;
    HIWORD(v40) = (unsigned int)" %lld" >> 16;
    ...
    V_UNLOCK();
    LOWORD(v41) = -21180;
    HIWORD(v41) = (unsigned int)"got uneffective temp, sensor[%d], addr:%02x" >> 16;
    zlog(g_zc, v41, 170, "check_nonce_ckb", 15, 560, 20, v54);
    return 2;
  }
  else
  {
...
LABEL_11:
        ...
        V_UNLOCK();
        LOWORD(v37) = -21180;
        HIWORD(v37) = (unsigned int)"got uneffective temp, sensor[%d], addr:%02x" >> 16;
        zlog(g_zc, v37, 170, "check_nonce_ckb", 15, 590, 20, v54);
        return 1;
      }
    }
    else if ( v7 > v24 )
    {
      ...
      V_UNLOCK();
      LOWORD(v39) = -21180;
      HIWORD(v39) = (unsigned int)"got uneffective temp, sensor[%d], addr:%02x" >> 16;
      zlog(g_zc, v39, 170, "check_nonce_ckb", 15, 565, 20, v54);
      return 3;
    }
    v27 = v48;
