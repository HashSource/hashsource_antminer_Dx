int __fastcall serdes_internal_loop_ate_init_rvn(int a1, unsigned int a2, int a3, int a4)
{
  ...
  zlog(g_zc, v12, 173, "serdes_internal_loop_ate_init_rvn", 33, 158, 60, v41);
  ...
  V_UNLOCK();
  LOWORD(v14) = 7620;
  HIWORD(v14) = (unsigned int)"nt> %lld" >> 16;
  LOWORD(v10) = -9416;
  zlog(g_zc, v14, 173, "serdes_internal_loop_ate_init_rvn", 33, 162, 60, v41);
  ...
  zlog(g_zc, v16, 173, "serdes_internal_loop_ate_init_rvn", 33, 172, 60, v41);
  ...
  V_UNLOCK();
  LOWORD(v21) = 7620;
  HIWORD(v21) = (unsigned int)"nt> %lld" >> 16;
  zlog(g_zc, v21, 173, "serdes_internal_loop_ate_init_rvn", 33, 291, 60, v41);
