int __fastcall stratum_handle_response_hns(int a1, int a2, int a3)
{
  ...
  if ( !v4 )
  {
    ...
    LOWORD(v28) = 18848;
    LOWORD(v29) = 18952;
    HIWORD(v28) = (unsigned int)"s.c" >> 16;
    HIWORD(v29) = (unsigned int)"failed!" >> 16;
    zlog(g_zc, v29, 163, v28, 27, 381, 40, v32);
    return 0;
  }
...
LABEL_43:
  LOWORD(v24) = 18848;
  V_LOCK();
  HIWORD(v24) = (unsigned int)"s.c" >> 16;
  LOWORD(v25) = 15224;
  ...
  zlog(g_zc, v26, 163, v24, 27, 405, 20, v32);
LABEL_24:
  if ( *((_DWORD *)v5 + 1) != -1 )
  {
