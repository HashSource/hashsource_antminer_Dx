int __fastcall set_core_mode_dash(int a1, int a2)
{
  ...
  LOWORD(v2) = -19020;
  HIWORD(v2) = (unsigned int)"freq_DASH_1766" >> 16;
  V_LOCK();
  LOWORD(v5) = -16848;
  HIWORD(v5) = (unsigned int)"Setting_analog_mux_DCR_1727" >> 16;
  logfmt_raw(v11, 0x1000u, 0, v5, v2 + 1404, 1, a2, v8, 0, 0, 0, 0);
  V_UNLOCK();
  LOWORD(v6) = -17536;
  HIWORD(v6) = (unsigned int)"info error" >> 16;
  zlog(g_zc, v6, 172, v2 + 1424, 18, 377, 20, v11);
  LOWORD(v10) = 3327;
  v9[2] = 65537;
  v9[0] = a2;
