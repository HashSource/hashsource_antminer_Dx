int __fastcall dhash_start_kda(int a1)
{
  ...
  V_INT((int)v10, v3, *(int *)(a1 + 232));
  HIWORD(v2) = (unsigned int)"k_delay_LTC_1489" >> 16;
  ...
  zlog(g_zc, v4, 170, "dhash_start_kda", 15, 482, 40, v14);
  v9[2] = 5505025;
  v9[1] = 0;
  v9[0] = 4;
  v9[3] = 0;
  ...
  V_UNLOCK();
  LOWORD(v6) = -21416;
  HIWORD(v6) = (unsigned int)"_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/backend_ckb_2042/backend_ckb_2042.c" >> 16;
  zlog(g_zc, v6, 149, "ChipSetting_nonce_len_KDA_2110", 30, 282, 40, v14);
