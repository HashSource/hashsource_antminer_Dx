int __fastcall work_2_packet_dcr(int a1, _DWORD *a2, _BYTE *a3, _DWORD *a4)
{
  ...
  *v8 = (v22 + 1) & 0x7F;
  ...
  if ( !memcmp(&last_header_dcr, v10, 0xB4u) )
  {
    V_LOCK();
    LOWORD(v29) = -21200;
    HIWORD(v29) = (unsigned int)"analog value %08x" >> 16;
    logfmt_raw((char *)v32, 0x1000u, 0, v29);
    V_UNLOCK();
    LOWORD(v30) = -15760;
    HIWORD(v30) = (unsigned int)"04x expected value %04x" >> 16;
    zlog(g_zc, v30, 170, "work_2_packet_dcr", 17, 120, 80, v32);
  }
  ...
  *a4 = 186;
  ...
  V_LOCK();
  LOWORD(v25) = -20944;
  HIWORD(v25) = (unsigned int)"x, but %02x, data %08x" >> 16;
  logfmt_raw((char *)v32, 0x1000u, 0, v25, "ChipSetting_bridge_reset_DCR_1727", 68);
  V_UNLOCK();
  LOWORD(v26) = -21416;
  HIWORD(v26) = (unsigned int)"_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/backend_ckb_2042/backend_ckb_2042.c" >> 16;
  zlog(g_zc, v26, 149, "ChipSetting_bridge_reset_DCR_1727", 33, 112, 20, v32);
  v32[1] = 0;
  v33 = 0;
  v34 = 0;
