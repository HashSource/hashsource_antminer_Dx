int __fastcall sub_5CC6C(_DWORD *a1)
{
  _DWORD *v1; // r0
  _DWORD *v2; // r7
  _DWORD *v3; // r0
...
LABEL_45:
  ...
  zlog(
    ...
    20,
    v77);
  dword_18BB94 = json_integer_value(v4);
  ...
  if ( v6 && *v6 == 3 )
  {
    ...
    zlog(
      ...
      20,
      v77);
    dword_18BB98 = json_integer_value(v7);
    ...
    if ( v9 && *v9 == 3 )
    {
      ...
      zlog(
        ...
        20,
        v77);
      dword_18BB9C = json_integer_value(v10);
      ...
      if ( v12 && *v12 == 3 )
      {
        ...
        zlog(
          ...
          20,
          v77);
        dword_18BBA0 = json_integer_value(v13);
        ...
        if ( v15 && *v15 == 3 )
        {
          ...
          zlog(
            ...
            20,
            v77);
          dword_18BBA4 = json_integer_value(v16);
          ...
          if ( v18 && *v18 == 3 )
          {
            ...
            zlog(
              ...
              20,
              v77);
            dword_18BBA8 = json_integer_value(v19);
            ...
            if ( v21 && *v21 == 3 )
            {
              ...
              zlog(
                ...
                20,
                v77);
              dword_18BBAC = json_integer_value(v22);
              ...
              if ( v24 && *v24 == 3 )
              {
                ...
                zlog(
                  ...
                  20,
                  v77);
                dword_18BBB0 = json_integer_value(v25);
                ...
                if ( v27 && *v27 == 3 )
                {
                  ...
                  zlog(
                    ...
                    20,
                    v77);
                  dword_18BBB4 = json_integer_value(v28);
                      ...
                      if ( v42 && *v42 == 3 )
                      {
                        ...
                        if ( v48 && *v48 == 3 )
                        {
                          ...
                          if ( v54 && *v54 == 1 )
                          {
                            ...
                            dword_18BBC8 = (int)calloc((size_t)v55, 0xCu);
                            if ( !dword_18BBC8 )
                            {
                              V_LOCK();
                            ...
                            while ( 1 )
                            {
                              ...
                              zlog(
                                ...
                                20,
                                v77);
                              *(_DWORD *)(dword_18BBC8 + v56) = json_integer_value(v61);
                              ...
                              zlog(
                                ...
                                20,
                                v77);
                              *(_DWORD *)(dword_18BBC8 + v56 + 8) = json_integer_value(v64);
