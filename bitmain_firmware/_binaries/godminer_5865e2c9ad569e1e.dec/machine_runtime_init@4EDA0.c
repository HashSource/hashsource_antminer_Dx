_DWORD *__fastcall machine_runtime_init(int a1, int a2)
{
  ...
  switch ( a2 )
  {
    ...
    default:
      V_LOCK();
      LOWORD(v3) = 27172;
      HIWORD(v3) = (unsigned int)"set_frequency_with_voltage_zec" >> 16;
      logfmt_raw(v11, 0x1000u, 0, v3, a2);
      V_UNLOCK();
      LOWORD(v4) = 27148;
      LOWORD(v5) = 27200;
      HIWORD(v4) = (unsigned int)&unk_136B14 >> 16;
      HIWORD(v5) = (unsigned int)"ec" >> 16;
      zlog(g_zc, v5, 170, v4, 20, 65, 100, v11);
      MEMORY[0x48] = 0;
      __und(0);
  }
  v6[18] = a2;
  V_LOCK();
  LOWORD(v7) = 27184;
  HIWORD(v7) = (unsigned int)"y_with_voltage_zec" >> 16;
  logfmt_raw(v11, 0x1000u, 0, v7, a2);
  V_UNLOCK();
  LOWORD(v8) = 27148;
  LOWORD(v9) = 27200;
  HIWORD(v8) = (unsigned int)&unk_136B14 >> 16;
  HIWORD(v9) = (unsigned int)"ec" >> 16;
  zlog(g_zc, v9, 170, v8, 20, 69, 40, v11);
  return v6;
}
