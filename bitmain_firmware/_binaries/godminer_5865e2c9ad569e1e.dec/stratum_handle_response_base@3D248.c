int __fastcall stratum_handle_response_base(int a1, int a2, int a3)
{
  ...
  if ( !v4 )
  {
    ...
    zlog(g_zc, v26, 151, "stratum_handle_response_base", 28, 321, 40, v31);
    return 0;
  }
...
LABEL_32:
    V_LOCK();
    LOWORD(v19) = 15224;
    HIWORD(v19) = (unsigned int)"rontend/frontend_ckb/frontend_ckb.c" >> 16;
    logfmt_raw(v31, 0x1000u, 0, v19, "stratum_handle_response_base");
    V_UNLOCK();
    LOWORD(v20) = 14288;
    HIWORD(v20) = (unsigned int)"failed(%d): %s" >> 16;
    v16 = 0;
    zlog(g_zc, v20, 151, "stratum_handle_response_base", 28, 345, 20, v31);
    goto LABEL_33;
  }
LABEL_18:
  if ( *v12 == 7 )
