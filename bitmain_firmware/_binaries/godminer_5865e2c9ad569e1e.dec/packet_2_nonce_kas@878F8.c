int __fastcall packet_2_nonce_kas(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, signed int *a6, _DWORD *a7)
{
  ...
  if ( v11 != v13 && *(_BYTE *)(a1 + 238) )
  {
    ...
    if ( v29 <= 9 )
    {
      ...
      V_INT((int)v61, v30, *(int *)(a1 + 232));
      LOWORD(v31) = -4132;
      HIWORD(v31) = (unsigned int)"nce_kas" >> 16;
      logfmt_raw(s, 0x1000u, 0, v62, v61[0], v61[1], v61[2], v61[3], v61[4], v61[5], v61[6], v62, v31, 0, v14, v13);
      V_UNLOCK();
      LOWORD(v32) = -2504;
      HIWORD(v32) = (unsigned int)" passed! diff %d expected_diff %d " >> 16;
      zlog(g_zc, v32, 170, "packet_2_nonce_kas", 18, 273, 40, s);
    }
    return 11;
  }
  else
      ...
      if ( v18 != -1 )
      {
        ...
        *a4 = 1;
        ...
        if ( v33 <= 0 )
        {
          ...
          v36 = 0;
LABEL_33:
          *(_QWORD *)&dword_182150[v44 + 20] = v36;
          return 0;
        }
        v34 = *(_DWORD *)(a1 + 432);
        v35 = 0;
        ...
        v43 = v37;
        v44 = 2 * v60;
        v45 = *(_QWORD *)&dword_182150[2 * v60 + 20];
        if ( v45 >= v36 )
        {
          LOWORD(v46) = 8736;
        }
        ...
        {
          LOWORD(v46) = (unsigned __int16)&unk_182220;
          if ( v36 - v45 <= 0x63 )
          {
            v47 = 0;
            HIWORD(v46) = (unsigned int)&unk_182220 >> 16;
            v48 = s;
            do
            {
              v50 = *(_QWORD *)v48;
...
LABEL_31:
    ...
    LOWORD(v55) = -2504;
    HIWORD(v55) = (unsigned int)" passed! diff %d expected_diff %d " >> 16;
    zlog(g_zc, v55, 170, "packet_2_nonce_kas", 18, v54, 20, s);
    return 12;
  }
}
