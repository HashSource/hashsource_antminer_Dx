int __fastcall recover_mining_eth(int a1)
{
  ...
  if ( eeprom_phy_seq_level > 0xA )
  {
    ...
    LOWORD(v8) = -10792;
    HIWORD(v8) = (unsigned int)"error! wrong PHY sequence parameter\n" >> 16;
    ...
    zlog(g_zc, v9, 170, "recover_mining_eth", 18, 1676, 60, v12);
    return 31;
  }
  else
  {
