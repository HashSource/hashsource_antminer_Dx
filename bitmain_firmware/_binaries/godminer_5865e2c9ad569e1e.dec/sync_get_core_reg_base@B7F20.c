int __fastcall sync_get_core_reg_base(pthread_mutex_t *a1, int a2, int a3, int a4, int *a5, unsigned __int64 a6)
{
  int v7; // r5
  char v10; // r1
  __int16 v12; // r3
  ...
  v27[0] = sub_12F324(a6, 0x3E8u);
  while ( a3 > v18 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(a1[35].__lock, v28, 0xBu, v27) == 110 )
      {
        v7 = 3;
        goto LABEL_15;
      }
