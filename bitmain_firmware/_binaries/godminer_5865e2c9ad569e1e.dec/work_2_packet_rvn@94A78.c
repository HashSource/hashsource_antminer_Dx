int __fastcall work_2_packet_rvn(int *a1, int *a2, int a3, _DWORD *a4)
{
  ...
  if ( v4 )
  {
    ...
    *(_BYTE *)(a3 + 2) = 32;
    ...
    v13[513] = v11;
    *v13 = v10;
    v14 = (unsigned __int8)byte_18A228;
    v13[1] = v12;
    if ( *((unsigned __int8 *)a2 + 88) != v14 )
    {
      V_LOCK();
      LOWORD(v43) = 6420;
      HIWORD(v43) = (unsigned int)" phy seq level = P%d ..." >> 16;
      logfmt_raw(v47, 0x1000u, 0, v43, (unsigned __int8)byte_18A228, *((unsigned __int8 *)a2 + 88));
      V_UNLOCK();
      LOWORD(v44) = 6248;
      HIWORD(v44) = (unsigned int)"final pattern %08x" >> 16;
      zlog(g_zc, v44, 170, "work_2_packet_rvn", 17, 919, 40, v47);
  ...
  else
  {
    V_LOCK();
    LOWORD(v45) = -2128;
    HIWORD(v45) = (unsigned int)"_2_packet_kda" >> 16;
    logfmt_raw(v47, 0x1000u, 0, v45, "work_2_packet_rvn");
    V_UNLOCK();
    LOWORD(v46) = 6248;
    HIWORD(v46) = (unsigned int)"final pattern %08x" >> 16;
    v21 = 3;
    zlog(g_zc, v46, 170, "work_2_packet_rvn", 17, 906, 0x14u, v47);
  }
  return v21;
}
