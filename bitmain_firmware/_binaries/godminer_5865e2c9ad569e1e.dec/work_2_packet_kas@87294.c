int __fastcall work_2_packet_kas(int a1, int a2, _BYTE *a3, _DWORD *a4)
{
  ...
  {
    v42 = a2;
    dword_182150[0] = (int)malloc(0x450u);
    v6 = *(_DWORD *)(a1 + 800);
    a2 = v42;
    if ( v6 )
      goto LABEL_3;
LABEL_12:
    V_LOCK();
    LOWORD(v39) = -2128;
    HIWORD(v39) = (unsigned int)"_2_packet_kda" >> 16;
    logfmt_raw(v44, 0x1000u, v6, v39, "work_2_packet_kas");
    V_UNLOCK();
    LOWORD(v40) = -2504;
    HIWORD(v40) = (unsigned int)" passed! diff %d expected_diff %d " >> 16;
    zlog(g_zc, v40, 170, "work_2_packet_kas", 17, 203, 0x14u, v44);
    return 3;
  }
  v6 = *(_DWORD *)(a1 + 800);
  if ( !v6 )
