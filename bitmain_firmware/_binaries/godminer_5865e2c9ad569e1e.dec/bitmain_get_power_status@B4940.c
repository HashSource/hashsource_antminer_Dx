int bitmain_get_power_status()
{
  ...
  if ( dword_18A85C || (v0 = sub_B44D4(), v0 >= 0) )
  {
    ...
    {
      LOWORD(v1) = 26952;
      HIWORD(v1) = (unsigned int)"open" >> 16;
      v2 = *v1;
      v3 = v1[1];
      v4 = v1[2];
      v5 = v1[3];
      ...
      zlog(g_zc, v7, 172, "_bitmain_get_power_status", 25, 531, 100, v30);
      LOWORD(v8) = 26976;
      HIWORD(v8) = (unsigned int)"tsensor_write" >> 16;
      v9 = *v8;
      v10 = v8[1];
      v11 = v8[2];
      v12 = v8[3];
      ...
      zlog(g_zc, v15, 172, "bitmain_get_power_status", 24, 585, 100, v30);
      return -2147482880;
    }
  ...
  {
    LOWORD(v17) = 26740;
    HIWORD(v17) = (unsigned int)"atchdog" >> 16;
    ...
    zlog(g_zc, v18, 172, "bitmain_get_power_status", 24, 581, 100, v30);
  }
  return v0;
}
