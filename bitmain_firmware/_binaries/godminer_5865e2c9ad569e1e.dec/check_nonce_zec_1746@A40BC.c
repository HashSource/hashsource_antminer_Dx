  ...
  *(_WORD *)((char *)&s[35] + 1) = 1344;
  ...
  if ( v9 == v8 )
  {
    if ( v9 <= 0x11 )
    {
      ...
      LOWORD(v24) = 15168;
      HIWORD(v24) = (unsigned int)"02x != %02x" >> 16;
...
LABEL_12:
      LOWORD(v25) = 14720;
      HIWORD(v25) = (unsigned int)"ailed after retry %d times" >> 16;
      zlog(g_zc, v25, 170, "check_nonce_zec_1746", 20, v33, 20, v48);
      return v31;
    }
    if ( v10 < v6 )
    {
LABEL_14:
    ...
    LOWORD(v20) = 15308;
    HIWORD(v20) = (unsigned int)"chain_mps_voltage" >> 16;
    logfmt_raw(v48, 0x1000u, 0, v43, v42[0], v42[1], v42[2], v42[3], v42[4], v42[5], v42[6], v43, v20);
    V_UNLOCK();
    LOWORD(v21) = 14720;
    HIWORD(v21) = (unsigned int)"ailed after retry %d times" >> 16;
    zlog(g_zc, v21, 170, "check_nonce_zec_1746", 20, 932, 20, v48);
    return 0;
  }
  else
  {
    ...
    V_UNLOCK();
    LOWORD(v27) = 14720;
    HIWORD(v27) = (unsigned int)"ailed after retry %d times" >> 16;
    zlog(g_zc, v27, 170, "check_nonce_zec_1746", 20, 886, 20, v48);
    return 3;
  }
}
