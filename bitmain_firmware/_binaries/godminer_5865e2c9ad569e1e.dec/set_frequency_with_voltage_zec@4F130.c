int __fastcall set_frequency_with_voltage_zec(int a1)
{
  ...
  V_LOCK();
  LOWORD(v7) = 27488;
  HIWORD(v7) = (unsigned int)"ork" >> 16;
  logfmt_raw(v43, 0x1000u, 0, v7);
  V_UNLOCK();
  LOWORD(v8) = 27564;
  HIWORD(v8) = (unsigned int)"set all chain target voltage is %d mV" >> 16;
  zlog(g_zc, v8, 178, "set_frequency_with_voltage_zec", 30, 218, 60, v43);
  v9 = calloc(1u, 0xD8u);
  LOWORD(v10) = 27744;
  v11 = v9 + 2;
  HIWORD(v10) = (unsigned int)"_to_be256_target_base" >> 16;
  v12 = v9;
  v13 = *v10;
  v14 = v10[1];
  v15 = v10[2];
  ...
  *v11 = v13;
  ...
  V_LOCK();
  LOWORD(v16) = 27756;
  HIWORD(v16) = (unsigned int)"rget_base" >> 16;
  logfmt_raw(v43, 0x1000u, 0, v16);
  V_UNLOCK();
  LOWORD(v17) = 27564;
  HIWORD(v17) = (unsigned int)"set all chain target voltage is %d mV" >> 16;
  zlog(g_zc, v17, 178, "set_frequency_with_voltage_zec", 30, 227, 60, v43);
  if ( v42 > 0 )
  {
    ++*((_BYTE *)v12 + 40);
    ...
    while ( 1 )
    {
      (*(void (__fastcall **)(int, _DWORD *))(v18 + 32))(v18, v12);
      if ( v42 <= ++v20 )
        break;
      ++*((_BYTE *)v12 + 40);
      v21 = *((_DWORD *)v19 + 1);
...
LABEL_30:
      V_LOCK();
      LOWORD(v33) = 27788;
      HIWORD(v33) = (unsigned int)"set_target" >> 16;
      logfmt_raw(v43, 0x1000u, 0, v33, v3, current_voltage);
      V_UNLOCK();
      LOWORD(v34) = 27564;
      HIWORD(v34) = (unsigned int)"set all chain target voltage is %d mV" >> 16;
      zlog(g_zc, v34, 178, "set_frequency_with_voltage_zec", 30, 266, 60, v43);
      return 0;
    }
    else
    {
...
LABEL_31:
    LOWORD(v35) = 24068;
    LOWORD(v36) = 5892;
    HIWORD(v35) = (unsigned int)" have been poweroff." >> 16;
    HIWORD(v36) = (unsigned int)"simulation submit thread create failed" >> 16;
    printf(v36, v35);
    return 3;
  }
