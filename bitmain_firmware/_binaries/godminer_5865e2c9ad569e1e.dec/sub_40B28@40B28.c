int __fastcall sub_40B28(int a1, int a2, _DWORD *a3)
{
  _DWORD *v5; // r0
  const char *v6; // r7
  _DWORD *v7; // r0
...
LABEL_24:
    ...
    LOWORD(v25) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/"
                                    "release/build/godminer-origin_godminer-new/frontend/frontend_eth/frontend_eth.c";
    goto LABEL_25;
  }
  if ( a2 == -456 )
  {
...
LABEL_25:
  HIWORD(v25) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/releas"
                              "e/build/godminer-origin_godminer-new/frontend/frontend_eth/frontend_eth.c" >> 16;
  zlog(v24, v25, 163, "stratum_notify_eth", 18, v23, 100, v29);
  pthread_mutex_unlock((pthread_mutex_t *)(a2 + 1592));
  return 0;
}
