int __fastcall get_chip_dag_packet_num_rvn(int a1)
{
  ...
  else
  {
    ...
    V_INT((int)v27, v14, *(int *)(a1 + 232));
    LOWORD(v15) = 6756;
    HIWORD(v15) = (unsigned int)"core_status_RVN" >> 16;
    v26 = 12;
    ...
    zlog(g_zc, v16, 170, "get_chip_dag_packet_num_rvn", 27, 1855, 100, v33);
  }
  v21 = sub_93738(a1, 116, v19);
  if ( v21 == 8 )
    goto LABEL_4;
  V_LOCK();
  LOWORD(v17) = 620;
  HIWORD(v17) = (unsigned int)" %lld" >> 16;
  V_INT((int)v29, v17, *(int *)(a1 + 232));
  logfmt_raw(
    v33,
    0x1000u,
    0,
  ...
  V_UNLOCK();
  LOWORD(v18) = 6248;
  HIWORD(v18) = (unsigned int)"final pattern %08x" >> 16;
  zlog(g_zc, v18, 170, "get_chip_dag_packet_num_rvn", 27, 1862, 100, v33);
  v26 = 12;
  if ( v21 > 0 )
  {
LABEL_4:
    ...
    LOWORD(v6) = 5076;
    v7 = 0;
    HIWORD(v3) = (unsigned int)"ait_status_rvn" >> 16;
    HIWORD(v4) = (unsigned int)" %lld" >> 16;
    HIWORD(v5) = (unsigned int)"000000000000000000000000000000000000" >> 16;
    HIWORD(v6) = (unsigned int)"ow config parameter!" >> 16;
    v22 = v3;
    s = v4;
    v23 = v5;
    v24 = v6;
    do
    {
      ...
      zlog(g_zc, v12, 170, "get_chip_dag_packet_num_rvn", 27, 1871, 60, v33);
    }
    while ( v21 > v7 );
  }
  free(ptr);
