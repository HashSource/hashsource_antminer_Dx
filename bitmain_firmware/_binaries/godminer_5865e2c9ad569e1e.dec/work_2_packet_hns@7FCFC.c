int __fastcall work_2_packet_hns(int a1, _DWORD *a2, _BYTE *a3, _DWORD *a4)
{
  ...
  *(_BYTE *)(v7 + 42496) = (v23 + 1) & 0x7F;
  ...
  if ( !memcmp(&last_header_hns, v10, 0x100u) )
  {
    V_LOCK();
    LOWORD(v30) = -21200;
    HIWORD(v30) = (unsigned int)"analog value %08x" >> 16;
    logfmt_raw((char *)v32, 0x1000u, 0, v30);
    V_UNLOCK();
    LOWORD(v31) = -4556;
    HIWORD(v31) = (unsigned int)"n temperature between two readings(%d, %d), trimming remote temp(%d, %d)" >> 16;
    zlog(g_zc, v31, 170, "work_2_packet_hns", 17, 124, 80, v32);
  }
  ...
  *a4 = 262;
  ...
  V_LOCK();
  LOWORD(v26) = -20944;
  HIWORD(v26) = (unsigned int)"x, but %02x, data %08x" >> 16;
  logfmt_raw((char *)v32, 0x1000u, 0, v26, "ChipSetting_bridge_reset_HNS_2130", 68);
  V_UNLOCK();
  LOWORD(v27) = -21416;
  HIWORD(v27) = (unsigned int)"_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/backend_ckb_2042/backend_ckb_2042.c" >> 16;
  zlog(g_zc, v27, 149, "ChipSetting_bridge_reset_HNS_2130", 33, 112, 20, v32);
  v32[1] = 0;
  v33 = 0;
  v34 = 0;
  v28 = *(void (__fastcall **)(int, _DWORD *))(a1 + 248);
  LOBYTE(v33) = 1;
  v32[0] = 2;
  HIWORD(v33) = 68;
  v28(a1, v32);
