int get_power_voltage_calibration_data()
{
  ...
  if ( v0 )
  {
    ...
    if ( POWER_CRC16((int)v34, 30) == v2 )
    {
      ...
      v29 = v1;
      v30 = v1;
      sub_B422C((int)&v29, 12, v3);
      sub_B422C((int)&v31 + 3, 7, __PAIR64__(v1, v4));
      V_LOCK();
      LOWORD(v6) = 27172;
      HIWORD(v6) = (unsigned int)"ew/backend/device/hal/tsensor/bitmain_tsensor.c" >> 16;
      logfmt_raw(v41, 0x1000u, v1, v6, "get_power_voltage_calibration_data", &v29);
      V_UNLOCK();
      LOWORD(v7) = 26388;
      HIWORD(v7) = (unsigned int)" failed" >> 16;
      zlog(g_zc, v7, 172, "get_power_voltage_calibration_data", 34, 1070, 100, v41);
      v8 = v36;
      ...
      unk_18A87C = v32;
      word_18A880 = v33;
      dword_18A928 = 100 * (WORD2(v10) % 0xCu)
                   + 100
      ...
      if ( (unsigned int)(v5 - 1) > 0xFE )
      {
        ...
        zlog(g_zc, v14, 172, "get_power_voltage_calibration_data", 34, 1094, 100, v41);
        return -1;
      }
      v16 = 255.0 / (double)v5;
      v17 = (__int16)(v36[0] + (v35 << 8));
...
LABEL_16:
    ...
    else
    {
      V_LOCK();
      LOWORD(v27) = 27160;
      HIWORD(v27) = (unsigned int)"n_godminer-new/backend/device/hal/tsensor/bitmain_tsensor.c" >> 16;
      logfmt_raw(v41, 0x1000u, v1, v27, "get_power_voltage_calibration_data");
      V_UNLOCK();
      LOWORD(v28) = 26388;
      HIWORD(v28) = (unsigned int)" failed" >> 16;
      zlog(g_zc, v28, 172, "get_power_voltage_calibration_data", 34, 1055, 100, v41);
      return -1;
    }
  }
  else
  {
    V_LOCK();
    LOWORD(v24) = 27128;
    HIWORD(v24) = (unsigned int)"tmp/release/build/godminer-origin_godminer-new/backend/device/hal/tsensor/bitmain_tsensor.c" >> 16;
    logfmt_raw(v41, 0x1000u, 0, v24, "get_power_voltage_calibration_data");
    V_UNLOCK();
    LOWORD(v25) = 26388;
    HIWORD(v25) = (unsigned int)" failed" >> 16;
    zlog(g_zc, v25, 172, "get_power_voltage_calibration_data", 34, 1034, 100, v41);
    return -1;
  }
}
