int __fastcall sub_28024(_DWORD *a1, int a2)
{
  int v3; // r5
  _DWORD *v4; // r4
  char *v5; // r0
  ...
  *(_DWORD *)v144 = 0;
  ...
  {
    sub_2463C(a1, 1, 70, *(const char **)(a2 + 8));
    v136 = json_array();
    v4 = json_object();
    v5 = BUFX_strdup("2.12");
    ...
    if ( v25 )
    {
      sub_12F00C((__int64)(v19 * v20 * 100.0));
      v129 = json_real();
      json_object_set_new(v16, "GHS 5s", v129);
    }
    else
    {
      sub_12F00C((__int64)(v21 * v20 * 100.0));
      v26 = json_real();
      json_object_set_new(v16, "GHS 5s", v26);
      v24 = *(float *)&v20 * v24;
      v23 = *(float *)&v20 * v23;
    }
    sub_12F00C((__int64)(v24 * 100.0));
    v27 = json_real();
    json_object_set_new(v16, "GHS av", v27);
    sub_12F00C((__int64)(v23 * 100.0));
    v28 = json_real();
    json_object_set_new(v16, "rate_30m", v28);
    sub_12F00C((__int64)(v142 * 100.0));
    v29 = json_real();
      ...
      if ( v138 > 0 )
      {
        ...
        if ( v138 > 0 )
        {
          ...
          do
          {
            ...
            sub_24AEC(*((_DWORD *)v68 - 52), *((_DWORD *)v68 - 47), v154);
          ...
          if ( v138 > 0 )
          {
            ...
            do
            {
              ...
              sub_24AEC(*((_DWORD *)v73 - 53), *((_DWORD *)v73 - 48), v154);
            ...
            if ( v138 > 0 )
            {
              ...
              do
              {
                ...
                sub_24AEC(*((_DWORD *)v78 - 52), *((_DWORD *)v78 - 47), v154);
...
LABEL_75:
    ...
    v102 = v97;
    if ( opt_algo == 9 )
      LODWORD(v102) = sub_12F324(v97, 0x3E8u);
