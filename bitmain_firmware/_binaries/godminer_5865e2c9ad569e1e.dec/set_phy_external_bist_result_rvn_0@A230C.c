int set_phy_external_bist_result_rvn_0()
{
  ...
  LOWORD(v1) = 7864;
  HIWORD(v1) = (unsigned int)&unk_1510A4 >> 16;
  sprintf(v6, v1, v0[2], v0[3]);
  memset(v6, 0, 0x80u);
  LOWORD(v2) = 7888;
  HIWORD(v2) = (unsigned int)"membist1_rvn" >> 16;
  sprintf(v6, v2, v0[4], v0[5]);
  memset(v6, 0, 0x80u);
  LOWORD(v3) = -6200;
  HIWORD(v3) = (unsigned int)"t_init" >> 16;
  sprintf(v6, v3, *v0);
  memset(v6, 0, 0x80u);
  LOWORD(v4) = -6176;
  HIWORD(v4) = (unsigned int)" %s handshake failed!" >> 16;
