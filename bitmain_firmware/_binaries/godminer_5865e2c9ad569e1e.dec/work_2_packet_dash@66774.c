int __fastcall work_2_packet_dash(int a1, int a2, _BYTE *a3, _DWORD *a4)
{
  ...
  *(_BYTE *)(v5 + 21504) = (v19 + 1) & 0x7F;
  ...
  if ( !v23 )
  {
    V_LOCK();
    LOWORD(v32) = -21200;
    HIWORD(v32) = (unsigned int)"analog value %08x" >> 16;
    LOWORD(v33) = -21008;
    logfmt_raw((char *)v46, 0x1000u, 0, v32);
    V_UNLOCK();
    LOWORD(v34) = -17536;
    HIWORD(v34) = (unsigned int)"info error" >> 16;
    v35 = a2 + 39;
    v36 = a2 + 119;
    zlog(g_zc, v34, 172, "work_2_packet_dash", 18, 126, 80, v46);
    v44 = (unsigned __int8)a3[3];
    do
    {
      v37 = *(unsigned __int8 *)++v35;
      HIWORD(v33) = (unsigned int)" %02x, reg %02x, clk_delay %08x" >> 16;
    ...
    V_LOCK();
    LOWORD(v38) = -17360;
    HIWORD(v38) = (unsigned int)"2x%02x%02x%02x chipid:%d coreid:%d" >> 16;
    logfmt_raw((char *)v46, 0x1000u, 0, v38, v43, v44);
    V_UNLOCK();
    LOWORD(v39) = -17536;
    HIWORD(v39) = (unsigned int)"info error" >> 16;
    zlog(g_zc, v39, 172, "dump_work_dash", 14, 76, 20, v46);
    V_LOCK();
    logfmt_raw((char *)v46, 0x1000u, 0, "dump work: %s", v45);
    V_UNLOCK();
    LOWORD(v40) = -17536;
    HIWORD(v40) = (unsigned int)"info error" >> 16;
    zlog(g_zc, v40, 172, "dump_work_dash", 14, 77, 20, v46);
  }
  ...
  *a4 = 86;
  ...
  v26 = dword_182110;
  v27 = 3435973837LL * (unsigned int)dword_182110++;
  ...
  if ( v26 == 20 * (HIDWORD(v27) >> 4) )
  {
    ...
    V_LOCK();
    LOWORD(v29) = -20944;
    HIWORD(v29) = (unsigned int)"x, but %02x, data %08x" >> 16;
    logfmt_raw((char *)v46, 0x1000u, v28, v29, "ChipSetting_bridge_reset_DASH_1766", 68);
    V_UNLOCK();
    LOWORD(v30) = -21416;
    HIWORD(v30) = (unsigned int)"_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/backend_ckb_2042/backend_ckb_2042.c" >> 16;
    zlog(g_zc, v30, 149, "ChipSetting_bridge_reset_DASH_1766", 34, 112, 20, v46);
    v46[1] = v28;
    v48 = BYTE1(v28);
    v50 = v28;
    v49 = 68;
    v47 = 1;
    v46[0] = 2;
    (*(void (__fastcall **)(int, _DWORD *))(a1 + 248))(a1, v46);
    usleep(0x64u);
  }
  return 0;
}
