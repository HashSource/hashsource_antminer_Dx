int __fastcall hs_header_print(_DWORD *a1, const char *a2)
{
  ...
  LOWORD(v4) = -31416;
  HIWORD(v4) = (unsigned int)"ead_back_data[3] = 0x%02x" >> 16;
  printf(v4, a2);
  LOWORD(v5) = -31404;
  HIWORD(v5) = (unsigned int)"a[3] = 0x%02x" >> 16;
  printf(v5, a2, *a1);
  LOWORD(v6) = -31388;
  HIWORD(v6) = (unsigned int)"Get one chain ISL: domain addr = %x vol=%u" >> 16;
  printf(v6, a2, a1[2]);
  LOWORD(v7) = -31372;
  HIWORD(v7) = (unsigned int)"L: domain addr = %x vol=%u" >> 16;
  printf(v7, a2, v21);
  LOWORD(v8) = -31352;
  HIWORD(v8) = (unsigned int)"vol=%u" >> 16;
  printf(v8, a2, v19);
  LOWORD(v9) = -31332;
  HIWORD(v9) = (unsigned int)"age [%d, %d], set default voltage %d" >> 16;
  printf(v9, a2, v20);
  LOWORD(v10) = -31312;
  HIWORD(v10) = (unsigned int)"fault voltage %d" >> 16;
  printf(v10, a2, v18);
  LOWORD(v11) = -31292;
  HIWORD(v11) = (unsigned int)"set vol %d,  %d, set again!" >> 16;
  printf(v11, a2, v22);
  LOWORD(v12) = -31268;
  HIWORD(v12) = (unsigned int)"in!" >> 16;
  printf(v12, a2, v23);
  LOWORD(v13) = -31244;
  HIWORD(v13) = (unsigned int)"omain addr = %x set vol %d, get vol %d" >> 16;
  printf(v13, a2, v24);
  LOWORD(v14) = -31224;
  HIWORD(v14) = (unsigned int)"vol %d, get vol %d" >> 16;
  printf(v14, a2, a1[63]);
  LOWORD(v15) = -31208;
