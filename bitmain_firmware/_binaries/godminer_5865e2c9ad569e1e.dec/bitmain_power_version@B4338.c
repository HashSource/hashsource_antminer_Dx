int bitmain_power_version()
{
  ...
  if ( dword_18A85C || (v0 = bitmain_power_open(), v0 >= 0) )
  {
    ...
    if ( sub_B3B48((void *)dword_18A858, (unsigned __int8 *)&v12, 6u, (unsigned __int8 *)&v14, 8u) )
    {
      ...
      zlog(g_zc, v11, 172, "_bitmain_get_power_version", 26, 300, 100, v18);
    }
    else
    {
  ...
  {
    LOWORD(v2) = 26740;
    HIWORD(v2) = (unsigned int)"atchdog" >> 16;
    snprintf((char *)s, 0x800u, v2, "bitmain_power_version");
    V_LOCK();
    logfmt_raw(v18, 0x1000u, 0, s);
    V_UNLOCK();
    LOWORD(v3) = 26388;
    HIWORD(v3) = (unsigned int)" failed" >> 16;
    zlog(g_zc, v3, 172, "bitmain_power_version", 21, 681, 100, v18);
  }
  return v0;
}
