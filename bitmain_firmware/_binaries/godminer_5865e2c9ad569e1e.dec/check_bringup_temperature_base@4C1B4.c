int __fastcall check_bringup_temperature_base(int a1)
{
  ...
  if ( ptr )
  {
    ...
    HIWORD(v13) = (unsigned int)"t_temp_monitor" >> 16;
    v49 = 0;
    v51 = 0;
    s = v12;
    v63 = v13;
...
LABEL_29:
          if ( v6 > 0 )
          {
            ...
            v62 = 0;
            HIWORD(v27) = (unsigned int)"high voltage befor rise freq." >> 16;
            v58 = v26;
            v60 = v27;
            v56 = 255;
            while ( 1 )
...
LABEL_58:
                V_LOCK();
                LOWORD(v44) = 25864;
                HIWORD(v44) = (unsigned int)"freq." >> 16;
                logfmt_raw(v80, 0x1000u, 0, v44);
                V_UNLOCK();
                LOWORD(v45) = 25580;
                HIWORD(v45) = (unsigned int)"or_addr %02x, J0:6" >> 16;
                zlog(g_zc, v45, 165, "check_bringup_temperature_base", 30, 267, 100, v80);
                while ( 1 )
                  ;
              }
            }
...
LABEL_53:
                LOWORD(v42) = 25580;
                HIWORD(v42) = (unsigned int)"or_addr %02x, J0:6" >> 16;
                zlog(v40, v42, 165, "check_bringup_temperature_base", 30, v41, 100, v80);
              }
            }
            ++v32;
            v31 += 6;
      ...
      if ( *v15 != -64 )
      {
        ...
        if ( !v18 )
        {
          ...
          *((_DWORD *)v19 - 128) = v17;
          ...
          LOWORD(v20) = 25804;
          HIWORD(v20) = (unsigned int)"ate failed" >> 16;
...
LABEL_23:
          LOWORD(v23) = 25580;
          HIWORD(v23) = (unsigned int)"or_addr %02x, J0:6" >> 16;
          zlog(v22, v23, 165, "check_bringup_temperature_base", 30, v21, 40, v80);
          goto LABEL_19;
        }
        if ( v18 == 1 )
        {
...
LABEL_19:
  ...
  LOWORD(v46) = 25788;
  LOWORD(v47) = 5892;
  HIWORD(v46) = (unsigned int)"temp monitor create failed" >> 16;
  HIWORD(v47) = (unsigned int)"simulation submit thread create failed" >> 16;
  printf(v47, v46);
  return 3;
}
