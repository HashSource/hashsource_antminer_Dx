int __fastcall set_voltage_and_freq_by_eeprom_chip_ft(_DWORD *a1, _DWORD *a2)
{
  ...
  *a2 = 0xFFFF;
      ...
      *v4++ = 0;
      ...
      while ( !*v8 || !strstr(*v8, v31) )
      {
        ...
        if ( v8 == v9 )
        {
          V_LOCK();
          LOWORD(v24) = 26424;
          HIWORD(v24) = (unsigned int)"r." >> 16;
          logfmt_raw(v32, 0x1000u, 0, v24, v31);
          V_UNLOCK();
          LOWORD(v25) = 25580;
          HIWORD(v25) = (unsigned int)"or_addr %02x, J0:6" >> 16;
          zlog(g_zc, v25, 165, "get_voltage_and_freq_by_chip_ft", 31, 950, 100, v32);
          return 33;
        }
      }
      v10 = v28;
  ...
  V_LOCK();
  LOWORD(v21) = 26448;
  HIWORD(v21) = (unsigned int)" J%d:4." >> 16;
  logfmt_raw(v32, 0x1000u, 0, v21, "set_voltage_and_freq_by_eeprom_chip_ft", *a1, *a2);
  V_UNLOCK();
  LOWORD(v22) = 25580;
  HIWORD(v22) = (unsigned int)"or_addr %02x, J0:6" >> 16;
  zlog(g_zc, v22, 165, "set_voltage_and_freq_by_eeprom_chip_ft", 38, 989, 0x28u, v32);
  return 0;
}
