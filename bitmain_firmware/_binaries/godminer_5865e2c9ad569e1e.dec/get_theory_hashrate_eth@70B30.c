int __fastcall get_theory_hashrate_eth(int a1, double *a2)
{
  ...
  if ( is_eeprom_loaded() )
  {
    ...
    if ( LODWORD(v4) )
    {
      ...
      LOWORD(v9) = -11964;
      HIWORD(v9) = (unsigned int)" baud tx failed!!!" >> 16;
      logfmt_raw(v19, 0x1000u, 0, v18, v17[0], v17[1], v17[2], v17[3], v17[4], v17[5], v17[6], v18, v9);
      V_UNLOCK();
      LOWORD(v10) = -12340;
      HIWORD(v10) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
      LODWORD(v4) = zlog(g_zc, v10, 170, "get_theory_hashrate_eth", 23, 1358, 100, v19);
      v5 = v14 * 1920.0;
    }
    else
    {
...
LABEL_6:
  ...
  *a2 = 1.0;
  ...
  HIWORD(v11) = (unsigned int)"counter: %d, [DAG] for chip %1d: %s" >> 16;
  ...
  zlog(g_zc, v13, 170, "get_theory_hashrate_eth", 23, 1349, 100, v19);
  return 32;
}
