int __fastcall packet_2_nonce_zec_1746(int a1, _BYTE *a2, int a3, _BYTE *a4, _DWORD *a5, unsigned int *a6, _DWORD *a7)
{
  ...
  if ( v11 > 5 )
  {
    V_LOCK();
    LOWORD(v16) = 15328;
    HIWORD(v16) = (unsigned int)"set_chain_mps_voltage" >> 16;
    logfmt_raw(var1004, 0x1000u, 0, v16, "packet_2_nonce_zec_1746", v12);
    V_UNLOCK();
    LOWORD(v17) = 14720;
    HIWORD(v17) = (unsigned int)"ailed after retry %d times" >> 16;
    zlog(g_zc, v17, 170, "packet_2_nonce_zec_1746", 23, 394, 80, var1004);
    return 14;
  }
  else
  {
    ...
    if ( v14 == 15 )
    {
      ...
      do
      {
        ...
        if ( __PAIR64__(HIBYTE(v55), (unsigned __int8)v55) != __PAIR64__(v20[90], v20[89]) )
        {
          V_LOCK();
          LOWORD(v21) = 15352;
          HIWORD(v21) = (unsigned int)"%s[%d]=%s" >> 16;
          logfmt_raw(
            var1004,
            0x1000u,
            0,
          ...
          V_UNLOCK();
          LOWORD(v22) = 14720;
          HIWORD(v22) = (unsigned int)"ailed after retry %d times" >> 16;
          zlog(g_zc, v22, 170, "verify_nonce_integrality_zec_1746", 33, 294, 20, var1004);
          return 11;
        }
        ++v18;
        v20 += 91;
      ...
      for ( i = 0; i != 16; ++i )
      {
        ...
        if ( (v26 & 0xF) != i )
        {
          V_LOCK();
          LOWORD(v27) = 15400;
          HIWORD(v27) = (unsigned int)"/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/device/hal/drv_pic/mps2973.c" >> 16;
          logfmt_raw(var1004, 0x1000u, 0, v27, i);
          V_UNLOCK();
          v28 = 303;
LABEL_15:
          LOWORD(v29) = 14720;
          HIWORD(v29) = (unsigned int)"ailed after retry %d times" >> 16;
          zlog(g_zc, v29, 170, "verify_nonce_integrality_zec_1746", 33, v28, 20, var1004);
          return 36;
        }
      }
      v30 = v19;
      ...
      do
      {
        ...
        if ( v32 != *(unsigned __int8 *)(v19 + 1) )
        {
          V_LOCK();
          LOWORD(v34) = 15428;
          HIWORD(v34) = (unsigned int)"ootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/device/hal/drv_pic/mps2973.c" >> 16;
          logfmt_raw(
            var1004,
            0x1000u,
            0,
      ...
      do
      {
        ...
        if ( v37 != *(unsigned __int8 *)(v19 + 2) )
        {
          V_LOCK();
          LOWORD(v39) = 15464;
          HIWORD(v39) = (unsigned int)"dminer-origin_godminer-new/backend/device/hal/drv_pic/mps2973.c" >> 16;
          logfmt_raw(
            var1004,
            0x1000u,
            0,
      ...
      do
      {
        ...
        if ( v41 != *(unsigned __int8 *)(v19 + 3) )
        {
          ...
          V_LOCK();
          LOWORD(v43) = 15500;
          HIWORD(v43) = (unsigned int)"evice/hal/drv_pic/mps2973.c" >> 16;
          logfmt_raw(
            var1004,
            0x1000u,
            0,
