...
LABEL_14:
        ...
        HIWORD(v14) = (unsigned int)"t_temp_monitor" >> 16;
        v47 = 0;
        v53 = 0;
        s = v13;
        v56 = v14;
...
LABEL_23:
        ...
        while ( 1 )
        {
          ...
          if ( *v16 != -64 )
          {
            v19 = *(_DWORD *)(*(_DWORD *)(all_created_runtime[v17] + 364) + v15 + 12);
            if ( !v19 )
            {
              v20 = &v75[4 * v47++];
              *((_DWORD *)v20 - 128) = v18;
              V_LOCK();
              V_INT((int)v63, s, *(int *)(all_created_runtime[v17] + 232));
              LOWORD(v21) = 25804;
              HIWORD(v21) = (unsigned int)"ate failed" >> 16;
...
LABEL_22:
              LOWORD(v24) = 25580;
              HIWORD(v24) = (unsigned int)"or_addr %02x, J0:6" >> 16;
              zlog(v23, v24, 165, "check_temperature_base", 22, v22, 20, v75);
              goto LABEL_18;
            }
            if ( v19 == 1 )
            {
              ...
              *((_DWORD *)v44 - 64) = v18;
              V_LOCK();
              V_INT((int)v65, s, *(int *)(all_created_runtime[v17] + 232));
...
LABEL_25:
      if ( v8 > 0 )
      {
        ...
        v30 = -64;
        v52 = v26;
        HIWORD(v28) = (unsigned int)"high voltage befor rise freq." >> 16;
        v49 = v27;
        v55 = v28;
        sa = 0;
        while ( 1 )
...
LABEL_45:
              ...
              zlog(v42, v43, 165, "check_temperature_base", 22, v41, 100, v75);
            }
LABEL_34:
...
LABEL_41:
  ...
  else
  {
    LOWORD(v45) = 25788;
    LOWORD(v46) = 5892;
    HIWORD(v45) = (unsigned int)"temp monitor create failed" >> 16;
    HIWORD(v46) = (unsigned int)"simulation submit thread create failed" >> 16;
    printf(v46, v45);
    return 3;
  }
  return result;
