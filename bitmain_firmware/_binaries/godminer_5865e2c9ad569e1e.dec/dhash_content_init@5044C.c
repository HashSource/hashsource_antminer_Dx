_DWORD *__fastcall dhash_content_init(int a1)
{
  ...
  switch ( a1 )
  {
    ...
    default:
      ...
      LOWORD(v2) = 28408;
      LOWORD(v3) = 28468;
      HIWORD(v2) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/rel"
                                 "ease/build/godminer-origin_godminer-new/dhash_content/eth/eth_2280/eth_2280_content.c" >> 16;
      HIWORD(v3) = (unsigned int)"ld/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/dhash_content/eth/eth_2280/eth_2280_content.c" >> 16;
      zlog(g_zc, v3, 156, v2, 18, 56, 100, v5);
      result = 0;
      break;
  }
  return result;
