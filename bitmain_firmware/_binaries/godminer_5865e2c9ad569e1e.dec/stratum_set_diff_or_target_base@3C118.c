int __fastcall stratum_set_diff_or_target_base(int a1, int a2, _DWORD *a3)
{
  ...
  if ( json_array_get(a3, 0) && *json_array_get(a3, 0) == 2 )
  {
    ...
    if ( v18 && strlen(v18) == 64 )
    {
      V_LOCK();
      LOWORD(v20) = 14440;
      HIWORD(v20) = (unsigned int)"set diff or target" >> 16;
      logfmt_raw((char *)v30, 0x1000u, 0, v20, "stratum_set_diff_or_target_base", v19);
      V_UNLOCK();
      LOWORD(v21) = 14288;
      HIWORD(v21) = (unsigned int)"failed(%d): %s" >> 16;
      zlog(g_zc, v21, 151, "stratum_set_diff_or_target_base", 31, 24, 20, v30);
      v22 = strlen(v19);
...
LABEL_7:
    LOWORD(v15) = 14016;
    LOWORD(v16) = 14288;
    HIWORD(v15) = (unsigned int)"meters" >> 16;
    HIWORD(v16) = (unsigned int)"failed(%d): %s" >> 16;
    zlog(g_zc, v16, 151, v15, 31, v14, 100, v30);
    return 0;
  }
  ...
  *(double *)(a2 + 1808) = v3;
  ...
  V_LOCK();
  LOWORD(v9) = 14464;
  HIWORD(v9) = (unsigned int)" %d is jsonrpc_2, no need to subscribe" >> 16;
  logfmt_raw((char *)v30, 0x1000u, 0, v9, "stratum_set_diff_or_target_base", v29, v3);
  V_UNLOCK();
  LOWORD(v10) = 14288;
  HIWORD(v10) = (unsigned int)"failed(%d): %s" >> 16;
  zlog(g_zc, v10, 151, "stratum_set_diff_or_target_base", 31, 42, 20, v30);
  V_LOCK();
  LOWORD(v11) = 14488;
  HIWORD(v11) = (unsigned int)"d to subscribe" >> 16;
  logfmt_raw(
    (char *)v30,
    0x1000u,
    0,
  ...
  zlog(g_zc, v12, 151, "stratum_set_diff_or_target_base", 31, 43, 20, v30);
  pthread_mutex_unlock((pthread_mutex_t *)(a2 + 1592));
  return 1;
}
