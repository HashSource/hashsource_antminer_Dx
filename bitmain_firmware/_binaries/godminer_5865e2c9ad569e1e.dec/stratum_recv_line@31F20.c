  ...
  if ( !strchr(spins, 10) && a1[1].__kind != -1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v13 )
      {
        V_LOCK();
        LOWORD(v23) = 9000;
        HIWORD(v23) = (unsigned int)"e url err!" >> 16;
      ...
      if ( v13 < 0 )
      {
        V_LOCK();
        v14 = _errno_location();
        HIWORD(v12) = (unsigned int)" port: %d" >> 16;
        logfmt_raw((char *)v32, 0x1000u, 0, v12, v13, *v14);
        V_UNLOCK();
        LOWORD(v15) = 8852;
        HIWORD(v15) = (unsigned int)"rror %d" >> 16;
        zlog(g_zc, v15, 144, "stratum_recv_line", 17, 63, 20, v32);
        if ( *v14 != 11 || !socket_full(a1[1].__kind, 1) )
        {
          V_LOCK();
          LOWORD(v16) = 9076;
          HIWORD(v16) = (unsigned int)"setsockopt SO_REUSEADDR failed (ignored): %s" >> 16;
...
LABEL_20:
          LOWORD(v24) = 8852;
          HIWORD(v24) = (unsigned int)"rror %d" >> 16;
          zlog(v17, v24, 144, "stratum_recv_line", 17, v18, 20, v32);
          V_LOCK();
          LOWORD(v25) = 5072;
          ...
          V_UNLOCK();
          LOWORD(v26) = 8852;
          HIWORD(v26) = (unsigned int)"rror %d" >> 16;
          zlog(g_zc, v26, 144, "stratum_recv_line", 17, 74, 20, v34);
          goto LABEL_21;
        }
      }
      else
...
LABEL_2:
  ...
  LOWORD(v5) = 5912;
  v6 = v4;
  HIWORD(v5) = (unsigned int)"read create failed" >> 16;
  v7 = strtok(spins, v5);
  if ( v7 )
  {
    v8 = _strdup(v7);
    ...
    if ( opt_protocol )
    {
      ...
      lock = a1->__lock;
      LOWORD(v20) = 5072;
      HIWORD(v20) = (unsigned int)"unknow config parameter!" >> 16;
      LOWORD(v21) = 9216;
      ...
      zlog(g_zc, v22, 144, "stratum_recv_line", 17, 97, 60, v34);
    }
    return v8;
  }
  else
  {
    V_LOCK();
    LOWORD(v27) = 9152;
    HIWORD(v27) = (unsigned int)"ip address config error" >> 16;
    logfmt_raw(v34, 0x1000u, 0, v27);
    V_UNLOCK();
    LOWORD(v28) = 8852;
    HIWORD(v28) = (unsigned int)"rror %d" >> 16;
    zlog(g_zc, v28, 144, "stratum_recv_line", 17, 82, 100, v34);
LABEL_21:
    pthread_mutex_unlock(v1);
    return 0;
  }
