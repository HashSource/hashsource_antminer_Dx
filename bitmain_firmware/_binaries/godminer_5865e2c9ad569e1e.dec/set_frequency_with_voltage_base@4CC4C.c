int __fastcall set_frequency_with_voltage_base(int a1)
{
  ...
  if ( !is_check_asic_voltage_enable() )
  {
    ...
    V_LOCK();
    LOWORD(v24) = 26100;
    HIWORD(v24) = (unsigned int)"mes:%d" >> 16;
    logfmt_raw(v56, 0x1000u, 0, v24);
    V_UNLOCK();
    LOWORD(v25) = 25580;
    HIWORD(v25) = (unsigned int)"or_addr %02x, J0:6" >> 16;
    zlog(g_zc, v25, 165, "set_frequency_with_voltage_base", 31, 510, 40, v56);
  }
  if ( *(_DWORD *)(a1 + 92) != -64 )
  ...
  V_LOCK();
  LOWORD(v8) = 24112;
  HIWORD(v8) = (unsigned int)"p on!" >> 16;
  logfmt_raw(v56, 0x1000u, 0, v8);
  V_UNLOCK();
  LOWORD(v9) = 25580;
  HIWORD(v9) = (unsigned int)"or_addr %02x, J0:6" >> 16;
  zlog(g_zc, v9, 165, "set_frequency_with_voltage_base", 31, 520, 60, v56);
...
LABEL_30:
      ...
      V_UNLOCK();
      LOWORD(v27) = 25580;
      HIWORD(v27) = (unsigned int)"or_addr %02x, J0:6" >> 16;
      zlog(g_zc, v27, 165, "set_frequency_with_voltage_base", 31, 555, 60, v56);
      if ( v50 > 0 )
      {
        LOWORD(v28) = 5912;
        ...
        for ( i = 0; i < v50; ++i )
        {
          v31 = *((_DWORD *)v29 + 1);
          v29 += 4;
          if ( api_get_eeprom_fmt_version(*(_DWORD *)(v31 + 228)) == 4 )
          {
            eeprom_asic_freqs = api_get_eeprom_asic_freqs(*(_DWORD *)(*(_DWORD *)v29 + 228), &dest, &v51);
            if ( !eeprom_asic_freqs )
            {
              memset(s, 0, sizeof(s));
              v33 = *(_DWORD *)v29;
              v34 = *(_DWORD *)(*(_DWORD *)v29 + 312);
              if ( v34 )
              {
                v35 = (float *)&v54;
                v36 = dest + 0.0;
                ...
                while ( 1 )
                {
                  ...
                  {
                    HIWORD(v28) = (unsigned int)"read create failed" >> 16;
                    *v39 = *v28;
                  }
                }
              }
              ...
              v40 = v36 / (float)v34;
              (*(void (__fastcall **)(int, float *))(v33 + 200))(v33, &dest);
              v41 = *(_DWORD *)v29;
              *(_DWORD *)(v41 + 440) = (int)v40;
              *(float *)(v41 + 940) = (float)(int)v40;
              eeprom_sweep_freq = api_get_eeprom_sweep_freq(i);
              V_LOCK();
              v43 = *(_DWORD *)(*(_DWORD *)v29 + 228);
              ...
              V_UNLOCK();
              LOWORD(v46) = 25580;
              HIWORD(v46) = (unsigned int)"or_addr %02x, J0:6" >> 16;
              zlog(g_zc, v46, 165, "set_frequency_with_voltage_base", 31, 588, 40, v56);
            }
          }
        }
      }
...
LABEL_29:
      LOWORD(v22) = 24068;
      LOWORD(v23) = 5892;
      HIWORD(v22) = (unsigned int)" have been poweroff." >> 16;
