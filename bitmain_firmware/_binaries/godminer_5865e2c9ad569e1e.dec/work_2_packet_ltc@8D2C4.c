int __fastcall work_2_packet_ltc(int a1, _DWORD *a2, unsigned __int8 *a3, _DWORD *a4)
{
  ...
  *(_BYTE *)(v5 + 27136) = (v21 + 1) & 0x7F;
  ...
  if ( !v27 )
  {
    V_LOCK();
    LOWORD(v31) = -21200;
    HIWORD(v31) = (unsigned int)"analog value %08x" >> 16;
    LOWORD(v32) = -21008;
    logfmt_raw(v46, 0x1000u, 0, v31);
    V_UNLOCK();
    LOWORD(v33) = -316;
    LOWORD(v34) = 572;
    HIWORD(v33) = (unsigned int)"ChipSetting_pll_sel_LTC_1489" >> 16;
    HIWORD(v34) = (unsigned int)"ildroot/tmp/release/build/godminer-origin_godminer-new/./backend/chip_setting.c" >> 16;
    zlog(g_zc, v34, 170, v33, 17, 198, 80, v46);
    v35 = (char *)a2 + 71;
    v36 = (char *)a2 + 151;
    v44 = a3[3];
    do
    {
      ...
      HIWORD(v32) = (unsigned int)" %02x, reg %02x, clk_delay %08x" >> 16;
    ...
    V_LOCK();
    LOWORD(v38) = 744;
    HIWORD(v38) = (unsigned int)"iff %02x ans diff %02x TICKET_MASK_ZERO_COUNT_LTC %02x" >> 16;
    logfmt_raw(v46, 0x1000u, 0, v38, v43, v44);
    V_UNLOCK();
    LOWORD(v39) = 572;
    HIWORD(v39) = (unsigned int)"ildroot/tmp/release/build/godminer-origin_godminer-new/./backend/chip_setting.c" >> 16;
    zlog(g_zc, v39, 170, "dump_work_ltc", 13, 117, 20, v46);
    V_LOCK();
    logfmt_raw(v46, 0x1000u, 0, "dump work: %s", v45);
    V_UNLOCK();
    LOWORD(v40) = 572;
    HIWORD(v40) = (unsigned int)"ildroot/tmp/release/build/godminer-origin_godminer-new/./backend/chip_setting.c" >> 16;
    zlog(g_zc, v40, 170, "dump_work_ltc", 13, 118, 20, v46);
  }
