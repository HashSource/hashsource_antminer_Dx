int __fastcall set_sweep_frequency_ckb(int a1, float *a2)
{
  ...
  if ( v13 > 0 )
  {
    ...
    HIWORD(v15) = (unsigned int)"software_reset_DASH_1766" >> 16;
    v42 = v14;
    v38 = 4 * v44;
    v45 = 1;
    v43 = v15;
    do
    {
            ...
            do
            {
              ...
              if ( !v22 && !v21 )
              {
                ...
                zlog(
                  ...
                  20,
                  s);
                (*(void (__fastcall **)(int, _DWORD *))(a1 + 248))(a1, v51);
                usleep(0x2710u);
                *v19 = v23;
              }
              v37 += v44;
      ...
      V_LOCK();
      LOWORD(v26) = -19172;
      HIWORD(v26) = (unsigned int)"ing_core_ticket_mask_DASH_1766" >> 16;
      v35 = v45++;
      logfmt_raw(s, 0x1000u, 0, v26, *(_DWORD *)(a1 + 228), v34, (float)(v5 + (float)(v16 * v2)), v5, v2, v35);
      V_UNLOCK();
      zlog(
        g_zc,
  ...
  if ( v44 * chain_domain_num > 0 )
  {
    ...
    do
    {
      v31 = *v29++;
      v32 = v30;
      HIWORD(v28) = (unsigned int)"chine_info" >> 16;
      ++v30;
