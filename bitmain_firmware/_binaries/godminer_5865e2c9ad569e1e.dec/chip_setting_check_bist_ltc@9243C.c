int __fastcall chip_setting_check_bist_ltc(int a1, int a2, int a3, int a4, int *a5)
{
  ...
  V_LOCK();
  LOWORD(v11) = 2328;
  HIWORD(v11) = (unsigned int)"dag_node_num_rvn" >> 16;
  logfmt_raw(v41, 0x1000u, 0, v11, a2, a3, a4);
  V_UNLOCK();
  LOWORD(v12) = 2084;
  HIWORD(v12) = (unsigned int)"d core %d " >> 16;
  zlog(g_zc, v12, 175, "chip_setting_check_bist_ltc", 27, 188, 20, v41);
  ...
  HIWORD(v37) = 6;
  BYTE1(v38) = v14;
  (*(void (__fastcall **)(int, _DWORD *, int, char *, int *, int, int, _DWORD))(a1 + 276))(
    a1,
    v36,
    v30,
    ptr,
  ...
  if ( v35 > 0 )
  {
    ...
    do
    {
      ...
      if ( *((_WORD *)v15 + 3) == 6 )
        v17 = v15[3] & 1;
      if ( a2 )
        a5[(unsigned int)(unsigned __int8)v15[4] / *(_DWORD *)(a1 + 404)] = v17;
      else
        *a5 = v17;
      v15 += 12;
    }
  ...
  V_UNLOCK();
  LOWORD(v21) = 2084;
  HIWORD(v21) = (unsigned int)"d core %d " >> 16;
  zlog(g_zc, v21, 175, "chip_setting_check_bist_ltc", 27, 223, 80, v41);
  if ( v30 <= 0 )
  {
LABEL_21:
    v18 = 0;
  ...
  else
  {
    ...
    v18 = 0;
    LOWORD(v23) = 2452;
    HIWORD(v22) = (unsigned int)"d core %d " >> 16;
    v24 = &a5[v30];
    v25 = 0;
    v31 = v22;
    do
    {
      if ( !*v8++ )
      {
        ...
        if ( a2 )
          v27 = v25;
        HIWORD(v23) = (unsigned int)"_ctrl_RVN" >> 16;
        logfmt_raw(v41, 0x1000u, 0, v23, v27, a4);
        V_UNLOCK();
        zlog(g_zc, v31, 175, "chip_setting_check_bist_ltc", 27, 228, 80, v41);
      }
      ++v25;
    }
    while ( v24 != v8 );
