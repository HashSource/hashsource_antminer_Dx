bool __fastcall stratum_connect(int a1)
{
    ...
    || !(server_port_from_url = get_server_port_from_url((char *)(v3 + 14), cp, &v31)) )
  {
    ...
    V_LOCK();
    LOWORD(v5) = -1252;
    HIWORD(v5) = (unsigned int)"pted" >> 16;
    V_STR(optval, v5, *(const char **)(a1 + 32));
    LOWORD(v6) = 9260;
    HIWORD(v6) = (unsigned int)"...retry after %d seconds failures %d" >> 16;
    logfmt_raw(
      v36,
      0x1000u,
      0,
    ...
    zlog(g_zc, v7, 144, "stratum_connect", 15, 117, 100, v36);
    goto LABEL_4;
  }
  V_LOCK();
  LOWORD(v9) = 9276;
  HIWORD(v9) = (unsigned int)"d seconds failures %d" >> 16;
  logfmt_raw(v36, 0x1000u, 0, v9, *(_DWORD *)(a1 + 32), cp, v31);
  V_UNLOCK();
  LOWORD(v10) = 8852;
  HIWORD(v10) = (unsigned int)"rror %d" >> 16;
  zlog(g_zc, v10, 144, "stratum_connect", 15, 120, 20, v36);
  v11 = *(_BYTE **)(a1 + 44);
  if ( !v11 )
  {
  ...
  if ( *(_DWORD *)(a1 + 36) == -1 )
  {
    ...
    *(_DWORD *)(a1 + 36) = v17;
    if ( v17 == -1 )
    {
      V_LOCK();
      LOWORD(v24) = 9308;
      HIWORD(v24) = (unsigned int)"is active, pool url %s, current_pool %d" >> 16;
      server_port_from_url = 0;
    ...
    if ( setsockopt(v17, 1, 2, optval, 4u) )
    {
      ...
      v19 = strerror(*v18);
      LOWORD(v20) = 9336;
      HIWORD(v20) = (unsigned int)"ent_pool %d" >> 16;
      logfmt_raw(v36, 0x1000u, 0, v20, v19);
      V_UNLOCK();
      LOWORD(v21) = 8852;
      HIWORD(v21) = (unsigned int)"rror %d" >> 16;
      zlog(g_zc, v21, 144, "stratum_connect", 15, 145, 100, v36);
    }
  }
  if ( inet_addr(cp) == -1 )
  {
    if ( _res_init() < 0 )
    {
      ...
      *(_DWORD *)(a1 + 36) = -1;
      V_LOCK();
      LOWORD(v29) = 9388;
      HIWORD(v29) = (unsigned int)"ection interrupted" >> 16;
    ...
    else
    {
      ...
      *(_DWORD *)(a1 + 36) = -1;
      V_LOCK();
      LOWORD(v30) = 9416;
      HIWORD(v30) = (unsigned int)"thread out" >> 16;
...
LABEL_24:
    ...
    zlog(v25, v28, 144, "stratum_connect", 15, v27, v26, v36);
    goto LABEL_4;
  }
  ...
  *(_WORD *)addr.sa_data = __rev16(v31);
  ...
  else
  {
    if ( dword_174CCC <= 3 )
    {
      ...
      v14 = strerror(*v13);
      LOWORD(v15) = 9440;
      HIWORD(v15) = (unsigned int)"k, no pool %d, empty url or user" >> 16;
      logfmt_raw(v36, 0x1000u, 0, v15, v14);
      V_UNLOCK();
      LOWORD(v16) = 8852;
      HIWORD(v16) = (unsigned int)"rror %d" >> 16;
      zlog(g_zc, v16, 144, "stratum_connect", 15, 197, 100, v36);
    }
    server_port_from_url = 0;
    close(*(_DWORD *)(a1 + 36));
    *(_DWORD *)(a1 + 36) = -1;
