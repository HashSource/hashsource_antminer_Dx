int __fastcall phy_external_bist_init_rvn(int a1, int a2, unsigned int a3, int a4)
{
  ...
  V_INT((int)v26, v7, *(int *)(a1 + 232));
  LOWORD(v8) = -5776;
  HIWORD(v8) = (unsigned int)"Setting_bridge_reset_HNS_2130" >> 16;
  logfmt_raw(
    v36,
    0x1000u,
    0,
  ...
  V_UNLOCK();
  LOWORD(v9) = 7620;
  HIWORD(v9) = (unsigned int)"nt> %lld" >> 16;
  zlog(g_zc, v9, 173, "phy_external_bist_init_rvn", 26, 988, 60, v36);
  ...
  if ( check_core_reg_with_expect_data_rvn_0(a1, a2, a3, 125, 0x70007000u) )
  {
    ...
    V_UNLOCK();
    LOWORD(v22) = 7620;
    HIWORD(v22) = (unsigned int)"nt> %lld" >> 16;
    zlog(g_zc, v22, 173, "phy_external_bist_init_rvn", 26, 1041, 100, v36);
  }
  ...
  if ( check_core_reg_with_expect_data_rvn_0(a1, a2, a3, 119, 0) )
  {
    ...
    V_INT((int)v30, v10, *(int *)(a1 + 232));
    LOWORD(v11) = -6536;
    HIWORD(v11) = (unsigned int)"ock failed!" >> 16;
    logfmt_raw(
      v36,
      0x1000u,
      0,
    ...
    V_UNLOCK();
    LOWORD(v12) = 7620;
    HIWORD(v12) = (unsigned int)"nt> %lld" >> 16;
    zlog(g_zc, v12, 173, "phy_external_bist_init_rvn", 26, 1068, 100, v36);
  }
  ...
  V_INT((int)v32, v14, *(int *)(a1 + 232));
  HIWORD(v13) = (unsigned int)" lost cnt> %lld" >> 16;
  logfmt_raw(
    v36,
    0x1000u,
    0,
  ...
  zlog(g_zc, v15, 173, "phy_external_bist_init_rvn", 26, 1074, 100, v36);
  ...
  if ( check_core_reg_with_expect_data_rvn_0(a1, a2, a3, 83, 0) )
  {
    ...
    V_INT((int)v34, v16, *(int *)(a1 + 232));
    LOWORD(v17) = -9728;
    LOWORD(v18) = -6464;
    HIWORD(v17) = (unsigned int)"ore %d reg %04x rdata %08x" >> 16;
    ...
    V_UNLOCK();
    LOWORD(v19) = 7620;
    HIWORD(v19) = (unsigned int)"nt> %lld" >> 16;
    zlog(g_zc, v19, 173, "phy_handshake_rvn", 17, 827, 100, v36);
  }
