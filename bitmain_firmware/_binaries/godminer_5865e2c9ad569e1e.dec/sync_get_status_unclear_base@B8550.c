int __fastcall sync_get_status_unclear_base(pthread_mutex_t *a1, int a2, int a3, int *a4, unsigned __int64 a5)
{
  int v5; // r5
  ...
  v17[0] = sub_12F324(a5, 0x3E8u);
  while ( v10 < a2 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(a1[35].__lock, v18, 0xAu, v17) == 110 )
      {
        v5 = 3;
        goto LABEL_12;
      }
