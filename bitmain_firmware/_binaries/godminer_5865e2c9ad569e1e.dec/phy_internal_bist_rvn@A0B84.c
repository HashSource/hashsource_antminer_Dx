int __fastcall phy_internal_bist_rvn(int a1, int a2, unsigned int a3, int a4)
{
  ...
  V_UNLOCK();
  LOWORD(v10) = 7620;
  HIWORD(v10) = (unsigned int)"nt> %lld" >> 16;
  zlog(g_zc, v10, 173, "phy_internal_bist_rvn", 21, 870, 20, v65);
  v37 = malloc(0x300u);
  ...
  if ( check_core_reg_with_expect_data_rvn_0(a1, a2, a3, 125, 0x70007000u) )
  {
    V_LOCK();
    LOWORD(v31) = 620;
    HIWORD(v31) = (unsigned int)" %lld" >> 16;
    V_INT((int)v47, v31, *(int *)(a1 + 232));
    LOWORD(v32) = -6572;
    HIWORD(v32) = (unsigned int)"re %02x reg %04x rdata %08x" >> 16;
    logfmt_raw(
      v65,
      0x1000u,
      0,
  ...
  if ( check_core_reg_with_expect_data_rvn_0(a1, a2, a3, 119, 0) )
  {
    ...
    V_INT((int)v49, v29, *(int *)(a1 + 232));
    LOWORD(v30) = -6536;
    HIWORD(v30) = (unsigned int)"ock failed!" >> 16;
    logfmt_raw(
      v65,
      0x1000u,
      0,
  ...
  V_LOCK();
  LOWORD(v12) = 620;
  HIWORD(v12) = (unsigned int)" %lld" >> 16;
  V_INT((int)v51, v12, *(int *)(a1 + 232));
  HIWORD(v11) = (unsigned int)" lost cnt> %lld" >> 16;
  logfmt_raw(
    v65,
    0x1000u,
    0,
  ...
  if ( check_core_reg_with_expect_data_rvn_0(a1, a2, a3, 83, 0) )
  {
    ...
    LOWORD(v14) = -6464;
    V_INT((int)v63, v13, *(int *)(a1 + 232));
    LOWORD(v15) = -9728;
    HIWORD(v15) = (unsigned int)"ore %d reg %04x rdata %08x" >> 16;
    ...
    V_UNLOCK();
    LOWORD(v16) = 7620;
    HIWORD(v16) = (unsigned int)"nt> %lld" >> 16;
    zlog(g_zc, v16, 173, "phy_handshake_rvn", 17, 827, 100, v65);
  }
  phy_pll_switch_rvn(a1, a2, a3, a4);
  sub_99D08(a1, a3, 98, -1426085121);
  usleep(0x64u);
  if ( check_core_reg_with_expect_data_rvn_0(a1, a2, a3, 64, 0xFF000100) )
  {
    V_LOCK();
    LOWORD(v34) = 620;
    HIWORD(v34) = (unsigned int)" %lld" >> 16;
    V_INT((int)v53, v34, *(int *)(a1 + 232));
    LOWORD(v35) = -6452;
    HIWORD(v35) = (unsigned int)" lane num> %d" >> 16;
    logfmt_raw(
      v65,
      0x1000u,
      0,
  ...
  sub_99D08(a1, a3, 133, 255);
  usleep(0x64u);
  sub_99D08(a1, a3, 134, 255);
  usleep(0x64u);
  sub_99D08(a1, a3, 132, -2147483647);
  sleep(6u);
  if ( check_core_reg_with_expect_data_rvn_0(a1, a2, a3, 139, 0xFF0000FF) )
  {
    V_LOCK();
    LOWORD(v33) = 620;
    HIWORD(v33) = (unsigned int)" %lld" >> 16;
    V_INT((int)v55, v33, *(int *)(a1 + 232));
    logfmt_raw(
      v65,
      0x1000u,
      0,
  ...
  LOWORD(v17) = -6380;
  HIWORD(v17) = (unsigned int)"[PHY EQ MAIN SET] chip 0x0 core 0x0 reg 0x70 rdata %08x" >> 16;
  v39 = v17;
  v43 = -1970698105;
  v18 = 135;
...
LABEL_17:
  ...
  LOWORD(v23) = 620;
  LOWORD(v22) = -6320;
  HIWORD(v23) = (unsigned int)" %lld" >> 16;
  HIWORD(v22) = (unsigned int)"t !!! %s PHY core %02x macro0 rx is invalid!" >> 16;
  v40 = v22;
  v44 = -2088599168;
  v24 = 128;
  for ( j = (int *)((char *)&v44 + 1); ; j = (_DWORD *)((char *)j + 1) )
  {
    ...
    if ( v26 )
    {
      ...
      do
      {
        ...
        V_LOCK();
        v25 += 3;
        V_INT((int)v60, v23, *(int *)(a1 + 232));
        V_INT((int)v62, v23, *(int *)(a1 + 232));
        logfmt_raw(
          v65,
          0x1000u,
          0,
