int __fastcall membist1(int a1)
{
  ...
  zlog(g_zc, v4, 170, "membist1", 8, 663, 60, v63);
  memset(s, 0, sizeof(s));
  LOWORD(v5) = -11100;
  ...
  do
  {
    sub_70158(a1, v41, 12, 1);
    usleep(0x61A80u);
    sub_70158(a1, v41, 160, -2147483647);
    usleep(0xC3500u);
    memset(ptr, 0, 0x600u);
    v6 = sub_703F8(a1, (unsigned __int16)v41, 161, ptr);
    if ( v6 == 8 )
      goto LABEL_4;
    V_LOCK();
    LOWORD(v7) = 620;
    HIWORD(v7) = (unsigned int)" %lld" >> 16;
    V_INT((int)v48, v7, *(int *)(a1 + 232));
    LOWORD(v8) = -11184;
    HIWORD(v8) = (unsigned int)"%llx/0x%llx" >> 16;
    ...
    zlog(g_zc, v9, 170, "membist1", 8, 683, 100, v63);
    if ( v6 > 0 )
    {
LABEL_4:
      LOWORD(v10) = 620;
      ...
      do
      {
        while ( (*v11 & 0x80) == 0 )
        {
          ...
          V_UNLOCK();
          LOWORD(v13) = -12340;
          HIWORD(v13) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
          zlog(g_zc, v13, 170, "membist1", 8, 699, 100, v63);
          if ( v6 <= v12 )
            goto LABEL_10;
        }
        if ( (*v11 & 0xFFFFFF00) != 0 )
        {
          ...
          V_UNLOCK();
          LOWORD(v29) = -12340;
          HIWORD(v29) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
          zlog(g_zc, v29, 170, "membist1", 8, 692, 100, v63);
...
LABEL_10:
    memset(ptr, 0, 0x600u);
    v14 = sub_703F8(a1, (unsigned __int16)v41, 162, ptr);
    if ( v14 == 8 )
      goto LABEL_12;
    V_LOCK();
    LOWORD(v15) = 620;
    HIWORD(v15) = (unsigned int)" %lld" >> 16;
    V_INT((int)v54, v15, *(int *)(a1 + 232));
    logfmt_raw(
      v63,
      0x1000u,
      0,
    ...
    zlog(g_zc, v16, 170, "membist1", 8, 707, 100, v63);
    if ( v14 > 0 )
    {
LABEL_12:
      LOWORD(v17) = 620;
      ...
      do
      {
        while ( (*v18 & 0x80) == 0 )
        {
          ...
          zlog(g_zc, v20, 170, "membist1", 8, 723, 100, v63);
          if ( v14 <= v19 )
            goto LABEL_18;
        }
        if ( (*v18 & 0xFFFFFF00) != 0 )
        {
          ...
          zlog(g_zc, v31, 170, "membist1", 8, 716, 100, v63);
...
LABEL_18:
  ...
  LOWORD(v21) = 620;
  LOWORD(v22) = -10976;
  HIWORD(v21) = (unsigned int)" %lld" >> 16;
  LOWORD(v23) = -12340;
  v24 = 0;
  HIWORD(v22) = (unsigned int)"get chip dag crc status failed, resp_num: %d, retry_time: %d" >> 16;
  useconds = v21;
  ...
  do
  {
    ...
    v36 += v25;
    v40 += ptra;
    V_INT((int)v60, useconds, *(int *)(a1 + 232));
    v33 = v24++;
    logfmt_raw(
      v63,
      0x1000u,
      ...
      v36);
    V_UNLOCK();
    v26 = zlog(g_zc, v45, 170, "membist1", 8, 736, 100, v63);
  }
  while ( v24 != 8 );
  v27 = dev_ctrl(v26);
