int __fastcall membist0(int a1)
{
  ...
  LOWORD(v1) = -11660;
  HIWORD(v1) = (unsigned int)"done!" >> 16;
  v2 = &g_zc;
  v71 = v1;
  v72[0] = -2023406815;
  v72[1] = 1266163410;
  ...
  v72[3] = 517098360;
  LOWORD(v4) = -11544;
  HIWORD(v4) = (unsigned int)"t0: lost/err/etherr: %08x/%08x/%08x, total:lost/err/etherr: %llx/%llx/%llx" >> 16;
  v65 = v4;
  v72[4] = -766805986;
  V_LOCK();
  LOWORD(v5) = -11848;
  ...
  zlog(g_zc, v6, 170, "membist0", 8, 545, 40, v96);
  v70 = v72;
  memset(s, 0, sizeof(s));
  ...
  for ( i = 0; i != 5; ++i )
  {
    ...
    V_UNLOCK();
    LOWORD(v9) = -12340;
    HIWORD(v9) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
    zlog(*v2, v9, 170, "membist0", 8, 555, 60, v96);
    sub_7002C(a1, 164, v8);
    v10 = v2;
    v11 = a1;
    v12 = v10;
    do
    {
      ...
      V_LOCK();
      LOWORD(v14) = 620;
      HIWORD(v14) = (unsigned int)" %lld" >> 16;
      V_INT((int)v75, v14, *(int *)(v11 + 232));
      LOWORD(v15) = -11632;
      HIWORD(v15) = (unsigned int)"cnt failed, resp_num: %d\n" >> 16;
      logfmt_raw(v96, 0x1000u, 0, v76, v75[0], v75[1], v75[2], v75[3], v75[4], v75[5], v75[6], v76, v15, v13);
      V_UNLOCK();
      LOWORD(v16) = -12340;
      HIWORD(v16) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
      zlog(*v12, v16, 170, "membist0", 8, 566, 100, v96);
      if ( v13 > 0 )
      {
LABEL_5:
        LOWORD(v17) = 620;
        v18 = (unsigned int *)ptr;
        HIWORD(v17) = (unsigned int)" %lld" >> 16;
        v19 = 0;
        v57 = v17;
        do
        {
          while ( (*v18 & 0x80) == 0 )
          {
            ...
            V_UNLOCK();
            LOWORD(v20) = -12340;
            HIWORD(v20) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
            zlog(*v12, v20, 170, "membist0", 8, 582, 100, v96);
            if ( v13 <= v19 )
              goto LABEL_11;
          }
          if ( (*v18 & 0xFFFFFF00) != 0 )
          {
            ...
            V_UNLOCK();
            LOWORD(v49) = -12340;
            HIWORD(v49) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
            zlog(*v12, v49, 170, "membist0", 8, 576, 100, v96);
...
LABEL_11:
      ...
      V_UNLOCK();
      LOWORD(v23) = -12340;
      HIWORD(v23) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
      zlog(*v12, v23, 170, "membist0", 8, 590, 100, v96);
      if ( v21 > 0 )
      {
LABEL_13:
        LOWORD(v24) = 620;
        v25 = (unsigned int *)ptr;
        HIWORD(v24) = (unsigned int)" %lld" >> 16;
        v26 = 0;
        v58 = v24;
        do
        {
          while ( (*v25 & 0x80) == 0 )
          {
            ...
            V_UNLOCK();
            LOWORD(v27) = -12340;
            HIWORD(v27) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
            zlog(*v12, v27, 170, "membist0", 8, 605, 100, v96);
            if ( v21 <= v26 )
              goto LABEL_19;
          }
          if ( (*v25 & 0xFFFFFF00) != 0 )
          {
            ...
            V_UNLOCK();
            LOWORD(v51) = -12340;
            HIWORD(v51) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
            zlog(*v12, v51, 170, "membist0", 8, 599, 100, v96);
...
LABEL_19:
      ...
      LOWORD(v30) = -11368;
      HIWORD(v30) = (unsigned int)"02x membist not done!" >> 16;
      logfmt_raw(v96, 0x1000u, 0, v88, v87[0], v87[1], v87[2], v87[3], v87[4], v87[5], v87[6], v88, v30, v28);
      V_UNLOCK();
      LOWORD(v31) = -12340;
      HIWORD(v31) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
      zlog(*v12, v31, 170, "membist0", 8, 613, 100, v96);
      if ( v28 > 0 )
      {
LABEL_21:
        LOWORD(v32) = 620;
        LOWORD(v33) = -11320;
        HIWORD(v32) = (unsigned int)" %lld" >> 16;
        v63 = v32;
        v34 = 0;
        v35 = ptr;
        do
        {
          ...
          HIWORD(v33) = (unsigned int)" resp_num: %d" >> 16;
          logfmt_raw(
            v96,
            0x1000u,
            0,
...
LABEL_26:
  ...
  LOWORD(v38) = -11276;
  LOWORD(v39) = 620;
  HIWORD(v38) = (unsigned int)"lost cnt: %08x" >> 16;
  LOWORD(v40) = -12340;
  v66 = v38;
  HIWORD(v39) = (unsigned int)" %lld" >> 16;
  HIWORD(v40) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
  v67 = v39;
  v68 = v40;
  useconds = 0;
  free(ptr);
  ...
  do
  {
    ...
    do
    {
      ...
      logfmt_raw(
        ...
        v61);
      V_UNLOCK();
      v46 = zlog(*v2, v68, 170, "membist0", 8, 640, 100, v96);
    }
    while ( v42 != 8 );
    useconds += 4;
  }
