int __fastcall stratum_handle_response_eth(int a1, int a2, int a3)
{
  ...
  if ( !v4 )
  {
    ...
    V_UNLOCK();
    LOWORD(v24) = 17696;
    HIWORD(v24) = (unsigned int)"%13.2f" >> 16;
    zlog(g_zc, v24, 163, "stratum_handle_response_eth", 27, 1118, 40, v29);
    return 0;
  }
...
LABEL_9:
  if ( !v12 || *v12 == 7 )
  {
    V_LOCK();
    LOWORD(v25) = 15224;
    HIWORD(v25) = (unsigned int)"rontend/frontend_ckb/frontend_ckb.c" >> 16;
    logfmt_raw(v29, 0x1000u, 0, v25, "stratum_handle_response_eth");
    V_UNLOCK();
    LOWORD(v26) = 17696;
    HIWORD(v26) = (unsigned int)"%13.2f" >> 16;
    v14 = 0;
    zlog(g_zc, v26, 163, "stratum_handle_response_eth", 27, 1147, 40, v29);
  }
  else
  {
    if ( v8 )
