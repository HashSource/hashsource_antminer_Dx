int __fastcall work_2_packet_kda(int a1, int a2, int a3, _DWORD *a4)
{
  ...
  *(_BYTE *)(a3 + 6) = v24;
  ...
  if ( !v28 )
  {
    V_LOCK();
    LOWORD(v33) = -21200;
    HIWORD(v33) = (unsigned int)"analog value %08x" >> 16;
    LOWORD(v34) = -11740;
    logfmt_raw((char *)v53, 0x1000u, 0, v33);
    V_UNLOCK();
    LOWORD(v35) = -804;
    HIWORD(v35) = (unsigned int)"%d ans diff %d ticket_mask %d" >> 16;
    v36 = a3 - 1;
    zlog(g_zc, v35, 170, "work_2_packet_kda", 17, 133, 20, v53);
    v51 = *(unsigned __int8 *)(a3 + 3);
    do
    {
      v37 = *(unsigned __int8 *)++v36;
      HIWORD(v34) = (unsigned int)"chip %02x core %02x membist0 lost cnt: %08x" >> 16;
    ...
    v41 = 0;
    LOWORD(v42) = -804;
    HIWORD(v42) = (unsigned int)"%d ans diff %d ticket_mask %d" >> 16;
    zlog(g_zc, v42, 170, "dump_work_kda", 13, 84, 20, v53);
    do
    {
      v43 = *(unsigned __int8 *)++v40;
      HIWORD(v38) = (unsigned int)"chip %02x core %02x membist0 lost cnt: %08x" >> 16;
    ...
    V_LOCK();
    LOWORD(v44) = -616;
    HIWORD(v44) = (unsigned int)"top_init_kda" >> 16;
    logfmt_raw((char *)v53, 0x1000u, 0, v44, v50, v51);
    V_UNLOCK();
    LOWORD(v45) = -804;
    HIWORD(v45) = (unsigned int)"%d ans diff %d ticket_mask %d" >> 16;
    zlog(g_zc, v45, 170, "dump_work_kda", 13, 90, 20, v53);
    V_LOCK();
    LOWORD(v46) = -20960;
    HIWORD(v46) = (unsigned int)"expected reg %02x, but %02x, data %08x" >> 16;
    logfmt_raw((char *)v53, 0x1000u, 0, v46, v52);
    V_UNLOCK();
    LOWORD(v47) = -804;
    HIWORD(v47) = (unsigned int)"%d ans diff %d ticket_mask %d" >> 16;
    zlog(g_zc, v47, 170, "dump_work_kda", 13, 91, 20, v53);
  }
