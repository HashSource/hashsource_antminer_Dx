void __noreturn dag_gen_rvn_thread_func()
{
  ...
  LOWORD(v0) = 13832;
  HIWORD(v0) = (unsigned int)&unk_143710 >> 16;
  v101 = v0;
  while ( 1 )
  {
    do
    ...
    while ( qword_1751F8 == *(_QWORD *)&dword_175200 );
    V_LOCK();
    logfmt_raw((char *)v112, 0x1000u, 0, "cur_block_num enter: %llu", qword_1751F8);
    V_UNLOCK();
    LOWORD(v2) = 30244;
    LOWORD(v3) = -2608;
    HIWORD(v3) = (unsigned int)&unk_13F6D8 >> 16;
    HIWORD(v2) = (unsigned int)algn_14772C >> 16;
    zlog(g_zc, v2, 163, v3, 23, 353, 60, v112);
    v102 = qword_1751F8;
    v4 = sub_12F324(qword_1751F8, 3u);
    v5 = &s[7];
    v6 = &v111;
...
LABEL_28:
    ...
    *(_QWORD *)&dword_175200 = v102;
    if ( v103 )
    {
      ...
      HIWORD(v52) = (unsigned int)"er-new/dhash_content/zec/zec_1746/zec_1746_content.c" >> 16;
      HIWORD(v53) = (unsigned int)&unk_13F6D8 >> 16;
      HIWORD(v54) = (unsigned int)algn_14772C >> 16;
      v78 = v52;
      v67 = v53;
      v70 = v54;
      do
      {
        ...
        v56 = &v109;
        v57 = 0;
        zlog(g_zc, v70, 163, v67, 23, 362, 40, v112);
        v58 = sub_12F324(qword_1751F8, 0x1D4Cu);
        v59 = *((_DWORD *)v55 + 1);
        v55 += 4;
        ...
        V_LOCK();
        LOWORD(v62) = 30448;
        HIWORD(v62) = (unsigned int)"46_content.c" >> 16;
        ++v72;
        logfmt_raw((char *)v112, 0x1000u, 0, v62);
        V_UNLOCK();
        zlog(g_zc, v70, 163, v67, 23, 368, 40, v112);
        v63 = v103;
        *(_BYTE *)(*(_DWORD *)v55 + 239) = 1;
      }
      while ( v63 > v72 );
    }
  }
