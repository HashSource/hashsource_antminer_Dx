unsigned int __fastcall sub_37274(int a1, int a2)
{
  const void **v2; // r7
  unsigned int v5; // r4
  bool v6; // cc
            ...
            if ( !v21 )
            {
              ...
              *v39 = 0;
              ...
              if ( *v39 == 34 )
              {
                if ( v40 < 0 )
                {
                  sub_36EBC(a2, (_DWORD *)a1, 15, "too big negative integer");
                }
                else
                {
                  *v39 = 0;
                  ...
                  if ( *v39 == 34 )
                  {
                    sub_36EBC(a2, (_DWORD *)a1, 15, "too big integer");
                    return *(_DWORD *)(a1 + 60);
                  }
                }
              }
...
LABEL_70:
            ...
            sub_36EBC(a2, (_DWORD *)a1, 15, "real number overflow");
            return *(_DWORD *)(a1 + 60);
          }
          v20 = sub_3721C(a1, a2);
...
LABEL_146:
            ...
            sub_36EBC(a2, (_DWORD *)a1, 8, v44, *(_DWORD *)arg);
            goto LABEL_57;
          }
          v46 = v35 - 55296;
          ...
          else
          {
            ...
            {
LABEL_153:
              sub_36EBC(a2, (_DWORD *)a1, 8, "invalid Unicode '\\u%04X'", v35);
              goto LABEL_57;
            }
            v37 = sub_36DB0((int)(j + 7));
            if ( v37 < 0 )
            {
              LOWORD(v44) = 12448;
              *(_DWORD *)arg = j + 6;
            ...
            {
              sub_36EBC(a2, (_DWORD *)a1, 8, "invalid Unicode '\\u%04X\\u%04X'", v36, v37);
              goto LABEL_57;
            }
...
LABEL_109:
    ...
    if ( v17 == -1 )
    {
      sub_36EBC(a2, (_DWORD *)a1, 6, "premature end of input");
      goto LABEL_57;
    }
    if ( v17 <= 0x1F )
      break;
...
LABEL_56:
        sub_36EBC(a2, (_DWORD *)a1, 8, "invalid escape");
        goto LABEL_57;
      }
      v19 = v18 == 92;
      if ( v18 != 92 )
  ...
  sub_3725C((_DWORD *)a1, v17);
  if ( v17 == 10 )
    sub_36EBC(a2, (_DWORD *)a1, 8, "unexpected newline");
  else
    sub_36EBC(a2, (_DWORD *)a1, 8, "control character 0x%x", v17);
LABEL_57:
  jsonp_free(*(void **)(a1 + 64));
  v8 = *(_DWORD *)(a1 + 60);
  *(_DWORD *)(a1 + 64) = 0;
