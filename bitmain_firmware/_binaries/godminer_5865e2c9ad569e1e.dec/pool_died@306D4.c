  ...
  *((_BYTE *)a1 + 1904) = 1;
  ...
  if ( !v3 )
  {
    ...
    if ( a1 == v5 )
    {
      v9 = *a1;
      LOWORD(v10) = 5072;
      HIWORD(v10) = (unsigned int)"unknow config parameter!" >> 16;
      LOWORD(v11) = 7884;
      V_INT((int)v13, v10, v9);
      HIWORD(v11) = (unsigned int)"total_pools = %d, need to remove %d pools" >> 16;
      logfmt_raw(v17, 0x1000u, 0, v14, v13[0], v13[1], v13[2], v13[3], v13[4], v13[5], v13[6], v14, v11);
      V_UNLOCK();
      LOWORD(v12) = 7484;
      HIWORD(v12) = (unsigned int)"stratum" >> 16;
      zlog(g_zc, v12, 133, "pool_died", 9, 402, 80, v17);
      return switch_pools();
    }
    else
    {
      LOWORD(v6) = 5072;
      HIWORD(v6) = (unsigned int)"unknow config parameter!" >> 16;
      V_INT((int)v15, v6, *a1);
      LOWORD(v7) = 7900;
      HIWORD(v7) = (unsigned int)", need to remove %d pools" >> 16;
      logfmt_raw(v17, 0x1000u, 0, v16, v15[0], v15[1], v15[2], v15[3], v15[4], v15[5], v15[6], v16, v7);
      V_UNLOCK();
      LOWORD(v8) = 7484;
      HIWORD(v8) = (unsigned int)"stratum" >> 16;
      return zlog(g_zc, v8, 133, "pool_died", 9, 405, 20, v17);
    }
  }
  return result;
}
