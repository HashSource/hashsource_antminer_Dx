int bitmain_get_sample_voltage()
{
  ...
  if ( dword_18A85C || sub_B44D4() >= 0 )
  {
    ...
    {
      LOWORD(v3) = 26904;
      HIWORD(v3) = (unsigned int)"ower eeprom list get error!" >> 16;
      v4 = *v3;
      v5 = v3[1];
      v6 = v3[2];
      v7 = v3[3];
      ...
      zlog(g_zc, v9, 172, "_bitmain_get_sample_N", 21, 459, 100, v28);
      LOWORD(v10) = 26924;
      HIWORD(v10) = (unsigned int)" error!" >> 16;
      v11 = *v10;
      v12 = v10[1];
      v13 = v10[2];
      v14 = v10[3];
      ...
      V_UNLOCK();
      LOWORD(v17) = 26388;
      HIWORD(v17) = (unsigned int)" failed" >> 16;
      return zlog(g_zc, v17, 172, "bitmain_get_sample_voltage", 26, 571, 100, v28);
    }
  }
  else
  {
    LOWORD(v1) = 26740;
    HIWORD(v1) = (unsigned int)"atchdog" >> 16;
    ...
    return zlog(g_zc, v2, 172, "bitmain_get_sample_voltage", 26, 567, 100, v28);
  }
  return result;
}
