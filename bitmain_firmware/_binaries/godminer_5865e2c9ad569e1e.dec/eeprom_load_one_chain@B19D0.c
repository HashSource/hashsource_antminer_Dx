int __fastcall eeprom_load_one_chain(unsigned int a1, int a2)
{
  ...
  while ( 1 )
  {
    ...
    {
      LOWORD(v9) = 25092;
      HIWORD(v9) = (unsigned int)"sensor_addr OOM" >> 16;
      snprintf(v15, 0x800u, v9, a1);
      V_LOCK();
      logfmt_raw(v16, 0x1000u, 0, v15);
      V_UNLOCK();
      LOWORD(v10) = 23620;
      HIWORD(v10) = (unsigned int)"ithout_header_len:%d, fixture_actual_len:%d" >> 16;
      zlog(g_zc, v10, 169, "eeprom_load_one_chain", 21, 822, 100, v16);
      return v6;
    }
    if ( !eeprom_decode_fixture_info_0(s, v14) )
      break;
    HIWORD(v4) = (unsigned int)"ain = %d." >> 16;
    ...
    zlog(g_zc, v7, 169, "eeprom_load_one_chain", 21, 836, 100, v16);
    usleep(0x7A120u);
    if ( !--v5 )
      goto LABEL_6;
  }
