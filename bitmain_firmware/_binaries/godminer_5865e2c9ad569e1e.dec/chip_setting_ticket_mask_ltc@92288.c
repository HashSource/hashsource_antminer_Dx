int __fastcall chip_setting_ticket_mask_ltc(_DWORD *a1, unsigned int a2)
{
  ...
  V_LOCK();
  LOWORD(v4) = 2284;
  HIWORD(v4) = (unsigned int)"%d chip_addr %02x reg:%02x, core_id:%d" >> 16;
  logfmt_raw(v21, 0x1000u, 0, v4, "chip_setting_ticket_mask_ltc", 2, a2, v15, 0, 0, 0, 0);
  V_UNLOCK();
  LOWORD(v5) = 2084;
  HIWORD(v5) = (unsigned int)"d core %d " >> 16;
  zlog(g_zc, v5, 175, "chip_setting_ticket_mask_ltc", 28, 146, 60, v21);
  v6 = a1[79];
  v17 = 131073;
  ...
  V_LOCK();
  LOWORD(v11) = 2316;
  HIWORD(v11) = (unsigned int)"_id:%d" >> 16;
  logfmt_raw(v21, 0x1000u, 0, v11, v14);
  V_UNLOCK();
  LOWORD(v12) = 2084;
  HIWORD(v12) = (unsigned int)"d core %d " >> 16;
  zlog(g_zc, v12, 175, "chip_setting_ticket_mask_ltc", 28, 177, 60, v21);
  return v9;
}
