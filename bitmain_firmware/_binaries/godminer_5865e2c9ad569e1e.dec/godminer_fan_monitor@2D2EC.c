char *__fastcall godminer_fan_monitor(int a1)
{
  ...
  if ( (v2 & 2) != 0 )
  {
    ...
    LOWORD(v8) = 4744;
    LOWORD(v9) = 4756;
    HIWORD(v8) = (unsigned int)" it should not be here" >> 16;
    HIWORD(v9) = (unsigned int)"ot be here" >> 16;
    LOWORD(v10) = 4764;
    V_STR(v15, v9, v8);
    HIWORD(v10) = (unsigned int)"re" >> 16;
    ...
    zlog(g_zc, v11, 138, "godminer_fan_monitor", 20, 747, 20, v19);
    V_LOCK();
    LOWORD(v12) = 4812;
    LOWORD(v13) = 4784;
    HIWORD(v12) = (unsigned int)"no" >> 16;
    HIWORD(v13) = (unsigned int)"ch" >> 16;
    logfmt_raw(v19, 0x1000u, 0, v13, v12);
    V_UNLOCK();
    LOWORD(v14) = 4264;
    HIWORD(v14) = (unsigned int)"or: jobid %p cancel %d" >> 16;
    result = (char *)zlog(g_zc, v14, 138, "godminer_fan_monitor", 20, 748, 100, v19);
    v2 = *((_DWORD *)v3 + 8);
    *((_DWORD *)v3 + 10) |= 2u;
  }
  if ( (v2 & 1) != 0 )
  {
    ...
    LOWORD(v4) = 4816;
    LOWORD(v5) = 4756;
    HIWORD(v4) = (unsigned int)"submit idle pool's nonce." >> 16;
    HIWORD(v5) = (unsigned int)"ot be here" >> 16;
    V_STR(v17, v5, v4);
    LOWORD(v6) = 4828;
    HIWORD(v6) = (unsigned int)"pool's nonce." >> 16;
    logfmt_raw(v19, 0x1000u, 0, v18, v17[0], v17[1], v17[2], v17[3], v17[4], v17[5], v17[6], v18, v6);
    V_UNLOCK();
    LOWORD(v7) = 4264;
    HIWORD(v7) = (unsigned int)"or: jobid %p cancel %d" >> 16;
    result = (char *)zlog(g_zc, v7, 138, "godminer_fan_monitor", 20, 756, 20, v19);
    *((_DWORD *)v3 + 10) |= 1u;
  }
  return result;
}
