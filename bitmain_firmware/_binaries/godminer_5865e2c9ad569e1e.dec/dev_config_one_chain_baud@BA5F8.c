int __fastcall dev_config_one_chain_baud(int a1, char *a2)
{
  ...
  LOWORD(v4) = 29868;
  HIWORD(v4) = (unsigned int)"ns/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/device/hal/power/bitmain_power_APW9.c" >> 16;
...
LABEL_13:
  LOWORD(v7) = 29408;
  HIWORD(v7) = (unsigned int)"r_open" >> 16;
  ...
  uart_get_config(0, 0, &v10, (int)v11);
  LOWORD(v8) = 29892;
  HIWORD(v8) = (unsigned int)"miner_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/device/hal/power/bitmain_power_APW9.c" >> 16;
