int __fastcall check_nonce_dash(int a1, int a2)
{
  ...
  *(_DWORD *)(a2 + 54) = v6;
  ...
  if ( v10 <= 0x22 )
  {
    ...
    V_LOCK();
    LOWORD(v12) = -17320;
    HIWORD(v12) = (unsigned int)"nonce crc error calc value %04x expected value %04x\n" >> 16;
    logfmt_raw(v21, 0x1000u, 0, v12, v11, *(unsigned __int8 *)(a2 + 52), 35);
    V_UNLOCK();
    LOWORD(v13) = -17536;
    HIWORD(v13) = (unsigned int)"info error" >> 16;
    zlog(g_zc, v13, 172, "check_nonce_dash", 16, 790, 20, v21);
    return 2;
  }
  ...
  if ( v15 == v10 )
  {
    ...
    V_UNLOCK();
    LOWORD(v16) = -17536;
    HIWORD(v16) = (unsigned int)"info error" >> 16;
    zlog(g_zc, v16, 172, "check_nonce_dash", 16, 823, 20, v21);
    return 1;
  }
  else
  {
    ...
    V_LOCK();
    LOWORD(v17) = -19780;
    HIWORD(v17) = (unsigned int)"ce crc error calc value %04x expected value %04x" >> 16;
    logfmt_raw(v21, 0x1000u, 0, v17, v11, *(unsigned __int8 *)(a2 + 52), v5);
    V_UNLOCK();
    LOWORD(v18) = -17536;
    HIWORD(v18) = (unsigned int)"info error" >> 16;
    zlog(g_zc, v18, 172, "check_nonce_dash", 16, 800, 20, v21);
    return 3;
  }
}
