int __fastcall get_chip_dag_packet_num(int a1)
{
  ...
  while ( 1 )
  {
    ...
    zlog(g_zc, v6, 170, "get_chip_dag_packet_num", 23, 1572, 100, v55);
    if ( v4 == 5 )
    {
      v42 = 12;
      goto LABEL_6;
...
LABEL_6:
  ...
  while ( 1 )
  {
    ...
    V_UNLOCK();
    LOWORD(v11) = -12340;
    HIWORD(v11) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
    zlog(g_zc, v11, 170, "get_chip_dag_packet_num", 23, 1586, 100, v55);
    if ( v9 == 5 )
      break;
    usleep(0x2710u);
  }
...
LABEL_11:
  ...
  LOWORD(v14) = -10628;
  HIWORD(v14) = (unsigned int)"tus_ETH" >> 16;
  logfmt_raw(v55, 0x1000u, 0, v48, v47[0], v47[1], v47[2], v47[3], v47[4], v47[5], v47[6], v48, v14, 8 - v10);
  V_UNLOCK();
  LOWORD(v15) = -12340;
  HIWORD(v15) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
  zlog(g_zc, v15, 170, "get_chip_dag_packet_num", 23, 1599, 100, v55);
LABEL_14:
  ...
  if ( sa )
  {
    ...
    LOWORD(v17) = -10564;
    LOWORD(v18) = 16184;
    HIWORD(v18) = (unsigned int)"000000000000000000000000000000000000" >> 16;
    V_INT((int)v51, v16, *(int *)(a1 + 232));
    HIWORD(v17) = (unsigned int)"get_single_chip_core_status_ETH" >> 16;
    v38 = v17;
    v19 = "no";
    if ( *v36 )
      v19 = v18;
    ...
    zlog(g_zc, v20, 170, "get_chip_dag_packet_num", 23, 1611, 60, v55);
    if ( v10 > 1 )
    {
      LOWORD(v21) = 620;
  ...
  else
  {
    ...
    LOWORD(v29) = -10600;
    HIWORD(v29) = (unsigned int)"le_chip_core_status_ETH" >> 16;
    logfmt_raw(v55, 0x1000u, 0, v50, v49[0], v49[1], v49[2], v49[3], v49[4], v49[5], v49[6], v50, v29);
    V_UNLOCK();
    LOWORD(v30) = -12340;
    HIWORD(v30) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
    zlog(g_zc, v30, 170, "get_chip_dag_packet_num", 23, 1607, 100, v55);
  }
LABEL_12:
  free(ptr);
  free(v36);
