int __fastcall phy_external_bist_rvn(int a1, int a2, unsigned __int8 *a3, unsigned int a4)
{
  ...
  zlog(g_zc, v10, 173, "phy_external_bist_rvn", 21, 1095, 60, v90);
  memset(s, 0, sizeof(s));
  ...
  if ( a4 )
  {
    ...
    v69 = a3 - 1;
    LOWORD(v13) = 620;
    HIWORD(v11) = (unsigned int)" lane num> %d" >> 16;
    ...
    do
    {
      ...
      {
        v16 = *++v15;
        if ( check_core_reg_with_expect_data_rvn_0(a1, a2, v16, 64, 0xFF000100) )
          break;
        if ( v15 == v14 )
          goto LABEL_6;
      }
...
LABEL_6:
    ...
    {
      v19 = *++v18;
      sub_99D08(a1, v19, 133, 0xFFFF);
      sub_99D08(a1, *v18, 134, 1342177279);
    }
    while ( v15 != v18 );
    ...
    do
    {
      ...
      {
        v22 = *++v17;
        if ( check_core_reg_with_expect_data_rvn_0(a1, a2, v22, 139, 0xFF0000FF) )
          break;
        if ( v18 == v17 )
          goto LABEL_12;
      }
      V_LOCK();
      V_INT((int)v76, v62, *(int *)(a1 + 232));
      HIWORD(v20) = (unsigned int)"ip 0x0 core 0x0 reg 0x6f rdata %08x" >> 16;
      logfmt_raw(
        v90,
        0x1000u,
        0,
...
LABEL_12:
    ...
    HIWORD(v24) = (unsigned int)"t !!! %s PHY core %02x macro0 rx is invalid!" >> 16;
    v63 = v23;
    v70 = v24;
    do
    {
...
LABEL_21:
      ...
      LOWORD(v37) = -6380;
      HIWORD(v37) = (unsigned int)"[PHY EQ MAIN SET] chip 0x0 core 0x0 reg 0x70 rdata %08x" >> 16;
      v25 = a1;
      v68 = v37;
      v38 = 135;
      v66 = (int *)((char *)&v85 + 1);
...
LABEL_31:
  ...
  free(ptr);
  v47 = *(_QWORD *)&dword_18A258;
  v48 = &s[1];
  v49 = *(_QWORD *)&dword_18A260;
  for ( i = &v89[1]; ; ++i )
  {
    v47 += v46;
    v49 += a4;
  ...
  *(_QWORD *)&dword_18A258 = v47;
  *(_QWORD *)&dword_18A260 = v49;
  V_LOCK();
  LOWORD(v53) = 620;
  HIWORD(v53) = (unsigned int)" %lld" >> 16;
  V_INT((int)&v82, v53, *(int *)(a1 + 232));
  logfmt_raw(
    v90,
    0x1000u,
    0,
  ...
  V_UNLOCK();
  LOWORD(v54) = 7620;
  HIWORD(v54) = (unsigned int)"nt> %lld" >> 16;
  zlog(g_zc, v54, 173, "phy_external_bist_rvn", 21, 1299, 60, v90);
  V_LOCK();
  LOWORD(v55) = 620;
  HIWORD(v55) = (unsigned int)" %lld" >> 16;
  V_INT((int)&v85, v55, *(int *)(a1 + 232));
  logfmt_raw(
    v90,
    0x1000u,
    0,
  ...
  V_UNLOCK();
  LOWORD(v56) = 7620;
  HIWORD(v56) = (unsigned int)"nt> %lld" >> 16;
  zlog(g_zc, v56, 173, "phy_external_bist_rvn", 21, 1300, 60, v90);
  return 0;
}
