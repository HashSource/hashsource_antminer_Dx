int __fastcall sync_get_core_reg_ltc(pthread_mutex_t *a1, int a2, int a3, int a4, int *a5, unsigned __int64 a6)
{
  ...
  while ( a3 > v30 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        V_LOCK();
        HIWORD(v22) = (unsigned int)"set_ltc" >> 16;
        logfmt_raw(v44, 0x1000u, 0, v22, v37);
        V_UNLOCK();
        LOWORD(v25) = 1552;
        HIWORD(v25) = (unsigned int)"_misc_ltc" >> 16;
        HIWORD(v23) = (unsigned int)"_software_reset_ltc" >> 16;
        zlog(g_zc, v25, 174, v23, 21, 370, 100, v44);
      }
      v24 = v39;
