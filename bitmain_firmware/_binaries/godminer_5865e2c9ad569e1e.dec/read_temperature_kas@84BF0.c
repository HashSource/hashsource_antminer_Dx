int __fastcall read_temperature_kas(int a1, int *a2)
{
  ...
  if ( v2 > 0 )
  {
    ...
    for ( i = a2; v20 != i; i += 2 )
    {
      ...
      LOWORD(v14) = -2504;
      HIWORD(v14) = (unsigned int)" passed! diff %d expected_diff %d " >> 16;
      zlog(g_zc, v14, 170, "read_temperature_kas", 20, v13, 100, v33);
      v6 = v21;
LABEL_4:
      *i = v6;
      v7 = v3[1];
...
LABEL_11:
        ...
        zlog(g_zc, v16, 170, "read_temperature_kas", 20, v15, 100, v33);
        v12 = v22;
        goto LABEL_6;
      }
      v12 = v22;
