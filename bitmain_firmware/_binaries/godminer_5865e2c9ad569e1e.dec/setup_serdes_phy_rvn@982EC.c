int __fastcall setup_serdes_phy_rvn(int a1, int a2)
{
  ...
  LOWORD(v5) = 6692;
  HIWORD(v5) = (unsigned int)"ing_get_single_chip_core_status_RVN" >> 16;
  v12 = v5;
  v6 = (int *)((char *)&v14 + 3);
  logfmt_raw(
    (char *)v15,
  ...
  zlog(g_zc, v7, 170, "setup_serdes_phy_rvn", 20, 1041, 60, v15);
  V_LOCK();
  LOWORD(v8) = -10848;
  ...
  V_UNLOCK();
  LOWORD(v9) = 6248;
  HIWORD(v9) = (unsigned int)"final pattern %08x" >> 16;
  zlog(g_zc, v9, 170, "setup_serdes_phy_rvn", 20, 1048, 60, v15);
  v15[0] = 50462976;
  v15[1] = 117835012;
  v15[2] = 185207048;
  v16 = 252579084;
