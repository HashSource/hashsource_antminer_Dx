int __fastcall sub_522C4(int a1)
{
  int v2; // r4
  int v3; // r1
  ...
  if ( str2hex((int)&v6, v3, 8) != 4 )
  {
    ...
    zlog(
      ...
      "godminer-new/dhash_content/rvn/rvn_2020/rvn_2020_content.c",
      172,
  ...
  qword_175158 += v2;
  V_LOCK();
  logfmt_raw(v8, 0x1000u, 0, "start_nonce_rvn_high: %016llx", qword_175158);
  V_UNLOCK();
  zlog(
    g_zc,
