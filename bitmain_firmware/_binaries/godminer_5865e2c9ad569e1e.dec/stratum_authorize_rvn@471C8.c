int __fastcall stratum_authorize_rvn(int a1, int *a2, void *a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( !v8 )
    {
      ...
      V_UNLOCK();
      LOWORD(v54) = 21080;
      HIWORD(v54) = (unsigned int)"fy" >> 16;
      zlog(g_zc, v54, 163, "stratum_authorize_rvn", 21, 191, 100, v70);
LABEL_2:
      free(v16);
      if ( !v6 )
        goto LABEL_10;
LABEL_3:
    ...
    {
      LOWORD(v18) = 14584;
      HIWORD(v18) = (unsigned int)"{\"id\": 1, \"method\": \"mining.subscribe\", \"params\": [\"GodMiner/2.0.1\", null]}" >> 16;
      v19 = json_object_get(v6, v18);
      LOWORD(v20) = 4756;
      v58 = (_DWORD *)v19;
      HIWORD(v20) = (unsigned int)"ot be here" >> 16;
      v21 = json_object_get(v6, v20);
      LOWORD(v22) = 5244;
      v57 = (_DWORD *)v21;
      HIWORD(v22) = (unsigned int)"e time: %s type: %s" >> 16;
      ...
      if ( v24 || *v58 == 6 )
      {
        V_LOCK();
        LOWORD(v36) = 5072;
        HIWORD(v36) = (unsigned int)"unknow config parameter!" >> 16;
        V_INT((int)&v60, v36, *a2);
        v37 = json_array_get(v57, 1u);
        v38 = json_string_value(v37);
        LOWORD(v39) = 18820;
        HIWORD(v39) = (unsigned int)"end/frontend_hns/frontend_hns.c" >> 16;
        logfmt_raw(v70, 0x1000u, 0, v67, v60, v61, v62, v63, v64, v65, v66, v67, v39, v38);
        V_UNLOCK();
        LOWORD(v40) = 21080;
        HIWORD(v40) = (unsigned int)"fy" >> 16;
        zlog(g_zc, v40, 163, "stratum_authorize_rvn", 21, 215, 80, v70);
        if ( !v3 )
        {
LABEL_36:
          v8 = 0;
        ...
        if ( !v57 )
        {
          ...
          if ( v43 )
          {
            LOWORD(v45) = 14984;
            v16 = v43;
            HIWORD(v45) = (unsigned int)"ime notify.ntime successfuly" >> 16;
            v8 = 0;
            v46 = *v45;
            v47 = v45[1];
            v48 = v45[2];
            ...
            *((_DWORD *)v44 + 3) = v49;
            ...
            V_LOCK();
            LOWORD(v51) = 15004;
            HIWORD(v51) = (unsigned int)"cessfuly" >> 16;
            logfmt_raw(v70, 0x1000u, 0, v51, v16, v59);
            V_UNLOCK();
            LOWORD(v52) = 21080;
            HIWORD(v52) = (unsigned int)"fy" >> 16;
            zlog(g_zc, v52, 163, "stratum_authorize_rvn", 21, 222, 100, v70);
LABEL_37:
            free(v16);
            if ( *((_DWORD *)v6 + 1) != -1 )
            {
LABEL_5:
          ...
          LOWORD(v55) = 15004;
          v8 = 0;
          HIWORD(v55) = (unsigned int)"cessfuly" >> 16;
          logfmt_raw(v70, 0x1000u, 0, v55, 0, v59);
          V_UNLOCK();
          LOWORD(v56) = 21080;
          HIWORD(v56) = (unsigned int)"fy" >> 16;
          zlog(g_zc, v56, 163, "stratum_authorize_rvn", 21, 222, 100, v70);
          if ( *((_DWORD *)v6 + 1) == -1 )
            return v8;
LABEL_27:
      ...
      else
      {
        ...
        LOWORD(v28) = 18820;
        HIWORD(v28) = (unsigned int)"end/frontend_hns/frontend_hns.c" >> 16;
        logfmt_raw(v70, 0x1000u, 0, v67, v60, v61, v62, v63, v64, v65, v66, v67, v28, v27);
        V_UNLOCK();
        LOWORD(v29) = 21080;
        HIWORD(v29) = (unsigned int)"fy" >> 16;
        zlog(g_zc, v29, 163, "stratum_authorize_rvn", 21, 215, 80, v70);
        if ( !v3 )
          goto LABEL_36;
      }
      ...
      V_LOCK();
      LOWORD(v30) = 15004;
      HIWORD(v30) = (unsigned int)"cessfuly" >> 16;
      logfmt_raw(v70, 0x1000u, 0, v30, v16, v59);
      V_UNLOCK();
      LOWORD(v31) = 21080;
      HIWORD(v31) = (unsigned int)"fy" >> 16;
      zlog(g_zc, v31, 163, "stratum_authorize_rvn", 21, 222, 100, v70);
      if ( v16 )
        goto LABEL_36;
      if ( *((_DWORD *)v6 + 1) != -1 )
        goto LABEL_27;
    ...
    else
    {
      V_LOCK();
      LOWORD(v41) = 14540;
      HIWORD(v41) = (unsigned int)"e\", \"params\": [\"ckbminer-v1.0.0\", null]}" >> 16;
      logfmt_raw(v70, 0x1000u, 0, v41, *(_DWORD *)v68, v69);
      V_UNLOCK();
      LOWORD(v42) = 21080;
      HIWORD(v42) = (unsigned int)"fy" >> 16;
      zlog(g_zc, v42, 163, "stratum_authorize_rvn", 21, 205, 100, v70);
      free(v16);
    }
LABEL_10:
    if ( a3 )
