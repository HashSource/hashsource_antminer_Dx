int __fastcall top_init_ckb(int *a1)
{
  ...
  LOWORD(v3) = -19052;
  HIWORD(v3) = (unsigned int)"ge_reset_DASH_1766" >> 16;
  logfmt_raw(v14, 0x1000u, 0, v13, v12[0], v12[1], v12[2], v12[3], v12[4], v12[5], v12[6], v13, v3);
  V_UNLOCK();
  LOWORD(v4) = -21180;
  HIWORD(v4) = (unsigned int)"got uneffective temp, sensor[%d], addr:%02x" >> 16;
  zlog(g_zc, v4, 170, "top_init_ckb", 12, 454, 40, v14);
  v5 = a1[78];
  v6 = a1[116];
