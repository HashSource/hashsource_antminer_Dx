int bitmain_power_fw_version()
{
  ...
  if ( dword_18A85C || (v0 = sub_B44D4(), v0 >= 0) )
  {
    ...
    if ( sub_B3B48((void *)dword_18A858, (unsigned __int8 *)&v13, 6u, (unsigned __int8 *)&v15, 8u) )
    {
      ...
      V_UNLOCK();
      LOWORD(v12) = 26388;
      HIWORD(v12) = (unsigned int)" failed" >> 16;
      zlog(g_zc, v12, 172, "_bitmain_get_power_fw_version", 29, 255, 100, v19);
      v1 = -2147482880;
      v0 = -2147482880;
    }
    else
  ...
  {
    LOWORD(v3) = 26740;
    HIWORD(v3) = (unsigned int)"atchdog" >> 16;
    ...
    zlog(g_zc, v4, 172, "bitmain_power_fw_version", 24, 670, 100, v19);
  }
  return v0;
}
