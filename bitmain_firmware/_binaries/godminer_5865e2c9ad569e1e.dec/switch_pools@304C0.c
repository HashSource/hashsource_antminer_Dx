int switch_pools()
{
  ...
  if ( total_pools > 0 )
  {
    ...
    v6 = 0;
    v0 = v17;
    HIWORD(v5) = (unsigned int)"stratum" >> 16;
    v16 = v5;
    while ( 1 )
    {
      v7 = 0;
      ...
      while ( 1 )
      {
        ...
        {
          V_LOCK();
          HIWORD(v4) = (unsigned int)"t pool error, try again" >> 16;
          logfmt_raw(v17, 0x1000u, 0, v4, v6);
          V_UNLOCK();
          zlog(*v2, v16, 133, "priority_pool", 13, 252, 100, v17);
...
LABEL_11:
  ...
  V_UNLOCK();
  LOWORD(v13) = 7484;
  HIWORD(v13) = (unsigned int)"stratum" >> 16;
  result = zlog(*v2, v13, 133, "switch_pools", 12, 364, 40, v0);
  if ( (_DWORD *)v1 != v12 )
  {
