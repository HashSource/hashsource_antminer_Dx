int __fastcall check_nonce_ltc(int a1, int a2)
{
  ...
  if ( v6 <= 0x1A )
  {
    V_LOCK();
    LOWORD(v21) = 1008;
    HIWORD(v21) = (unsigned int)"crc error calc value %04x expected value %04x\n" >> 16;
    logfmt_raw(v26, 0x1000u, 0, v21, v7, *(unsigned __int8 *)(a2 + 84), 27);
    V_UNLOCK();
    LOWORD(v22) = 572;
    HIWORD(v22) = (unsigned int)"ildroot/tmp/release/build/godminer-origin_godminer-new/./backend/chip_setting.c" >> 16;
    zlog(g_zc, v22, 170, "check_nonce_ltc", 15, 707, 20, v26);
    return 2;
  }
...
LABEL_13:
    LOWORD(v18) = 572;
    HIWORD(v18) = (unsigned int)"ildroot/tmp/release/build/godminer-origin_godminer-new/./backend/chip_setting.c" >> 16;
    zlog(g_zc, v18, 170, "check_nonce_ltc", 15, v17, 20, v26);
    return 3;
  }
  if ( v6 != v8 + 16 )
  {
    V_LOCK();
    LOWORD(v23) = 1136;
    HIWORD(v23) = (unsigned int)"top_init_ltc() out" >> 16;
...
LABEL_4:
  ...
  V_LOCK();
  LOWORD(v19) = -19736;
  HIWORD(v19) = (unsigned int)"%04x" >> 16;
  logfmt_raw(v26, 0x1000u, 0, v19, v7, v5);
  V_UNLOCK();
  LOWORD(v20) = 572;
  HIWORD(v20) = (unsigned int)"ildroot/tmp/release/build/godminer-origin_godminer-new/./backend/chip_setting.c" >> 16;
  zlog(g_zc, v20, 170, "check_nonce_ltc", 15, 724, 20, v26);
  return 1;
}
