...
LABEL_18:
  ...
  else
  {
    V_LOCK();
    LOWORD(v20) = 5528;
    HIWORD(v20) = (unsigned int)"on argument -- '%s'" >> 16;
    logfmt_raw(v28, 0x1000u, 0, v20, "set_working_voltage_and_runtime_freq");
    V_UNLOCK();
    LOWORD(v21) = 4264;
    HIWORD(v21) = (unsigned int)"or: jobid %p cancel %d" >> 16;
    zlog(g_zc, v21, 138, "set_working_voltage_and_runtime_freq", 36, 1103, 100, v28);
    V_LOCK();
    LOWORD(v22) = 5552;
    LOWORD(v23) = 4784;
    HIWORD(v22) = (unsigned int)"algo %d, %s" >> 16;
    HIWORD(v23) = (unsigned int)"ch" >> 16;
    logfmt_raw(v28, 0x1000u, 0, v23, v22);
    V_UNLOCK();
    LOWORD(v24) = 4264;
    HIWORD(v24) = (unsigned int)"or: jobid %p cancel %d" >> 16;
    zlog(g_zc, v24, 138, "set_working_voltage_and_runtime_freq", 36, 1104, 100, v28);
    return -1;
  }
  return result;
}
