...
LABEL_21:
              ...
              LOWORD(v18) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buil"
                                              "droot/tmp/release/build/godminer-origin_godminer-new/common/general/http.c";
              v25 = v34;
              goto LABEL_23;
            }
            V_LOCK();
            logfmt_raw(v34, 0x1000u, 0, &unk_158FB4);
            V_UNLOCK();
            zlog(
              g_zc,
      ...
      do
      {
        ...
        zlog(
          ...
          "gin_godminer-new/common/general/http.c",
          148,
          "statusServiceThread",
          19,
          159,
...
LABEL_23:
    ...
    HIWORD(v18) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/rele"
                                "ase/build/godminer-origin_godminer-new/common/general/http.c" >> 16;
    zlog(v15, v18, 148, v17, 19, v16, 20, v25);
    return 0;
  }
}
