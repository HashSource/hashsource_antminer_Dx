int __fastcall sync_get_status_base(pthread_mutex_t *a1, int a2, int a3, int *a4, unsigned __int64 a5)
{
  int v5; // r6
  int v7; // r10
  int v8; // r2
  ...
  v7 = 0;
  sub_12F324(a5, 0x3E8u);
  v19[1] = 1000000 * v8;
  v19[0] = sub_12F324(a5, 0x3E8u);
  while ( v7 < a2 )
  {
    LOWORD(v9) = 28948;
    while ( 1 )
    {
      if ( queue_dequeue_for(a1[35].__lock, (char *)&v20, 0xAu, v19) == 110 )
      {
        v5 = 3;
        goto LABEL_14;
      }
      V_LOCK();
      HIWORD(v9) = (unsigned int)"dev_config_hal" >> 16;
      logfmt_raw(v27, 0x1000u, 0, v9, v20, v21, v24, v23, v25);
      V_UNLOCK();
      LOWORD(v10) = 28720;
      HIWORD(v10) = (unsigned int)":%02x" >> 16;
      zlog(g_zc, v10, 153, "sync_get_status_base", 20, 1109, 20, v27);
