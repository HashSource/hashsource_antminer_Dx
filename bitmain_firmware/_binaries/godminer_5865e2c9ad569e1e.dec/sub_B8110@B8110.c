int __fastcall sub_B8110(pthread_mutex_t *a1, int a2, int a3, int *a4, unsigned __int64 a5)
{
  ...
  v22[0] = sub_12F324(a5, 0x3E8u);
  while ( a2 > v9 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(a1[35].__lock, (char *)&v23, 0x4Au, v22) == 110 )
      {
        v8 = 3;
        goto LABEL_10;
      }
