int __fastcall get_all_chip_temp_kas(int a1)
{
  ...
  v38[3] = 0;
  v38[2] = 7340033;
  (*(void (__fastcall **)(int, _DWORD *, int, char *, _DWORD *))(a1 + 268))(a1, v38, v2, v3, v37);
  ...
  if ( v2 <= 0 )
  {
    ...
    HIWORD(v35) = (unsigned int)"ChipSetting_analog_mux_KDA_2110" >> 16;
    ...
    do
    {
      while ( 1 )
      {
        ...
        if ( !v23 )
          break;
        v22 = *v20++;
        HIWORD(v17) = (unsigned int)"_2110" >> 16;
        v21 += snprintf(v25, v24, v17, (char *)&v40[184] + v21, v22);
        if ( v19 == v18 )
          goto LABEL_13;
      }
      HIWORD(v16) = (unsigned int)"ChipSetting_freq_KDA_2110" >> 16;
      v21 += 5;
...
LABEL_13:
    LOWORD(v26) = -2000;
    LOWORD(v27) = -1996;
    HIWORD(v26) = (unsigned int)"0" >> 16;
    HIWORD(v27) = (unsigned int)"ChipSetting_analog_mux_KDA_2110" >> 16;
    LOWORD(v28) = -2008;
    LOWORD(v29) = -2016;
    ...
    do
    {
      ...
      {
        v31 = *v15++;
        HIWORD(v29) = (unsigned int)"ing_freq_KDA_2110" >> 16;
        fprintf(v30, v29, v31);
        if ( v19 == v14 )
          goto LABEL_17;
      }
      HIWORD(v28) = (unsigned int)"_KDA_2110" >> 16;
