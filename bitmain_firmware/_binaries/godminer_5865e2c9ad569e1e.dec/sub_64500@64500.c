int __fastcall sub_64500(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, signed int *a6, _DWORD *a7)
{
  int v8; // r4
  int v12; // r9
  int v13; // r3
  ...
  *(_BYTE *)(a3 + 65) = v12;
  *(_BYTE *)(a3 + 64) = v18;
  v19 = (unsigned int)*(unsigned __int8 *)(a2 + 3) / *(_DWORD *)(a1 + 404);
  if ( v19 >= *(_DWORD *)(a1 + 312) )
  {
    v29 = rand();
    sub_12ECD4(v29, *(_DWORD *)(a1 + 312));
    v19 = v30;
  }
  *a6 = v19;
  *(_DWORD *)(a3 + 8) = v19;
  *(_DWORD *)(a3 + 12) = (*(_BYTE *)(a2 + 8) & 3)
  ...
  {
    v26 = dword_18210C;
    v27 = 274877907LL * (unsigned int)dword_18210C++;
