...
LABEL_8:
  ...
  LOWORD(v6) = -12156;
  V_INT((int)v13, v5, *(int *)(a1 + 232));
  HIWORD(v6) = (unsigned int)"ue %04x resp value %04x" >> 16;
  logfmt_raw(v17, 0x1000u, 0, v14, v13[0], v13[1], v13[2], v13[3], v13[4], v13[5], v13[6], v14, v6, a2);
  V_UNLOCK();
  LOWORD(v7) = -12340;
  HIWORD(v7) = (unsigned int)"atus] asic %02x, reg %02x state %08x" >> 16;
  zlog(g_zc, v7, 170, "set_baud_eth", 12, 1189, 60, v17);
  v12[2] = 3145729;
  v12[1] = 0;
  v12[0] = v4;
  v12[3] = 0;
  ...
  V_UNLOCK();
  LOWORD(v9) = -21416;
  HIWORD(v9) = (unsigned int)"_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/backend_ckb_2042/backend_ckb_2042.c" >> 16;
  zlog(g_zc, v9, 149, "ChipSetting_misc_ctrl_ETH", 25, 218, 40, v17);
  v10 = (*(int (__fastcall **)(int, _DWORD *))(a1 + 248))(a1, v12);
  usleep(0x2710u);
  return v10;
}
