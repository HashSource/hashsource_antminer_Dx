int __fastcall sub_5158C(int a1, int *a2, int a3)
{
  size_t *v3; // r7
  int *v6; // r8
  int v7; // r3
  ...
  {
    v6 = a2 + 116;
    if ( a3 && memcmp(&unk_175028, a2 + 116, 0x116u) )
    {
      qword_175148 = 0;
      memcpy(&unk_175028, v6, 0x11Eu);
    }
    ...
    if ( v7 && v7 == *v3 )
    {
      ...
      zlog(
        ...
        20,
        v16);
      memcpy(v3 + 1, &qword_175148, *v3);
      if ( (unsigned __int64)qword_175148 > 0xFF )
        qword_175148 = 0;
      else
        ++qword_175148;
    }
