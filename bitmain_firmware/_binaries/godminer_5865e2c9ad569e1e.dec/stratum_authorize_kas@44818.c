int __fastcall stratum_authorize_kas(int a1, int *a2, void *a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( !v8 )
    {
      ...
      V_UNLOCK();
      LOWORD(v35) = 19864;
      HIWORD(v35) = (unsigned int)"thod\":\"mining.submit\", \"params\":[\"%s\",\"%s\",\"0x%s\"]}" >> 16;
      zlog(g_zc, v35, 163, "stratum_authorize_kas", 21, 139, 100, v42);
LABEL_2:
      free(v16);
      if ( !v6 )
        goto LABEL_10;
...
LABEL_10:
  ...
  if ( !v6 )
  {
    V_LOCK();
    LOWORD(v28) = 14540;
    HIWORD(v28) = (unsigned int)"e\", \"params\": [\"ckbminer-v1.0.0\", null]}" >> 16;
    logfmt_raw(v42, 0x1000u, 0, v28, *(_DWORD *)v40, v41);
    V_UNLOCK();
    LOWORD(v29) = 19864;
    HIWORD(v29) = (unsigned int)"thod\":\"mining.submit\", \"params\":[\"%s\",\"%s\",\"0x%s\"]}" >> 16;
    zlog(g_zc, v29, 163, "stratum_authorize_kas", 21, 153, 100, v42);
    free(v16);
    goto LABEL_10;
  }
  LOWORD(v18) = 5244;
  ...
  LOWORD(v21) = 4756;
  v37 = v20;
  HIWORD(v21) = (unsigned int)"ot be here" >> 16;
  ...
  V_UNLOCK();
  LOWORD(v26) = 19864;
  HIWORD(v26) = (unsigned int)"thod\":\"mining.submit\", \"params\":[\"%s\",\"%s\",\"0x%s\"]}" >> 16;
  zlog(g_zc, v26, 163, "stratum_authorize_kas", 21, 163, 80, v42);
  if ( !v3
    || (v16 = json_dumps(v36, 3),
        ...
        V_UNLOCK(),
        LOWORD(v30) = 19864,
        HIWORD(v30) = (unsigned int)"thod\":\"mining.submit\", \"params\":[\"%s\",\"%s\",\"0x%s\"]}" >> 16,
        zlog(g_zc, v30, 163, "stratum_authorize_kas", 21, 170, 100, v42),
        v16) )
  {
    v8 = 0;
LABEL_22:
