int __fastcall serdes_internal_loop_ate_init(int a1, unsigned int a2, int a3, int a4)
{
  ...
  LOWORD(v9) = -9448;
  HIWORD(v9) = (unsigned int)"tx_cnxt_sel rx_cnxt_sel tx_cmn_cntx_sel" >> 16;
  v26 = a4;
  a4 <<= 7;
  logfmt_raw(
    v41,
  ...
  sub_76660(a1, (unsigned __int16)a3, 240, v10);
  V_LOCK();
  LOWORD(v11) = 620;
  ...
  zlog(g_zc, v12, 173, "serdes_internal_loop_ate_init", 29, 158, 60, v41);
  sub_7660C(a1, a3, 86, 67634184);
  sub_76660(a1, (unsigned __int16)a3, 86, v10);
  V_LOCK();
  LOWORD(v13) = 620;
  ...
  V_UNLOCK();
  LOWORD(v14) = -9688;
  HIWORD(v14) = (unsigned int)"%02x sram ext load done" >> 16;
  LOWORD(v10) = -9416;
  zlog(g_zc, v14, 173, "serdes_internal_loop_ate_init", 29, 162, 60, v41);
  ...
  HIWORD(v10) = (unsigned int)"ntx_sel" >> 16;
  logfmt_raw(
    v41,
    0x1000u,
    0,
  ...
  zlog(g_zc, v16, 173, "serdes_internal_loop_ate_init", 29, 172, 60, v41);
  ...
  sub_76B84(a1, a3, 24642, v26 | 0x600);
  sub_7660C(a1, a3, 77, 0);
  sub_7660C(a1, a3, 78, -2144247741);
  sub_76B84(a1, a3, 24644, a4);
  sub_76B84(a1, a3, 24642, v26 | 7);
  sub_7660C(a1, a3, 77, 16777472);
  sub_7660C(a1, a3, 78, -2144247741);
  sub_76B84(a1, a3, 24644, a4 | 0x8000);
  sub_7660C(a1, a3, 77, 0);
  ...
  sub_76B84(a1, a3, 24644, a4 | 0x8020);
  sub_76B84(a1, a3, 24644, a4 | 0x8060);
  ...
  if ( v26 == 2 )
    ...
    HIWORD(v18) = 501;
  sub_7660C(a1, a3, 77, v18);
  sub_7660C(a1, a3, 78, -2144247559);
  sub_7660C(a1, a3, 77, 25166208);
  sub_7660C(a1, a3, 78, -2144251901);
  sub_7660C(a1, a3, 77, 92800392);
  sub_7660C(a1, a3, 78, -2144251901);
  sub_7660C(a1, a3, 77, 0);
  sub_7660C(a1, a3, 78, -2144251900);
  sub_7660C(a1, a3, 77, 541073472);
  sub_7660C(a1, a3, 78, -2144251900);
  sub_7660C(a1, a3, 77, 0);
  ...
  LOWORD(v20) = -9380;
  HIWORD(v20) = (unsigned int)"%s Overriding lane_cntx_en" >> 16;
  logfmt_raw(
    v41,
    0x1000u,
    0,
  ...
  V_UNLOCK();
  LOWORD(v21) = -9688;
  HIWORD(v21) = (unsigned int)"%02x sram ext load done" >> 16;
  zlog(g_zc, v21, 173, "serdes_internal_loop_ate_init", 29, 291, 60, v41);
  ...
  sub_7660C(a1, a3, 77, (int)&loc_E000C + 2);
  sub_7660C(a1, a3, 78, -2144247768);
  sub_7660C(a1, a3, 77, (int)&loc_E000C + 2);
  sub_7660C(a1, a3, 78, -2144247768);
  sub_7660C(a1, a3, 77, (int)&loc_30000 + 3);
  ...
  HIWORD(v22) = (unsigned int)"verride tx_req, rx_req, and De-assert rx_data_en" >> 16;
  logfmt_raw(
    v41,
    0x1000u,
    0,
