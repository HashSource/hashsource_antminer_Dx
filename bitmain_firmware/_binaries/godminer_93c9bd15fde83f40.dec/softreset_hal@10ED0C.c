int __fastcall softreset_hal(int a1)
{
  ...
  while ( 1 )
  {
    ...
    v4 = sub_9AB94((unsigned __int8)v2);
    if ( v4 > 0x10 )
    {
      v4 = 16;
      goto LABEL_9;
    ...
    if ( !v4 )
      break;
LABEL_9:
    v9 = sub_9A778(v2, (int)v11, v4);
    pthread_mutex_unlock(v3);
    if ( !v9 )
      goto LABEL_4;
  }
  pthread_mutex_unlock(&stru_1AA46C[v2]);
LABEL_4:
  sleep(1u);
  do
  {
    ...
    v7 = sub_9AB94((unsigned __int8)v5);
    if ( v7 > 0x10 )
    {
      v7 = 16;
    }
