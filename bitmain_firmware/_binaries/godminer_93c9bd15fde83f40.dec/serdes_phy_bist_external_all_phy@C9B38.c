int __fastcall serdes_phy_bist_external_all_phy(int a1, int a2, int a3, int a4)
{
  ...
  logfmt_raw(v12, 0x1000u, 0, 1560772, "serdes_phy_bist_external_all_phy");
  ...
  | ((_WORD)a4 << 8) & 0x700
  | (16 * (_BYTE)a4) & 0x70);
  sub_DAF1C(a1, 0xFFu, 144, -15);
  sub_DAF1C(a1, 0xFFu, 145, -2147422207);
  sub_DAF1C(a1, 0xFFu, 144, (2 * (_BYTE)a4) & 0xE);
  sub_DAF1C(a1, 0xFFu, 145, -2147422190);
  sub_DAF1C(a1, 0xFFu, 144, 0);
  sub_DAF1C(a1, 0xFFu, 145, -2147422207);
  v8 = a4 & 0xF;
  v11[1] = 0;
  switch ( v8 )
...
LABEL_7:
  ...
  zlog(
    ...
    60,
    v12);
  sub_DAF1C(a1, 0xFFu, 98, 255);
  enable_rxbist_autostop(a1, a2, 0xFFu, a3, 0x1Fu);
  read_rx_debug_reg2(a1, a2, (_BYTE *)0xFF, a3);
  sub_DAF1C(a1, 0xFFu, 144, -9);
  sub_DAF1C(a1, 0xFFu, 145, -2147422207);
  sub_DAF1C(a1, 0xFFu, 144, 8);
  sub_DAF1C(a1, 0xFFu, 145, -2147422063);
  sub_DAF1C(a1, 0xFFu, 144, -1073741825);
  sub_DAF1C(a1, 0xFFu, 145, -2147422207);
  sub_DAF1C(a1, 0xFFu, 144, 0x40000000);
  sub_DAF1C(a1, 0xFFu, 145, -2147422089);
  sub_DAF1C(a1, 0xFFu, 144, 0);
  sub_DAF1C(a1, 0xFFu, 145, -2147422207);
  pthread_mutex_lock(&stru_1A8A24);
  logfmt_raw(v12, 0x1000u, 0, 1560736);
  pthread_mutex_unlock(&stru_1A8A24);
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_D7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_ma"
