int __fastcall div32_20210813_500M(int a1, int a2, int a3, int a4)
{
  ...
  sub_BF774(a1, a3, v8, 0xFFFFu);
  sub_BF774(a1, a3, v9, 0xFFFF0000);
  sub_BF774(a1, a3, v8, 0xFFFF0000);
  sub_BF774(a1, a3, v10, 0xFFFFu);
  sub_BF774(a1, a3, v8, (unsigned int)&loc_FFFFC + 3);
  sub_BF774(a1, a3, v10, 0);
  sub_BF774(a1, a3, v8, 0xFFF00000);
  sub_BF774(a1, a3, v11, 0);
  sub_BF774(a1, a3, v8, 0xFFFFFFu);
  sub_BF774(a1, a3, v11, 0xFF000000);
  sub_BF774(a1, a3, v8, 0xFF000000);
  sub_BF774(a1, a3, v12, 0xFFFFFFu);
  sub_BF774(a1, a3, v8, 0xFFFu);
  sub_BF774(a1, a3, v13, 0);
