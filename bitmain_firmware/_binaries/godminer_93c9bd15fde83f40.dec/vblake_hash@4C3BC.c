unsigned int __fastcall vblake_hash(int *a1, int *a2)
{
  ...
  sub_89E20(
    ...
    8,
    12,
    *(_QWORD *)&v67[2 * unk_171B41],
    *(_QWORD *)&v67[2 * unk_171B40],
  ...
  while ( 1 )
  {
    ...
    v10 += 16;
    v26 = qword_171C40[v15];
    v27 = qword_171C40[(unsigned __int8)*(v10 - 45)];
    v28 = qword_171C40[(unsigned __int8)*(v10 - 42)];
    v11 = qword_171C40[(unsigned __int8)*(v10 - 33)];
    v29 = *(_QWORD *)((char *)qword_171C40 + v30);
    v31 = *(_QWORD *)((char *)qword_171C40 + v32);
    v33 = qword_171C40[(unsigned __int8)*(v10 - 41)];
    v34 = qword_171C40[v12];
    v35 = qword_171C40[(unsigned __int8)*(v10 - 39)];
    v36 = qword_171C40[(unsigned __int8)*(v10 - 36)];
    v37 = qword_171C40[(unsigned __int8)*(v10 - 37)];
    v38 = qword_171C40[(unsigned __int8)*(v10 - 34)];
    v39 = qword_171C40[v17];
    v40 = qword_171C40[v18];
    sub_89E20(
      (int)&v43,
      4,
      8,
      ...
      *(_QWORD *)&v67[2 * (unsigned __int8)*(v10 - 47)],
      qword_171C40[v13],
      qword_171C40[(unsigned __int8)*(v10 - 47)]);
  }
