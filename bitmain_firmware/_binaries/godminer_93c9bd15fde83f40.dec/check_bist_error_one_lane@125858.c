int __fastcall check_bist_error_one_lane(int a1, int a2, int a3, int a4)
{
  ...
  zlog(
    ...
    v60);
  v36 = v6 << 12;
  v7 = sub_C20C4(a1, a3, (unsigned __int16)(v6 << 12) | 0x10, (int)v58);
  if ( *(_DWORD *)(a1 + 236) != v7 )
  {
    v8 = v7;
    pthread_mutex_lock(&stru_1A8A24);
  ...
  v9 = sub_C20C4(a1, a3, v36 & 0xF000 | 0x13, (int)v49);
  if ( *(_DWORD *)(a1 + 236) != v9 )
  {
    pthread_mutex_lock(&stru_1A8A24);
    logfmt_raw(
  ...
  v10 = sub_C20C4(a1, a3, v36 & 0xF000 | 0x14, (int)v49);
  ...
  v12 = sub_C20C4(a1, a3, v36 & 0xF000 | 0x15, (int)v48);
  if ( *(_DWORD *)(a1 + 236) != v12 )
  {
    pthread_mutex_lock(&stru_1A8A24);
    logfmt_raw(
      v60,
  ...
  v20 = sub_C20C4(a1, a3, v36 & 0xF000 | 0x16, (int)v49);
  if ( v20 > 0 )
  {
    v39[1] = v50 >> 12;
    if ( v20 != 1 )
  ...
  v21 = sub_C20C4(a1, a3, v36 & 0xF000 | 0x17, (int)v49);
  if ( v21 > 0 )
  {
    v22 = v39;
    v23 = v49;
