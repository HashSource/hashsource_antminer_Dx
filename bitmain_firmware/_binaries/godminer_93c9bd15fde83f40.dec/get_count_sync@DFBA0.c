int __fastcall get_count_sync(int a1, int a2)
{
  ...
  logfmt_raw(v21, 0x1000u, 0, 1560772, "get_count_sync");
  ...
  if ( v4 > 0 )
  {
    ...
    else
    {
      ...
      do
      {
        ...
        v5 += 24;
        logfmt_raw(v21, 0x1000u, 0, 1570452, v16, v17, v8, v7);
        pthread_mutex_unlock(&stru_1A8A24);
        zlog(
          g_zc,
    ...
    do
    {
      ...
      v10 += 12;
      logfmt_raw(v21, 0x1000u, 0, 1570452, v12, v14, v13, v11);
      pthread_mutex_unlock(&stru_1A8A24);
      zlog(
        g_zc,
