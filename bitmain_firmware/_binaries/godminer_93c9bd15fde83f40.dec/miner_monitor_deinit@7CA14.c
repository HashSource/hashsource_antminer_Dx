void miner_monitor_deinit()
{
  ...
  v0 = (void *)dword_1A44BC;
  if ( *(_BYTE *)(dword_1A44BC + 6148) )
  {
    v1 = *(_DWORD *)(dword_1A44BC + 6152);
  ...
  v5 = dword_1A4178;
  free(v4);
  free((void *)dword_1A45BC);
  free((void *)dword_1A45B0);
  free((void *)dword_1A45B8);
  free((void *)dword_1A4170);
  free((void *)dword_1A45B4);
  do
  {
    v6 = (void *)v5[15];
    v5 += 52;
