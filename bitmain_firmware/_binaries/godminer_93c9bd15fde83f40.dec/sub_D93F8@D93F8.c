int __fastcall sub_D93F8(int a1, int a2, int a3, int *a4, unsigned __int64 a5)
{
  ...
  v27[0] = sub_16EB04(a5, 0x3E8u);
  while ( a2 > v9 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(*(_DWORD *)(a1 + 664), (char *)&v28, 0x4Au, v27) == 110 )
      {
        v8 = 3;
        goto LABEL_11;
      }
