int __fastcall check_mac_done(int a1, int a2, int a3, int a4)
{
  ...
  int v25; // r2
  _BOOL4 v27; // r3
  int v28; // [sp+14h] [bp-1030h]
  int v29; // [sp+18h] [bp-102Ch]
  int v30; // [sp+20h] [bp-1024h]
  int v32; // [sp+28h] [bp-101Ch]
  _DWORD v33[4]; // [sp+30h] [bp-1014h] BYREF
  char v34[4100]; // [sp+40h] [bp-1004h] BYREF

  v5 = a3;
  pthread_mutex_lock(&stru_1A8A24);
  logfmt_raw(v34, 0x1000u, 0, "%s...", "check_mac_done");
  ...
  zlog(
    ...
    60,
    v34);
  sub_DAF1C(a1, v5, 149, 0);
  sub_DAF1C(a1, v5, 151, 0);
  sub_DAF1C(a1, v5, 153, 0);
  sub_DAF1C(a1, v5, 87, 255);
  sub_DAF1C(a1, v5, 159, 0);
  sub_DAF1C(a1, v5, 133, 805306367);
  if ( a4 )
  {
    if ( a4 == 1 )
    {
      sub_DAF1C(a1, a3, 134, 0xFFFFFFF);
      sub_DAF1C(a1, a3, 132, -2147483647);
    }
  }
  else
  {
    sub_DAF1C(a1, a3, 134, 0xFFFFFFF);
    sub_DAF1C(a1, a3, 132, 17);
  }
  sleep(8u);
  ...
  do
  {
    v13 = a3;
    if ( a3 == 255 )
      v13 = *((unsigned __int8 *)v33 + v30);
    v28 = v13;
    v14 = (unsigned __int16)v13;
    ((void (__fastcall *)(int))off_1A2BB4[0])(*(_DWORD *)(a1 + 132));
    v15 = sub_DF23C(a1, v14, 139, v11);
    if ( v15 > 0 )
    {
      v16 = v11 + 16;
      v29 = (int)&v11[12 * v15 + 16];
      while ( 1 )
      {
        while ( 1 )
        {
...
LABEL_21:
        zlog(
          ...
          v34);
LABEL_22:
        if ( sub_E0BD8(a1, v22, v14, 135, v11) )
        {
          v19 = *(_DWORD *)v11 == 0;
          if ( *(_DWORD *)v11 )
            v19 = v28 == 3;
...
LABEL_27:
        if ( sub_E0BD8(a1, v22, v14, 136, v11) && *(_DWORD *)v11 )
        {
          pthread_mutex_lock(&stru_1A8A24);
          logfmt_raw(
            v34,
        ...
        if ( sub_E0BD8(a1, v22, v14, 137, v11) )
        {
          v20 = *(_DWORD *)v11 == 0;
          if ( *(_DWORD *)v11 )
            v20 = v28 == 3;
        ...
        if ( sub_E0BD8(a1, v22, v14, 138, v11) && *(_DWORD *)v11 )
        {
          pthread_mutex_lock(&stru_1A8A24);
          logfmt_raw(
            v34,
