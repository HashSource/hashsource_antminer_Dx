int __fastcall div8_seq_one_lane(int a1, int a2, int a3, int a4)
{
  ...
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8B, 0xFF000000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, 0xFFFF0000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8C, 0xFF00u);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, (unsigned int)&loc_FFFFC + 3);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8C, 0xF0000000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, 0xFFF00000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8D, (unsigned int)&loc_FF00C + 3);
  ...
  sub_BF774(a1, a3, a4 & 0xF000 | 0x8E, 0xFF00FFu);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, 0xFFFu);
  sub_BF774(a1, a3, a4 & 0xF000 | 0x8A, 0xFF00000u);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, 0xFFFFF000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8B, 0xFF0u);
