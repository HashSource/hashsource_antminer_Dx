int __fastcall sub_2E244(_DWORD *a1, int a2)
{
  int v4; // r6
  bool v5; // zf
  _DWORD *v6; // r4
  ...
  {
    sub_2885C(a1, 1, 11, *(const char **)(a2 + 8));
    v57 = json_array();
    v6 = json_object();
    ...
    v9 = v69;
    v10 = v68;
    format_hashrate_string(*(_DWORD *)(v4 + 84), v64);
    format_hashrate_string(*(_DWORD *)(v4 + 84), v63);
    format_hashrate_string(*(_DWORD *)(v4 + 84), v62);
    format_hashrate_string(*(_DWORD *)(v4 + 84), v61);
