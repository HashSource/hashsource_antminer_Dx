int __fastcall check_bist_done_one_lane(int a1, int a2, int a3, int a4)
{
  ...
  logfmt_raw(v18, 0x1000u, 0, 1560772, "check_bist_done_one_lane");
  ...
  if ( v7 > 0 )
  {
    ...
    do
    {
      ...
      {
        pthread_mutex_lock(&stru_1A8A24);
        logfmt_raw(v18, 0x1000u, 0, 1613644, a4, *((unsigned __int8 *)v8 - 20), *((unsigned __int8 *)v8 - 19));
        pthread_mutex_unlock(&stru_1A8A24);
        v10 = g_zc;
        v11 = 100;
        v12 = 9034;
      ...
      else
      {
        v15 = v13 & 0x20000;
        pthread_mutex_lock(&stru_1A8A24);
        logfmt_raw(v18, 0x1000u, v15, 1613592, a4, *((unsigned __int8 *)v8 - 20), *((unsigned __int8 *)v8 - 19));
        pthread_mutex_unlock(&stru_1A8A24);
        v10 = g_zc;
        v11 = 60;
        v12 = 9031;
