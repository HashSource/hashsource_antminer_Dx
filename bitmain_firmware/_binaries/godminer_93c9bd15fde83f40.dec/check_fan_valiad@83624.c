int check_fan_valiad()
{
  ...
  unsigned int v7; // r1
  int *v8; // r3
  int v9; // [sp+38h] [bp-184Ch]
  int v10; // [sp+3Ch] [bp-1848h]
  unsigned int v11; // [sp+40h] [bp-1844h]
  unsigned int v12; // [sp+44h] [bp-1840h]
...
LABEL_27:
  ...
  if ( v14[0] != 60 )
  {
    v8 = (int *)(unsigned __int8)fan_pwm_fixed;
    if ( fan_pwm_fixed )
      v8 = &dword_1A25A0;
    else
      v7 = 60;
    if ( fan_pwm_fixed )
      v7 = v8[11];
    return pwm_set(dword_1A4994, v7);
  }
  return result;
}
