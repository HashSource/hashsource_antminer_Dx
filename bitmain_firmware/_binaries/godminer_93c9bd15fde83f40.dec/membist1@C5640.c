int __fastcall membist1(int a1)
{
  ...
  do
  {
    ...
    usleep((__useconds_t)&stru_18694.st_info);
    usleep((__useconds_t)&stru_18694.st_info);
    v5 = sub_DF23C(a1, (unsigned __int16)v2, 161, ptr);
    if ( v5 > 0 )
    {
      v6 = ptr + 28;
      v7 = (int)&ptr[12 * v5 + 28];
...
LABEL_9:
    v11 = sub_DF23C(a1, (unsigned __int16)v2, 162, ptr);
    if ( v11 > 0 )
    {
      v12 = ptr + 28;
...
LABEL_15:
  ...
  v21 = strlen(src);
  if ( v21 <= 0x3F && dword_1A8B44[0] <= 63 )
  {
    strncpy((char *)&dword_1A8B44[16 * dword_1A8B44[0] + 1], src, v21);
    ++dword_1A8B44[0];
  }
  else
  {
