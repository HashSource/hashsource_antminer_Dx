int __fastcall check_ref_clock_ready_ext(int a1, int a2, _DWORD *a3, int a4, _BYTE *a5)
{
  ...
  v31[1] = 0;
  v31[0] = 0;
  v7 = *(void (__fastcall **)(int, _DWORD *))(v5 + 156);
  HIWORD(v32) = 112;
  LOBYTE(v32) = 1;
  v7(v5, v31);
  v8 = usleep((__useconds_t)&stru_18694.st_info);
  if ( a3 == (_DWORD *)255 )
  {
    v28 = 14;
    v8 = 100991489;
  ...
  for ( i = 0; i != 3; ++i )
  {
    ...
    for ( j = 0; j < v28; v14 = ++j )
    {
      ...
      v15 = sub_DF23C(a1, (unsigned __int16)v5, 112, ptr);
      if ( v15 > 0 )
      {
        v16 = ptr + 16;
        v5 += (int)(a5 + 16);
          ...
          if ( a5 )
          {
            *(_BYTE *)(v5 - 16) = 0;
            ...
            zlog(
              ...
              20,
              v31);
            if ( !sub_E0BD8(a1, *(v16 - 12), v24, 113, v13) || *(_DWORD *)v13 == -1 )
            {
              *(_BYTE *)(v5 - 16) = 0;
LABEL_49:
              pthread_mutex_lock(&stru_1A8A24);
