int __fastcall sub_2EB60(_DWORD *a1, const char **a2)
{
  int v3; // r4
  int v4; // r7
  _DWORD *v5; // r6
  ...
  *(_DWORD *)s = 0;
  ...
  if ( v3 > 0 )
  {
    ...
    do
    {
      v16 = *v12++;
      __pld(v13);
      memcpy(dest, &dword_1A4178[52 * *(_DWORD *)(v16 + 132)], 0xD0u);
      v17 = v13 - 1664;
      v13 += 208;
    ...
    if ( (_DWORD)v18 )
    {
      ...
      do
      {
        *(_DWORD *)s = 0;
        ...
        v27 = strlen(s);
        if ( utf8_check_string((int)s, v27) && (v23 = off_1A25E8(v27 + 1), (v24 = v23) != 0) )
        {
          memcpy(v23, s, v27);
          v24[v27] = 0;
    ...
    for ( i = (float *)(v66 + 96); ; i += 52 )
    {
      ...
      *(_DWORD *)s = 0;
      ...
      v29 = strlen(s);
      if ( utf8_check_string((int)s, v29) && (v30 = off_1A25E8(v29 + 1), (v31 = v30) != 0) )
      {
        memcpy(v30, s, v29);
        v31[v29] = 0;
        v32 = off_1A25E8(0x10u);
        if ( v32 )
        {
          v33 = v32;
          v32[2] = v31;
