        ...
        unsigned __int8 a9)
{
  ...
  | ((_WORD)a4 << 8) & 0x700
  | (16 * a4) & 0x70);
  sub_BF774(a1, a7, v14, 0xFFFFFFF1);
  sub_BF774(a1, a7, v15, (2 * (_BYTE)a4) & 0xE);
  sub_BF774(a1, a7, v14, 0);
  if ( a5 )
  {
    v32 = a5 >> 1;
    if ( a5 >> 1 )
  ...
  do
  {
    ...
    v42 = 8;
    v45 = a7;
    (*(void (__fastcall **)(int, unsigned int *))(a1 + 156))(a1, &v42);
    usleep((__useconds_t)&stru_18694.st_info);
    v44 = 9502720;
    v45 = 0;
  ...
  if ( v38 == 4 )
  {
    ...
    do
    {
      ...
      read_rx_debug_reg2_one_lane(a1, a2, (_BYTE *)a6, a8);
      read_rx_debug_reg2_one_lane(a1, a2, (_BYTE *)a7, a9);
      sub_BF774(a1, a7, v39, 0xFFFFFFF7);
      sub_BF774(a1, a7, v40, 8u);
      sub_BF774(a1, a7, v39, 0xBFFFFFFF);
      sub_BF774(a1, a7, (unsigned __int16)(a9 << 12) | 0x77, 0x40000000u);
      sub_BF774(a1, a7, v39, 0);
      usleep((__useconds_t)&loc_F4240);
      check_bist_tx_running_one_lane(a1, a2, a6, a8);
      check_bist_rx_running_one_lane(a1, a2, a7, a9);
      usleep(0x493E0u);
      sub_BF774(a1, a7, v39, 0xFFFFFFF7);
      sub_BF774(a1, a7, v40, 0);
      sub_BF774(a1, a7, v39, 0);
      check_ref_clock_ready(a1, a2, a6);
      check_bist_done_one_lane(a1, a2, a6, a9);
      check_ref_clock_ready(a1, a2, a7);
