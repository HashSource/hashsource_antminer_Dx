int __fastcall get_pcba_test_level_dash(int *a1, int *a2)
{
  ...
  if ( v2 )
    goto LABEL_2;
  v6 = off_1A2BB8(a1[33], 52, 0x60000u, &v17);
  if ( !v6 )
  {
...
LABEL_24:
    v9 = *(int *)((char *)&off_17E888[723] + 10 * v6);
    a1[192] = v9;
LABEL_8:
    if ( !v9 )
    {
      ...
      v10 = *(int *)((char *)&off_17E888[723] + 10 * v9);
      a1[192] = v10;
      if ( !v10 )
LABEL_15:
        a1[192] = 5;
    ...
    v12 = 5 * (a1[192] - 1);
    v26[8] = "chain";
    v13 = (char *)off_17E888 + 2 * v12;
    v26[9] = 5;
    v26[10] = 3;
    v14 = (unsigned __int8)v13[2901];
    v16 = (unsigned __int8)v13[2900];
    v26[12] = v11;
    v26[13] = v11 >> 31;
    v26[14] = 0;
    ++dword_1A8A20[0];
