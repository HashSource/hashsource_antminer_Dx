int __fastcall sub_C0678(int a1)
{
  int v1; // r10
  int v3; // r8
  int v4; // r9
  ...
  logfmt_raw(v32, 0x1000u, 0, "get_addr %s chip_no %d", "ChipSetting_get_addr_AE", 4u);
  ...
  (*(void (__fastcall **)(int, _DWORD *, unsigned int, char *, int *, int, int, _DWORD))(a1 + 172))(
    a1,
    v22,
    4u,
    ptr,
