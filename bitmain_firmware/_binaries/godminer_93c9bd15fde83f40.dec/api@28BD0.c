...
LABEL_104:
      ...
      dword_1A3F70 = servlen;
      dword_1A3F74 = servlen;
      dword_1A3F78 = servlen;
      dword_1A3F7C = servlen;
      v138[v10] = servlen;
      *(_DWORD *)v110 = servlen;
      *(_DWORD *)v106 = servlen;
      v111 = servlen;
      ...
      *((_DWORD *)v7 + 251) = time((time_t *)servlen);
      getnameinfo(&addr, 0x80u, (char *)&dword_1A3F70, 0x10u, (char *)servlen, servlen, 1u);
      pthread_mutex_lock(&stru_1A8A24);
      logfmt_raw(v130, 0x1000u, servlen, "connect_addr: %s", &dword_1A3F70);
      pthread_mutex_unlock(&stru_1A8A24);
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_D7_release/build/rootfs/buildroot/tmp/release/build/godminer-origi"
      ...
      *(_DWORD *)s1 = servlen;
      v116 = servlen;
      v117 = servlen;
      v11 = sub_C479C((int)v138, servlen, (int)v121);
      v12 = v11;
      if ( !v11 || *v11 )
        goto LABEL_36;
      v13 = sub_12D418((unsigned __int16 *)"command", 7u, hashtable_seed);
      v14 = v12[3];
      v15 = v13;
      v16 = v13 & ~(-1 << v12[4]);
...
LABEL_36:
        v12 = json_object();
        v25 = sub_C479C((int)v138, 0, (int)v122);
        v26 = v25;
        if ( !v25 || *v25 )
        {
          v91 = 2;
        ...
        if ( !v50 || *(_DWORD *)v50 != 2 )
        {
          ...
          zlog(
            ...
            100,
            v131);
          sub_2885C(v12, 0, 24, "Missing JSON 'command'");
LABEL_40:
          if ( v91 != 2 )
          {
            v28 = (char *)json_dumps(v12, 24576);
            v29 = v28;
            if ( v28 )
              sub_260C0(&fd, v28);
            if ( v12 && v12[1] != -1 )
...
LABEL_160:
            ...
            if ( !v87 )
            {
              ...
              v27 = v91;
LABEL_39:
              sub_28A0C(v12, v110, (int)v106, v27);
              goto LABEL_40;
            }
          }
        }
