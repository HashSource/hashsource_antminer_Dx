int __fastcall div8_seq(int a1, int a2, int a3, int a4)
{
  ...
  sub_BF774(a1, a3, v10, 0xFFFFu);
  sub_BF774(a1, a3, v18, 0xFF000000);
  sub_BF774(a1, a3, v10, 0xFFFF0000);
  sub_BF774(a1, a3, v11, 0xFF00u);
  sub_BF774(a1, a3, v10, (unsigned int)&loc_FFFFC + 3);
  sub_BF774(a1, a3, v11, 0xF0000000);
  sub_BF774(a1, a3, v10, 0xFFF00000);
  sub_BF774(a1, a3, v12, (unsigned int)&loc_FF00C + 3);
  sub_BF774(a1, a3, v10, 0xFFFFFFu);
  sub_BF774(a1, a3, v12, 0);
  sub_BF774(a1, a3, v10, 0xFF000000);
  sub_BF774(a1, a3, v13, 0xFF00FFu);
  sub_BF774(a1, a3, v10, 0xFFFu);
  sub_BF774(a1, a3, v19, 0xFF00000u);
  sub_BF774(a1, a3, v10, 0xFFFFF000);
  sub_BF774(a1, a3, v18, 0xFF0u);
