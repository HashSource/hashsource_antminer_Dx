int __fastcall div2_seq(int a1, int a2, int a3, int a4)
{
  ...
  sub_BF774(a1, a3, v19, 0xCCCC0000);
  sub_BF774(a1, a3, v11, 0xFFFF0000);
  sub_BF774(a1, a3, v12, 0xCCCCu);
  sub_BF774(a1, a3, v11, (unsigned int)&loc_FFFFC + 3);
  sub_BF774(a1, a3, v12, 0xCCC00000);
  sub_BF774(a1, a3, v11, 0xFFF00000);
  sub_BF774(a1, a3, v13, (unsigned int)&loc_CCCCC);
  sub_BF774(a1, a3, v11, 0xFFFFFFu);
  sub_BF774(a1, a3, v13, 0xCC000000);
  sub_BF774(a1, a3, v11, 0xFF000000);
  sub_BF774(a1, a3, v20, 0xCCCCCCu);
  sub_BF774(a1, a3, v11, 0xFFFu);
  sub_BF774(a1, a3, v14, 0xCCCCC000);
  sub_BF774(a1, a3, v11, 0xFFFFF000);
  sub_BF774(a1, a3, v19, 0xCCCu);
