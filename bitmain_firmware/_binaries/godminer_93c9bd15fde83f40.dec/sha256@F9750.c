int __fastcall sha256(char *src, size_t a2, int *a3)
{
  ...
  __int128 v84; // [sp+B8h] [bp-124h]
  int v85; // [sp+C8h] [bp-114h]
  int v86; // [sp+CCh] [bp-110h]
  int v87; // [sp+D0h] [bp-10Ch]
  int v88; // [sp+D4h] [bp-108h]
  _DWORD v89[27]; // [sp+D8h] [bp-104h]
  char v90; // [sp+144h] [bp-98h] BYREF
  int v91; // [sp+190h] [bp-4Ch]
  unsigned int v92; // [sp+194h] [bp-48h]
  unsigned int v93; // [sp+198h] [bp-44h]
  int v94; // [sp+1B4h] [bp-28h]
  int v95; // [sp+1B8h] [bp-24h] BYREF
  unsigned int v96; // [sp+1C8h] [bp-14h]
  unsigned int v97; // [sp+1CCh] [bp-10h]
  int v98; // [sp+1D0h] [bp-Ch]
  int v99; // [sp+1D4h] [bp-8h]
  ...
  if ( v5 > 0x3F )
  {
    ...
    v29 = 16;
    v89[1] = bswap32(dest[1]);
    v89[3] = bswap32(dest[3]);
    v89[4] = bswap32(dest[4]);
    v89[5] = bswap32(dest[5]);
    v30 = bswap32(dest[0]);
    v89[6] = bswap32(dest[6]);
    v89[7] = bswap32(dest[7]);
    v89[8] = bswap32(dest[8]);
    v89[2] = bswap32(dest[2]);
    v89[0] = v30;
    v89[9] = bswap32(dest[9]);
    v89[10] = bswap32(dest[10]);
    v31 = bswap32(dest[14]);
    v89[11] = bswap32(dest[11]);
    v89[12] = bswap32(dest[12]);
    v89[13] = bswap32(dest[13]);
    v32 = bswap32(dest[15]);
    v89[14] = v31;
    v89[15] = v32;
    do
    ...
    v98 = v91
        + v94
        + (__ROR4__(v96, 17) ^ __ROR4__(v96, 19) ^ (v96 >> 10))
        + (__ROR4__(v92, 7) ^ __ROR4__(v92, 18) ^ (v92 >> 3));
    if ( v58 != 1 )
      v99 = (__ROR4__(v97, 19) ^ __ROR4__(v97, 17) ^ (v97 >> 10))
          + v95
          + v92
          + (__ROR4__(v93, 18) ^ __ROR4__(v93, 7) ^ (v93 >> 3));
    v63 = v84;
    v64 = 0;
    v65 = *(_QWORD *)((char *)&v84 + 4);
    v66 = v85;
    v67 = HIDWORD(v84);
    v68 = v86;
    v69 = v87;
  ...
  *((_BYTE *)dest + v12) = BYTE2(v9);
  ...
  v24 = HIBYTE(v85);
  v25 = BYTE10(v84);
  *a3 = BYTE3(v84) | (unsigned __int16)(BYTE2(v84) << 8) | (BYTE1(v84) << 16) & 0xFFFFFF | ((unsigned __int8)v84 << 24);
  v26 = v88;
