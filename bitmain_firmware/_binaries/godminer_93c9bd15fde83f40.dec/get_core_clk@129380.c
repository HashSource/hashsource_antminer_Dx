int __fastcall get_core_clk(int a1)
{
  ...
  logfmt_raw(v21, 0x1000u, 0, 1560772, "get_core_clk");
    ...
    if ( v1 > 0 )
    {
      ...
      do
      {
        ...
        else
        {
          ...
          v2 += 3;
          logfmt_raw(v21, 0x1000u, 0, 1613964, v8, v7, 121, 0, 0);
        }
        pthread_mutex_unlock(&stru_1A8A24);
        zlog(
          g_zc,
    ...
    if ( v9 > 0 )
    {
      ...
      do
      {
        ...
        else
        {
          ...
          v10 += 3;
          logfmt_raw(v21, 0x1000u, 0, 1614016, v16, v15, 122, 0, 0);
        }
        pthread_mutex_unlock(&stru_1A8A24);
        zlog(
          g_zc,
