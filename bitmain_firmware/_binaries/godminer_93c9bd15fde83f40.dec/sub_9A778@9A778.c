unsigned int __fastcall sub_9A778(int a1, int a2, unsigned int a3)
{
...
LABEL_5:
      v7 = a3 >> 2;
      v8 = dword_1A8A8C;
      *(_DWORD *)(dword_1A8A8C + v5) = a3 & 0x3FF | 0x80000000;
      if ( a3 >> 2 )
      {
        if ( v7 <= 8 )
        {
        ...
        else
        {
          ...
          do
          {
            ...
            *(v9 - 74) = BYTE2(v12);
            *(v9 - 73) = BYTE1(v12);
            v13 = *(_DWORD *)(dword_1A8A8C + v6);
            *(v9 - 68) = v13;
            *(v9 - 71) = HIBYTE(v13);
            *(v9 - 70) = BYTE2(v13);
            *(v9 - 69) = BYTE1(v13);
            v14 = *(_DWORD *)(dword_1A8A8C + v6);
            *(v9 - 64) = v14;
            *(v9 - 67) = HIBYTE(v14);
            *(v9 - 66) = BYTE2(v14);
            *(v9 - 65) = BYTE1(v14);
            v15 = *(_DWORD *)(dword_1A8A8C + v6);
            *(v9 - 60) = v15;
            *(v9 - 63) = HIBYTE(v15);
            *(v9 - 62) = BYTE2(v15);
            *(v9 - 61) = BYTE1(v15);
            v16 = *(_DWORD *)(dword_1A8A8C + v6);
            *(v9 - 56) = v16;
            *(v9 - 59) = HIBYTE(v16);
            *(v9 - 58) = BYTE2(v16);
            *(v9 - 57) = BYTE1(v16);
            v17 = *(_DWORD *)(dword_1A8A8C + v6);
            *(v9 - 55) = HIBYTE(v17);
            *(v9 - 54) = BYTE2(v17);
            *(v9 - 52) = v17;
            *(v9 - 53) = BYTE1(v17);
            v18 = *(_DWORD *)(dword_1A8A8C + v6);
            *(v9 - 48) = v18;
            *(v9 - 51) = HIBYTE(v18);
            *(v9 - 50) = BYTE2(v18);
            *(v9 - 49) = BYTE1(v18);
            v19 = *(_DWORD *)(dword_1A8A8C + v6);
            *(v9 - 44) = v19;
            *(v9 - 47) = HIBYTE(v19);
            *(v9 - 46) = BYTE2(v19);
            *(v9 - 45) = BYTE1(v19);
