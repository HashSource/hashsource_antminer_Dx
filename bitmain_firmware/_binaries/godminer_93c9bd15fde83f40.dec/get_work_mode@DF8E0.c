int __fastcall get_work_mode(int a1)
{
  ...
  logfmt_raw(v19, 0x1000u, 0, 1560772, "get_work_mode");
  ...
  if ( v2 > 0 )
  {
    ...
    else
    {
      ...
      do
      {
        ...
        v3 += 24;
        logfmt_raw(v19, 0x1000u, 0, 1570452, v14, v15, v6, v5);
        pthread_mutex_unlock(&stru_1A8A24);
        zlog(
          g_zc,
    ...
    do
    {
      ...
      v8 += 12;
      logfmt_raw(v19, 0x1000u, 0, 1570452, v10, v12, v11, v9);
      pthread_mutex_unlock(&stru_1A8A24);
      zlog(
        g_zc,
