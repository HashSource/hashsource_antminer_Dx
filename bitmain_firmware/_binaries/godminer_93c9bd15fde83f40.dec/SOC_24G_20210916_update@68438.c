int __fastcall SOC_24G_20210916_update(int a1, int a2, char a3, int a4)
{
  ...
  logfmt_raw(v70, 0x1000u, 0, 1560772, "SOC_24G_20210916_update");
  v9 = 61483;
  v10 = 61480;
  ...
  sub_BF774(a1, a3, v53, 0x80000000);
  ...
  sub_BF774(a1, a3, v43, 0x32u);
  sub_BF774(a1, a3, v7, 0xFFFFFFu);
  sub_BF774(a1, a3, v51, 0x32000000u);
  ...
  sub_BF774(a1, a3, v7, 0xFFFFFFFB);
  sub_BF774(a1, a3, v48, 4u);
  sub_BF774(a1, a3, v7, 0x7FFFFFFFu);
  sub_BF774(a1, a3, v41, 0);
  sub_BF774(a1, a3, v7, 0xFFFFFBFF);
  sub_BF774(a1, a3, v49, 0);
  ...
  sub_BF774(a1, a3, v44, 0x20000u);
  sub_BF774(a1, a3, v7, 0xFFFFFFFC);
  sub_BF774(a1, a3, v45, 2u);
  sub_BF774(a1, a3, v7, 0xFFFCFFFF);
  sub_BF774(a1, a3, v45, 0x30000u);
  sub_BF774(a1, a3, v7, 0xFFFCFFFF);
  sub_BF774(a1, a3, v58, 0x30000u);
  ...
  sub_BF774(a1, a3, v59, 0x2000u);
  sub_BF774(a1, a3, v7, 0xFFBFFFFF);
  sub_BF774(a1, a3, v60, 0x400000u);
  sub_BF774(a1, a3, v7, 0xFFFFFE0F);
  sub_BF774(a1, a3, v46, 0x180u);
  sub_BF774(a1, a3, v7, 0xFFFFFF1F);
  sub_BF774(a1, a3, v61, 0);
  sub_BF774(a1, a3, v7, 0xFFFF0FFF);
  sub_BF774(a1, a3, v46, 0);
  sub_DB014(a1, 1, 7u, 144, 0x2000);
  sub_DB014(a1, 1, 7u, 145, -2147454786);
  serdes_apb_write_1_chip(a1, 1, 5, 20670, 0x6000u);
  sub_DB014(a1, 1, 7u, 144, 24576);
  sub_DB014(a1, 1, 7u, 145, -2147479362);
  sub_DB014(a1, 0, 7u, 144, 0x2000);
  sub_DB014(a1, 0, 7u, 145, -2147467074);
  sub_DB014(a1, 0, 7u, 144, 0x2000);
  sub_DB014(a1, 0, 7u, 145, -2147458882);
  sub_DB014(a1, 0, 7u, 144, 0x2000);
  sub_DB014(a1, 0, 7u, 145, -2147454786);
  sub_BF774(a1, a3, v7, 0xFFFF7FFF);
  sub_BF774(a1, a3, v62, 0x8000u);
  sub_BF774(a1, a3, v7, 0xFFFEFFFF);
  sub_BF774(a1, a3, v63, 0x10000u);
  sub_BF774(a1, a3, v7, 0xFFFDFFFF);
  sub_BF774(a1, a3, v63, 0x20000u);
  sub_BF774(a1, a3, v7, 0xFFFF000F);
  sub_BF774(a1, a3, v44, 0x8000u);
  sub_BF774(a1, a3, v7, 0xFFFFFFF3);
  sub_BF774(a1, a3, v64, 8u);
  ...
  sub_BF774(a1, a3, v7, 0xFFFFFFFC);
  sub_BF774(a1, a3, v42, 2u);
  sub_BF774(a1, a3, v7, 0xF3FFFFFF);
  sub_BF774(a1, a3, v66, 0x8000000u);
  sub_BF774(a1, a3, v7, 0xCFFFFFFF);
  sub_BF774(a1, a3, v67, 0x20000000u);
  ...
  sub_BF774(a1, a3, v9, 0);
  sub_BF774(a1, a3, v7, 0xFFFFFFF1);
  sub_BF774(a1, a3, v68, 0);
  sub_BF774(a1, a3, v7, 0xFFFFFF0F);
  sub_BF774(a1, a3, v69, 0x60u);
  sub_BF774(a1, a3, v7, 0xFFFFFFFC);
  sub_BF774(a1, a3, v44, 2u);
