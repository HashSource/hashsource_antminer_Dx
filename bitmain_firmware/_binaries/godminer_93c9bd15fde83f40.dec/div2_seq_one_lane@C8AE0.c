int __fastcall div2_seq_one_lane(int a1, int a2, int a3, int a4)
{
  ...
  logfmt_raw((char *)&v13, 0x1000u, 0, "%s chip_id %02x core_id %02x channel_id %02x", "div2_seq_one_lane", a2, a3, v12);
  ...
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8B, 0xCCCC0000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, 0xFFFF0000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8C, 0xCCCCu);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, (unsigned int)&loc_FFFFC + 3);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8C, 0xCCC00000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, 0xFFF00000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8D, (unsigned int)&loc_CCCCC);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, 0xFFFFFFu);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8D, 0xCC000000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, 0xFF000000);
  sub_BF774(a1, a3, a4 & 0xF000 | 0x8E, 0xCCCCCCu);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, 0xFFFu);
  sub_BF774(a1, a3, a4 & 0xF000 | 0x8A, 0xCCCCC000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, 0xFFFFF000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8B, 0xCCCu);
  ...
  v16 = (unsigned __int8)a3;
  v13 = -2147442687;
  (*(void (__fastcall **)(int, int *))(a1 + 156))(a1, &v13);
  usleep((__useconds_t)&stru_18694.st_info);
  return 0;
}
