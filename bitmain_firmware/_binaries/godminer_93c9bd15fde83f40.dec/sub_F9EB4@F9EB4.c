int __fastcall sub_F9EB4(_DWORD *a1, int a2, _DWORD *a3)
{
  unsigned int v5; // r4
  int v6; // r1
  int v7; // r2
  ...
  do
  {
    ...
    sub_1512D0(src, &src[16]);
    sub_1512D0(&src[16], src);
    v23 = v22 - 640;
    v22 += 256;
  ...
  *a3 = 1779033703;
  ...
  sub_87A28(&v156, &v174);
  sub_1516E0(&v156, (int)src, 1);
  sub_1516E0(&v156, (int)&src[16], 1);
  sub_87A28(&v156, dword_180274);
  v174 = v156;
  v175 = v157;
  v176 = v158;
  v177 = v159;
