int __fastcall SOC_24G_20210915_update(int a1, int a2, char a3, int a4)
{
  ...
  logfmt_raw(v56, 0x1000u, 0, 1560772, "SOC_24G_20210915_update");
  v8 = 61580;
  v9 = 61630;
  ...
  if ( !v12 )
    v33 = 2;
  sub_BF774(a1, a3, v6, 0xFFFFFFF7);
  sub_BF774(a1, a3, v35, 0);
  ...
  sub_DAF1C(a1, a3, 144, 4);
  sub_DAF1C(a1, a3, 145, -2147434433);
  sub_BF774(a1, a3, v6, 0xFFFFFFFD);
  sub_BF774(a1, a3, v35, 0);
  sub_BF774(a1, a3, v6, 0x7FFFFFFFu);
  sub_BF774(a1, a3, v36, 0x80000000);
  sub_BF774(a1, a3, v6, 0xFFFBFFFF);
  sub_BF774(a1, a3, v35, 0);
  sub_BF774(a1, a3, v6, 0xFFFFFFFB);
  sub_BF774(a1, a3, v35, 0);
  ...
  sub_BF774(a1, a3, v6, 0xFFFFFC00);
  sub_BF774(a1, a3, v37, 0x32u);
  sub_BF774(a1, a3, v6, 0xFFFFFFu);
  sub_BF774(a1, a3, v38, 0x32000000u);
  sub_BF774(a1, a3, v6, 0xFFFFFFFC);
  sub_BF774(a1, a3, v39, 0);
  sub_BF774(a1, a3, v6, 0xFFFFF7FF);
  sub_BF774(a1, a3, v40, 0);
  sub_BF774(a1, a3, v6, 0xFFDFFFFF);
  sub_BF774(a1, a3, v41, 0);
  sub_BF774(a1, a3, v6, 0xDFFFFFFF);
  sub_BF774(a1, a3, v11, 0);
  sub_BF774(a1, a3, v6, 0xFFFFFFFB);
  sub_BF774(a1, a3, v42, 4u);
  sub_BF774(a1, a3, v6, 0x7FFFFFFFu);
  sub_BF774(a1, a3, v11, 0);
  sub_BF774(a1, a3, v6, 0xFFFFFBFF);
  sub_BF774(a1, a3, v43, 0);
  ...
  sub_BF774(a1, a3, v6, 0xFBFFFFFF);
  sub_BF774(a1, a3, v44, 0x4000000u);
  sub_DAF1C(a1, a3, 144, -131073);
  sub_DAF1C(a1, a3, 145, -2147450879);
  sub_DAF1C(a1, a3, 144, 0);
  sub_DAF1C(a1, a3, 145, -2147450818);
  sub_BF774(a1, a3, v6, 0xFFFBFFFF);
  sub_BF774(a1, a3, v45, 0x40000u);
  sub_BF774(a1, a3, v6, 0xFFFFFBFF);
  sub_BF774(a1, a3, v46, 0x400u);
  sub_BF774(a1, a3, v6, 0xFF7FFFFF);
  sub_BF774(a1, a3, v47, 0x800000u);
  sub_BF774(a1, a3, v6, 0xFFFFFFFu);
  sub_BF774(a1, a3, v48, 0x60000000u);
  ...
  sub_BF774(a1, a3, v6, 0xFFFCFFFF);
  sub_BF774(a1, a3, v33, 0x20000u);
  sub_BF774(a1, a3, v6, 0xFFFFFFFC);
  sub_BF774(a1, a3, v10, 2u);
  sub_BF774(a1, a3, v6, 0xFFFCFFFF);
  sub_BF774(a1, a3, v10, 0x30000u);
  sub_BF774(a1, a3, v6, 0xFFFCFFFF);
  sub_BF774(a1, a3, v49, 0x30000u);
  ...
  sub_BF774(a1, a3, v6, 0xFFFFCFFF);
  sub_BF774(a1, a3, v50, 0x2000u);
  sub_BF774(a1, a3, v6, 0xFFBFFFFF);
  sub_BF774(a1, a3, v51, 0x400000u);
  sub_BF774(a1, a3, v6, 0xFFFFFE0F);
  sub_BF774(a1, a3, v9, 0x180u);
  sub_BF774(a1, a3, v6, 0xFFFFFF1F);
  sub_BF774(a1, a3, v52, 0);
  sub_BF774(a1, a3, v6, 0xFFFF0FFF);
  sub_BF774(a1, a3, v9, 0x4000u);
  sub_BF774(a1, a3, v6, 0xFFFF7FFF);
  sub_BF774(a1, a3, v53, 0x8000u);
  sub_BF774(a1, a3, v6, 0xFFFEFFFF);
  sub_BF774(a1, a3, v8, 0x10000u);
  sub_BF774(a1, a3, v6, 0xFFFDFFFF);
  sub_BF774(a1, a3, v8, 0x20000u);
  sub_BF774(a1, a3, v6, 0xFFFF000F);
  sub_BF774(a1, a3, v33, 0x8000u);
  sub_BF774(a1, a3, v6, 0xFFFFFFF3);
  sub_BF774(a1, a3, v54, 8u);
  sub_BF774(a1, a3, v6, 0xFFFFF9FF);
  sub_BF774(a1, a3, v55, 0x400u);
