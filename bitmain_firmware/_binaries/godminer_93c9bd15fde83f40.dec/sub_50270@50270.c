int __fastcall sub_50270(int a1, int *a2, _DWORD *a3, int a4)
{
  char v4; // r7
  int v8; // r5
  signed int v10; // r2
  ...
  v18 = 26738688;
  BYTE1(v20) = a4;
  v8 = (*(int (__fastcall **)(int, int *))(a1 + 152))(a1, &v18);
  if ( v8 )
    return 0;
  usleep(0xC350u);
  v10 = *(_DWORD *)(a1 + 192);
  ...
  v12 = v11;
  HIWORD(v20) = 32;
  (*(void (__fastcall **)(int, int *, signed int, unsigned __int8 *, int *))(a1 + 172))(a1, &v18, v16, v11, &v17);
  v13 = v17;
  if ( v17 == 1 )
  {
    if ( a4 == v12[4] )
