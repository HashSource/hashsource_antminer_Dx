int __fastcall sub_30234(_DWORD *a1, const char **a2)
{
  int v3; // r5
  _DWORD *v4; // r6
  int v5; // r7
  ...
  if ( a2 )
  {
    ...
    else
    {
      ...
      {
        v13 = *v9++;
        v14 = &dword_1A4178[52 * *(_DWORD *)(v13 + 132)];
        v12 += *((_QWORD *)v14 + 9);
        v11 = v11 + *((float *)v14 + 8);
        v10 = v10 + *((float *)v14 + 9);
        v6 = v6 + *((float *)v14 + 10);
    ...
    if ( v48 > 0 )
    {
      ...
      do
      {
        v46 = *v42++;
        __pld(v43);
        memcpy(dest, &dword_1A4178[52 * *(_DWORD *)(v46 + 132)], 0xD0u);
        v47 = v43 - 1664;
        v43 += 208;
    ...
    LODWORD(v20) = sub_16E7EC((__int64)(v18 * v15));
    v21 = v20;
    v22 = (double *)off_1A25E8(16);
    if ( v22 )
    {
      *(_DWORD *)v22 = 4;
      *((_DWORD *)v22 + 1) = 1;
    ...
    LODWORD(v23) = sub_16E7EC((__int64)(v18 * v16));
    v24 = v23;
    v25 = (double *)off_1A25E8(16);
    if ( v25 )
    {
      *(_DWORD *)v25 = 4;
      *((_DWORD *)v25 + 1) = 1;
    ...
    LODWORD(v26) = sub_16E7EC((__int64)(v18 * v17));
    v27 = v26;
    v28 = (double *)off_1A25E8(16);
    if ( v28 )
    {
      *(_DWORD *)v28 = 4;
      v28[1] = v27 * 0.01;
    ...
    v33 = *(_QWORD *)&dword_1AB198;
    v34 = (_QWORD *)off_1A25E8(16);
    if ( v34 )
    {
      v34[1] = v33;
      *(_DWORD *)v34 = 3;
