int __fastcall div4_seq_one_lane(int a1, int a2, int a3, int a4)
{
  ...
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8B, 0xF0F00000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, 0xFFFF0000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8C, 0xF0F0u);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, (unsigned int)&loc_FFFFC + 3);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8C, 0xF000000u);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, 0xFFF00000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8D, (unsigned int)&loc_F0F0C + 3);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, 0xFFFFFFu);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8D, 0xF0000000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, 0xFF000000);
  sub_BF774(a1, a3, a4 & 0xF000 | 0x8E, 0xF0F0F0u);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, 0xFFFu);
  sub_BF774(a1, a3, a4 & 0xF000 | 0x8A, 0xF0F0000u);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 1, 0xFFFFF000);
  sub_BF774(a1, a3, (unsigned __int16)a4 | 0x8B, 0xF0Fu);
