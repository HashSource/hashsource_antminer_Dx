int __fastcall sub_9B2AC(int a1)
{
...
LABEL_7:
  ...
  else
  {
    ...
    while ( 1 )
    {
      v4 = (unsigned __int8)(*(_DWORD *)(dword_1A8A8C + (v10 & 0xFFFFFFFC)) >> v7);
      if ( v4 == 255 )
        break;
      printf("%s: waiting fpga uart%d clear send fifo space ...\n", "clear_uart_tx_fifo", a1);
      *(_DWORD *)(dword_1A8A8C + (v9 & 0xFFFFFFFC)) = v4 | 0x80000000;
      usleep(0xBB8u);
      if ( !--v3 )
      {
