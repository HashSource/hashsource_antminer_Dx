int __fastcall stratum_connect(int a1)
{
  ...
  {
    sub_C0448(v7, (int *)v26);
    sa_family = v26[0].sa_family;
    pthread_mutex_lock(&stru_1A8A24);
    logfmt_raw((char *)v26, 0x1000u, 0, 1618348, *(_DWORD *)(a1 + 28), dest, sa_family);
    ...
    if ( *(_DWORD *)(a1 + 32) == -1 )
    {
      ...
      *(_DWORD *)(a1 + 32) = v15;
      ...
      if ( setsockopt(v15, 1, 2, v22, 4u) )
      {
        ...
        v16 = _errno_location();
        v17 = strerror(*v16);
        logfmt_raw((char *)v26, 0x1000u, 0, 1618396, v17);
        V_UNLOCK();
        zlog(
          g_zc,
  ...
  else
  {
    ...
    v22[1] = 4;
    v22[4] = v13;
    logfmt_raw((char *)v26, 0x1000u, 0, 0, 1533548, 4, 0, 0, v13, 0, v23, 0, 1618380);
    pthread_mutex_unlock(&stru_1A8A24);
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
