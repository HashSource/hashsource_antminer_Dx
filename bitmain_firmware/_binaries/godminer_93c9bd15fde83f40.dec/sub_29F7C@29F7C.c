int __fastcall sub_29F7C(_DWORD *a1, int a2)
{
  _BOOL4 v4; // r5
  int v5; // r6
  int v6; // r5
  ...
  *(_DWORD *)v84 = 0;
  ...
  else
  {
    ...
    if ( total_pools )
    {
      sub_2885C(a1, 1, 7, *(const char **)(a2 + 8));
      v79 = json_array();
      if ( total_pools > 0 )
      {
        v77 = 0;
        do
        {
          ...
          *(_DWORD *)v84 = 0;
          ...
          v45 = json_string(&byte_1746D4);
          json_object_set_new(v7, "Proxy Type", v45);
          v46 = json_string(&byte_1746D4);
          json_object_set_new(v7, "Proxy", v46);
          LODWORD(v47) = sub_16E7EC((__int64)(*(double *)(v6 + 1328) * 100.0));
          v48 = v47;
          v49 = (double *)off_1A25E8(0x10u);
          if ( v49 )
          {
            *(_DWORD *)v49 = 4;
            v49[1] = v48 * 0.01;
          ...
          LODWORD(v50) = sub_16E7EC((__int64)(*(double *)(v6 + 1336) * 100.0));
          v51 = v50;
          v52 = (double *)off_1A25E8(0x10u);
          if ( v52 )
          {
            *(_DWORD *)v52 = 4;
            v52[1] = v51 * 0.01;
          ...
          LODWORD(v53) = sub_16E7EC((__int64)(*v40 * 100.0));
          v54 = v53;
          v55 = (double *)off_1A25E8(0x10u);
          if ( v55 )
          {
            *(_DWORD *)v55 = 4;
            v55[1] = v54 * 0.01;
          ...
          LODWORD(v56) = sub_16E7EC((__int64)(*(double *)(v6 + 992) * 100.0));
          v57 = v56;
          v58 = (double *)off_1A25E8(0x10u);
          if ( v58 )
          {
            *(_DWORD *)v58 = 4;
            *((_DWORD *)v58 + 1) = 1;
          ...
          json_object_set_new(v7, "Stratum Active", dword_1A24DC);
          v60 = json_string(&byte_1746D4);
          json_object_set_new(v7, "Stratum URL", v60);
          json_object_set_new(v7, "Has GBT", dword_1A24E4);
          v61 = off_1A25E8(0x10u);
          if ( v61 )
          {
            *(_DWORD *)v61 = 4;
            v61[1] = 0;
          ...
          {
            LODWORD(v65) = sub_16E7EC((__int64)(v62 / v63 * 100.0));
            v64 = v65 * 0.01;
          }
          v66 = (double *)off_1A25E8(0x10u);
          if ( v66 )
          {
            *(_DWORD *)v66 = 4;
            v66[1] = v64;
          ...
          {
            LODWORD(v69) = sub_16E7EC((__int64)(*v40 / v67 * 100.0));
            v68 = v69 * 0.01;
          }
          v70 = (int)off_1A25E8(0x10u);
          v73 = v70;
          v72 = v70 == 0;
          if ( v70 )
          {
