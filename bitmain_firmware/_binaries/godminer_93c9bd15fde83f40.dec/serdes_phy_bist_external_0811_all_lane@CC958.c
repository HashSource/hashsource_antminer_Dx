        ...
        unsigned int a6)
{
  ...
  | (a5 << 8) & 0x700
  | (16 * a5) & 0x70);
  sub_BF774(a1, (char)a3, v39, 0xFFFFFFF1);
  sub_BF774(a1, (char)a3, v17, (2 * a5) & 0xE);
  sub_BF774(a1, (char)a3, v39, 0);
  if ( a6 )
  {
    v30 = a6 >> 1;
    if ( a6 >> 1 )
  ...
  do
  {
    ...
    (*(void (__fastcall **)(int, int *))(a1 + 156))(a1, &v45);
    usleep((__useconds_t)&stru_18694.st_info);
    v48 = 0;
    v46 = 0;
    v47 = 9437185;
  ...
  if ( v38 == 4 )
  {
    ...
    do
    {
      ...
      read_rx_debug_reg2_one_lane(a1, a2, a3, a4);
      sub_BF774(a1, (char)a3, v39, 0xFFFFFFF7);
      sub_BF774(a1, (char)a3, v41, 8u);
      sub_BF774(a1, (char)a3, v39, 0xBFFFFFFF);
      sub_BF774(a1, (char)a3, v40, 0x40000000u);
      sub_BF774(a1, (char)a3, v39, 0);
      usleep((__useconds_t)&loc_F4240);
      check_bist_tx_running(a1, a2, (int)a3, a4);
      check_bist_rx_running(a1, a2, (unsigned int)a3, a4);
