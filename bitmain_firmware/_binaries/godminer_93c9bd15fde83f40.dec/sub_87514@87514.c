_DWORD *__fastcall sub_87514(int a1, _DWORD *a2)
{
  _DWORD *v2; // r4
  _DWORD *v4; // r0
  _DWORD *v5; // r5
  ...
  if ( a2 )
  {
    ...
    else
    {
      ...
      if ( *(_BYTE *)(a1 + 1016) )
      {
        ...
        snprintf(s, 0x40u, "%s", *(const char **)&aReadTemperatur_0[4 * opt_algo + 956]);
        strcpy(v25, "linux");
