int __fastcall set_baud_dash(int a1, char *a2)
{
  ...
  while ( v2 != 210 );
  v6 = *(void (__fastcall **)(int, int, int))(a1 + 144);
  v7 = *(_DWORD *)(a1 + 296);
  *(_DWORD *)(a1 + 240) = 3;
  v6(a1, v7, 70);
  v8 = 0;
  ...
  v21[1] = 0;
  v23 = 0;
  v9 = (*(int (__fastcall **)(int, _DWORD *))(a1 + 152))(a1, v21);
  v11 = *(_DWORD *)(a1 + 192);
  v12 = v9;
  LOBYTE(v22) = 0;
  if ( v11 <= 0 )
...
LABEL_40:
  ...
  while ( 1 )
  {
    ...
    if ( v8 % 5u == 4 )
    {
      v13 = *(_DWORD *)(a1 + 240);
      v21[0] = -1601955279;
      v14 = *(int (__fastcall **)(int, _DWORD *))(a1 + 152);
      BYTE1(v22) = v13 * v8;
      v15 = v14(a1, v21);
      v11 = *(_DWORD *)(a1 + 192);
      v12 = v15;
...
LABEL_19:
  ...
  {
LABEL_20:
    v20 = *(int (__fastcall **)(int, _DWORD *, int))(a1 + 152);
