int __fastcall sub_80A30(int a1, _DWORD *a2, int a3)
{
  int *v3; // r10
  int v4; // r5
  int v5; // r6
...
LABEL_21:
  ...
  if ( (v30 & 3) != 0 )
  {
    v38 = *((_DWORD *)v65 + 603) + 1;
    v39 = *((_DWORD *)v65 + 603) - 14 < 0;
    *((_DWORD *)v65 + 603) = v38;
    if ( !(v39 ^ __OFSUB__(v38, 15) | (v38 == 15)) )
    {
      pthread_mutex_lock(&stru_1A8A24);
      logfmt_raw((char *)v101, 0x1000u, 0, "fan_error_num: %d fan_num %d", *((_DWORD *)v65 + 603), v63[21]);
      pthread_mutex_unlock(&stru_1A8A24);
      if ( !*(_BYTE *)(v67 + 142) )
        zlog(
          g_zc,
