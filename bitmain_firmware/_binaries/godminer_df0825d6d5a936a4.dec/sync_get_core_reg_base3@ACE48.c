int __fastcall sync_get_core_reg_base3(pthread_mutex_t *a1, int a2, int a3, int a4, int *a5, unsigned __int64 a6)
{
  int v7; // r5
  char v10; // r1
  __int16 v12; // r3
  ...
  sub_1229FC(a6, 0x3E8u);
  v29[1] = (_DWORD)&loc_F4240 * v19;
  v29[0] = sub_1229FC(a6, 0x3E8u);
  while ( v18 < a3 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(a1[34].__lock, v30, 0xAu, v29) == 110 )
      {
        v7 = 3;
        goto LABEL_15;
      }
