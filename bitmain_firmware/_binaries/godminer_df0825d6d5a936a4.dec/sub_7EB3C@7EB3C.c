bool __fastcall sub_7EB3C(int a1, int a2, char **a3)
{
  char v3; // r3
  _DWORD *v5; // r8
  int v6; // r6
  ...
  BYTE1(v25) = v3;
  v5 = calloc(0xCu, 1u);
  (*(void (__fastcall **)(int, int *, int, _DWORD *, int *))(a1 + 252))(a1, &v23, 1, v5, &v22);
  if ( v22 <= 0 )
  {
    v20 = 0;
  }
...
LABEL_9:
  ...
  *a3 = v20;
  ...
  (*(void (__fastcall **)(int, int *, int, _DWORD *, int *, int, int, _DWORD))(a1 + 260))(
    a1,
    &v23,
    v12,
    ptr,
