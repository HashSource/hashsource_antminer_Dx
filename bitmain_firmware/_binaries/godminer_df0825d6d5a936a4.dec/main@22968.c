int __fastcall main(int argc, const char **argv, const char **envp)
{
  ...
  while ( 1 )
  {
    v14 = EVPX_EncryptInit_ex(argc, (int)argv, "a:c:hp:Po:u:v:F", (const char **)&off_124114, 0);
    if ( v14 < 0 )
      break;
  ...
  v15 = 4;
  V_LOCK();
  logfmt_raw(s, 0x1000u, 0, "opt_algo %d, %s", opt_algo, off_1240C0[opt_algo]);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_go"
  ...
  if ( !v12 )
  {
    ...
    logfmt_raw(
      ...
      "2.0.0_release_clean_master_dd07674242d861adea50a1168cb2b93e2f1abf95_Mar 28 2023 14:27:49");
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
    ...
    *(_DWORD *)s = 0;
    ...
    if ( !v12 )
    {
      ...
      signal(2, (__sighandler_t)sub_2C45C);
      v15 = 4u;
      signal(3, (__sighandler_t)sub_2C45C);
      signal(15, (__sighandler_t)sub_2C45C);
      signal(11, (__sighandler_t)sub_2C45C);
      signal(10, (__sighandler_t)sub_2C45C);
      ...
      {
        thr_info = 0;
        pthread_attr_init(&stru_1784B8);
        v24 = pthread_create(dword_1784B4, &stru_1784B8, (void *(*)(void *))work_generator_thread, &thr_info);
        pthread_attr_destroy(&stru_1784B8);
        if ( v24 )
        {
          V_LOCK();
          v12 = 1;
        ...
        {
          dword_1784E0 = 1;
          pthread_attr_init((pthread_attr_t *)&dword_1784E4[1]);
          v12 = pthread_create(
                  dword_1784E4,
                  (const pthread_attr_t *)&dword_1784E4[1],
                  (void *(*)(void *))nonce_submit_thread,
                  &dword_1784E0);
          v21 = pthread_attr_destroy((pthread_attr_t *)&dword_1784E4[1]);
          if ( !v12 )
          {
