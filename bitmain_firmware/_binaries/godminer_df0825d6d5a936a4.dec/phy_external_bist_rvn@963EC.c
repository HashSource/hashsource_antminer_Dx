int __fastcall phy_external_bist_rvn(int a1, int a2, unsigned __int8 *a3, unsigned int a4)
{
  ...
  if ( a4 )
  {
    ...
    do
    {
      ...
      {
        v11 = *++v10;
        if ( check_core_reg_with_expect_data_rvn_0(a1, a2, v11, 64, 0xFF000100) )
          break;
        if ( v10 == v9 )
          goto LABEL_6;
      }
...
LABEL_6:
    ...
    {
      v14 = *++v13;
      sub_8E658(a1, v14, 133, 0xFFFF);
      sub_8E658(a1, *v13, 134, 1342177279);
    }
    while ( v10 != v13 );
    sub_8E614(a1, 132, -2147483647);
    sleep(0xAu);
    do
    {
      while ( 1 )
      {
        v15 = *++v12;
        if ( check_core_reg_with_expect_data_rvn_0(a1, a2, v15, 139, 0xFF0000FF) )
          break;
        if ( v13 == v12 )
          goto LABEL_12;
      }
...
LABEL_31:
  ...
  free(ptr);
  v37 = *(_QWORD *)&dword_176E40;
  v38 = &s[1];
  v39 = *(_QWORD *)&dword_176E48;
  for ( i = &v70[1]; ; ++i )
  {
    v37 += v36;
    v39 += a4;
  ...
  *(_QWORD *)&dword_176E40 = v37;
  *(_QWORD *)&dword_176E48 = v39;
  V_LOCK();
  ...
  zlog(
    ...
    v71);
  V_LOCK();
  V_INT((int)&v66, "chain", *(int *)(a1 + 216));
  logfmt_raw(
    v71,
    0x1000u,
    0,
