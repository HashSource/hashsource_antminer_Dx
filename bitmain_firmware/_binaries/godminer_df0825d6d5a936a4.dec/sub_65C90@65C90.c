int __fastcall sub_65C90(int a1, int a2, char a3)
{
  int v4; // r6
  _DWORD *v5; // r10
  _DWORD *v6; // r4
  ...
  v17 = 0;
  v5 = calloc(0xCu, 1u);
  (*(void (__fastcall **)(int, _DWORD *, int, _DWORD *, int *))(a1 + 260))(a1, v15, 1, v5, &v14);
  if ( v14 <= 0 )
  {
    v10 = v9;
  }
  ...
  LOBYTE(v17) = -1;
  LOBYTE(v16) = v12;
  v7 = *(int (__fastcall **)(int, _DWORD *))(a1 + 236);
  BYTE1(v16) = v11;
  v15[0] = v10;
  result = v7(a1, v15);
  if ( result < 0 )
