int __fastcall hardware_init(int a1)
{
  ...
  if ( result )
    return result;
  v3 = *(const char **)&aSetBaudBase_0[4 * a1 + 220];
  ...
  if ( v62[0] > 0 )
  {
    ...
    do
    {
      v14 = *((_DWORD *)v13 + 1);
      v13 += 4;
      strcpy((char *)(v14 + 280), v4);
      *(_DWORD *)(*(_DWORD *)v13 + 288) = (unsigned __int16)__rev16(LOWORD(v61[0]));
      is_adjustable_power = platform_is_adjustable_power();
      v16 = *(_DWORD *)v13;
      *(_DWORD *)(*(_DWORD *)v13 + 944) = is_adjustable_power;
      chain_sensor_num = platform_get_chain_sensor_num(v11);
      v18 = *(_DWORD *)v13;
      *(_DWORD *)(v16 + 356) = chain_sensor_num;
      sensor_max_chip_temp = platform_get_sensor_max_chip_temp(v11);
      v20 = *(_DWORD *)v13;
      *(_DWORD *)(v18 + 360) = sensor_max_chip_temp;
      sensor_max_pcb_temp = platform_get_sensor_max_pcb_temp(v11);
      v22 = *(_DWORD *)v13;
      *(_DWORD *)(v20 + 364) = sensor_max_pcb_temp;
      sensor_min_pcb_temp = platform_get_sensor_min_pcb_temp(v11);
      v24 = *(_DWORD *)v13;
      *(_DWORD *)(v22 + 368) = sensor_min_pcb_temp;
      *(_DWORD *)(v24 + 372) = platform_get_sensor_max_uneffective_count(v11++);
    }
    while ( v11 < v62[0] );
  }
  free(v4);
...
LABEL_29:
  ...
  if ( v60 > 0 )
  {
    ...
    do
    {
      ...
      v56 = *((_DWORD *)v55 + 1);
      v55 += 4;
      logfmt_raw((char *)v62, 0x1000u, 0, "chain[%d] %s", v40, v56 + 280);
      V_UNLOCK();
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origi"
      ...
      V_LOCK();
      v59 = v40++;
      logfmt_raw((char *)v62, 0x1000u, 0, "chain[%d] %x", v59, *(_DWORD *)(*(_DWORD *)v55 + 288));
      V_UNLOCK();
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origi"
