int __fastcall sub_87E4C(int a1, int a2, __int16 a3, void *a4)
{
  int v4; // r7
  ...
  V_LOCK();
  v8 = 0;
  logfmt_raw(v22, 0x1000u, 0, "%s core_no %d", "ChipSetting_get_core_status_RVN", v4);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  v19 = v5;
  src = calloc(12 * v4, 1u);
  (*(void (__fastcall **)(int, _DWORD *, int, _DWORD *, int *, int, int, _DWORD))(a1 + 260))(
    a1,
    v16,
    v4,
    src,
