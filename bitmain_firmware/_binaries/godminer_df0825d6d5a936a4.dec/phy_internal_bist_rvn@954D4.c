int __fastcall phy_internal_bist_rvn(int a1, int a2, unsigned int a3, int a4)
{
  ...
  V_LOCK();
  V_INT((int)v24, "chain", *(int *)(a1 + 216));
  logfmt_raw(
    v44,
    0x1000u,
    0,
  ...
  zlog(
    ...
    v44);
  v18 = malloc(0x300u);
  sub_8E658(a1, a3, 86, 3670024);
  usleep(0x12Cu);
  sub_8E658(a1, a3, 85, 109905420);
  usleep(0x12Cu);
  sub_8E658(a1, a3, 101, -268374016);
  usleep(0x12Cu);
  ...
  {
    V_LOCK();
    V_INT((int)v26, "chain", *(int *)(a1 + 216));
    logfmt_raw(
      v44,
      0x1000u,
      0,
  ...
  {
    V_LOCK();
    V_INT((int)v28, "chain", *(int *)(a1 + 216));
    logfmt_raw(
      v44,
      0x1000u,
      0,
  ...
  sub_8E658(a1, a3, 82, 0);
  usleep(0x64u);
  V_LOCK();
  V_INT((int)v30, "chain", *(int *)(a1 + 216));
  logfmt_raw(
    v44,
    0x1000u,
    0,
  ...
  zlog(
    ...
    20,
    v44);
  sub_8E658(a1, a3, 83, 16711935);
  if ( check_core_reg_with_expect_data_rvn_0(a1, a2, a3, 83, 0) )
  {
    V_LOCK();
    V_INT((int)v42, "chain", *(int *)(a1 + 216));
    logfmt_raw(
      v44,
      0x1000u,
      0,
  ...
  sub_8E658(a1, a3, 133, 255);
  usleep(0x64u);
  sub_8E658(a1, a3, 134, 255);
  usleep(0x64u);
  sub_8E658(a1, a3, 132, -2147483647);
  sleep(6u);
  if ( check_core_reg_with_expect_data_rvn_0(a1, a2, a3, 139, 0xFF0000FF) )
  {
    V_LOCK();
    V_INT((int)v34, "chain", *(int *)(a1 + 216));
    logfmt_raw(
      v44,
      0x1000u,
      0,
  ...
  for ( i = (int *)((char *)&v22 + 1); ; i = (_DWORD *)((char *)i + 1) )
  {
    ...
    if ( v10 )
    {
      ...
      do
      {
        ...
        V_LOCK();
        v9 += 3;
        V_INT((int)v36, "chain", *(int *)(a1 + 216));
        V_INT((int)v38, "chain", *(int *)(a1 + 216));
        logfmt_raw(
          v44,
          0x1000u,
          0,
