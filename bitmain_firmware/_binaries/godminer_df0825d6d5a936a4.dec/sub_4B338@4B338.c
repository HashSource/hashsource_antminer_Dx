int __fastcall sub_4B338(_DWORD *a1, __int64 *a2)
{
  __int64 v2; // r2
  const char *v5; // r1
  int v6; // r12
  ...
  v6 = a1[53];
  v23[120] = dword_165D00;
  v23[121] = BYTE1(dword_165D00) | ((_BYTE)v6 << 6);
  ...
  v35 = v13;
  V_LOCK();
  logfmt_raw(v42, 0x1000u, 0, "start nonce: %08x target_diff: %d", dword_165D00, v27);
  V_UNLOCK();
  zlog(
    g_zc,
