int __fastcall push_work_base(int a1, int a2)
{
  ...
  {
    v7 = dev_ctrl(v6);
    v6 = ((int (__fastcall *)(_DWORD))v7[17])(*(_DWORD *)(a1 + 212));
  }
  while ( v6 < v11 );
  v8 = dev_ctrl(v6);
  v9 = ((int (__fastcall *)(_DWORD, void *, unsigned int))v8[13])(*(_DWORD *)(a1 + 212), v5, v11);
  pthread_mutex_unlock(v4);
  if ( v9 <= 0 )
  {
    V_LOCK();
    logfmt_raw(v12, 0x1000u, 0, "device %d push work failed,errcode %d", *(_DWORD *)(a1 + 212), v9);
    V_UNLOCK();
    zlog(
      g_zc,
