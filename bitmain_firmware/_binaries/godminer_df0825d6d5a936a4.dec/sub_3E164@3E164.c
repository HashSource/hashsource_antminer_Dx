bool __fastcall sub_3E164(int a1, pthread_mutex_t *a2, _DWORD *a3)
{
  _DWORD *v5; // r0
  _DWORD *v6; // r5
  _BOOL4 v7; // r4
  ...
  size_t v51; // r0
  int v52; // lr
  signed int v53; // [sp+10h] [bp-103Ch]
  const char *v54; // [sp+14h] [bp-1038h]
  unsigned int v55; // [sp+14h] [bp-1038h]
  char *s; // [sp+18h] [bp-1034h]
  _BOOL4 v57; // [sp+1Ch] [bp-1030h]
  pthread_mutex_t *mutex; // [sp+24h] [bp-1028h]
  void *ptr; // [sp+28h] [bp-1024h]
  char *ptra; // [sp+28h] [bp-1024h]
  size_t n; // [sp+2Ch] [bp-1020h]
  size_t v62; // [sp+30h] [bp-101Ch]
  size_t nmemb; // [sp+34h] [bp-1018h]
  int v64; // [sp+38h] [bp-1014h]
    ...
    if ( v7 )
    {
      ...
      if ( hex2bin((int)v29, (unsigned __int8 *)v17, nmemb) )
      {
        ...
        if ( hex2bin((int)v30, (unsigned __int8 *)v14, n) )
        {
          ...
          if ( v7 )
          {
            v41 = (void *)a2[12].__count;
            if ( v41 )
              free(v41);
            if ( (v55 & 3) != 0 )
              v55 = (v55 & 0xFFFFFFFC) + 4;
            v42 = calloc(v55, 1u);
            a2[12].__count = (unsigned int)v42;
            if ( !v42 )
            {
              V_LOCK();
            ...
            memcpy((void *)a2[12].__count, v30, n);
            memcpy(&a2[19], v29, nmemb);
            memcpy((char *)&a2[19] + nmemb, v66, (size_t)ptra);
            memcpy(&ptra[nmemb + (_DWORD)(a2 + 19)], v30, n);
            memcpy(&a2[25], (const void *)a2[3].__count, a2[3].__lock);
            memcpy(&a2[26].__align + 2, v40, v62);
