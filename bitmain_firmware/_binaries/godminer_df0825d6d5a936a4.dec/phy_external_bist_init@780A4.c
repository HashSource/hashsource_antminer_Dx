int __fastcall phy_external_bist_init(int a1, unsigned int a2, unsigned __int8 a3, int a4, int a5)
{
  ...
  v17 = a3;
  V_LOCK();
  V_INT((int)v18, "chain", *(int *)(a1 + 216));
  logfmt_raw(
    v30,
    0x1000u,
    0,
  ...
  v14 = v7[8];
  V_LOCK();
  V_INT((int)v20, "chain", *(int *)(a1 + 216));
  v10 = "enabled";
  if ( !v8 )
    v10 = "disabled";
  logfmt_raw(
  ...
  zlog(
    ...
    60,
    v30);
  sub_6F21C(a1, v17, 86, 3670024);
  usleep(0x12Cu);
  sub_6F21C(a1, v17, 85, 109905420);
  usleep(0x12Cu);
  sub_6F21C(a1, v17, 101, -268374016);
  usleep(0x12Cu);
  sub_6F21C(a1, v17, 64, 256);
  usleep(0x12Cu);
  sub_6F21C(a1, v17, 80, 33423870);
  usleep(0x12Cu);
  sub_6F21C(a1, v17, 81, 832516511);
  usleep(0x12Cu);
  sub_6F21C(a1, v17, 88, -1);
  usleep(0x12Cu);
  if ( check_core_reg_with_expect_data(a1, a2, v17, 125, 0x70007000u) )
  {
    V_LOCK();
    V_INT((int)v22, "chain", *(int *)(a1 + 216));
    logfmt_raw(
      v30,
      0x1000u,
      0,
  ...
  sub_6F21C(a1, v17, 86, 137889800);
  usleep(0x12Cu);
  sub_6F21C(a1, v17, 80, 0);
  usleep(0x12Cu);
