int __fastcall bitmain_power_read(__int16 a1, int a2, int a3)
{
  ...
  else
  {
    ...
    if ( v6 < 0 )
    {
      snprintf((char *)s, 0x800u, "%s: auto exec bitmain_power_open, but open power failed", "bitmain_power_read");
      V_LOCK();
...
LABEL_10:
  ...
  if ( sub_A7840((void *)dword_177458, (unsigned __int8 *)&v13, 8u, v17, a3 + 7) )
  {
    v6 = -2147482880;
    strcpy((char *)s, "set DA conversion N failed");
    V_LOCK();
    logfmt_raw(v19, 0x1000u, 0, s);
    V_UNLOCK();
    v12 = 860;
