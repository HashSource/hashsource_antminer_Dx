int platform_init()
{
  ...
  zlog(
    ...
    "dminer-new/backend/device/hal/platform/7007/7007_common.c",
    173,
    "platform_init",
    13,
    63,
...
LABEL_9:
    zlog(
      ...
      "godminer-new/backend/device/hal/platform/7007/7007_common.c",
      173,
      "platform_init",
      13,
      v3,
  ...
  memset(&unk_176E70, 0, 0x124u);
  v4 = 0;
  fpga_read(0, &v4);
  v4 |= 0x20000000u;
  snprintf((char *)s, 0x800u, "HARDWARE_VERSION = 0x%x", v4);
  V_LOCK();
  logfmt_raw(v6, 0x1000u, 0, s);
  V_UNLOCK();
  zlog(
