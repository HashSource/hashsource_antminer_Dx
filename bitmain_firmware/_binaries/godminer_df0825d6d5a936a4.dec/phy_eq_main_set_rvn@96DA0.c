int __fastcall phy_eq_main_set_rvn(int a1, int a2)
{
  ...
  if ( v5 )
  {
    ...
    sub_8E614(a1, 111, bswap32(*v6) | v3);
  }
LABEL_7:
  v8 = sub_8E6AC(a1, 0, 111, v4);
  if ( v8 )
  {
    v9 = v4;
    v10 = 0;
...
LABEL_13:
  ...
  if ( v12 )
  {
    ...
    sub_8E614(a1, 112, bswap32(*v13) | v3);
  }
LABEL_19:
  v15 = sub_8E6AC(a1, 0, 112, v4);
  if ( v15 )
  {
    v16 = v4;
    v17 = 0;
