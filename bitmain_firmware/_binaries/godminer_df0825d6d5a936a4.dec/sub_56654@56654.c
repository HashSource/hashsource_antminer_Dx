int __fastcall sub_56654(_DWORD *a1)
{
  _DWORD *v1; // r0
  _DWORD *v2; // r7
  _DWORD *v3; // r0
...
LABEL_45:
  ...
  zlog(
    ...
    20,
    v77);
  dword_178714 = json_integer_value(v4);
  ...
  if ( v6 && *v6 == 3 )
  {
    ...
    zlog(
      ...
      20,
      v77);
    dword_178718 = json_integer_value(v7);
    ...
    if ( v9 && *v9 == 3 )
    {
      ...
      zlog(
        ...
        20,
        v77);
      dword_17871C = json_integer_value(v10);
      ...
      if ( v12 && *v12 == 3 )
      {
        ...
        zlog(
          ...
          20,
          v77);
        dword_178720 = json_integer_value(v13);
        ...
        if ( v15 && *v15 == 3 )
        {
          ...
          zlog(
            ...
            20,
            v77);
          dword_178724 = json_integer_value(v16);
          ...
          if ( v18 && *v18 == 3 )
          {
            ...
            zlog(
              ...
              20,
              v77);
            dword_178728 = json_integer_value(v19);
            ...
            if ( v21 && *v21 == 3 )
            {
              ...
              zlog(
                ...
                20,
                v77);
              dword_17872C = json_integer_value(v22);
              ...
              if ( v24 && *v24 == 3 )
              {
                ...
                zlog(
                  ...
                  20,
                  v77);
                dword_178730 = json_integer_value(v25);
                ...
                if ( v27 && *v27 == 3 )
                {
                  ...
                  zlog(
                    ...
                    20,
                    v77);
                  dword_178734 = json_integer_value(v28);
                      ...
                      if ( v42 && *v42 == 3 )
                      {
                        ...
                        if ( v48 && *v48 == 3 )
                        {
                          ...
                          if ( v54 && *v54 == 1 )
                          {
                            ...
                            dword_178748 = (int)calloc((size_t)v55, 0xCu);
                            if ( !dword_178748 )
                            {
                              V_LOCK();
                            ...
                            while ( 1 )
                            {
                              ...
                              zlog(
                                ...
                                20,
                                v77);
                              *(_DWORD *)(dword_178748 + v56) = json_integer_value(v61);
                              ...
                              zlog(
                                ...
                                20,
                                v77);
                              *(_DWORD *)(dword_178748 + v56 + 8) = json_integer_value(v64);
