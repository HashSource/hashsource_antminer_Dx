int __fastcall chip_setting_reset_bist_ltc(int a1, int a2, int a3, int a4, int a5)
{
  ...
  if ( !a4 )
  {
    ...
    if ( !a2 )
      v8 = a5;
    LOBYTE(v26) = a2;
    LOBYTE(v9) = *(_BYTE *)(a1 + 300);
    if ( a2 )
    {
      BYTE1(v27) = *(_BYTE *)(a1 + 300);
      v8 = a5;
      goto LABEL_4;
    }
    goto LABEL_13;
...
LABEL_4:
    ...
    while ( 1 )
    {
      ...
      LOBYTE(v27) = v12;
      HIWORD(v27) = 0;
      v13 = (*(int (__fastcall **)(int, int *))(a1 + 236))(a1, &v24);
      if ( v13 )
        break;
      ++v12;
      usleep(0x3E8u);
