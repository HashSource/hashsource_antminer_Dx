int __fastcall sub_25324(_DWORD *a1, int a2)
{
  bool v4; // zf
  int v5; // r5
  __int64 v6; // kr00_8
  ...
  *(_DWORD *)v57 = 0;
  ...
  else
  {
    ...
    if ( total_pools )
    {
      sub_2358C(a1, 1, 7, *(const char **)(a2 + 8));
      v52 = json_array();
      if ( total_pools > 0 )
      {
        v6 = 0;
        do
        {
          ...
          *(_DWORD *)v57 = 0;
          ...
          sub_1226E4((__int64)(*(double *)(v17 + 1952) * 100.0));
          v46 = json_real();
          json_object_set_new(v18, "Difficulty Accepted", v46);
          sub_1226E4((__int64)(*(double *)(v17 + 1960) * 100.0));
          v47 = json_real();
          json_object_set_new(v18, "Difficulty Rejected", v47);
          sub_1226E4((__int64)(*(double *)(v17 + 1808) * 100.0));
          v48 = json_real();
          json_object_set_new(v18, "Difficulty Stale", v48);
          sub_1226E4((__int64)(*(double *)(v17 + 1616) * 100.0));
          v49 = json_real();
