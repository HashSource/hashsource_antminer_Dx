int __fastcall sub_80024(int *a1, int a2)
{
  int v2; // r4
  void *v5; // r0
  ...
  v5 = calloc(12 * a2, 1u);
  v23 = &v33;
  v6 = (void (__fastcall *)(int *, _DWORD *, int, void *, int *, int, int, _DWORD))a1[63];
  ptr = v5;
  v6(a1, v34, a2, v5, &v33, v24, 3000, 0);
  V_LOCK();
  V_INT((int)v35, "chain", a1[54]);
  logfmt_raw(
    v43,
    0x1000u,
    0,
  ...
  if ( v33 > 0 )
  {
    ...
    v27 = "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-ori"
    ...
    do
    {
      while ( 1 )
      {
        ...
        V_UNLOCK();
        zlog(g_zc, v27, 149, v26, 29, 64, 20, v43);
        if ( a1[72] == (unsigned __int16)v8 )
          break;
        v7 += 6;
        if ( v33 <= v2 )
          goto LABEL_7;
      ...
      V_UNLOCK();
      zlog(g_zc, v27, 149, v26, 29, 70, 20, v43);
    }
    while ( v33 > v2 );
LABEL_7:
    v2 = v29;
...
LABEL_13:
  ...
  if ( a1[74] > v29 )
  {
    ...
    zlog(
      ...
      v43);
    V_LOCK();
    logfmt_raw(v43, 0x1000u, 0, "Sweep error string = J%d:2.", a1[54]);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
