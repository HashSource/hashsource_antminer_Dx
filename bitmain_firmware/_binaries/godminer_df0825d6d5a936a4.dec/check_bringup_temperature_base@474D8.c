...
LABEL_35:
              ...
              {
                V_LOCK();
                V_INT((int)v57, "chain", *(int *)(*(_DWORD *)v22 + 216));
                logfmt_raw(
                  v65,
                  0x1000u,
                  0,
              ...
              {
                V_LOCK();
                V_INT((int)v59, "chain", *(int *)(*(_DWORD *)v22 + 216));
                logfmt_raw(
                  v65,
                  0x1000u,
                  0,
            ...
            if ( v28 == 1 )
            {
              ...
              {
                V_LOCK();
                V_INT((int)v61, "chain", *(int *)(*(_DWORD *)v22 + 216));
                logfmt_raw(
                  v65,
                  0x1000u,
                  0,
...
LABEL_57:
    ...
    while ( 1 )
    {
      ...
      if ( *v13 != -64 )
      {
        v16 = *(_DWORD *)(*(_DWORD *)(all_created_runtime[v14] + 348) + v12 + 12);
        if ( !v16 )
        {
          v17 = &v65[4 * v38++];
          *((_DWORD *)v17 - 128) = v15;
          V_LOCK();
          V_INT((int)v53, "chain", *(int *)(all_created_runtime[v14] + 216));
          logfmt_raw(
            v65,
            0x1000u,
            0,
...
LABEL_23:
        ...
        if ( v16 == 1 )
        {
          ...
          *((_DWORD *)v36 - 64) = v15;
          V_LOCK();
          V_INT((int)v55, "chain", *(int *)(all_created_runtime[v14] + 216));
          logfmt_raw(
            v65,
            0x1000u,
            0,
