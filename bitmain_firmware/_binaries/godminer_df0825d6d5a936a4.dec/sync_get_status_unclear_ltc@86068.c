int __fastcall sync_get_status_unclear_ltc(pthread_mutex_t *a1, int a2, int a3, int *a4, unsigned __int64 a5)
{
  int v5; // r5
  ...
  v18[0] = sub_1229FC(a5, 0x3E8u);
  while ( v10 < a2 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(a1[34].__lock, v19, 9u, v18) == 110 )
      {
        v5 = 3;
        goto LABEL_13;
      }
