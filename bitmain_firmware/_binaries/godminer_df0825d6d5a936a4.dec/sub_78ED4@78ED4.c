int __fastcall sub_78ED4(int a1, int a2)
{
  float v2; // s0
  __int16 v3; // r3
  int v4; // r12
...
LABEL_9:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)(v12 - 16) <= 0xEA )
    {
      ...
      {
        v14 = sub_122118(25 * v12, v5);
        v15 = sub_122118(v14, v8 + 1);
        v16 = (float)sub_122118(v15, v10 + 1);
        v17 = v13 > 2400.0;
  ...
  zlog(
    ...
    v36);
  if ( v16 > 0.0 )
    v10 = (*(int (__fastcall **)(int, _DWORD *))(a1 + 232))(a1, v26);
  else
    v10 = -1;
LABEL_24:
  usleep(0x2710u);
