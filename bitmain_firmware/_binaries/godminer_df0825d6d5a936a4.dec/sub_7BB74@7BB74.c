int __fastcall sub_7BB74(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, _DWORD *a6, _DWORD *a7)
{
  int v7; // r7
  int v11; // r6
  int v13; // r3
  ...
  *(_BYTE *)(a3 + 57) = v11;
  *(_BYTE *)(a3 + 56) = v17;
  v18 = (unsigned int)*(unsigned __int8 *)(a2 + 3) / *(_DWORD *)(a1 + 388);
  v19 = v18;
  if ( v18 >= *(_DWORD *)(a1 + 296) )
  {
    v26 = rand();
    sub_1223AC(v26, *(_DWORD *)(a1 + 296));
    *a6 = v20;
  }
  else
  {
    v20 = (unsigned int)*(unsigned __int8 *)(a2 + 3) / *(_DWORD *)(a1 + 388);
    *a6 = v18;
  }
  *(_DWORD *)(a3 + 8) = v20;
  *(_DWORD *)(a3 + 12) = *(_BYTE *)(a2 + 8) & 0x3F;
  ...
  if ( v21 != v22 && *(_BYTE *)(a1 + 222) )
  {
    v24 = *(_DWORD *)(a1 + 216);
    v25 = dword_176E00[v24];
    dword_176E00[v24] = v25 + 1;
    if ( v25 <= 9 )
    {
      V_LOCK();
