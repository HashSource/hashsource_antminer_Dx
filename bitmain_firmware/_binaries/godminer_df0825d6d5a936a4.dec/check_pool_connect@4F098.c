int check_pool_connect()
{
  ...
  {
    V_LOCK();
    logfmt_raw((char *)v11, 0x1000u, 0, 1201400);
    V_UNLOCK();
    zlog(
      g_zc,
  ...
  else
  {
    ...
    while ( v1 );
    V_LOCK();
    logfmt_raw((char *)v11, 0x1000u, 0, 1288924);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
      ...
      v11);
    V_LOCK();
    logfmt_raw((char *)v11, 0x1000u, 0, 1288984);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
      ...
      v11);
    V_LOCK();
    logfmt_raw((char *)v11, 0x1000u, 0, 1289060);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
    ...
    V_LOCK();
    logfmt_raw((char *)v11, 0x1000u, 0, 1288856);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
    ...
    while ( !pools_active )
      sleep(1u);
    V_LOCK();
    logfmt_raw((char *)v11, 0x1000u, 0, 1288884);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
