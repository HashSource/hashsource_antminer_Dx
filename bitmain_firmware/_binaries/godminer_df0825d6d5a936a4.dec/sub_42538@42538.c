int __fastcall sub_42538(int a1, pthread_mutex_t *a2, _DWORD *a3)
{
  _DWORD *v5; // r0
  _DWORD *v6; // r5
  _DWORD *v8; // r0
    ...
    && (valid = valid_hex(v71)) != 0 )
  {
    ...
    if ( v24 )
    {
      ...
      else
      {
        ...
        {
          V_LOCK();
          logfmt_raw(v86, 0x1000u, 0, "Stratum notify: new job's job_id doesnot change, %s, %s", a2[65].__kind, v9);
          V_UNLOCK();
          zlog(
            g_zc,
