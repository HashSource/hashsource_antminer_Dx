int __fastcall sync_get_core_reg_base2(pthread_mutex_t *a1, int a2, int a3, int a4, int *a5, unsigned __int64 a6)
{
  int v7; // r5
  char v10; // r1
  unsigned int v12; // r0
  ...
  v21[0] = sub_1229FC(a6, 0x3E8u);
  while ( v15 < a3 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(a1[34].__lock, v24, 0xCu, v21) == 110 )
      {
        v7 = 3;
        goto LABEL_14;
      }
