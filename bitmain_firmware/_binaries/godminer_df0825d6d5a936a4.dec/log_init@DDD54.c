int log_init()
{
  ...
  if ( v1 )
  {
    LOWORD(v8) = -21108;
    v1 = -1;
    HIWORD(v8) = (unsigned int)"ng error" >> 16;
    puts(v8);
  }
  else
  {
    ...
    if ( g_zc )
    {
      ...
      if ( g_temp_zc )
      {
        ...
        else
        {
          LOWORD(v13) = -20972;
          v1 = -3;
          HIWORD(v13) = (unsigned int)"iled!" >> 16;
          v14 = puts(v13);
          zlog_fini(v14);
        }
      }
      else
      {
        LOWORD(v9) = -21028;
        v1 = -3;
        HIWORD(v9) = (unsigned int)"ore %02x sram boot failed!" >> 16;
        v10 = puts(v9);
        zlog_fini(v10);
      }
    }
    else
    {
      LOWORD(v11) = -21076;
      v1 = -2;
      HIWORD(v11) = (unsigned int)"work mode select" >> 16;
      v12 = puts(v11);
      zlog_fini(v12);
    }
  }
