int __fastcall dev_init_hal(int a1)
{
  ...
  {
    V_LOCK();
    logfmt_raw(v9, 0x1000u, 0, 1347304);
    V_UNLOCK();
    zlog(
      g_zc,
  ...
  else
  {
    ...
    do
    {
      ...
      V_LOCK();
      logfmt_raw(v9, 0x1000u, 0, 1347492, total_chain, g_chain_info[2 * total_chain]);
      V_UNLOCK();
      zlog(
        g_zc,
...
LABEL_14:
        ...
        {
          V_LOCK();
          logfmt_raw(v9, 0x1000u, 0, 1347564, total_chain, g_chain_info[2 * total_chain]);
          V_UNLOCK();
          v5 = g_zc;
          v6 = 80;
          goto LABEL_14;
        ...
        V_LOCK();
        logfmt_raw(v9, 0x1000u, 0, 1347616, total_chain, g_chain_info[2 * total_chain], v8);
        V_UNLOCK();
        zlog(
          g_zc,
...
LABEL_7:
    ...
    {
      V_LOCK();
      logfmt_raw(v9, 0x1000u, 0, 1198464, 1347672);
      V_UNLOCK();
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origi"
    ...
    fpga_reset();
    V_LOCK();
    logfmt_raw(v9, 0x1000u, 0, 1347728);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
      ...
      v9);
    enable_bypass_mode();
    dev_config_hal((int)"ync_get_dag_node_base");
    return 0;
  }
}
