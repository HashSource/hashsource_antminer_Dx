int __fastcall membist0(int a1)
{
  ...
  V_LOCK();
  logfmt_raw(v37, 0x1000u, 0, "%s...", "membist0");
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  do
  {
    ...
    do
    {
      sub_69488(a1, v22, 12, 1);
      sub_69488(a1, v22, 160, 3);
      usleep((__useconds_t)&loc_61A80);
      v3 = ptr;
      v4 = sub_69728(a1, (unsigned __int16)v22, 161, ptr);
      if ( v4 > 0 )
      {
        v5 = &ptr[12 * v4];
        do
...
LABEL_10:
      v6 = ptr;
      v7 = sub_69728(a1, (unsigned __int16)v22, 162, ptr);
      if ( v7 > 0 )
      {
        v8 = &ptr[12 * v7];
        do
...
LABEL_16:
      v9 = ptr;
      v10 = sub_69728(a1, (unsigned __int16)v22, 163, ptr);
      if ( v10 > 0 )
      {
        v11 = &ptr[12 * v10];
        do
...
LABEL_22:
  ...
  while ( &s[5] != v12 );
  v19 = dev_ctrl(v18);
  ((void (__fastcall *)(_DWORD))v19[20])(*(_DWORD *)(a1 + 212));
  return 0;
}
