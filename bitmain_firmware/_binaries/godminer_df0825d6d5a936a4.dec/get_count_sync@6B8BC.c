int __fastcall get_count_sync(int a1, int a2)
{
  ...
  V_UNLOCK();
  LOWORD(v5) = -1528;
  HIWORD(v5) = (unsigned int)&unk_133160 >> 16;
  zlog(g_zc, v5, 170, "get_count_sync", 14, 202, 20, v16);
  v6 = (char *)malloc(0x600u);
  v7 = sub_69728(a1, a2, 202, v6);
  if ( v7 > 0 )
  {
    LOWORD(v8) = -1024;
    LOWORD(v9) = -1528;
    ...
    do
    {
      V_LOCK();
      v12 = *(_DWORD *)v11;
      HIWORD(v8) = (unsigned int)&unk_133350 >> 16;
      v13 = (unsigned __int8)v11[4];
      v14 = *((unsigned __int16 *)v11 + 3);
      v11 += 12;
      logfmt_raw(v16, 0x1000u, 0, v8, v13, (unsigned __int8)*(v11 - 4), v14, v12);
      V_UNLOCK();
      HIWORD(v9) = (unsigned int)&unk_133160 >> 16;
      zlog(g_zc, v9, 170, "get_count_sync", 14, 208, 20, v16);
    }
    while ( v11 != v10 );
  }
  free(v6);
