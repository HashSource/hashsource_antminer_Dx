void __noreturn dag_gen_rvn_thread_func()
{
  ...
  while ( 1 )
  {
    ...
    while ( qword_165ED8 == *(_QWORD *)&dword_165EE0 );
    V_LOCK();
    logfmt_raw((char *)v101, 0x1000u, 0, "cur_block_num enter: %llu", qword_165ED8);
    V_UNLOCK();
    zlog(
      g_zc,
    ...
    if ( v92 )
    {
      ...
      do
      {
        ...
        zlog(
          ...
          40,
          v101);
        v52 = sub_1229FC(qword_165ED8, 0x1D4Cu);
        v53 = *((_DWORD *)v49 + 1);
        v49 += 4;
        v54 = (__int64)qword_1361E0[v52] >> 8;
        v55 = HIDWORD(qword_1361E0[v52]) >> 8;
