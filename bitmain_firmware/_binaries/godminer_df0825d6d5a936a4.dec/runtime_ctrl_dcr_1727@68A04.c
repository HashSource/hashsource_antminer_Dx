void *runtime_ctrl_dcr_1727()
{
  ...
  LODWORD(v3[33]) = 3625540;
  HIDWORD(v3[41]) = 210;
  LODWORD(v3[42]) = 500;
  LODWORD(v3[35]) = 7496548;
  HIDWORD(v3[43]) = sensor_info_dcr_1727;
  v3[44] = qword_163538;
  v3[45] = qword_163540;
  v3[46] = qword_163548;
  v0 = calloc(1u, 0x3B8u);
  ...
  HIDWORD(v3[11]) = sub_66F74;
  HIDWORD(v3[13]) = sub_668C8;
  LODWORD(v3[13]) = sub_66CA4;
  LODWORD(v3[11]) = sub_67090;
  LODWORD(v3[12]) = sub_65524;
  HIDWORD(v3[14]) = sub_6600C;
  HIDWORD(v3[16]) = get_theory_hashrate_dcr;
  LODWORD(v3[16]) = get_chip_status_dcr;
  LODWORD(v3[14]) = sub_66500;
  LODWORD(v3[15]) = sub_65C68;
  ...
  LODWORD(v3[24]) = sub_67930;
  LODWORD(v3[25]) = sub_6553C;
  HIDWORD(v3[24]) = sub_64B58;
  HIDWORD(v3[25]) = top_init_dcr;
  LODWORD(v3[28]) = set_chipaddr_base;
  LODWORD(v3[26]) = dhash_start_dcr;
