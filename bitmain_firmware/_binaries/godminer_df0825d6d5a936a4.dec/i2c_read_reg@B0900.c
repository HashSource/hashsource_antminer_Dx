int __fastcall i2c_read_reg(void *a1, unsigned __int8 *a2, int a3, int a4, unsigned int a5)
{
  ...
  _DWORD s[512]; // [sp+28h] [bp-7F8h] BYREF
  ...
  if ( (unsigned int)(a3 - 1) > 1 )
  {
    ...
    zlog(
      ...
      "godminer-new/backend/device/hal/platform/7007/7007_i2c.c",
      170,
      "i2c_read_reg",
      12,
      298,
  ...
  {
    v6 = pthread_mutex_lock(&stru_177D1C);
    if ( v6 )
    {
    ...
    {
      v19 = 0;
      if ( find_c_map((int *)dword_177D18, (int)&ptr, &v19) == 1 )
      {
        v7 = v19;
        snprintf((char *)s, 0x800u, "i2c read master = %d, slave = %d", *v19, v19[1]);
        V_LOCK();
        logfmt_raw(_828, 0x1000u, 0, s);
        V_UNLOCK();
        zlog(
          ...
          "gin_godminer-new/backend/device/hal/platform/7007/7007_i2c.c",
          170,
          "i2c_read_reg",
          12,
          309,
        ...
        if ( a5 )
        {
          while ( 1 )
          {
            ...
            if ( !sub_AFCFC() )
            {
              ...
              zlog(
                ...
                _828);
              free(v19);
              pthread_mutex_unlock(&stru_177D1C);
              return -2;
            }
            fpga_write(48, v14);
            snprintf((char *)s, 0x800u, "i2c read master = %d, slave = %d, config = %08x", *v7, v7[1], v14);
            V_LOCK();
            logfmt_raw(_828, 0x1000u, 0, s);
            V_UNLOCK();
            zlog(
          ...
          zlog(
            ...
            "rigin_godminer-new/backend/device/hal/platform/7007/7007_i2c.c",
            170,
            "i2c_read_reg",
            12,
            344,
