void sub_2FBF8()
{
  ...
  if ( dword_1650FC > 0 )
  {
    ...
    do
    {
      v5 = sub_2EEF8();
      ++v4;
      sub_2E870((void **)(v5 + 8), (_BYTE *)(v5 + 24), v3);
      set_user(v3 + 256);
      v6 = v3 + 512;
      v3 += 768;
      set_pass(v6);
    }
    while ( dword_1650FC > v4 );
  }
  if ( total_pools == v39 )
  {
    V_LOCK();
  ...
  else
  {
    ...
    V_LOCK();
    v31 = 0;
    logfmt_raw((char *)v42, 0x1000u, 0, "reload new pool configuration, check pool connect");
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
  ...
  if ( v40 )
  {
    ...
    v34 = pthread_create((pthread_t *)&dword_178514, &attr, (void *(*)(void *))watchpool_thread, &dword_178510);
