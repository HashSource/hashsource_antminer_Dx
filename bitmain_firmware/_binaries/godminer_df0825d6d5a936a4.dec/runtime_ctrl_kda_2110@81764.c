void *runtime_ctrl_kda_2110()
{
  ...
  LODWORD(v3[33]) = 3359051;
  HIDWORD(v3[41]) = 210;
  LODWORD(v3[42]) = 500;
  LODWORD(v3[35]) = 6382699;
  HIDWORD(v3[43]) = sensor_info_kda_2110;
  v3[44] = qword_163770;
  v3[45] = qword_163778;
  v3[46] = qword_163780;
  v0 = calloc(1u, 0x3B8u);
  ...
  LODWORD(v3[25]) = sub_7E054;
  HIDWORD(v3[23]) = set_frequency_kda_2110;
  LODWORD(v3[24]) = sub_80590;
  LODWORD(v3[28]) = set_chipaddr_base;
  HIDWORD(v3[25]) = top_init_kda;
  LODWORD(v3[26]) = dhash_start_kda;
