int __fastcall sub_43FE4(int a1, pthread_mutex_t *a2)
{
  void *v2; // r10
  int v5; // r11
  double *v6; // r6
  ...
  v34 = (unsigned __int8)a2[68].__size[16];
  if ( a2[68].__size[16] )
    return 1;
  v2 = 0;
  v5 = 0;
  ...
  do
  {
    ...
    if ( spins )
      v13 = strlen(spins) + 256;
    else
      v13 = 256;
    v14 = (char *)malloc(v13);
    strcpy(v14, "{\"id\": 1, \"method\": \"mining.subscribe\", \"params\": [\"GodMiner/2.0.0\", null]}");
    if ( !(*(int (__fastcall **)(pthread_mutex_t *, char *))(a1 + 12))(a2, v14) )
    {
      V_LOCK();
    ...
    v8 = socket_full(a2[1].__owner, 30);
    if ( !v8 )
    {
      V_LOCK();
...
LABEL_4:
    ...
    v15 = (*(int (__fastcall **)(pthread_mutex_t *))(a1 + 8))(a2);
    v2 = (void *)v15;
    if ( v15 )
    {
...
LABEL_44:
        ...
        v27 = _strdup(v26);
        a2[3].__count = (unsigned int)v27;
        a2[3].__lock = strlen(v27);
        V_LOCK();
        V_INT((int)v37, "poolno", a2->__lock);
        logfmt_raw(
          v41,
          0x1000u,
          0,
        ...
        v30 = (const char *)a2[3].__count;
        a2[64].__owner = (int)v29;
        strcpy(v29, v30);
        pthread_mutex_unlock(a2 + 66);
        if ( !(*(int (__fastcall **)(int, pthread_mutex_t *, _DWORD *, int))(a1 + 52))(a1, a2, v35, 1) )
        {
          V_LOCK();
        ...
        v31 = (const char *)a2[3].__count;
        v32 = a2[79].__nusers + 1;
        a2[79].__nusers = v32;
        sprintf(v14, "{\"id\": %d, \"method\": \"mining.extranonce.subscribe\", \"params\": [\"%s\"]}", v32, v31);
        v33 = (*(int (__fastcall **)(pthread_mutex_t *, char *))(a1 + 12))(a2, v14);
        if ( v33 )
        {
          v8 = socket_full(a2[1].__owner, 30);
          if ( v8 )
