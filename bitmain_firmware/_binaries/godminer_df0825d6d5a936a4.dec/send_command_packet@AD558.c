int __fastcall send_command_packet(pthread_mutex_t *a1, int a2, unsigned int a3)
{
  ...
  {
    v8 = dev_ctrl(i);
    if ( ((int (__fastcall *)(int))v8[16])(a1[8].__spins) >= a3 )
      break;
  }
  v9 = dev_ctrl(10000);
  v10 = ((int (__fastcall *)(int, int, unsigned int))v9[14])(a1[8].__spins, a2, a3);
  pthread_mutex_unlock(v3);
  if ( v10 <= 0 )
  {
    V_LOCK();
    logfmt_raw(v12, 0x1000u, 0, "device %d send cmd failed, errcode %d ", a1[8].__spins, v10);
    V_UNLOCK();
    zlog(
      g_zc,
