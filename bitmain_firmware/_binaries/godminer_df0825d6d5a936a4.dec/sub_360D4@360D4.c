unsigned int __fastcall sub_360D4(int a1, int a2)
{
  const void **v2; // r7
  unsigned int v5; // r4
  bool v6; // cc
...
LABEL_70:
            ...
            sub_35D1C(a2, (_DWORD *)a1, 15, "real number overflow");
            return *(_DWORD *)(a1 + 60);
          }
          v20 = sub_3607C(a1, a2);
...
LABEL_146:
            ...
            sub_35D1C(a2, (_DWORD *)a1, 8, v43, *(_DWORD *)arg);
            goto LABEL_57;
          }
          v46 = v35 - 55296;
          ...
          else
          {
            ...
            {
LABEL_153:
              sub_35D1C(a2, (_DWORD *)a1, 8, "invalid Unicode '\\u%04X'", v35);
              goto LABEL_57;
            }
            v37 = sub_35C10((int)(j + 7));
            if ( v37 < 0 )
            {
              LOWORD(v43) = 26436;
              *(_DWORD *)arg = j + 6;
            ...
            {
              sub_35D1C(a2, (_DWORD *)a1, 8, "invalid Unicode '\\u%04X\\u%04X'", v36, v37);
              goto LABEL_57;
            }
...
LABEL_109:
    ...
    if ( v17 == -1 )
    {
      sub_35D1C(a2, (_DWORD *)a1, 6, "premature end of input");
      goto LABEL_57;
    }
    if ( v17 <= 0x1F )
      break;
...
LABEL_56:
        sub_35D1C(a2, (_DWORD *)a1, 8, "invalid escape");
        goto LABEL_57;
      }
      v19 = v18 == 92;
      if ( v18 != 92 )
  ...
  sub_360BC((_DWORD *)a1, v17);
  if ( v17 == 10 )
    sub_35D1C(a2, (_DWORD *)a1, 8, "unexpected newline");
  else
    sub_35D1C(a2, (_DWORD *)a1, 8, "control character 0x%x", v17);
LABEL_57:
  jsonp_free(*(void **)(a1 + 64));
  v8 = *(_DWORD *)(a1 + 60);
  *(_DWORD *)(a1 + 64) = 0;
