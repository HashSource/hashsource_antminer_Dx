int __fastcall stratum_thread(int a1)
{
  ...
  {
    V_LOCK();
    logfmt_raw(v37, 0x1000u, 0, 1203120, v4[2]);
    V_UNLOCK();
    zlog(
      g_zc,
    ...
    V_LOCK();
    v6 = syscall(224);
    logfmt_raw(v37, 0x1000u, 0, 1197936, v5, v6);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
      ...
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          while ( 1 )
          {
            ...
            logfmt_raw(v37, 0x1000u, 0, 1203184, v22, v16, *current_pool);
            V_UNLOCK();
            zlog(
              g_zc,
...
LABEL_11:
          ...
          logfmt_raw(v37, 0x1000u, 0, v28, v27[0], v27[1], v27[2], v27[3], v27[4], v27[5], v27[6], v28, 1203232);
          V_UNLOCK();
          zlog(
            g_zc,
...
LABEL_21:
          ...
          logfmt_raw(v37, 0x1000u, 0, v36, v29, v30, v31, v32, v33, v34, v35, v36, 1203260);
          V_UNLOCK();
          zlog(
            g_zc,
            "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-o"
        ...
        if ( !(*(int (__fastcall **)(int, int *, int))(v2 + 20))(v2, v4, v14) )
          (*(void (__fastcall **)(int, void *, int *))(v2 + 28))(v2, v15, v4);
        free(v15);
        pools_active = 1;
      }
    }
  ...
  V_LOCK();
  V_INT((int)&v29, "poolno", *v4);
  logfmt_raw(v37, 0x1000u, 0, v36, v29, v30, v31, v32, v33, v34, v35, v36, 1203292);
  V_UNLOCK();
  zlog(
    g_zc,
