void *runtime_ctrl_rvn_2020()
{
  ...
  LODWORD(v3[33]) = 5133906;
  LODWORD(v3[35]) = 7239282;
  HIDWORD(v3[41]) = 500;
  LODWORD(v3[42]) = 500;
  v0 = calloc(1u, 0x3B8u);
