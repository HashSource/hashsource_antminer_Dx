int __fastcall sub_42E68(int a1, int a2, _DWORD *a3)
{
  _DWORD *v5; // r0
  _DWORD *v6; // r0
  char *v7; // r9
  ...
  v34 = (char *)json_string_value(v10);
  ...
  if ( a2 == -448 )
    goto LABEL_25;
  v20 = *(const char **)(a2 + 1572);
  if ( v20 && !strcmp(v20, s2) )
  {
    V_LOCK();
    logfmt_raw(v38, 0x1000u, 0, "Stratum notify: new job's job_id does not change, %s, %s", *(_DWORD *)(a2 + 1572), s2);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
...
LABEL_16:
      ...
      *(_DWORD *)(a2 + 1580) = v24;
      ...
      hex2bin((int)v24, (unsigned __int8 *)v9, v14 >> 1);
      hex2bin(a2 + 1480, (unsigned __int8 *)v34, v18 >> 1);
      v25[12] = v32;
      v26 = target_to_diff_rvn(a2 + 1480);
      *(double *)(a2 + 1512) = (double)v26;
      *(double *)(a2 + 1800) = (double)v26;
      sprintf((char *)(a2 + 1968), "%13.2f", (double)v26);
      v37 = 0;
      ...
      *(_DWORD *)(a2 + 1528) = get_epoch_number_rvn(v25);
      V_LOCK();
      logfmt_raw(v38, 0x1000u, 0, "epoch:%d targetdiff:%02x", *(_DWORD *)(a2 + 1528), v26);
      V_UNLOCK();
      zlog(
        g_zc,
