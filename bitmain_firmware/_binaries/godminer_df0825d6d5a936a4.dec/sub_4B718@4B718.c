int __fastcall sub_4B718(int a1, pthread_mutex_t *a2, int a3)
{
  size_t *v3; // r6
  ...
  {
    v6 = a2 + 19;
    if ( a3 && memcmp(&unk_165D08, &a2[19], 0x116u) )
    {
      qword_165E28 = 0;
      memcpy(&unk_165D08, v6, 0x11Eu);
    }
    ...
    if ( owner && owner == *v3 )
    {
      ...
      zlog(
        ...
        20,
        v16);
      memcpy(v3 + 1, &qword_165E28, *v3);
      if ( (unsigned __int64)qword_165E28 > 0xFF )
        qword_165E28 = 0;
      else
        ++qword_165E28;
    }
