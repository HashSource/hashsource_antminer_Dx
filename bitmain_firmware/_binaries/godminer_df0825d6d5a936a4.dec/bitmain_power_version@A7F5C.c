int bitmain_power_version()
{
  ...
  if ( dword_17745C || (v0 = bitmain_power_open(), v0 >= 0) )
  {
    v5 = 0;
    v4 = 0;
    v2 = 33860181;
    ...
    {
      v0 = -2147482880;
      strcpy((char *)s, "get power version failed");
      V_LOCK();
    ...
    else
    {
      ...
      if ( (_WORD)v5 )
        dword_177460 = (unsigned __int16)v5;
    }
  }
  else
  {
    snprintf((char *)s, 0x800u, "%s: auto exec bitmain_power_open, but open power failed", "bitmain_power_version");
    V_LOCK();
    logfmt_raw(v7, 0x1000u, 0, s);
    V_UNLOCK();
    zlog(
