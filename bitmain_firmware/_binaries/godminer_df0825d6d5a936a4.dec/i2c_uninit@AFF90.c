int __fastcall i2c_uninit(int a1)
{
  ...
  v4 = a1;
  v1 = pthread_mutex_lock(&stru_177D1C);
  if ( v1 )
  {
  ...
  {
    if ( exists_c_map((int *)dword_177D18, (int)&v4) == (int *)1 )
    {
      ...
      zlog(
        ...
        20,
        v6);
      remove_c_map((int *)dword_177D18, (int)&v4);
    }
    else
    {
    ...
    v2 = (int (**)(void))new_iterator_c_map(dword_177D18);
    if ( (*v2)() )
    {
      do
        ++v1;
    ...
    else
    {
      ...
      zlog(
        ...
        v6);
      dword_177D14 = 0;
      result = delete_c_map((void (__fastcall ***)(_DWORD))dword_177D18);
      dword_177D18 = 0;
    }
  }
  return result;
