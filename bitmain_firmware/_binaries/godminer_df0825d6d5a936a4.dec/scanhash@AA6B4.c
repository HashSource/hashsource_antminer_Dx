int __fastcall scanhash(int a1)
{
  ...
  snprintf(v2, 0x40u, "%.10s_%d", "scanhash", *(_DWORD *)(a1 + 212));
  V_LOCK();
  v21 = 1;
  v3 = syscall(224);
  v4 = 0;
  ...
  v23 = 1;
  v5 = *(_DWORD *)(a1 + 808);
  v6 = calloc(1u, *(_DWORD *)(a1 + 784));
  v22 = 0;
  v7 = (char *)calloc(1u, *(_DWORD *)(a1 + 788));
  while ( 1 )
  {
    memset(s, 0, sizeof(s));
...
LABEL_5:
    ...
    v10 = *(unsigned __int8 *)(a1 + 836);
    if ( *(_BYTE *)(a1 + 836) )
      break;
    memset(v6, *(unsigned __int8 *)(a1 + 836), *(_DWORD *)(a1 + 784));
    v26 = v10;
    v27 = v10;
    v25 = v10;
    ...
    if ( v11 == 10 )
    {
      if ( !queue_enqueue(*(_DWORD *)(a1 + 816), s, v24 + 3) && v23 <= ++v22 )
      {
        V_LOCK();
        logfmt_raw(
          v29,
    ...
    else if ( !v11 && *(_BYTE *)(a1 + 222) )
    {
      if ( !*(_BYTE *)(a1 + v27 + 488) && v25 && platform_check_repeat_nonce((int *)a1, v26, v7) )
      {
        ++*(_QWORD *)(*(_DWORD *)(a1 + 416) + 48 * v26 + 32);
      }
      else
      {
        ...
        {
          v13 = v26;
          v14 = (_QWORD *)(*(_DWORD *)(a1 + 416) + 8 * v12 + 48 * v26);
          ++*v14;
          if ( v12 <= 1 )
          {
            v15 = *(_QWORD *)(a1 + 408) + 1LL;
            ++*(_DWORD *)(*(_DWORD *)(a1 + 440) + 4 * v13);
            v16 = v27;
            *(_QWORD *)(a1 + 408) = v15;
            ++*(_QWORD *)(a1 + 8 * v16 + 520);
            if ( !v12
              && !*(_BYTE *)(a1 + v16 + 488)
              && !queue_enqueue(*(_DWORD *)(*(_DWORD *)(a1 + 820) + 812), (char *)v6, 1)
              && v21 <= ++v4 )
            {
              V_LOCK();
              logfmt_raw(
