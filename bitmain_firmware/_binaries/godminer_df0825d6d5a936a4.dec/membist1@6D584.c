int __fastcall membist1(int a1)
{
  ...
  V_LOCK();
  V_INT((int)v16, "chain", *(int *)(a1 + 216));
  v15 = 0;
  logfmt_raw(v32, 0x1000u, 0, v17, v16[0], v16[1], v16[2], v16[3], v16[4], v16[5], v16[6], v17, "%s...", "membist1");
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  do
  {
    sub_69488(a1, v15, 12, 1);
    usleep(0x61A80u);
    sub_69488(a1, v15, 160, -2147483647);
    usleep(0xC3500u);
    memset(ptr, 0, 0x600u);
    v2 = sub_69728(a1, (unsigned __int16)v15, 161, ptr);
    if ( v2 == 8
      || (V_LOCK(),
...
LABEL_10:
    memset(ptr, 0, 0x600u);
    v5 = sub_69728(a1, (unsigned __int16)v15, 162, ptr);
    if ( v5 == 8
      || (V_LOCK(),
...
LABEL_18:
  ...
  v12 = dev_ctrl(v11);
  ((void (__fastcall *)(_DWORD))v12[20])(*(_DWORD *)(a1 + 212));
  unk_176DC8 = s[0];
  unk_176DCC = s[1];
  unk_176DD0 = s[2];
  unk_176DD4 = s[3];
