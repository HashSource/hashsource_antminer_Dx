int __fastcall clear_uart_rx_fifo(int a1)
{
  ...
  v2 = (pthread_mutex_t *)((char *)&unk_1771BC + 24 * a1);
  pthread_mutex_lock(v2);
  v3 = sub_A195C((unsigned __int8)a1);
  v4 = v3;
  if ( !v3 )
  ...
  if ( v5 )
  {
    ...
    if ( v7 != v4 )
    {
      ...
      zlog(
        ...
        "n_godminer-new/backend/device/hal/platform/7007/7007_uart.c",
        171,
        "clear_uart_rx_fifo",
        18,
        719,
  ...
  zlog(
    ...
    "dminer-new/backend/device/hal/platform/7007/7007_uart.c",
    171,
    "clear_uart_rx_fifo",
    18,
    709,
    ...
    v10);
  V_LOCK();
  logfmt_raw(v10, 0x1000u, 0, 1198464, 1201468);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_go"
