int __fastcall phy_internal_bist(int a1, int a2, unsigned int a3, int a4)
{
  ...
  zlog(
    ...
    v44);
  v18 = malloc(0x600u);
  sub_6F21C(a1, a3, 86, 3670024);
  usleep(0x12Cu);
  sub_6F21C(a1, a3, 85, 109905420);
  usleep(0x12Cu);
  sub_6F21C(a1, a3, 101, -268374016);
  usleep(0x12Cu);
  ...
  sub_6F21C(a1, a3, 86, 137889800);
  usleep(0x12Cu);
  sub_6F21C(a1, a3, 80, 0);
  usleep(0x12Cu);
  ...
  sub_6F21C(a1, a3, 133, 255);
  usleep(0x64u);
  sub_6F21C(a1, a3, 134, 255);
  usleep(0x64u);
  sub_6F21C(a1, a3, 132, -2147483647);
  sleep(6u);
