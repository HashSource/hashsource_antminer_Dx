int fpga_init()
{
  ...
  if ( dword_176FC4 )
    return 0;
  dword_176FC8 = open64("/dev/axi_fpga_dev");
  if ( dword_176FC8 < 0 )
  {
    snprintf(s, 0x800u, "/dev/axi_fpga_dev open failed. fd = %d", dword_176FC8);
    V_LOCK();
    ...
    zlog(
      ...
      "godminer-new/backend/device/hal/platform/7007/7007_fpga.c",
      171,
      "fpga_init",
      9,
      45,
  ...
  {
    v1 = mmap64(0, 4608, 3, 1, dword_176FC8);
    dword_176FCC = v1;
    if ( v1 )
    {
      ...
      if ( v2 < 0 )
      {
        ...
        zlog(
          ...
          "gin_godminer-new/backend/device/hal/platform/7007/7007_fpga.c",
          171,
          "fpga_init",
          9,
          64,
      ...
      else
      {
        ...
        if ( v3 )
        {
          ...
          zlog(
            ...
            "rigin_godminer-new/backend/device/hal/platform/7007/7007_fpga.c",
            171,
            "fpga_init",
            9,
            76,
