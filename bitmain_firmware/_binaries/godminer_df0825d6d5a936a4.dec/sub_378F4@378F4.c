int __fastcall sub_378F4(int a1, _DWORD *a2, _QWORD ***a3)
{
  __int64 v3; // d0
  int v5; // r0
  int v8; // r6
...
LABEL_109:
          if ( a2 && json_array_size(a2) != (_DWORD *)v31 )
          {
            ...
            sub_37430((int *)a1, "<validation>", 7, "%li array item(s) left unpacked", (char *)v61 - v31);
            return v8;
          }
          return 0;
        }
        ...
        {
LABEL_132:
          sub_37430((int *)a1, "<format>", 9, "Unexpected end of format string");
          return -1;
        }
        v32 = v30 == 33;
        if ( v30 != 33 )
...
LABEL_68:
          ...
          sub_37430((int *)a1, "<format>", 9, "Expected ']' after '%c', got '%c'", v30, v35);
          return -1;
        }
        while ( strchr("{[siIbfFOon", v30) )
        {
          if ( a2 )
          {
            ...
            {
              v8 = -1;
              sub_37430((int *)a1, "<validation>", 17, "Array index %lu out of range", v31);
              return v8;
            }
          }
          else
...
LABEL_102:
        ...
        v8 = -1;
        sub_37430((int *)a1, v60, 9, v59, v78);
      }
      return v8;
    case 'b':
      if ( !a2 )
    ...
    case 's':
      ...
      if ( *v47 )
      {
        ...
        if ( *(_BYTE *)(a1 + 36) == 37 )
        {
          ...
          {
            sub_37430((int *)a1, "<args>", 12, "NULL string length argument");
            return -1;
          }
        }
        else
      ...
      {
        sub_37430((int *)a1, "<args>", 12, "NULL string argument");
        return -1;
      }
      return v8;
    case '{':
      ...
      if ( v8 )
      {
        sub_37430((int *)a1, "<internal>", 1, "Out of memory");
        return -1;
      }
      if ( a2 && *a2 )
      {
        v8 = -1;
        sub_37430((int *)a1, "<validation>", 10, "Expected object, got %s", (&off_12696C)[*a2]);
        goto LABEL_30;
      }
      sub_37490((_DWORD *)a1);
...
LABEL_25:
            ...
            v8 = -1;
            sub_37430((int *)a1, "<format>", 9, "Expected '}' after '%c', got '%c'", v9, v17);
          }
          else
          {
            while ( 1 )
            {
              ...
              {
                v8 = -1;
                sub_37430((int *)a1, "<format>", 9, "Expected format 's', got '%c'", v9);
                goto LABEL_30;
              }
              v12 = (char **)(*a3)++;
              v13 = *v12;
              if ( !*v12 )
              {
                sub_37430((int *)a1, "<args>", 12, "NULL object key");
                v8 = -1;
                goto LABEL_30;
              }
              sub_37490((_DWORD *)a1);
              ...
              else if ( a2 )
              {
                ...
                {
                  v8 = -1;
                  sub_37430((int *)a1, "<validation>", 16, "Object item not found: %s", v13);
                  goto LABEL_30;
                }
              }
              else
...
LABEL_148:
      if ( v65 )
      {
        ...
        sub_37430((int *)a1, "<validation>", 7, "%li object item(s) left unpacked: %s", v65, v72);
        v8 = -1;
