int __fastcall update_temperature(int a1, _DWORD *a2, int a3)
{
  ...
  v101 = v4;
  v7 = calloc(v4, 8u);
  v8 = *(void (__fastcall **)(int, void *))(a1 + 200);
  ptr = v7;
  v8(a1, v7);
  if ( v4 <= 0 )
  {
...
LABEL_64:
  ...
  v98 = &g_temp_zc;
  s = "chain";
  v81 = "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origi"
  ...
  do
  {
    ...
    logfmt_raw(
      ...
      *v9,
      v9[1]);
    V_UNLOCK();
    zlog(*v83, v81, 192, "check_temperature", 17, 36, 20, v159);
    v53 = *v9;
    if ( *v9 == -64 )
    {
      v55 = 0;
...
LABEL_6:
    ...
    *v19 = v154[4];
    ...
    V_UNLOCK();
    zlog(*v83, v81, 192, "check_temperature", 17, 92, 20, v159);
    V_LOCK();
    V_INT((int)v136, s, *(int *)(a1 + 216));
    ...
    *v40 = v135[4];
    ...
    V_UNLOCK();
    zlog(*v98, v81, 192, "check_temperature", 17, 94, 40, v159);
  }
  while ( v9 != v97 );
  free(ptr);
  if ( v91 != v101 || v91 != v90 )
...
LABEL_33:
  ...
  if ( v91 )
  {
    ...
    v61 = v94;
    v89[5] = v95;
    dword_176B18[v59] = v61;
    dword_176B18[v59 + 16] = 0;
    goto LABEL_35;
  }
LABEL_59:
  v60 = v59;
  v69 = &dword_176B18[v59];
  v70 = v69[16] + 1;
  v65 = v69[16] - 1 < 0;
  v69[16] = v70;
...
LABEL_35:
  if ( v90 )
  {
    v62 = v89;
    v63 = v93;
    dword_176B18[v60 + 32] = 0;
    v62[4] = v63;
  }
  else
  {
    v73 = dword_176B18[v60 + 32] + 1;
    v65 = dword_176B18[v60 + 32] - 1 < 0;
    dword_176B18[v60 + 32] = v73;
  ...
  if ( *(_DWORD *)(a1 + 372) >= v92 )
  {
    dword_176B18[v60 + 48] = 0;
  }
  else
  {
    v64 = dword_176B18[v60 + 48] + 1;
    v65 = dword_176B18[v60 + 48] - 1 < 0;
    dword_176B18[v60 + 48] = v64;
  ...
  if ( v89[4] > *(_DWORD *)(a1 + 360) || dword_176B18[v59] > *(_DWORD *)(a1 + 364) )
  {
    v71 = dword_176B18[v60 + 64] + 1;
    v65 = dword_176B18[v60 + 64] - 1 < 0;
    dword_176B18[v60 + 64] = v71;
    if ( !(v65 ^ __OFSUB__(v71, 2) | (v71 == 2)) )
    {
      ...
      logfmt_raw(
        ...
        dword_176B18[*(_DWORD *)(a1 + 212) + 64],
        v89[4],
        dword_176B18[*(_DWORD *)(a1 + 212)]);
      V_UNLOCK();
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origi"
  ...
  {
    dword_176B18[v60 + 64] = 0;
  }
  if ( v89[5] <= *(_DWORD *)(a1 + 368) )
  {
    v66 = &dword_176B18[v60];
    v67 = v66[80] + 1;
    v65 = v66[80] - 1 < 0;
    v66[80] = v67;
