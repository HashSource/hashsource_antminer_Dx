int __fastcall sub_55F58(_DWORD *a1)
{
  signed int *v1; // r0
  signed int v2; // r4
  _DWORD *v3; // r0
  ...
  if ( v3 && *v3 == 2 )
  {
    ...
    if ( v6 && *v6 == 1 )
    {
      ...
      dword_17874C = (int)v8;
      dword_178764 = (int)calloc((size_t)v8, 2u);
      if ( (int)v8 > 0 )
      {
        do
        {
          ...
          v10 = 2 * v2++;
          *(_WORD *)(dword_178764 + v10) = json_integer_value((int)v9);
          V_LOCK();
          logfmt_raw(v32, 0x1000u, 0, "psu version = 0x%x", *(unsigned __int16 *)(dword_178764 + v10));
          V_UNLOCK();
          zlog(
            g_zc,
        ...
        if ( v15 && (unsigned int)(*v15 - 5) <= 1 )
        {
          ...
          if ( v17 && *v17 == 3 )
          {
            ...
            zlog(
              ...
              20,
              v32);
            dword_178754 = json_integer_value(v18);
            ...
            if ( v20 && *v20 == 3 )
            {
              ...
              zlog(
                ...
                20,
                v32);
              dword_178758 = json_integer_value(v21);
