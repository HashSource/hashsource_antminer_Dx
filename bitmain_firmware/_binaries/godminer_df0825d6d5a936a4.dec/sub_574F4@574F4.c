int __fastcall sub_574F4(_DWORD *a1)
{
  _DWORD *v1; // r0
  _DWORD *v2; // r8
  _DWORD *v3; // r0
    ...
    if ( v3 && *v3 == 2 )
    {
      ...
      if ( v6 && *v6 == 2 )
      {
        ...
        *(_DWORD *)(v10 + 24) = v11;
        ...
        V_LOCK();
        logfmt_raw(v36, 0x1000u, 0, "chip_type 0x%x", *(_DWORD *)(dword_178710 + 24));
        V_UNLOCK();
        zlog(
          g_zc,
          "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-ori"
        ...
        if ( v13 && *v13 == 3 )
        {
          ...
          zlog(
            ...
            20,
            v36);
          *(_DWORD *)(dword_178710 + 28) = json_integer_value(v14);
          ...
          if ( v16 && *v16 == 3 )
          {
            ...
            zlog(
              ...
              20,
              v36);
            *(_DWORD *)(dword_178710 + 36) = json_integer_value(v17);
            ...
            if ( v19 && *v19 == 3 )
            {
              ...
              zlog(
                ...
                20,
                v36);
              *(_DWORD *)(dword_178710 + 40) = json_integer_value(v20);
              ...
              if ( v22 && *v22 == 3 )
              {
                ...
                zlog(
                  ...
                  20,
                  v36);
                *(_DWORD *)(dword_178710 + 44) = json_integer_value(v23);
                ...
                if ( v25 && *v25 == 3 )
                {
                  ...
                  zlog(
                    ...
                    20,
                    v36);
                  *(_DWORD *)(dword_178710 + 48) = json_integer_value(v26);
