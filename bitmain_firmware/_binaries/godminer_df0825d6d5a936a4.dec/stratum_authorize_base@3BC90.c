int __fastcall stratum_authorize_base(int a1, _DWORD *a2)
{
  ...
  v8 = (*(int (__fastcall **)(_DWORD *, char *))(a1 + 12))(a2, v7);
  if ( !v8 )
  {
LABEL_2:
    free(v7);
  ...
  while ( 1 )
  {
    v10 = (void *)(*(int (__fastcall **)(_DWORD *))(a1 + 8))(a2);
    if ( !v10 )
    {
      v8 = 0;
      goto LABEL_2;
  ...
  if ( !v11 )
  {
    v8 = 0;
    V_LOCK();
    logfmt_raw(v23, 0x1000u, 0, 1208100, *(_DWORD *)v21, v22);
    V_UNLOCK();
    zlog(
      g_zc,
  ...
  if ( v16 || *v12 == 6 || v13 && *v13 != 7 )
  {
    V_LOCK();
    v8 = 0;
    logfmt_raw(v23, 0x1000u, 0, 1208720, v17);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
