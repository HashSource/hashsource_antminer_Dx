int __fastcall get_fake_regio_runtime(int a1)
{
  ...
  if ( dword_177910[a1] )
    return dword_177910[a1];
  v3 = calloc(1u, 0x3B8u);
  v3[53] = a1;
  dword_177910[a1] = v3;
  v4 = dev_ctrl((int)v3);
  ((void (__fastcall *)(int))v4[1])(a1);
  v5 = (pthread_mutex_t *)dword_177910[a1];
  ...
  *(_DWORD *)(v7 + 224) = set_chipaddr_base;
  *(_QWORD *)(v7 + 232) = v8;
  *(_DWORD *)(v7 + 228) = set_inactive_base;
  *(_DWORD *)(v7 + 252) = sync_get_chip_reg_base;
  *(_DWORD *)(v7 + 260) = sync_get_core_reg_base;
  *(_BYTE *)(v7 + 220) = 1;
  return v7;
}
