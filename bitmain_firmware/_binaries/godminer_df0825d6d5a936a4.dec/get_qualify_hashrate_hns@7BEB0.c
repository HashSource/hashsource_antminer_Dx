int __fastcall get_qualify_hashrate_hns(int a1, double *a2)
{
  ...
  v8 = 0.0;
  v5(a1, &v8);
  if ( *(_BYTE *)(a1 + 264) != 72 || *(_BYTE *)(a1 + 265) != 83 || *(_BYTE *)(a1 + 266) != 51 || *(_BYTE *)(a1 + 267) )
    return 25;
  api_get_eeprom_chip_bin(*(_DWORD *)(a1 + 212));
  v7 = (const char *)(api_get_eeprom_chip_ft(*(_DWORD *)(a1 + 212)) + 5);
