// Decompiled: cgminer-api_762ed1eac7325896
...

{
    ...
    pcVar6 = (char *)FUN_00010c1c(param_2[iVar2]);
    pcVar7 = "summary";
    if (*pcVar6 != '\0') {
        pcVar7 = pcVar6;
    }
    if (iVar2 + 1 < param_1) {
        pcVar3 = (char *)FUN_00010c1c(param_2[iVar2 + 1]);
        pcVar6 = "127.0.0.1";
        if (*pcVar3 != '\0') {
            pcVar6 = pcVar3;
        }
        if ((iVar2 + 2 < param_1) &&
            (pcVar3 = (char *)FUN_00010c1c(param_2[iVar2 + 2]),
             *pcVar3 != '\0')) {
...

{
    ...
    __libc_start_main(main, in_stack_00000000, &stack0x00000004, 0x11071,
                      0x110ad, param_1);
...
/* WARNING: Removing unreachable block (ram,0x00010bce) */
...
byte *FUN_00010c1c(byte *param_1)
