int __fastcall serdes_external_loop_ate_init_rvn(int a1, int a2, int a3, int a4)
{
  ...
  zlog(
    ...
    "dminer-new/backend/backend_rvn_2044/backend_rvn_phy_set.c",
    173,
    "serdes_external_loop_ate_init_rvn",
    33,
    422,
    60,
    v133);
  sub_AEC9C(a1, a3, 240, 0x80000000);
  sub_AEC9C(a1, a3, 86, 67634184);
  sub_AEC9C(a1, a3, 64, 256);
  sub_AEC9C(a1, a3, 80, 33423870);
  sub_AEC9C(a1, a3, 81, 832516511);
  sub_AEC9C(a1, a3, 88, -1);
  sub_AEC9C(a1, a3, 86, 201853960);
  V_LOCK();
  V_INT((int)v13, "chain", *(int *)(a1 + 256));
  logfmt_raw(
    v133,
    0x1000u,
    0,
  ...
  zlog(
    ...
    60,
    v133);
  sub_AEC9C(a1, a3, 77, (int)&loc_30000 + 3);
  sub_AEC9C(a1, a3, 78, -2144272046);
  sub_AEC9C(a1, a3, 77, 33554944);
  sub_AEC9C(a1, a3, 78, -2144247742);
  sub_AEC9C(a1, a3, 77, 100664832);
  sub_AEC9C(a1, a3, 78, -2144247742);
  sub_AEC9C(a1, a3, 77, (int)&dword_10000 + 1);
  sub_AEC9C(a1, a3, 78, -2144272003);
  V_LOCK();
  ...
  zlog(
    ...
    60,
    v133);
  sub_AF240(a1, a3, 24642, a4 | 0x600);
  sub_AEC9C(a1, a3, 77, 0);
  sub_AEC9C(a1, a3, 78, -2144247741);
  sub_AF240(a1, a3, 24644, a4 << 7);
  sub_AF240(a1, a3, 24642, a4 | 0x700);
  sub_AEC9C(a1, a3, 77, 16777472);
  sub_AEC9C(a1, a3, 78, -2144247741);
  sub_AF240(a1, a3, 24644, a4 << 7);
  V_LOCK();
  ...
  zlog(
    ...
    v133);
  sub_AEC9C(a1, a3, 77, 0);
  sub_AEC9C(a1, a3, 78, -2144251892);
  sub_AEC9C(a1, a3, 77, 268439552);
  sub_AEC9C(a1, a3, 78, -2144251892);
  sub_AEC9C(a1, a3, 77, 33489407);
  sub_AEC9C(a1, a3, 78, -2144272086);
  sub_AEC9C(a1, a3, 77, 268374015);
  sub_AEC9C(a1, a3, 78, -2144272085);
  V_LOCK();
  ...
  zlog(
    ...
    60,
    v133);
  sub_AF240(a1, a3, 24644, (a4 << 7) | 0x8020);
  sub_AF240(a1, a3, 24644, (a4 << 7) | 0x8060);
  sub_AEC9C(a1, a3, 77, -1);
  sub_AEC9C(a1, a3, 78, -2144247719);
  sub_AEC9C(a1, a3, 77, -8388737);
  sub_AEC9C(a1, a3, 78, -2144247718);
  V_LOCK();
  ...
  zlog(
    ...
    v133);
  sub_AEC9C(a1, a3, 77, 0);
  sub_AEC9C(a1, a3, 78, -2144247776);
  sub_AEC9C(a1, a3, 77, -2136964960);
  sub_AEC9C(a1, a3, 78, -2144247776);
  V_LOCK();
  ...
  if ( a4 == 2 )
    ...
    HIWORD(v7) = 4144;
  sub_AEC9C(a1, a3, 77, v7);
  sub_AEC9C(a1, a3, 78, -2144247722);
  sub_AEC9C(a1, a3, 77, -1);
  sub_AEC9C(a1, a3, 78, -2144247718);
  V_LOCK();
  ...
  zlog(
    ...
    v133);
  sub_AEC9C(a1, a3, 77, 0);
  sub_AEC9C(a1, a3, 78, -2144247771);
  sub_AEC9C(a1, a3, 77, (int)&loc_140014);
  sub_AEC9C(a1, a3, 78, -2144247771);
  V_LOCK();
  ...
  zlog(
    ...
    v133);
  sub_AEC9C(a1, a3, 77, 33554944);
  sub_AEC9C(a1, a3, 78, -2144247760);
  sub_AEC9C(a1, a3, 77, 122947412);
  sub_AEC9C(a1, a3, 78, -2144247760);
  V_LOCK();
  ...
  zlog(
    ...
    60,
    v133);
  sub_AEC9C(a1, a3, 77, 1073758208);
  sub_AEC9C(a1, a3, 78, -2144247770);
  sub_AEC9C(a1, a3, 77, -1072381932);
  sub_AEC9C(a1, a3, 78, -2144247770);
  V_LOCK();
  ...
  if ( a4 == 2 )
    ...
    HIWORD(v8) = 3;
  sub_AEC9C(a1, a3, 77, v8);
  sub_AEC9C(a1, a3, 78, -2144247739);
  sub_AEC9C(a1, a3, 77, -1);
  sub_AEC9C(a1, a3, 78, -2144247732);
  V_LOCK();
  ...
  zlog(
    ...
    v133);
  sub_AEC9C(a1, a3, 77, 268439552);
  sub_AEC9C(a1, a3, 78, -2144247769);
  sub_AEC9C(a1, a3, 77, 805318656);
  sub_AEC9C(a1, a3, 78, -2144247769);
  V_LOCK();
  ...
  zlog(
    ...
    v133);
  sub_AEC9C(a1, a3, 77, 0);
  sub_AEC9C(a1, a3, 78, -2144247751);
  sub_AEC9C(a1, a3, 77, 5505108);
  sub_AEC9C(a1, a3, 78, -2144247751);
  V_LOCK();
  ...
  zlog(
    ...
    v133);
  sub_AEC9C(a1, a3, 77, (int)&dword_10000 + 1);
  sub_AEC9C(a1, a3, 78, -2144251903);
  sub_AEC9C(a1, a3, 77, 2293795);
  sub_AEC9C(a1, a3, 78, -2144251903);
  V_LOCK();
  ...
  zlog(
    ...
    v133);
  sub_AEC9C(a1, a3, 77, 0);
  sub_AEC9C(a1, a3, 78, -2144251872);
  sub_AEC9C(a1, a3, 77, (int)&loc_80008);
  sub_AEC9C(a1, a3, 78, -2144251872);
  V_LOCK();
  ...
  zlog(
    ...
    v133);
  sub_AEC9C(a1, a3, 77, 0);
  sub_AEC9C(a1, a3, 78, -2144272111);
  sub_AEC9C(a1, a3, 77, 1073692671);
  sub_AEC9C(a1, a3, 78, -2144272088);
  V_LOCK();
  ...
  zlog(
    ...
    60,
    v133);
  sub_AEC9C(a1, a3, 77, 234884608);
  sub_AEC9C(a1, a3, 78, -2144272382);
  sub_AEC9C(a1, a3, 77, 235408904);
  sub_AEC9C(a1, a3, 78, -2144272382);
  V_LOCK();
  ...
  zlog(
    ...
    60,
    v133);
  sub_AEC9C(a1, a3, 77, (int)&unk_180018);
  sub_AEC9C(a1, a3, 78, -2144272353);
  V_LOCK();
  ...
  zlog(
    ...
    60,
    v133);
  sub_AEC9C(a1, a3, 77, 22348117);
  sub_AEC9C(a1, a3, 78, -2144272044);
  sub_AEC9C(a1, a3, 77, 67044351);
  sub_AEC9C(a1, a3, 78, -2144272044);
  V_LOCK();
  ...
  zlog(
    ...
    60,
    v133);
  sub_AEC9C(a1, a3, 77, 61277095);
  sub_AEC9C(a1, a3, 78, -2144272380);
  sub_AEC9C(a1, a3, 77, 65471463);
  sub_AEC9C(a1, a3, 78, -2144272380);
  V_LOCK();
  ...
  zlog(
    ...
    60,
    v133);
  sub_AEC9C(a1, a3, 77, (int)&loc_40004);
  sub_AEC9C(a1, a3, 78, -2144272379);
  sub_AEC9C(a1, a3, 77, (int)&loc_C000C);
  sub_AEC9C(a1, a3, 78, -2144272379);
  V_LOCK();
  ...
  zlog(
    ...
    v133);
  sub_AEC9C(a1, a3, 77, 0);
  sub_AEC9C(a1, a3, 78, -2144272372);
  sub_AEC9C(a1, a3, 77, (int)&locret_100010);
  sub_AEC9C(a1, a3, 78, -2144272372);
  V_LOCK();
  ...
  zlog(
    ...
    v133);
  sub_AEC9C(a1, a3, 77, 0);
  sub_AEC9C(a1, a3, 78, -2144272114);
  sub_AEC9C(a1, a3, 77, 710158932);
  sub_AEC9C(a1, a3, 78, -2144272114);
  V_LOCK();
  ...
  zlog(
    ...
    v133);
  sub_AEC9C(a1, a3, 77, 0);
  sub_AEC9C(a1, a3, 78, -2144272124);
  sub_AEC9C(a1, a3, 77, (int)"uihash_blake2b_update");
  sub_AEC9C(a1, a3, 78, -2144272124);
  V_LOCK();
  ...
  if ( a4 == 2 )
    ...
    HIWORD(v9) = 501;
  sub_AEC9C(a1, a3, 77, v9);
  sub_AEC9C(a1, a3, 78, -2144247559);
  V_LOCK();
  ...
  zlog(
    ...
    60,
    v133);
  sub_AEC9C(a1, a3, 77, 20971840);
  sub_AEC9C(a1, a3, 78, -2144251901);
  sub_AEC9C(a1, a3, 77, 88606024);
  sub_AEC9C(a1, a3, 78, -2144251901);
  V_LOCK();
  ...
  zlog(
    ...
    v133);
  sub_AEC9C(a1, a3, 77, (int)&locret_100010);
  sub_AEC9C(a1, a3, 78, -2144251900);
  sub_AEC9C(a1, a3, 77, 542122064);
  sub_AEC9C(a1, a3, 78, -2144251900);
  V_LOCK();
  ...
  zlog(
    ...
    60,
    v133);
  sub_AEC9C(a1, a3, 77, 537010178);
  sub_AEC9C(a1, a3, 78, -2144247750);
  V_LOCK();
  ...
  zlog(
    ...
    60,
    v133);
  sub_AEC9C(a1, a3, 77, 872428544);
  sub_AEC9C(a1, a3, 78, -2144247769);
  sub_AEC9C(a1, a3, 77, 1006648320);
  sub_AEC9C(a1, a3, 78, -2144247769);
  V_LOCK();
  ...
  zlog(
    ...
    v133);
  sub_AEC9C(a1, a3, 77, 0);
  sub_AEC9C(a1, a3, 78, -2144243666);
  sub_AEC9C(a1, a3, 77, (int)"uihash_blake2b_update");
  sub_AEC9C(a1, a3, 78, -2144243666);
  sub_AEC9C(a1, a3, 77, 4259905);
  sub_AEC9C(a1, a3, 78, -2144251869);
  sub_AEC9C(a1, a3, 77, 13304011);
  sub_AEC9C(a1, a3, 78, -2144251869);
  V_LOCK();
  ...
  zlog(
    ...
    60,
    v133);
  sub_AEC9C(a1, a3, 77, (int)&loc_A0008 + 2);
  sub_AEC9C(a1, a3, 78, -2144247768);
  V_LOCK();
  ...
  zlog(
    ...
    60,
    v133);
  sub_AEC9C(a1, a3, 77, (int)&loc_70004 + 3);
  sub_AEC9C(a1, a3, 78, -2144272078);
  V_LOCK();
  ...
  zlog(
    ...
    v133);
  sub_AEC9C(a1, a3, 77, (int)&dword_10000 + 1);
  sub_AEC9C(a1, a3, 78, -2144251757);
  sub_AEC9C(a1, a3, 77, (int)&dword_10000 + 1);
  sub_AEC9C(a1, a3, 78, -2144251757);
  sub_AEC9C(a1, a3, 77, (int)&loc_110010 + 1);
  sub_AEC9C(a1, a3, 78, -2144251757);
  sub_AEC9C(a1, a3, 77, (int)&dword_10000 + 1);
  sub_AEC9C(a1, a3, 78, -2144251757);
  sub_AEC9C(a1, a3, 77, (int)&loc_110010 + 1);
