int __fastcall sub_448FC(int a1, int a2, _DWORD *a3)
{
  _DWORD *v5; // r0
  const char *v6; // r7
  _DWORD *v7; // r0
  ...
  if ( v11 )
  {
    ...
    zlog(
      ...
      "godminer-new/frontend/frontend_eth_2282/frontend_eth_2282.c",
      173,
...
LABEL_24:
    v24 = g_zc;
    LOWORD(v25) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/"
                                    "release/build/godminer-origin_godminer-new/frontend/frontend_eth_2282/frontend_eth_2282.c";
    goto LABEL_25;
  }
  if ( a2 == -456 )
  {
LABEL_22:
  ...
  zlog(
    ...
    "dminer-new/frontend/frontend_eth_2282/frontend_eth_2282.c",
    173,
    "stratum_notify_eth_2282",
    23,
    943,
...
LABEL_14:
  ...
  *(_BYTE *)(a2 + 444) = 1;
  ...
  {
    *(_DWORD *)(a2 + 1536) = get_epoch_number_eth_2282(v18);
    v19 = v18 + 103;
    *((_WORD *)v18 + 52) = 0;
    v18[106] = 0;
  ...
  LOWORD(v25) = -18896;
LABEL_25:
  HIWORD(v25) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/releas"
                              "e/build/godminer-origin_godminer-new/frontend/frontend_eth_2282/frontend_eth_2282.c" >> 16;
  zlog(v24, v25, 173, "stratum_notify_eth_2282", 23, v23, 100, v29);
  pthread_mutex_unlock((pthread_mutex_t *)(a2 + 1592));
  return 0;
}
