      ...
      if ( *((_DWORD *)v91 + 1) == 16 )
      {
        ...
        *(_DWORD *)(v89 + 32) |= 4u;
        if ( !v39 )
        {
          ...
          v83 = (int)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/g"
                     "odminer-origin_godminer-new/miner_util/miner_monitor/update_miner_status/update_fanspeed.c";
          v82 = v72;
          v50 = 0;
          do
          {
            ...
            *v52 = v105[4];
            ...
            V_UNLOCK();
            zlog(*v85, v83, 189, "update_fanspeed", 15, 72, 40, v109);
            V_LOCK();
            ...
            *v52 = v108[4];
            ...
            V_UNLOCK();
            zlog(*v86, v83, 189, "update_fanspeed", 15, 73, 100, v109);
