int __fastcall membist1_rvn(int a1)
{
  ...
  V_LOCK();
  V_INT((int)v16, "chain", *(int *)(a1 + 256));
  n = 0;
  ...
  do
  {
    sub_A47C4(a1, n, 28, 1);
    usleep(0x61A80u);
    sub_A47C4(a1, n, 160, -2147483647);
    usleep(0xC3500u);
    memset(ptr, 0, 0x1800u);
    v2 = sub_A4B38(a1, (unsigned __int16)n, 161, ptr);
    if ( v2 == 8
      || (V_LOCK(),
          V_INT((int)v18, "chain", *(int *)(a1 + 256)),
          logfmt_raw(
            v32,
            0x1000u,
            0,
...
LABEL_10:
    memset(ptr, 0, 0x1800u);
    v5 = sub_A4B38(a1, (unsigned __int16)n, 162, ptr);
    if ( v5 == 8
      || (V_LOCK(),
...
LABEL_18:
  ...
  v12 = dev_ctrl(v11);
  ((void (__fastcall *)(_DWORD))v12[25])(*(_DWORD *)(a1 + 248));
  unk_1B3FD4 = s[0];
  unk_1B3FD8 = s[1];
  unk_1B3FDC = s[2];
  unk_1B3FE0 = s[3];
