int __fastcall sub_589CC(int a1, int *a2, int a3)
{
  size_t *v3; // r7
  int *v6; // r8
  int v7; // r3
  ...
  {
    v6 = a2 + 116;
    if ( a3 && memcmp(&unk_1968F0, a2 + 116, 0x116u) )
    {
      qword_196A10 = 0;
      memcpy(&unk_1968F0, v6, 0x11Eu);
    }
    ...
    if ( v7 && v7 == *v3 )
    {
      ...
      zlog(
        ...
        20,
        v16);
      memcpy(v3 + 1, &qword_196A10, *v3);
      if ( (unsigned __int64)qword_196A10 > 0xFF )
        qword_196A10 = 0;
      else
        ++qword_196A10;
    }
