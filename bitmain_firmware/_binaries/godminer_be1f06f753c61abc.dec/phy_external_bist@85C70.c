int __fastcall phy_external_bist(int a1, int a2, int a3, int a4)
{
  ...
  if ( a4 )
  {
    ...
    {
      v13 = *++v12;
      sub_7FA1C(a1, v13, 133, 0xFFFF);
      sub_7FA1C(a1, *v12, 134, 1342177279);
    }
    while ( v8 != v12 );
    v55 = v12;
    sub_7F9D8(a1, 132, -2147483647);
    sleep(0xAu);
...
LABEL_13:
      ...
      v52 = 0;
      v17 = *++v50;
      sub_7FA6C(a1, v17, 132, ptr);
      LOWORD(v79[0]) = 17475;
      while ( 1 )
      {
        v18 = sub_7FA6C(a1, *v50, v16, ptr);
        if ( v18 )
        {
          v19 = ptr;
          v20 = &ptr[12 * v18];
...
LABEL_44:
  ...
  while ( 1 )
  {
    *(_QWORD *)&dword_1A3E00 += v42;
    *(_QWORD *)&dword_1A3DF8 += v41;
    *(_QWORD *)&dword_1A3E08 += v43;
    V_LOCK();
  ...
  zlog(
    ...
    v90);
  V_LOCK();
  V_INT((int)&v84, "chain", *(int *)(a1 + 256));
  logfmt_raw(
    v90,
    0x1000u,
    0,
