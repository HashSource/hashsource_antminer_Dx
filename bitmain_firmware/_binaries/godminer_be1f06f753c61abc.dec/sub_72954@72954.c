int __fastcall sub_72954(int a1, int a2)
{
  int v4; // r2
  int v6; // r8
  __int64 v7; // r0
  ...
  if ( a2 == 700 )
  {
    v6 = 820;
LABEL_6:
    LODWORD(v7) = sub_145CA4(*(_QWORD *)(a1 + 1016), a2);
    *(_QWORD *)(a1 + 1016) = v7 * (int)*(float *)(a1 + 996);
    *(float *)(a1 + 996) = (float)a2;
    *(_DWORD *)(a1 + 1000) = v6;
    V_LOCK();
