int __fastcall sub_A5424(int *a1, int a2)
{
  int v2; // r4
  void *v5; // r0
  ...
  v5 = calloc(12 * a2, 1u);
  v23 = &v33;
  v6 = (void (__fastcall *)(int *, _DWORD *, int, void *, int *, int, int, _DWORD))a1[74];
  ptr = v5;
  v6(a1, v34, a2, v5, &v33, v24, 3000, 0);
  V_LOCK();
  V_INT((int)v35, "chain", a1[64]);
  logfmt_raw(
    v43,
    0x1000u,
    0,
  ...
  if ( v33 > 0 )
  {
    ...
    do
    {
      while ( 1 )
      {
        ...
        V_UNLOCK();
        zlog(g_zc, v27, 149, v26, 24, 121, 20, v43);
        if ( a1[86] == (unsigned __int16)v8 )
          break;
        v7 += 6;
        if ( v33 <= v2 )
          goto LABEL_7;
      ...
      V_UNLOCK();
      zlog(g_zc, v27, 149, v26, 24, 127, 20, v43);
    }
    while ( v33 > v2 );
LABEL_7:
    v2 = v29;
