...
LABEL_30:
      ...
      if ( v39 > 0 )
      {
        ...
        for ( i = 0; i < v39; ++i )
        {
          v22 = *((_DWORD *)v20 + 1);
          v20 += 4;
          if ( api_get_eeprom_fmt_version(*(_DWORD *)(v22 + 248)) == 4 )
          {
            eeprom_asic_freqs = api_get_eeprom_asic_freqs(*(_DWORD *)(*(_DWORD *)v20 + 248), &dest, &v40);
            if ( !eeprom_asic_freqs )
            {
              memset(s, 0, sizeof(s));
              v24 = *(_DWORD *)v20;
              v25 = *(_DWORD *)(*(_DWORD *)v20 + 352);
              if ( v25 )
              {
                v26 = (float *)&v43;
                v27 = dest + 0.0;
              ...
              v31 = v27 / (float)v25;
              (*(void (__fastcall **)(int, float *))(v24 + 204))(v24, &dest);
              v32 = *(_DWORD *)v20;
              *(_DWORD *)(v32 + 480) = (int)v31;
              *(float *)(v32 + 996) = (float)(int)v31;
              eeprom_sweep_freq = api_get_eeprom_sweep_freq(i);
              V_LOCK();
              v34 = *(_DWORD *)(*(_DWORD *)v20 + 248);
...
LABEL_16:
    ...
    if ( *(_DWORD *)all_created_runtime )
    {
      ...
      {
        ++v13;
        v2 = (*(int (__fastcall **)(int, _DWORD, int))(v11 + 192))(v11, 0, v9);
        if ( v2 )
          break;
        usleep(*(_DWORD *)(a1 + 100));
        if ( v39 <= v13 )
