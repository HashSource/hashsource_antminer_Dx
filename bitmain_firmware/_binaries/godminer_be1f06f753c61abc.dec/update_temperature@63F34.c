...
LABEL_6:
    ...
    *v40 = v135[4];
    ...
    V_UNLOCK();
    zlog(*v99, v81, 192, "check_temperature", 17, 94, 40, v159);
  }
  while ( v97 != v9 );
  free(ptr);
  if ( v91 != v101 || v91 != v90 )
...
LABEL_33:
  ...
  if ( v91 )
  {
    ...
    v61 = v94;
    v89[5] = v95;
    dword_1A3B18[v59] = v61;
    dword_1A3B18[v59 + 16] = 0;
    goto LABEL_35;
  }
LABEL_59:
  v60 = v59;
  v69 = &dword_1A3B18[v59];
  v70 = v69[16] + 1;
  v65 = v69[16] - 1 < 0;
  v69[16] = v70;
...
LABEL_35:
  if ( v90 )
  {
    v62 = v89;
    v63 = v93;
    dword_1A3B18[v60 + 32] = 0;
    v62[4] = v63;
  }
  else
  {
    v73 = dword_1A3B18[v60 + 32] + 1;
    v65 = dword_1A3B18[v60 + 32] - 1 < 0;
    dword_1A3B18[v60 + 32] = v73;
  ...
  if ( *(_DWORD *)(a1 + 428) >= v92 )
  {
    dword_1A3B18[v60 + 48] = 0;
  }
  else
  {
    v64 = dword_1A3B18[v60 + 48] + 1;
    v65 = dword_1A3B18[v60 + 48] - 1 < 0;
    dword_1A3B18[v60 + 48] = v64;
  ...
  if ( v89[4] > *(_DWORD *)(a1 + 416) || dword_1A3B18[v59] > *(_DWORD *)(a1 + 420) )
  {
    v71 = dword_1A3B18[v60 + 64] + 1;
    v65 = dword_1A3B18[v60 + 64] - 1 < 0;
    dword_1A3B18[v60 + 64] = v71;
  ...
  {
    dword_1A3B18[v60 + 64] = 0;
  }
  if ( v89[5] <= *(_DWORD *)(a1 + 424) )
  {
    v66 = &dword_1A3B18[v60];
    v67 = v66[80] + 1;
    v65 = v66[80] - 1 < 0;
    v66[80] = v67;
