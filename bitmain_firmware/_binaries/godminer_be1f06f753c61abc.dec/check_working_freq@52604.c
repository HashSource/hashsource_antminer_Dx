      ...
      if ( v17 > 0 )
      {
        ...
        for ( i = 0; i < v17; ++i )
        {
          ...
          if ( *(int *)(v7 + 352) > 0 )
          {
            ...
            do
            {
              pthread_mutex_lock((pthread_mutex_t *)(*(_DWORD *)(v6 + 544) + v8 + 20));
              v10 = *(_DWORD *)(*v4 + 544) + v8;
              v11 = *(float *)(v10 + 4);
              v12 = *(float *)(v10 + 12);
              *(float *)(v10 + 8) = v3;
              ...
              if ( v13 != v12 )
              {
                if ( !v9 )
                {
                  ...
                  logfmt_raw(
                    ...
                    *(float *)(*(_DWORD *)(*v4 + 544) + v8 + 4),
                    *(float *)(*(_DWORD *)(*v4 + 544) + v8 + 8),
                    *(float *)(*(_DWORD *)(*v4 + 544) + v8 + 12));
                  V_UNLOCK();
                  zlog(
                    g_zc,
                  ...
                  {
                    V_LOCK();
                    V_INT((int)v18, "chain", *(int *)(*v4 + 256));
                    logfmt_raw(
                      v20,
                      0x1000u,
                      0,
