int __fastcall packet_2_nonce_kas(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, signed int *a6, _DWORD *a7)
{
  ...
  {
    v28 = &dword_1A3E20[*(_DWORD *)(a1 + 256)];
    v29 = v28[1];
    v28[1] = v29 + 1;
    if ( v29 <= 9 )
    {
      ...
      if ( v18 != -1 )
      {
        ...
        *a4 = 1;
        ...
        if ( v30 <= 0 )
        {
          ...
          v33 = 0;
LABEL_33:
          *(_QWORD *)&dword_1A3E20[v41 + 20] = v33;
          return 0;
        }
        v31 = *(_DWORD *)(a1 + 472);
        v32 = 0;
        ...
        v40 = v34;
        v41 = 2 * v56;
        v42 = *(_QWORD *)&dword_1A3E20[2 * v56 + 20];
        if ( v42 >= v33 )
        {
          LOWORD(v43) = 16112;
        }
        ...
        {
          LOWORD(v43) = (unsigned __int16)&unk_1A3EF0;
          if ( v33 - v42 <= 0x63 )
          {
            v44 = 0;
            HIWORD(v43) = (unsigned int)&unk_1A3EF0 >> 16;
            v45 = s;
            do
            {
              v47 = *(_QWORD *)v45;
