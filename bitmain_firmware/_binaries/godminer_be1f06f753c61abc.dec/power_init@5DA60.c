...
LABEL_12:
  ...
  zlog(
    ...
    v66);
  V_LOCK();
  logfmt_raw(v66, 0x1000u, 0, "current_voltage_raw\t\t= %d", dword_196B1C);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_go"
    ...
    v66);
  V_LOCK();
  logfmt_raw(v66, 0x1000u, 0, "working_voltage_raw\t\t= %d", dword_196B0C);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_go"
    ...
    v66);
  V_LOCK();
  logfmt_raw(v66, 0x1000u, 0, "check_asic_voltage_enable\t= %d", (unsigned __int8)byte_196B10);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_go"
    ...
    v66);
  V_LOCK();
  logfmt_raw(v66, 0x1000u, 0, "check_asic_voltage_raw\t= %d", dword_196B14);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_go"
...
LABEL_28:
  ...
  if ( (unsigned int)(opt_algo - 11) > 1 )
  {
    ...
    if ( v65 > 0 )
    {
      ...
      {
        v51 = dev_ctrl(v49);
        (*(void (__fastcall **)(int))(v51 + 48))(j);
        v52 = sleep(1u);
        v53 = dev_ctrl(v52);
        (*(void (__fastcall **)(int))(v53 + 52))(j);
        v54 = usleep((__useconds_t)&loc_493E0);
        v55 = dev_ctrl(v54);
        (*(void (__fastcall **)(int))(v55 + 48))(j);
        v56 = sleep(1u);
        v57 = dev_ctrl(v56);
        (*(void (__fastcall **)(int))(v57 + 52))(j);
        v58 = usleep((__useconds_t)&loc_493E0);
        v59 = dev_ctrl(v58);
        v49 = (*(int (__fastcall **)(int))(v59 + 48))(j);
      }
    }
  }
  if ( byte_196B00 )
    ...
    if ( platform_is_pic_mcu_en() )
    {
      ...
      if ( device_num > 0 )
      {
        ...
        do
        {
          ...
          v19 = (*(int (__fastcall **)(int))(v18 + 60))(v17);
          read_feedback_voltage(v19);
          v20 = V_LOCK();
          v21 = dev_ctrl(v20);
          v22 = (*(int (__fastcall **)(int))(v21 + 60))(v17);
...
LABEL_44:
  ...
  if ( (unsigned int)(opt_algo - 11) <= 1 )
  {
    v23 = usleep((__useconds_t)&stru_186A0);
    if ( v65 > 0 )
    {
      for ( k = 0; k < v65; ++k )
      {
        v25 = dev_ctrl(v23);
        v23 = (*(int (__fastcall **)(int))(v25 + 48))(k);
      }
    }
    v26 = usleep((__useconds_t)&stru_186A0);
    if ( v65 > 0 )
    {
      for ( m = 0; m < v65; ++m )
      {
        v28 = dev_ctrl(v26);
        v26 = (*(int (__fastcall **)(int))(v28 + 52))(m);
      }
    }
    v29 = usleep((__useconds_t)&stru_186A0);
    if ( v65 > 0 )
    {
      for ( n = 0; n < v65; ++n )
      {
        v31 = dev_ctrl(v29);
        v29 = (*(int (__fastcall **)(int))(v31 + 48))(n);
      }
    }
    v32 = usleep((__useconds_t)&stru_186A0);
    if ( v65 > 0 )
    {
      for ( ii = 0; ii < v65; ++ii )
      {
        v34 = dev_ctrl(v32);
        v32 = (*(int (__fastcall **)(int))(v34 + 52))(ii);
      }
    }
    v35 = usleep((__useconds_t)&stru_186A0);
    if ( v65 > 0 )
    {
      for ( jj = 0; jj < v65; ++jj )
      {
        v37 = dev_ctrl(v35);
        v35 = (*(int (__fastcall **)(int))(v37 + 48))(jj);
      }
    }
  }
  return is_pic_mcu_en;
