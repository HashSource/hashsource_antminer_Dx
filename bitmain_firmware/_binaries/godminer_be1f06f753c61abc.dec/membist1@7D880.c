int __fastcall membist1(int a1)
{
  ...
  do
  {
    sub_790B8(a1, v20, 12, 1);
    usleep(0x61A80u);
    sub_790B8(a1, v20, 160, -2147483647);
    usleep(0xC3500u);
    memset(ptr, 0, 0x600u);
    v2 = sub_79354(a1, (unsigned __int16)v20, 161, ptr);
    if ( v2 == 8
      || (V_LOCK(),
...
LABEL_10:
    memset(ptr, 0, 0x600u);
    v5 = sub_79354(a1, (unsigned __int16)v20, 162, ptr);
    if ( v5 == 8
      || (V_LOCK(),
...
LABEL_18:
  ...
  while ( v8 != 8 );
  v11 = dev_ctrl(v10);
  ((void (__fastcall *)(_DWORD))v11[25])(*(_DWORD *)(a1 + 248));
  unk_1A3DC8 = s[0];
  unk_1A3DCC = s[1];
  unk_1A3DD0 = s[2];
  unk_1A3DD4 = s[3];
