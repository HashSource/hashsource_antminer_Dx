void __noreturn dag_gen_rvn_thread_func()
{
  ...
  while ( 1 )
  {
    ...
    V_LOCK();
    logfmt_raw((char *)v101, 0x1000u, 0, "cur_block_num enter: %llu", qword_196AC0);
    V_UNLOCK();
    zlog(
      g_zc,
    ...
    if ( v92 )
    {
      ...
      do
      {
        ...
        zlog(
          ...
          40,
          v101);
        v52 = sub_145CA4(qword_196AC0, 0x1D4Cu);
        v53 = *((_DWORD *)v49 + 1);
        v49 += 4;
        v54 = (__int64)qword_162940[v52] >> 8;
        v55 = HIDWORD(qword_162940[v52]) >> 8;
