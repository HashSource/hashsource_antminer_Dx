int __fastcall set_chain_mps_voltage(int a1, unsigned int a2)
{
  ...
  if ( a2 - 2350 > 0x12C )
  {
    if ( a2 <= 0xA59 )
      ...
      v4 = 2650;
    V_LOCK();
    logfmt_raw(v9, 0x1000u, 0, 1527612, v4, 2350, 2650);
    V_UNLOCK();
    v2 = v4;
    zlog(
      g_zc,
  ...
  {
    V_LOCK();
    logfmt_raw(v9, 0x1000u, 0, 1527672, v2);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
  ...
  else if ( sub_BB4B0(a1, 0)
         && (v6 = (int)(v2 - 490) / 10, src[0] = v6 & 0x1FF, sub_BB450(a1, 33, src, 2u))
         && sub_BB4B0(a1, 2)
         && (src[0] = (32 * v6) & 0x3FE0 | 0xC, sub_BB450(a1, 13, src, 2u)) )
  {
    return 0;
  }
  else
  {
    V_LOCK();
    logfmt_raw(v9, 0x1000u, 0, 1527708, a1);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
