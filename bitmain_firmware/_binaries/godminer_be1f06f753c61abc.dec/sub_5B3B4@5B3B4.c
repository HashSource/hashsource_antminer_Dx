int __fastcall sub_5B3B4(int a1, __int64 *a2)
{
  __int64 v2; // r2
  const char *v4; // r1
  __int64 *v6; // r3
  ...
  *(_DWORD *)&v24[87] = 0;
  V_LOCK();
  logfmt_raw((char *)v39, 0x1000u, 0, "start nonce: %08x", dword_196AD8);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  v12 = *(_BYTE *)v6;
  v13 = dword_196AD8 | (*(_DWORD *)(a1 + 248) << 22);
  *v7 = v12;
  v39[0] = v13;
  v24[70] = v13;
  ...
  v28 = v14;
  v17 = *((_DWORD *)a2 + 261);
  v18 = *(void (__fastcall **)(int, __int64 *))(a1 + 36);
  v29 = *((_DWORD *)a2 + 258);
  v30 = v15;
  v31 = v16;
  v32 = v17;
