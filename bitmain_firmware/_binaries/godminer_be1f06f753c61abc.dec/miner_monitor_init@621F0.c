int __fastcall miner_monitor_init(int a1)
{
  ...
  add_new_task(dword_198260, 401560, 1000);
  add_new_task(dword_198260, 401360, (int)"");
  add_new_task(dword_198260, 402996, 60000);
  dword_198264 = (int)new_task_timer();
  add_new_task(dword_198264, 401160, 5000);
  add_new_task(dword_198264, 400960, 1000);
  LOWORD(v12) = -2744;
