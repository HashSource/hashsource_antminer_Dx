int __fastcall stratum_set_diff_or_target_base(int a1, int a2, _DWORD *a3)
{
  ...
  if ( json_array_get(a3, 0) && *json_array_get(a3, 0) == 2 )
  {
    ...
    {
      V_LOCK();
      logfmt_raw((char *)v22, 0x1000u, 0, 1352708, "stratum_set_diff_or_target_base", v13);
      V_UNLOCK();
      zlog(
        g_zc,
...
LABEL_7:
  ...
  *(double *)(a2 + 1808) = v3;
  v8(a2 + 1488);
  V_LOCK();
  logfmt_raw((char *)v22, 0x1000u, 0, 1352732, "stratum_set_diff_or_target_base", v21, v3);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_go"
    "dminer-new/frontend/frontend_base.c",
    151,
    "stratum_set_diff_or_target_base",
    31,
    42,
