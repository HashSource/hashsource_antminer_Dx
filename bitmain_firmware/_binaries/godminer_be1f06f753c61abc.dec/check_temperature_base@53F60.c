...
LABEL_23:
        ...
        while ( 1 )
        {
          ...
          if ( *v14 != -64 )
          {
            v17 = *(_DWORD *)(*(_DWORD *)(all_created_runtime[v15] + 404) + v13 + 12);
            if ( !v17 )
            {
              v18 = &v60[4 * v38++];
              *((_DWORD *)v18 - 128) = v16;
              V_LOCK();
              V_INT((int)v48, "chain", *(int *)(all_created_runtime[v15] + 256));
              logfmt_raw(
                v60,
                0x1000u,
                0,
...
LABEL_22:
            ...
            if ( v17 == 1 )
            {
              ...
              *((_DWORD *)v37 - 64) = v16;
              V_LOCK();
              V_INT((int)v50, "chain", *(int *)(all_created_runtime[v15] + 256));
              logfmt_raw(
                v60,
                0x1000u,
                0,
...
LABEL_38:
        ...
        while ( 1 )
        {
          ...
          if ( !v29 )
          {
            ...
            {
              V_LOCK();
              V_INT((int)v54, "chain", *(int *)(*v40 + 256));
              logfmt_raw(
                v60,
                0x1000u,
                0,
          ...
          if ( v29 == 1 )
          {
            ...
            {
              V_LOCK();
              V_INT((int)v56, "chain", *(int *)(*v40 + 256));
              logfmt_raw(
                v60,
                0x1000u,
                0,
...
LABEL_29:
        ...
        V_LOCK();
        V_INT((int)v52, "chain", *(int *)(*v40 + 256));
        logfmt_raw(
          v60,
          0x1000u,
          0,
