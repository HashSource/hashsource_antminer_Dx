int __fastcall sub_C3390(int a1, int a2)
{
  int v3; // r7
  int *v4; // r11
  int v5; // r4
  ...
  zlog(
    ...
    "dminer-new/backend/device/hal/platform/7007/7007_ui.c",
    169,
    "gpio_ctrl_ui",
    12,
    277,
    20,
    v9);
  if ( pthread_mutex_lock(&stru_1B4500) )
  {
  ...
  if ( a2 == 1 )
  {
    sub_C31CC((int *)v3, (int *)dword_1B4518);
    v5 = gpio_write(v3, 0);
    pthread_mutex_unlock(&stru_1B4500);
  }
  else if ( a2 == 2 )
  {
    v7 = v3;
    ...
    {
      v5 = -1;
      if ( exists_c_map((int *)dword_1B4518, (int)&v7) )
      {
        ...
        zlog(
          ...
          "gin_godminer-new/backend/device/hal/platform/7007/7007_ui.c",
          169,
