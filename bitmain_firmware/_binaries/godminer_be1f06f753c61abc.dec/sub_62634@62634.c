int sub_62634()
{
  ...
  if ( v24 > 0 )
  {
    ...
    do
    {
      v2 = *(_DWORD *)(*((_DWORD *)v20 + 1) + 248);
      v20 += 4;
      v3 = &byte_1974D0[216 * v2];
      v4 = *((_QWORD *)v3 + 8);
      v5 = *((_QWORD *)v3 + 10);
      format_hashrate_string(*(const char **)(*(_DWORD *)(v23 + 72) + 16), v25);
      v6 = format_hashrate_string(*(const char **)(*(_DWORD *)(v23 + 72) + 16), v26);
      v7 = dev_ctrl(v6);
      v8 = (*(int (__fastcall **)(_DWORD))(v7 + 60))(*(_DWORD *)(*(_DWORD *)v20 + 248));
      LODWORD(v4) = snprintf(
                      v30,
                      0x1000u,
      ...
      v9 = snprintf(
             ...
             *(_DWORD *)v20 + 464,
             *(_DWORD *)(*(_DWORD *)v20 + 456),
             *(_DWORD *)(*(_DWORD *)v20 + 460),
             *(_DWORD *)(*(_DWORD *)v20 + 464),
             *(_DWORD *)(*(_DWORD *)v20 + 468),
             HIDWORD(v4));
      v10 = *(_DWORD *)v20;
      v11 = v4 + v9;
      v21 = *(_DWORD *)(*(_DWORD *)v20 + 352);
      if ( v21 > 0 )
      {
        v12 = 0;
        v19 = 0;
