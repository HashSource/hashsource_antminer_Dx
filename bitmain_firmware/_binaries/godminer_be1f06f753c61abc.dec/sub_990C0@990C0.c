int __fastcall sub_990C0(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, signed int *a6, _DWORD *a7)
{
  int v7; // r8
  int v12; // r11
  _DWORD *v13; // r7
  ...
  *(_DWORD *)(a3 + 12) = (*(_BYTE *)(a2 + 7) & 3)
  ...
  if ( v19 != v20 && *(_BYTE *)(a1 + 265) )
  {
    v23 = dword_1ABEF4;
    v24 = 274877907LL * (unsigned int)dword_1ABEF4++;
