int __fastcall main(int argc, const char **argv, const char **envp)
{
  ...
  while ( 1 )
  {
    v14 = EVPX_EncryptInit_ex(argc, (int)argv, "a:c:hl:p:Po:u:v:F", (const char **)&off_147930, 0);
    if ( v14 < 0 )
      break;
  ...
  V_LOCK();
  logfmt_raw(s, 0x1000u, 0, "opt_algo %d, %s", opt_algo, off_147478[opt_algo]);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_go"
  ...
  if ( !v12 )
  {
    ...
    logfmt_raw(
      ...
      "2.0.0_release_clean_master_02407a8dcb3ba67d09c39f48bef282a34fa1f935_May 28 2024 09:50:51");
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
...
LABEL_46:
    ...
    zlog(g_zc, v24, 138, "main", v25, v23, 100, s);
  }
  return v12;
}
