...
LABEL_86:
      V_LOCK();
      v76 |= 2u;
      V_INT((int)v141, v103, *(int *)(*(_DWORD *)v2 + 256));
...
LABEL_88:
        ...
        v118 = v76 | 4;
        v44 = v107;
        V_INT((int)v138, v103, *(int *)(v43 + 256));
...
LABEL_90:
      ...
      v52 = *(_DWORD *)v2;
      v107 = v118 | 8;
      V_INT((int)v135, v103, *(int *)(v52 + 256));
...
LABEL_92:
      V_LOCK();
      V_INT((int)v132, v103, *(int *)(*(_DWORD *)v2 + 256));
      V_STR(v131, s, v119);
      v60 = v131[1];
      v61 = v131[2];
      v62 = v131[3];
...
LABEL_24:
  ...
  if ( v128 > 0 )
  {
    ...
    {
      v15 = *v13++;
      v0 = (unsigned __int8)(v0 & *(_BYTE *)(v15 + 265));
    }
    while ( v14 != v13 );
  }
  v16 = 0;
...
LABEL_106:
      ...
      if ( v158[0] > 0 )
      {
        ...
        do
        {
          ...
          v74 = (*(int (**)(void))(v73 + 24))();
          v75 = dev_ctrl(v74);
          (*(void (__fastcall **)(_DWORD))(v75 + 32))(*(_DWORD *)(*(_DWORD *)v72 + 248));
        }
        while ( v70 < v158[0] );
      }
      power_off();
