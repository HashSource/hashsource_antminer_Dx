int __fastcall set_frequency_with_voltage_kas(int a1)
{
  ...
  zlog(
    ...
    "dminer-new/machine_runtime/kas_2380/machine_runtime_kas_2380.c",
    178,
...
LABEL_37:
  ...
  if ( v54 > 0 )
  {
    ...
    for ( k = 0; k < v54; ++k )
    {
      v41 = v39[1];
      ++v39;
      if ( api_get_eeprom_fmt_version(*(_DWORD *)(v41 + 248)) == 4
        && !api_get_eeprom_asic_freqs(*(_DWORD *)(*v39 + 248), dest, &v55) )
      {
        v42 = *v39;
        v43 = 0.0;
        v44 = *(_DWORD *)(*v39 + 352);
        if ( v44 )
        {
          ...
          do
          {
            ...
            v43 = v43 + v47;
            printf("%-6.1f ", v47);
            if ( (v45 & 0xF) == 0xF || (v42 = *v39, v44 = *(_DWORD *)(*v39 + 352), v44 - 1 == v45) )
            {
              putchar(10);
              v42 = *v39;
              v44 = *(_DWORD *)(*v39 + 352);
        ...
        v48 = v43 / (float)v44;
        *(_DWORD *)(v42 + 480) = (int)v48;
        *(float *)(v42 + 996) = (float)(int)v48;
