  ...
  else
  {
    ...
    *(_QWORD *)&total_rejected = __PAIR64__(v8, v11) + 1;
    ...
    else
    {
      ...
      v24 = 575;
      v25 = g_zc;
      LOWORD(v26) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tm"
                                      "p/release/build/godminer-origin_godminer-new/pool.c";
    }
    HIWORD(v26) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/rele"
                                "ase/build/godminer-origin_godminer-new/pool.c" >> 16;
    zlog(v25, v26, 133, "share_result", 12, v24, 80, v31);
    return 1;
  }
}
