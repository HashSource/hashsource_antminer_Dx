int __fastcall membist0(int a1)
{
  ...
  {
    V_LOCK();
    V_INT((int)v40, "chain", *(int *)(a1 + 256));
    v3 = *v38++;
    v35 = 0;
    logfmt_raw(
      v63,
    ...
    do
    {
      sub_790B8(v5, v35, 12, 1);
      sub_790B8(v5, v35, 160, 3);
      usleep((__useconds_t)&loc_61A80);
      v7 = sub_79354(v5, (unsigned __int16)v35, 161, ptr);
      if ( v7 == 8
        || (V_LOCK(),
            V_INT((int)v42, "chain", *(int *)(v5 + 256)),
            logfmt_raw(
              v63,
              0x1000u,
              0,
            ...
            v7 > 0) )
      {
        ...
        for ( j = 0; j < v7; ++j )
        {
          while ( (*v8 & 0x80) == 0 )
          {
            ...
            ++j;
            v8 += 3;
            V_INT((int)v46, "chain", *(int *)(v5 + 256));
            logfmt_raw(
              v63,
              0x1000u,
              0,
          ...
          {
            V_LOCK();
            V_INT((int)v44, "chain", *(int *)(v5 + 256));
            logfmt_raw(
              v63,
              0x1000u,
              0,
...
LABEL_11:
      memset(ptr, 0, 0x600u);
      v10 = sub_79354(v5, (unsigned __int16)v35, 162, ptr);
      if ( v10 == 8
        || (V_LOCK(),
            V_INT((int)v48, "chain", *(int *)(v5 + 256)),
            logfmt_raw(
              v63,
              0x1000u,
              0,
            ...
            v10 > 0) )
      {
        ...
        for ( k = 0; k < v10; ++k )
        {
          while ( (*v11 & 0x80) == 0 )
          {
            ...
            ++k;
            v11 += 3;
            V_INT((int)v52, "chain", *(int *)(v5 + 256));
            logfmt_raw(
              v63,
              0x1000u,
              0,
          ...
          {
            V_LOCK();
            V_INT((int)v50, "chain", *(int *)(v5 + 256));
            logfmt_raw(
              v63,
              0x1000u,
              0,
...
LABEL_19:
      memset(ptr, 0, 0x600u);
      v13 = sub_79354(v5, (unsigned __int16)v35, 163, ptr);
      if ( v13 == 8
        || (V_LOCK(),
            V_INT((int)v54, "chain", *(int *)(v5 + 256)),
            logfmt_raw(
              v63,
              0x1000u,
              0,
            ...
            v13 > 0) )
      {
        ...
        do
        {
          ...
          V_LOCK();
          v15 += 3;
          V_INT((int)v56, "chain", *(int *)(v5 + 256));
          logfmt_raw(
            v63,
            0x1000u,
            0,
...
LABEL_26:
  ...
  do
  {
    ...
    do
    {
      ...
      v32 += v21;
      v34 += v22;
      V_INT((int)v58, "chain", *((int *)v36 + 64));
      v28 = v19++;
      logfmt_raw(
        v63,
        0x1000u,
  ...
  while ( useconds != 20 );
  v24 = dev_ctrl(v23);
  ((void (__fastcall *)(_DWORD))v24[25])(*((_DWORD *)v36 + 62));
  return 0;
}
