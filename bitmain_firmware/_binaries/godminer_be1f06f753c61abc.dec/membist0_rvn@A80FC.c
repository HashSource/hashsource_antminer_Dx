int __fastcall membist0_rvn(int a1)
{
  ...
  do
  {
    ...
    {
      sub_A47C4(a1, n, 28, 1);
      sub_A47C4(a1, n, 160, 3);
      usleep((__useconds_t)&loc_61A80);
      v3 = ptr;
      v4 = sub_A4B38(a1, (unsigned __int16)n, 161, ptr);
      if ( v4 > 0 )
      {
        v5 = &ptr[12 * v4];
        do
...
LABEL_10:
      v6 = ptr;
      v7 = sub_A4B38(a1, (unsigned __int16)n, 162, ptr);
      if ( v7 > 0 )
      {
        v8 = &ptr[12 * v7];
        do
...
LABEL_16:
      v10 = ptr;
      v11 = sub_A4B38(a1, (unsigned __int16)n, 163, ptr);
      if ( v11 > 0 )
      {
        v12 = &ptr[12 * v11];
        do
...
LABEL_22:
  ...
  while ( &s[20] != v14 );
  v21 = dev_ctrl(v20);
  ((void (__fastcall *)(_DWORD))v21[25])(*(_DWORD *)(a1 + 248));
  return 0;
}
