int check_pool_connect()
{
  ...
  if ( check_pools_valid() > 0 )
    return 0;
  V_LOCK();
  logfmt_raw(v9, 0x1000u, 0, 1471004);
  V_UNLOCK();
  zlog(
    g_zc,
    ...
    v9);
  V_LOCK();
  logfmt_raw(v9, 0x1000u, 0, 1471064);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_go"
    ...
    v9);
  V_LOCK();
  logfmt_raw(v9, 0x1000u, 0, 1471140);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_go"
  ...
  V_LOCK();
  logfmt_raw(v9, 0x1000u, 0, 1470936);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_go"
  ...
  V_LOCK();
  logfmt_raw(v9, 0x1000u, 0, 1471268);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_go"
