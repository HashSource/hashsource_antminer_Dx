int ui_init()
{
  ...
  gpio_export(921);
  gpio_export(943);
  gpio_reg_callback(921, 799528);
  gpio_reg_callback(943, 799528);
  ...
  dword_1B4528 = 0;
  dword_1B452C = 0;
  dword_1B4518 = (int)new_c_map(798868, 0, 0);
  dword_1B44FC[0] = 1;
  pthread_create((pthread_t *)&dword_1B4534, 0, (void *(*)(void *))sub_C30A4, 0);
  dword_1B4530 = 1;
  return 0;
}
