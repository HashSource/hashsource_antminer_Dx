int __fastcall stratum_subscribe_base(int a1, int *a2)
{
  ...
  do
  {
    ...
    {
      v11 = "{\"id\": 1, \"method\": \"mining.subscribe\", \"params\": [\"GodMiner/2.0.1\", null]}";
      v12 = 76;
    }
    memcpy(v9, v11, v12);
    if ( !(*(int (__fastcall **)(int *, _BYTE *))(a1 + 12))(a2, v10) )
    {
      ...
      v13 = 190;
      v14 = g_zc;
      LOWORD(v15) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tm"
                                      "p/release/build/godminer-origin_godminer-new/frontend/frontend_base.c";
LABEL_11:
      HIWORD(v15) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/re"
                                  "lease/build/godminer-origin_godminer-new/frontend/frontend_base.c" >> 16;
      zlog(v14, v15, 151, "stratum_subscribe_base", 22, v13, 100, v37);
LABEL_12:
      if ( !v10 )
      {
        if ( !v5 )
