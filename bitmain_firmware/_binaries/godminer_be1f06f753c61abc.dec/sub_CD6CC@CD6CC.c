int __fastcall sub_CD6CC(int a1, int a2, int a3, int *a4, unsigned __int64 a5)
{
  ...
  sub_145CA4(a5, 0x3E8u);
  v9 = 0;
  v22[1] = (_DWORD)&loc_F4240 * v10;
  v22[0] = sub_145CA4(a5, 0x3E8u);
  while ( a2 > v9 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(*(_DWORD *)(a1 + 884), (char *)&v23, 0x4Au, v22) == 110 )
      {
        v8 = 3;
        goto LABEL_10;
      }
