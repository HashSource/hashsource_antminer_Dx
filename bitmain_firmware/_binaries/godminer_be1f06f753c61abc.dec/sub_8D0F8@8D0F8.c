int __fastcall sub_8D0F8(int a1, int a2)
{
  _DWORD *v2; // r6
  int v3; // r2
  int *v5; // r10
...
LABEL_4:
      *(v5 - 1) = v7;
      ...
      v10 = v2[3];
      v11 = v2[4];
      v12 = *(void (__fastcall **)(int, int *, int *, _DWORD, int, int, int, int, _DWORD))(a1 + 160);
      v32 = 0;
...
LABEL_6:
      *v5 = v13;
      v14 = v29;
      v15 = v6 + 2 * *(_DWORD *)(a1 + 248);
      v16 = v13 - *(unsigned __int8 *)(a1 + 1008) - v29;
      v17 = v15;
      if ( v16 < 0 )
        v16 = v29 - (v13 - *(unsigned __int8 *)(a1 + 1008));
      v18 = dword_1939C0[v15];
      v19 = v16 <= 3;
      v20 = dword_1939C0[v17 + 6];
      if ( v19 )
        goto LABEL_18;
      v21 = v18 == -64;
      if ( v18 == -64 )
      ...
      if ( v22 > v23 )
      {
        ...
        zlog(
          ...
          v45);
        v13 = v30;
        v14 = v30 - *(unsigned __int8 *)(a1 + 1008);
        *(v5 - 1) = v14;
        v27 = *(_DWORD *)(a1 + 248);
        v29 = v14;
LABEL_32:
      ...
      if ( v22 < v23 )
      {
        ...
        zlog(
          ...
          v45);
        v14 = v29;
        v13 = *(unsigned __int8 *)(a1 + 1008) + v29;
        *v5 = v13;
        v30 = v13;
        v27 = *(_DWORD *)(a1 + 248);
        goto LABEL_32;
...
LABEL_18:
      ++v6;
      if ( v18 != v14 )
        dword_1939C0[v15] = v14;
      if ( v20 != v13 )
        dword_1939C0[v17 + 6] = v13;
      v2 += 6;
      v5 += 2;
    }
    while ( v28 != v6 );
