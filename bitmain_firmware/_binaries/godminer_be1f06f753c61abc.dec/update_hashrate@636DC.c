  ...
  if ( v6 <= 16 )
  {
    ...
    if ( v9 >= 5.0 )
    {
      ...
      else
      {
        ...
        v38 = COERCE_FLOAT(sub_145B78(v37));
        v25 = v38 * (float)(COERCE_FLOAT(sub_145B78(v43)) / v9);
      }
      V_LOCK();
      logfmt_raw(
        v56,
      ...
      *((float *)&unk_198618 + 724 * v6 + v26[720]) = v25;
      ...
      v26[720] = v30 % 720;
      v32 = v25 + (float)(COERCE_FLOAT(sub_145B78(v29)) * *(float *)(a2 + 44));
      *(float *)(a2 + 44) = v32 / COERCE_FLOAT(sub_145B78(v31));
      *((_QWORD *)v26 + 361) = v31;
    }
    sub_63640((int)v39);
    *(float *)(a2 + 32) = 5.0;
