unsigned int __fastcall phy_rx_adapt(int a1, unsigned int a2, unsigned int a3)
{
  ...
  zlog(
    ...
    60,
    v21);
  sub_7FA1C(a1, a3, 84, -1);
  v7 = sub_7FCBC(a1, a2, (unsigned __int16)a3, 84, v6);
  if ( v7 )
  {
    v8 = (unsigned int *)v6;
    v9 = 0;
  ...
  sub_7FA1C(a1, a3, 84, -16711936);
  v11 = sub_7FCBC(a1, a2, (unsigned __int16)a3, 84, v6);
  if ( v11 )
  {
    v8 = (unsigned int *)v6;
    v12 = 0;
...
LABEL_18:
  sub_7FA1C(a1, a3, 100, (int)&loc_F000C + 3);
  v13 = sub_7FCBC(a1, a2, (unsigned __int16)a3, 100, v6);
  if ( v13 )
  {
    v8 = (unsigned int *)v6;
    v14 = 0;
...
LABEL_24:
  sub_7FA1C(a1, a3, 80, 1966110);
  v15 = sub_7FCBC(a1, a2, (unsigned __int16)a3, 80, v6);
  if ( v15 )
  {
    v8 = (unsigned int *)v6;
    v16 = 0;
...
LABEL_30:
  ...
  v17 = sub_7FCBC(a1, a2, (unsigned __int16)a3, 80, v6);
  if ( v17 )
  {
    v8 = (unsigned int *)v6;
    v18 = 0;
...
LABEL_36:
  ...
  sub_7FA1C(a1, a3, 84, -1);
  v19 = sub_7FCBC(a1, a2, (unsigned __int16)a3, 84, v6);
  if ( v19 )
  {
    v8 = (unsigned int *)v6;
    v20 = 0;
