  ...
  if ( !*(_BYTE *)(a1 + 914) )
  {
    while ( 1 )
    {
      ...
      if ( s[1] == 85 )
      {
        ...
        v9 = (*(int (__fastcall **)(_DWORD))(a1 + 176))((unsigned __int8)s[2]);
        queue_dequeue(v4, &s[3], v9);
        v10 = v9 + 3;
        check_and_print_uart_debug_log(a1 + 1040, v10, (unsigned __int8 *)s, *(_DWORD *)(a1 + 256), v18);
        v11 = *(unsigned __int8 *)(a1 + 914);
        if ( *(_BYTE *)(a1 + 914) )
          break;
        memset(v5, *(unsigned __int8 *)(a1 + 914), *(_DWORD *)(a1 + 848));
        v20 = v11;
        v21 = v11;
        v19 = v11;
        if ( (*(int (__fastcall **)(int, char *, void *, char *, void *, int *, int *))(a1 + 72))(
               ...
               &v20,
               &v21) == 10
          && !queue_enqueue(*(_DWORD *)(a1 + 884), s, v10)
          && v17 <= ++v16 )
        {
          V_LOCK();
          logfmt_raw(
          ...
          zlog(
            ...
            "rigin_godminer-new/backend/backend_base.c",
            149,
            "scanhash_1",
            10,
            174,
      ...
      v15 = *(_BYTE *)(a1 + 914);
      s[0] = s[1];
      check_and_print_uart_debug_log(a1 + 1040, 2, (unsigned __int8 *)s, v8, v15);
    }
  }
LABEL_5:
  *(_BYTE *)(a1 + 914) = 0;
