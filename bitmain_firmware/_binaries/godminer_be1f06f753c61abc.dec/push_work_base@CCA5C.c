int __fastcall push_work_base(int a1, int a2)
{
  ...
  while ( v6 < v11 );
  v8 = dev_ctrl(v6);
  v9 = ((int (__fastcall *)(_DWORD, unsigned __int8 *, unsigned int))v8[16])(*(_DWORD *)(a1 + 248), v5, v11);
  pthread_mutex_unlock(v4);
  check_and_print_uart_debug_log(a1 + 1112, v11, v5, *(_DWORD *)(a1 + 256), 1);
  if ( v9 <= 0 )
  {
    V_LOCK();
    logfmt_raw(v12, 0x1000u, 0, "device %d push work failed,errcode %d", *(_DWORD *)(a1 + 248), v9);
    V_UNLOCK();
    zlog(
      g_zc,
