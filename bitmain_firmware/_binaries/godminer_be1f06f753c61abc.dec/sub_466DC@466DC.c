bool __fastcall sub_466DC(int a1, int *a2, _DWORD *a3)
{
  _BOOL4 v4; // r4
  _DWORD *v7; // r0
  const char *v8; // r5
              ...
              if ( v4 )
              {
                ...
                if ( v4 )
                {
                  ...
                  if ( v4 )
                  {
                    ...
                    if ( memcmp(v27, &dword_196600, 0x20u) )
                    {
                      dword_196600 = *(_DWORD *)v27;
                      memset(dest, 0, sizeof(dest));
                      memset(&algn_196604[28], 0, 0x20u);
                      memset(v91, 0, 0xF0u);
                      hs_blake2b_init(v91, 32);
                      hs_blake2b_update((int)v91, v27, 0x20u);
                      hs_blake2b_update((int)v91, dest, 0x20u);
                      hs_blake2b_final((int)v91, &algn_196604[28], 0x20u);
                    }
                    v29 = a2 + 116;
                    v30 = a2[19];
                    ...
                    while ( &algn_196604[28] != (_BYTE *)v49 );
                    v52 = &sa[v85];
                    v53 = 0;
                    while ( 1 )
                    {
