int __fastcall sub_65984(_DWORD *a1)
{
  _DWORD *v1; // r0
  _DWORD *v2; // r7
  _DWORD *v3; // r0
...
LABEL_45:
  ...
  zlog(
    ...
    20,
    v77);
  dword_1B593C = json_integer_value(v4);
  ...
  if ( v6 && *v6 == 3 )
  {
    ...
    zlog(
      ...
      20,
      v77);
    dword_1B5940 = json_integer_value(v7);
    ...
    if ( v9 && *v9 == 3 )
    {
      ...
      zlog(
        ...
        20,
        v77);
      dword_1B5944 = json_integer_value(v10);
      ...
      if ( v12 && *v12 == 3 )
      {
        ...
        zlog(
          ...
          20,
          v77);
        dword_1B5948 = json_integer_value(v13);
        ...
        if ( v15 && *v15 == 3 )
        {
          ...
          zlog(
            ...
            20,
            v77);
          dword_1B594C = json_integer_value(v16);
          ...
          if ( v18 && *v18 == 3 )
          {
            ...
            zlog(
              ...
              20,
              v77);
            dword_1B5950 = json_integer_value(v19);
            ...
            if ( v21 && *v21 == 3 )
            {
              ...
              zlog(
                ...
                20,
                v77);
              dword_1B5954 = json_integer_value(v22);
              ...
              if ( v24 && *v24 == 3 )
              {
                ...
                zlog(
                  ...
                  20,
                  v77);
                dword_1B5958 = json_integer_value(v25);
                ...
                if ( v27 && *v27 == 3 )
                {
                  ...
                  zlog(
                    g_zc,
                    "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/go"
                    ...
                    20,
                    v77);
                  dword_1B595C = json_integer_value(v28);
                  ...
                  if ( v30 && *v30 == 3 )
                  {
                    ...
                    if ( v36 && *v36 == 3 )
                    {
                      ...
                      if ( v42 && *v42 == 3 )
                      {
                        ...
                        zlog(
                          g_zc,
                          "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/bu"
                        ...
                        if ( v48 && *v48 == 3 )
                        {
                          ...
                          zlog(
                            g_zc,
                            "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/"
                          ...
                          if ( v54 && *v54 == 1 )
                          {
                            ...
                            zlog(
                              g_zc,
                              "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/releas"
                            ...
                            dword_1B5970 = (int)calloc((size_t)v55, 0xCu);
                            if ( !dword_1B5970 )
                            {
                              V_LOCK();
                              ...
                              zlog(
                                g_zc,
                                "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/rele"
                            ...
                            while ( 1 )
                            {
                              ...
                              zlog(
                                ...
                                20,
                                v77);
                              *(_DWORD *)(dword_1B5970 + v56) = json_integer_value(v61);
                              ...
                              zlog(
                                ...
                                20,
                                v77);
                              *(_DWORD *)(dword_1B5970 + v56 + 8) = json_integer_value(v64);
