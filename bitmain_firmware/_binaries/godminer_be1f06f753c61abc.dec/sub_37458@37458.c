    ...
    case 0:
      ...
      if ( (v11 & 0x80) == 0 )
      {
        ...
        while ( 1 )
        {
          ...
          v26 = strlen(v25);
          sub_370C8(v25, v26, (int (__fastcall *)(const char *, int, int))a5, a6, v9);
          v27 = a5(v42, v22, a6) == 0;
          v28 = v23;
          v23 = v24;
          if ( !v27 )
          ...
          if ( sub_37458(v29, v9, v49, v7, a5, a6) )
            return -1;
          if ( !v24 )
          {
            v8 = (int)base;
            v14 = 0;
            if ( !sub_37350(v9, v45, 0, a5, a6) )
              goto LABEL_65;
            return -1;
          }
          if ( a5(&word_1471EC, 1, a6) || sub_37350(v9, v49, 1, a5, a6) )
            return -1;
        }
      }
      ...
      while ( v35 );
      v7 = v52;
      qsort(basea, nmemb, 4u, (__compar_fn_t)sub_370BC);
      if ( nmemb )
      {
        v54 = v8;
        v37 = v53;
        ...
        do
        {
          ...
          v41 = strlen(v39);
          sub_370C8(v39, v41, (int (__fastcall *)(const char *, int, int))a5, a6, v9);
          if ( a5(v42, v44, a6) || sub_37458(v40, v9, v49, v52, a5, a6) )
          {
LABEL_70:
            v14 = -1;
            jsonp_free(basea);
          ...
          else if ( sub_37350(v9, a3, 0, a5, a6) )
          {
            goto LABEL_70;
          }
        }
...
LABEL_47:
    ...
    case 2:
      ...
      return sub_370C8(v16, (int)v17, (int (__fastcall *)(const char *, int, int))a5, a6, v9);
    case 3:
  ...
  do
  {
    ...
    v14 = sub_37458(v32, v9, v31, v7, a5, a6);
    if ( v14 )
      return -1;
    v33 = (unsigned int)v43 - 1 > v30++;
    if ( v33 )
    {
      if ( a5(&word_1471EC, 1, a6) || sub_37350(v9, v31, 1, a5, a6) )
        return -1;
    }
    else if ( sub_37350(v9, v46, 0, a5, a6) )
    {
      return -1;
    }
  }
