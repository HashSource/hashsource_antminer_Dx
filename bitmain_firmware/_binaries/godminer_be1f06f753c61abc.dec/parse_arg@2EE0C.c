  ...
  if ( result > 117 )
  {
    if ( result > 1033 )
    {
      if ( result == 1035 )
      {
        ...
        result = zlog(
                   g_zc,
                   "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/god"
    ...
    if ( result > 99 )
    {
      ...
      else
      {
        if ( result == 111 )
        {
          ...
          v15 = 259;
          v16 = g_zc;
          LOWORD(v17) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroo"
        ...
        if ( result == 112 )
        {
          ...
          LOWORD(v17) = 31532;
LABEL_62:
          HIWORD(v17) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tm"
                                      "p/release/build/godminer-origin_godminer-new/god-miner.c" >> 16;
          return zlog(v16, v17, 138, "parse_arg", 9, v15, v14, v27);
        }
      }
      goto LABEL_19;
    }
