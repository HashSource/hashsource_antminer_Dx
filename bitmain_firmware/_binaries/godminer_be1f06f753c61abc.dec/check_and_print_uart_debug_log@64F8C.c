  ...
  *(_QWORD *)(v7 + 32) = v15 - 1;
  ...
  if ( *(_BYTE *)(v7 + 40) )
  {
    ...
    if ( a5 )
    {
      ...
      LOWORD(v22) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tm"
                                      "p/release/build/godminer-origin_godminer-new/backend/uart_debug_logger.c";
    }
    else
    {
    ...
    HIWORD(v22) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/rele"
                                "ase/build/godminer-origin_godminer-new/backend/uart_debug_logger.c" >> 16;
    return zlog(v20, v22, 154, v21, 30, v19, 40, _478);
  }
  return result;
}
