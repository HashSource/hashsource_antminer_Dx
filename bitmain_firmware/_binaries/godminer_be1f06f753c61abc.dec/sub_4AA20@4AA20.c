int __fastcall sub_4AA20(int a1, int *a2)
{
  int v2; // r7
  double *v5; // r6
  void *v6; // r9
...
LABEL_3:
      HIWORD(v9) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/rel"
                                 "ease/build/godminer-origin_godminer-new/frontend/frontend_ks5/frontend_ks5.c" >> 16;
      zlog(v8, v9, 163, "stratum_subscribe_ks5", 21, v7, 100, v32);
      free(v16);
      if ( !v5 )
        goto LABEL_11;
      goto LABEL_4;
