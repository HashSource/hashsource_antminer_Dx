  ...
  if ( !*(_BYTE *)(a1 + 912) )
  {
    while ( 1 )
    {
      ...
      if ( s[1] == 85 )
      {
        ...
        v8 = (*(int (__fastcall **)(_DWORD))(a1 + 176))((unsigned __int8)s[2]);
        v9 = v8 + 3;
        queue_dequeue(v4, &s[3], v8);
        check_and_print_uart_debug_log(a1 + 1040, v9, (unsigned __int8 *)s, *(_DWORD *)(a1 + 256), 0);
        v10 = *(unsigned __int8 *)(a1 + 912);
        if ( *(_BYTE *)(a1 + 912) )
          break;
        memset(v5, *(unsigned __int8 *)(a1 + 912), *(_DWORD *)(a1 + 848));
        v29 = v10;
        v30 = v10;
        v28 = v10;
        v11 = (*(int (__fastcall **)(int, char *, void *, char *, char *, int *, int *))(a1 + 72))(
                a1,
                s,
                v5,
                &v28,
        ...
        if ( v11 == 10 )
        {
          if ( !queue_enqueue(*(_DWORD *)(a1 + 884), s, v9) )
          {
            v17 = v27 > ++v26;
            if ( !v17 )
            {
        ...
        else if ( !v11 && *(_BYTE *)(a1 + 265) )
        {
          if ( !*(_BYTE *)(a1 + v30 + 552) && v28 && platform_check_repeat_nonce((int *)a1, v29, ptr) )
          {
            ++*(_QWORD *)(*(_DWORD *)(a1 + 472) + 48 * v29 + 32);
          }
          else
          {
            v12 = (*(int (__fastcall **)(int, void *))(a1 + 76))(a1, v5);
            if ( v12 <= 5 )
            {
              v13 = v29;
              v14 = (_QWORD *)(*(_DWORD *)(a1 + 472) + 8 * v12 + 48 * v29);
              ++*v14;
              if ( v12 <= 1 )
              {
                v15 = *(_QWORD *)(a1 + 464) + 1LL;
                ++*(_DWORD *)(*(_DWORD *)(a1 + 496) + 4 * v13);
                v16 = v30;
                *(_QWORD *)(a1 + 464) = v15;
                ++*(_QWORD *)(a1 + 8 * v16 + 584);
                if ( !v12
                  && !*(_BYTE *)(a1 + v16 + 552)
                  && !queue_enqueue(*(_DWORD *)(*(_DWORD *)(a1 + 888) + 880), (char *)v5, 1) )
                {
                  v17 = v25 > ++v24;
                  if ( !v17 )
                  {
      ...
      v22 = *(_BYTE *)(a1 + 912);
      s[0] = s[1];
      check_and_print_uart_debug_log(a1 + 1040, 2, (unsigned __int8 *)s, v7, v22);
    }
  }
LABEL_5:
  *(_BYTE *)(a1 + 912) = 0;
