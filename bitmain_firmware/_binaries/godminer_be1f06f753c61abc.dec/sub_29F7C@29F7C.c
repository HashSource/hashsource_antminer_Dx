        ...
        int a13)
{
  ...
  *(_DWORD *)v53 = 0;
  ...
  format_hashrate_string(*(const char **)(*(_DWORD *)(v48 + 72) + 16), v58);
  format_hashrate_string(*(const char **)(*(_DWORD *)(v48 + 72) + 16), v59);
  format_hashrate_string(*(const char **)(*(_DWORD *)(v48 + 72) + 16), v60);
  format_hashrate_string(*(const char **)(*(_DWORD *)(v48 + 72) + 16), v61);
  v27 = v23;
  format_hashrate_double(*(const char **)(*(_DWORD *)(v48 + 72) + 16), &v51, v52);
  v28 = v64;
  ...
  if ( v32 )
    JUMPOUT(0x2AD1C);
  sub_14598C((__int64)(v28 * v27 * 100.0));
  v33 = json_real();
  json_object_set_new(v24, "GHS 5s", v33);
  sub_14598C((__int64)(*(float *)&v27 * v31 * 100.0));
  v34 = json_real();
  json_object_set_new(v24, "GHS av", v34);
  sub_14598C((__int64)(*(float *)&v27 * v30 * 100.0));
  v35 = json_real();
  json_object_set_new(v24, "rate_30m", v35);
  sub_14598C((__int64)(v51 * 100.0));
  v36 = json_real();
