int __fastcall sub_58400(_DWORD *a1, __int64 *a2)
{
  __int64 v2; // r2
  const char *v5; // r1
  int v6; // r12
  ...
  v6 = a1[62];
  v23[120] = dword_1968E8;
  v23[121] = BYTE1(dword_1968E8) | ((_BYTE)v6 << 6);
  ...
  v35 = v13;
  V_LOCK();
  logfmt_raw(v42, 0x1000u, 0, "start nonce: %08x target_diff: %d", dword_1968E8, v27);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  v17 = *((_DWORD *)a2 + 277);
  v18 = *((_DWORD *)a2 + 278);
  v19 = (void (__fastcall *)(_DWORD *, __int64 *))a1[9];
  v36 = v15;
  v37 = v16;
  v38 = v17;
  v39 = v18;
