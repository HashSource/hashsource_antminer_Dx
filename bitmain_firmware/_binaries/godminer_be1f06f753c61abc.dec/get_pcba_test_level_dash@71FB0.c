...
LABEL_2:
  ...
  v6 = dev_ctrl((int)a1);
  v7 = ((int (__fastcall *)(_DWORD, int, int, int *))v6[26])(a1[62], 52, 393216, &v17);
  if ( !v7 )
  {
    v8 = (unsigned __int16 *)&unk_16B1CC;
    v9 = 700;
    v10 = (unsigned __int16)v17;
    v11 = HIWORD(v17);
    for ( i = (unsigned __int16 *)&unk_16B1CC; ; v9 = i[2] )
    {
...
LABEL_21:
    V_LOCK();
    V_INT((int)v22, "chain", (int)a1[64]);
    v16 = &aGlobalIdxInitD_1[10 * a1[251] - 10];
    logfmt_raw(
      v24,
      0x1000u,
      0,
