int __fastcall stratum_authorize_eth(int a1, int *a2)
{
  ...
  {
    V_LOCK();
    logfmt_raw((char *)v27, 0x1000u, 0, 1356960, a2[6]);
    V_UNLOCK();
    zlog(
      g_zc,
  ...
  V_LOCK();
  logfmt_raw((char *)v27, 0x1000u, 0, 1356824);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  V_LOCK();
  logfmt_raw((char *)v27, 0x1000u, 0, 1356920);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_go"
...
LABEL_4:
  ...
  if ( !v13 )
  {
    V_LOCK();
    v9 = 0;
    logfmt_raw((char *)v27, 0x1000u, 0, 1352808, s[0], v26);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
