int sub_32DBC()
{
  ...
  if ( dword_195B9C > 0 )
  {
    ...
    do
    {
      v5 = sub_3202C();
      ++v4;
      sub_319F0((void **)(v5 + 12), (_BYTE *)(v5 + 28), v3);
      set_user(v3 + 256);
      v6 = v3 + 512;
      v3 += 768;
      set_pass(v6);
    }
    while ( dword_195B9C > v4 );
  }
  if ( total_pools == v43 )
  {
    V_LOCK();
  ...
  zlog(
    ...
    v46);
  sleep(5u);
  v31 = (unsigned __int8)byte_195B98;
  if ( byte_195B98 )
  {
...
LABEL_57:
    ...
    v41 = pthread_create((pthread_t *)&dword_1B512C, &attr, (void *(*)(void *))watchpool_thread, &dword_1B5128);
