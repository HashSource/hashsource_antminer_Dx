...
LABEL_6:
    ...
    {
      v14 = *++v13;
      sub_AEC9C(a1, v14, 133, 0xFFFF);
      sub_AEC9C(a1, *v13, 134, 1342177279);
    }
    while ( v10 != v13 );
    sub_AEC58(a1, 132, -2147483647);
    sleep(0xAu);
    do
    {
      while ( 1 )
...
LABEL_31:
  ...
  free(ptr);
  v37 = *(_QWORD *)&dword_1B4000;
  v38 = &s[1];
  v39 = *(_QWORD *)&dword_1B4008;
  for ( i = &v70[1]; ; ++i )
  {
    v37 += v36;
    v39 += a4;
  ...
  *(_QWORD *)&dword_1B4000 = v37;
  *(_QWORD *)&dword_1B4008 = v39;
  V_LOCK();
  ...
  zlog(
    ...
    v71);
  V_LOCK();
  V_INT((int)&v66, "chain", *(int *)(a1 + 256));
  logfmt_raw(
    v71,
    0x1000u,
    0,
