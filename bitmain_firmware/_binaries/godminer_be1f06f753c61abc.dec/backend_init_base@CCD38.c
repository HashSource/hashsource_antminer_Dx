int __fastcall backend_init_base(int a1)
{
  ...
  *(_DWORD *)(a1 + 256) = v3;
  v4 = dev_ctrl(v3);
  v5 = ((int (__fastcall *)(_DWORD))v4[14])(*(_DWORD *)(a1 + 248));
  v6 = dev_ctrl(v5);
  ((void (__fastcall *)(_DWORD))v6[1])(*(_DWORD *)(a1 + 248));
  ...
  *(_BYTE *)(a1 + 916) = 0;
  if ( v16 )
    v16(a1);
  pthread_create((pthread_t *)(a1 + 900), 0, (void *(*)(void *))get_response, (void *)a1);
  pthread_create((pthread_t *)(a1 + 892), 0, (void *(*)(void *))scanhash, (void *)a1);
  pthread_create((pthread_t *)(a1 + 908), 0, (void *(*)(void *))send_work, (void *)a1);
  *(_BYTE *)(a1 + 260) = 1;
  return 0;
}
