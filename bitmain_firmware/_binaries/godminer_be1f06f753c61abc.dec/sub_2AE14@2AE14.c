int __fastcall sub_2AE14(_DWORD *a1, int a2)
{
  int v4; // r0
  bool v5; // zf
  int v6; // r5
  ...
  {
    v6 = v4;
    sub_25FCC(a1, 1, 11, *(const char **)(a2 + 8));
    v69 = json_array();
    v7 = json_object();
    ...
    LODWORD(v15) = sub_14598C(total_accepted);
    v70 = v11 * v9;
    v16 = v15;
    if ( v9 != 0.0 )
      v16 = v15 / v9;
    ...
    if ( v20 )
    {
      sub_14598C((__int64)(v10 * v9 * 100.0));
      v65 = json_real();
      json_object_set_new(v7, "GHS 5s", v65);
      sub_14598C((__int64)(v17 * 100.0));
      v66 = json_real();
      json_object_set_new(v7, "GHS av", v66);
      sub_14598C((__int64)(v70 * 100.0));
    }
    else
    {
      sub_14598C((__int64)(v13 * v9 * 100.0));
      v21 = json_real();
      json_object_set_new(v7, "GHS 5s", v21);
      sub_14598C((__int64)(*(float *)&v9 * v17 * 100.0));
      v22 = json_real();
      json_object_set_new(v7, "GHS av", v22);
      sub_14598C((__int64)(*(float *)&v9 * v70 * 100.0));
    }
    v23 = json_real();
    json_object_set_new(v7, "GHS 30m", v23);
    v24 = json_integer((unsigned int)dword_195880);
    ...
    sub_14598C((__int64)(dbl_195888 * 100.0));
    v36 = json_real();
    json_object_set_new(v7, "Total MH", v36);
    v37 = json_real();
    json_object_set_new(v7, "Work Utility", v37);
    sub_14598C((__int64)(total_diff_accepted * 100.0));
    v38 = json_real();
    json_object_set_new(v7, "Difficulty Accepted", v38);
    sub_14598C((__int64)(total_diff_rejected * 100.0));
    v39 = json_real();
    json_object_set_new(v7, "Difficulty Rejected", v39);
    sub_14598C((__int64)(total_diff_stale * 100.0));
    v40 = json_real();
    json_object_set_new(v7, "Difficulty Stale", v40);
    v41 = json_integer(*(__int64 *)&dword_195890);
    json_object_set_new(v7, "Best Share", v41);
    v67 = v68 + total_diff1;
    if ( v68 + total_diff1 )
    {
      LODWORD(v63) = sub_14597C(v68);
      HIDWORD(v63) = v62;
      LODWORD(v64) = sub_14597C(v67);
      sub_14598C((__int64)(v63 / v64 * 100.0));
    }
    v42 = json_real();
    json_object_set_new(v7, "Device Hardware%", v42);
    if ( total_diff1 )
    {
      LODWORD(v43) = sub_14598C(total_diff1);
      sub_14598C((__int64)(total_diff_rejected / v43 * 100.0));
    }
    v44 = json_real();
