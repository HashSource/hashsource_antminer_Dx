int __fastcall check_nonce_ks5(int a1, int a2)
{
  ...
  if ( v2 <= 0x23 )
  {
    ...
    v22 = 527;
    v23 = g_zc;
    LOWORD(v24) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/"
                                    "release/build/godminer-origin_godminer-new/backend/backend_ks5_2382/backend_ks5_2382.c";
LABEL_13:
    HIWORD(v24) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_D9_release/build/rootfs/buildroot/tmp/rele"
                                "ase/build/godminer-origin_godminer-new/backend/backend_ks5_2382/backend_ks5_2382.c" >> 16;
    zlog(v23, v24, 170, "check_nonce_ks5", 15, v22, 20, v34);
    return 2;
  }
  v6 = *(_DWORD *)(a1 + 840);
  v7 = (char *)&v30 + 3;
...
LABEL_11:
    ...
    zlog(
      ...
      "godminer-new/backend/backend_ks5_2382/backend_ks5_2382.c",
      170,
      "check_nonce_ks5",
      15,
      594,
