int __fastcall phy_internal_bist(int a1, int a2, unsigned int a3, int a4)
{
  ...
  sub_7FA1C(a1, a3, 133, 255);
  usleep(0x64u);
  sub_7FA1C(a1, a3, 134, 255);
  usleep(0x64u);
  sub_7FA1C(a1, a3, 132, -2147483647);
  sleep(6u);
