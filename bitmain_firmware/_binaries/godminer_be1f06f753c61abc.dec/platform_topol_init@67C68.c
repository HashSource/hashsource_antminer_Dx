...
LABEL_93:
  ...
  zlog(
    ...
    20,
    v191);
  dword_1B5938 = (int)calloc(v31, 0x78u);
  if ( !dword_1B5938 )
  {
    V_LOCK();
...
LABEL_16:
  ...
  zlog(
    ...
    20,
    v191);
  dword_1B591C = json_integer_value(v33);
  ...
  zlog(
    ...
    20,
    v191);
  dword_1B5920 = json_integer_value(v36);
  ...
  zlog(
    ...
    20,
    v191);
  dword_1B5924 = json_integer_value(v39);
  ...
  zlog(
    ...
    20,
    v191);
  dword_1B5928 = json_integer_value(v42);
  ...
  zlog(
    ...
    20,
    v191);
  dword_1B592C = json_integer_value(v45);
  ...
  zlog(
    ...
    20,
    v191);
  *(_DWORD *)(dword_1B5938 + 88) = json_integer_value(v51);
...
LABEL_132:
  ...
  *(_DWORD *)(v57 + 84) = v58;
  ...
  zlog(
    ...
    20,
    v191);
  *(_DWORD *)(dword_1B5938 + 96) = json_integer_value(v60);
  ...
  zlog(
    ...
    20,
    v191);
  *(_DWORD *)(dword_1B5938 + 100) = json_integer_value(v63);
  ...
  zlog(
    ...
    20,
    v191);
  *(_DWORD *)(dword_1B5938 + 104) = json_integer_value(v66);
  ...
  zlog(
    ...
    20,
    v191);
  *(_DWORD *)(dword_1B5938 + 108) = json_integer_value(v69);
  v179 = sub_66824(v180);
  if ( v179 )
  {
    V_LOCK();
    ...
    for ( i = 0; i < (unsigned int)json_array_size(v189); ++i )
    {
      ...
      *(_DWORD *)(v148 + 24 * v147) = v147;
      ...
      if ( strcmp(v153, "TMP451") )
      {
        do
          ++v143;
        while ( v143 != 5 && strcmp(v153, off_168DC8[v143]) );
      }
      v149[1] = v143;
      ...
      while ( 1 )
      {
        ...
        *(_DWORD *)(v80 + 24 * v79) = v79;
        ...
        if ( strcmp(v85, "TMP451") )
        {
          do
            ++v75;
          while ( v75 != 5 && strcmp(v85, off_168DC8[v75]) );
        }
        v81[1] = v75;
...
LABEL_170:
  ...
  if ( dword_1B5918 > 1 )
  {
    ...
    {
      ++v133;
      v134 = (void *)(dword_1B5938 + v132);
      v132 += 120;
      memcpy(v134, (const void *)dword_1B5938, 0x78u);
    }
    while ( v131 != v133 );
  }
  if ( *((_DWORD *)v1 + 1) != -1 )
