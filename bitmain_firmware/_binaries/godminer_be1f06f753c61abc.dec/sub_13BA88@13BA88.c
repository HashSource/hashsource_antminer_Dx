int __fastcall sub_13BA88(int a1, int a2)
{
  int *v4; // r3
  _DWORD *v5; // r5
  int v6; // r9
  ...
  sub_13B084((unsigned __int8 *)a1, &v868);
  sub_13B084((unsigned __int8 *)(a1 + 2), &v932);
  v4 = &v868;
  v5 = &unk_181610;
  v6 = 226;
  v7 = 46;
  ...
  v20 = 226;
  sub_13B084((unsigned __int8 *)(a1 + 1), &v996);
  sub_13B084((unsigned __int8 *)(a1 + 3), &v1060);
  v21 = &v868;
  v22 = v996 + v1060;
  v1060 = v996 - v1060;
  v996 = v22;
  ...
  if ( a2 )
  {
    v365 = (unsigned __int16 *)&unk_181DF0;
    v366 = &v867;
    for ( i = 2; ; i = v368 )
    {
      v369 = v366[1];
  ...
  {
    v51 = &v867;
    v52 = (unsigned __int16 *)&unk_181BF0;
    for ( j = 1; ; j = v54 )
    {
      v55 = v51[1];
      ++v51;
