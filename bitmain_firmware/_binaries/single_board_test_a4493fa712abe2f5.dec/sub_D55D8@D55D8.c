int __fastcall sub_D55D8(int a1, int a2, _BYTE *a3, _BYTE *a4)
{
  int v6; // r7
  int v7; // r8
  int v8; // r5
  ...
  int v19; // r6
  int v20; // r6
  _BYTE *v22; // [sp+14h] [bp-1810h]
  char s[2048]; // [sp+20h] [bp-1804h] BYREF
  char v24[4100]; // [sp+820h] [bp-1004h] BYREF
  ...
  *a3 = 85;
  ...
  while ( 1 )
  {
    ...
    {
      i2c_write(v19, (int)v22, (unsigned __int8)(v6 + 6));
    ...
    {
      i2c_read(v20, (int)a4, 7);
      pthread_mutex_unlock(&stru_3B5254);
    }
    pthread_mutex_unlock(&i2c_mutex_all);
    if ( (unsigned __int8)a4[1] == v7 && *a4 == 7 )
      break;
