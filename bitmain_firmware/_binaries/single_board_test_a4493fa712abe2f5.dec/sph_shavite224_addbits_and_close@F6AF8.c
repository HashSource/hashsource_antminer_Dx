int __fastcall sph_shavite224_addbits_and_close(int a1, char a2, int a3, int *a4)
{
  unsigned int v6; // r7
  int v7; // r6
  int v8; // r5
  ...
  *(_BYTE *)(a1 + 54) = v8;
  *(_BYTE *)(a1 + 58) = v7;
  *(_BYTE *)(a1 + 55) = BYTE1(v8);
  *(_BYTE *)(a1 + 56) = BYTE2(v8);
  *(_BYTE *)(a1 + 57) = HIBYTE(v8);
  ...
  *a4 = (unsigned __int8)*(_DWORD *)(a1 + 68)
  ...
  a4[4] = (unsigned __int16)((unsigned __int8)*(_DWORD *)(a1 + 84) | ((unsigned __int8)BYTE1(*(_DWORD *)(a1 + 84)) << 8))
