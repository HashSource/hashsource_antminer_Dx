int __fastcall sub_82DF8(int a1)
{
  ...
  else
  {
    ...
    do
    {
      v4 = (unsigned __int8)(*(_DWORD *)(dword_3B52A4 + (v10 & 0xFFFFFFFC)) >> v7);
      if ( v4 == 255 )
        return pthread_mutex_unlock(v1);
      printf("%s: waiting fpga uart%d clear send fifo space ...\n", "clear_uart_tx_fifo", a1);
      *(_DWORD *)(dword_3B52A4 + (v9 & 0xFFFFFFFC)) = v4 | 0x80000000;
      usleep(0xBB8u);
      --v3;
    }
    while ( v3 );
