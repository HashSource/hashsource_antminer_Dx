int __fastcall blake2b_final(int a1, int a2, int a3, int a4)
{
  ...
  *(_QWORD *)(a1 + 192) = v9;
  ...
  if ( v8 <= 0x7F )
  {
    memset((void *)(v8 + a1), 0, 128 - v8);
    HIDWORD(v5) = 128;
    *(_DWORD *)(a1 + 208) = 128;
  }
  result = sub_57088((_DWORD *)a1, 1, v5, SHIDWORD(v5), a4, savedregs);
  if ( *(_DWORD *)(a1 + 212) )
  {
    v12 = a2 - 1;
    v13 = 0;
    do
    {
      ...
      v15 = 8 * (v13++ & 7);
      v16 = v14 + 16;
      v17 = *(_DWORD *)(a1 + 8 * (v14 + 16) + 4);
      result = v17 >> (v15 - 32);
      *(_BYTE *)++v12 = (*(_DWORD *)(a1 + 8 * v16) >> v15) | (v17 << (32 - v15)) | result;
    }
