int __fastcall sub_D412C(int a1, char a2, __int16 a3, void *a4)
{
  int v7; // r4
  ...
  int v30; // [sp+80h] [bp-1014h]
  int v31; // [sp+84h] [bp-1010h]
  int v32; // [sp+88h] [bp-100Ch]
  int v33; // [sp+8Ch] [bp-1008h]
  char v34[4100]; // [sp+90h] [bp-1004h] BYREF

  v20 = 0;
  pthread_mutex_lock(&stru_3B526C);
  logfmt_raw(v34, 0x1000u, 0, "%s core_no %d", "ChipSetting_get_single_chip_core_status_ETH", 16);
