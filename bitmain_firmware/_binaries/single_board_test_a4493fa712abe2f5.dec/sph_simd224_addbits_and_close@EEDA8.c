int __fastcall sph_simd224_addbits_and_close(int a1, char a2, int a3, int *a4)
{
  int v5; // r0
  int v8; // r7
  unsigned int v10; // r1
  ...
  if ( a3 | v5 )
  {
    memset((void *)(v5 + a1), 0, 64 - v5);
    *(_BYTE *)(a1 + *(_DWORD *)(a1 + 64)) = (-1 << (8 - a3)) & a2;
