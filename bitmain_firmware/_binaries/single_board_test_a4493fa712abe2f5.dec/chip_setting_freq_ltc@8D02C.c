int __fastcall chip_setting_freq_ltc(int a1)
{
  float v1; // s0
  signed int v2; // r1
  float v4; // s14
  ...
  double v9; // d9
  int v10; // r4
  _BYTE v12[4]; // [sp+10h] [bp-1014h] BYREF
          ...
          if ( (_BYTE)v2 != 5 )
          {
            ...
            if ( (unsigned __int8)v2 != 6 )
            {
              ...
              if ( (unsigned int)v4 - 800 <= 0x640 )
              {
                v6 = 1;
LABEL_17:
                v7 = v6 | 0xA0000100 | (16 * v2) | ((v5 / 0x19) << 16);
                v8 = sub_F7148(25 * (v5 / 0x19), v2);
                v9 = (float)sub_F7148(v8, v6);
                goto LABEL_18;
              }
            }
          }
...
LABEL_18:
  ...
  zlog(
    ...
    60,
    v16);
  v10 = (*(int (__fastcall **)(int, _BYTE *))(a1 + 140))(a1, v12);
  usleep(0x2710u);
  return v10;
}
