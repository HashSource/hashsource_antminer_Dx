int __fastcall get_response(int a1)
{
  ...
  zlog(g_zc, "/home/xingfei.wang/work/1764/godminer/backend/backend_base.c", 60, "get_response", 12, 186, 60, v11);
  prctl(15, v2);
  memset(v11, 0, 0x100u);
  while ( 1 )
  {
    v5 = ((unsigned int (__fastcall *)(int, int, unsigned int))off_12946C)(*(_DWORD *)(a1 + 120), (int)v11, 0x100u);
