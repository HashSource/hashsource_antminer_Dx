int __fastcall sph_shavite512_close(int a1, int *a2)
{
  int v3; // r9
  unsigned int v5; // r3
  int v6; // r7
  ...
  *(_BYTE *)(a1 + 115) = BYTE1(v3);
  *(_BYTE *)(a1 + 116) = BYTE2(v3);
  *(_BYTE *)(a1 + 110) = v8;
  *(_BYTE *)(a1 + 120) = BYTE2(v7);
  *(_BYTE *)(a1 + 113) = HIBYTE(v8);
  *(_BYTE *)(a1 + 119) = BYTE1(v7);
  *(_BYTE *)(a1 + 123) = BYTE1(v6);
  *(_BYTE *)(a1 + 124) = BYTE2(v6);
  *(_WORD *)(a1 + 125) = HIBYTE(v6);
  *(_BYTE *)(a1 + 127) = 2;
  *(_BYTE *)(a1 + 117) = HIBYTE(v3);
  *(_BYTE *)(a1 + 121) = HIBYTE(v7);
  sub_62E70((_DWORD *)a1, (unsigned int *)a1);
  *a2 = (unsigned __int8)*(_DWORD *)(a1 + 132)
  ...
  a2[12] = (unsigned __int8)*(_DWORD *)(a1 + 180)
  ...
  v11 = (int *)&unk_116EF8;
  a2[13] = (unsigned __int8)*(_DWORD *)(a1 + 184)
  ...
  a2[14] = (unsigned __int8)*(_DWORD *)(a1 + 188)
  ...
  a2[15] = (unsigned __int8)*(_DWORD *)(a1 + 192)
