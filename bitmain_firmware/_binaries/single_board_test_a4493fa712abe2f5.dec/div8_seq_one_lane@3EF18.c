int __fastcall div8_seq_one_lane(int a1, int a2, int a3, int a4)
{
  ...
  logfmt_raw((char *)&v14, 0x1000u, 0, "%s chip_id %02x core_id %02x channel_id %02x", "div8_seq_one_lane", a2, a3, a4);
  ...
  sub_D19C4(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x8B, 0xFF000000);
  sub_D19C4(a1, a3, v8, 0xFFFF0000);
  sub_D19C4(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x8C, 0xFF00u);
  sub_D19C4(a1, a3, v8, (unsigned int)"_all_phy");
  sub_D19C4(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x8C, 0xF0000000);
  sub_D19C4(a1, a3, v8, 0xFFF00000);
  sub_D19C4(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x8D, (unsigned int)"ting_get_addr_CKB2");
  sub_D19C4(a1, a3, v8, 0xFFFFFFu);
  sub_D19C4(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x8D, 0);
  sub_D19C4(a1, a3, v8, 0xFF000000);
  sub_D19C4(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x8E, 0xFF00FFu);
  sub_D19C4(a1, a3, v8, 0xFFFu);
  sub_D19C4(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x8A, 0xFF00000u);
  sub_D19C4(a1, a3, v8, 0xFFFFF000);
  sub_D19C4(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x8B, 0xFF0u);
