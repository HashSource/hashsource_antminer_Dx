int __fastcall sub_D47F8(_DWORD *a1, int a2, unsigned int a3, int a4)
{
  unsigned int v4; // r6
  ...
  char v16; // r4
  unsigned int v17; // t1
  int v19; // [sp+1Ch] [bp-1028h]
  unsigned int v21; // [sp+24h] [bp-1020h]
  unsigned int v24; // [sp+38h] [bp-100Ch]
  ...
  LOWORD(v4) = 0;
  v21 = a3 >> 12;
  v5 = (void (__fastcall *)(_DWORD *, _DWORD *))a1[36];
  HIWORD(v27) = 145;
  LOBYTE(v27) = 1;
  v5(a1, v26);
  ...
  do
  {
    if ( a2 != 255 )
      LOWORD(v4) = a2;
    v8 = sub_73570(a1, (unsigned __int16)v4, 145, v6);
    if ( v8 > 0 )
    {
      v9 = v6 + 40;
      v10 = (int)&v6[12 * v8 + 40];
...
LABEL_12:
    v12 = sub_73570(a1, (unsigned __int16)v4, 146, v6);
    if ( v12 > 0 )
    {
      v13 = a4 + 8 * v19;
      v14 = v6;
