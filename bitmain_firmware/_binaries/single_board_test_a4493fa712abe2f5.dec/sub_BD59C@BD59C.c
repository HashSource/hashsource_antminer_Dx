int __fastcall sub_BD59C(int *a1)
{
  const char *v1; // r6
  void *v2; // r0
  ...
  logfmt_raw(v53, 0x1000u, 0, "get_addr %s chip_no %d", "ChipSetting_get_addr_GRIN29", 4);
  pthread_mutex_unlock(&stru_3B526C);
  v30 = "ChipSetting_get_addr_GRIN29";
  zlog(
    g_zc,
  ...
  ptr = v2;
  v3(v29, v37, 4, v2, &v36, v28[1], 2000, 0);
  v34 = &dword_3B52A8;
  pthread_mutex_lock(&stru_3B526C);
  v46 = "chain";
  v47 = 5;
