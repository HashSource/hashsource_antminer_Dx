int __fastcall sub_BE26C(int a1, int a2, int a3, int a4)
{
  int v9; // [sp+24h] [bp-1048h]
  unsigned __int8 v10; // [sp+28h] [bp-1044h] BYREF
  unsigned __int8 v11; // [sp+29h] [bp-1043h]
  int v12; // [sp+2Ch] [bp-1040h]
  char v13[4100]; // [sp+68h] [bp-1004h] BYREF
