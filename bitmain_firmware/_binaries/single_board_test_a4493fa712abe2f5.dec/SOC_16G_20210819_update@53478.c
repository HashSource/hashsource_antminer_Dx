int __fastcall SOC_16G_20210819_update(int a1, int a2, int a3, int a4)
{
  ...
  logfmt_raw(v38, 0x1000u, 0, "%s ...", "SOC_16G_20210819_update");
  ...
  sub_D19C4(a1, v7, v8, 0x8000u);
  sub_70324(a1, v7, 144, -2);
  sub_70324(a1, v7, 145, -2147450879);
  sub_70324(a1, v7, 144, 0);
  sub_70324(a1, v7, 145, -2147450878);
  sub_D19C4(a1, v7, v19, 0xFFFFFFFC);
  sub_D19C4(a1, v7, v8, 2u);
