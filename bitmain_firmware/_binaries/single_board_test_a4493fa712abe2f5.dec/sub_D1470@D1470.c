int __fastcall sub_D1470(int result, int a2, int a3, int a4, __int64 a5, __int64 a6, __int64 a7, __int64 a8)
{
  unsigned int *v8; // r7
  int *v10; // r6
  int v11; // r12
  ...
  *v8 = v19;
  v8[1] = v14;
  v20 = (a6 ^ a8) + *(_QWORD *)(result + 8) + __PAIR64__(v14, v19);
  *(_QWORD *)(result + 8) = v20;
  v21 = *(_QWORD *)v10 ^ v20;
  ...
  *v10 = HIDWORD(v21);
  ...
  v39 = v37 & ~((*(_DWORD *)(result + 12) | v36) ^ v36 & ~*(_DWORD *)(result + 12)) ^ v36 & ~*(_DWORD *)(result + 12);
  v40 = *(_DWORD *)(result + 12) & ~(v37 ^ v36);
  *v10 = (*(_DWORD *)(result + 8 * a3)
        & ~((*(_DWORD *)(result + 8) | v38) ^ v38 & ~*(_DWORD *)(result + 8))
        ^ v38
        & ~*(_DWORD *)(result + 8)
        | *(_DWORD *)(result + 8) & ~(*(_DWORD *)(result + 8 * a3) ^ v38))
       ^ HIDWORD(v21);
  v10[1] = (v39 | v40) ^ v21;
  return result;
}
