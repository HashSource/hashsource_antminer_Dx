int __fastcall check_bist_tx_running_one_lane(_DWORD *a1, int a2, int a3, int a4)
{
  int v7; // r0
  _QWORD *v8; // r4
  _QWORD *v9; // r9
  ...
  logfmt_raw(v17, 0x1000u, 0, "%s...", "check_bist_tx_running_one_lane");
  ...
  zlog(
    ...
    60,
    v17);
  v7 = sub_D47F8(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x4A, (int)v15);
  if ( v7 > 0 )
  {
    v8 = v16;
    v9 = &v16[v7];
