int __fastcall sync_get_core_reg_base3(int a1, int a2, int a3, int a4, int *a5, unsigned __int64 a6)
{
  ...
  _BYTE v65[7]; // [sp+2Eh] [bp-Eh] BYREF
  char v66; // [sp+35h] [bp-7h]
...
LABEL_32:
    if ( sub_D2F48(*(_DWORD *)(a1 + 636), v64, v63) == 110 )
    {
      v6 = 3;
      goto LABEL_9;
    }
    if ( (unsigned __int8)v64[0] != 170 || v64[1] != 85 || (v33 = v65[0], v65[0] != 8) || (v66 & 0xC0) != 0x40 )
    {
      v6 = 1;
      goto LABEL_9;
    }
