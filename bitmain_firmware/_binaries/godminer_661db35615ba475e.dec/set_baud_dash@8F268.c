int __fastcall set_baud_dash(int a1, int a2)
{
  ...
  *(_DWORD *)(a1 + 224) = 3;
  ...
  v21[1] = 0;
  v23 = 0;
  v9 = (*(int (__fastcall **)(int, _DWORD *))(a1 + 140))(a1, v21);
  v11 = *(_DWORD *)(a1 + 180);
  v12 = v9;
  LOBYTE(v22) = 0;
  if ( v11 <= 0 )
...
LABEL_40:
  ...
  while ( 1 )
  {
    ...
    if ( v8 % 5u == 4 )
    {
      v13 = *(_DWORD *)(a1 + 224);
      v21[0] = -1601955279;
      v14 = *(int (__fastcall **)(int, _DWORD *))(a1 + 140);
      BYTE1(v22) = v13 * v8;
      v15 = v14(a1, v21);
      v11 = *(_DWORD *)(a1 + 180);
      v12 = v15;
...
LABEL_19:
  ...
  {
LABEL_20:
    v20 = *(int (__fastcall **)(int, _DWORD *, int))(a1 + 140);
    BYTE1(v22) = *(_DWORD *)(a1 + 224) * v18;
