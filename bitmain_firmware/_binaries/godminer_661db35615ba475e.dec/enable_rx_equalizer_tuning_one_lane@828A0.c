int __fastcall enable_rx_equalizer_tuning_one_lane(int a1, int a2, int a3, int a4)
{
  ...
  sub_1325F4(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x2F, 0);
  sub_1325F4(a1, a3, v8, 0xFFBFFFFF);
  sub_1325F4(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x2F, 0x400000u);
  sub_1325F4(a1, a3, v8, 0xFFBFFFFF);
  sub_1325F4(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x2F, 0);
  sub_1325F4(a1, a3, v8, 0xFFFFF7FF);
  sub_1325F4(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x37, 0x800u);
  sub_1325F4(a1, a3, v8, 0xBFFFFFFF);
  v9 = (unsigned __int16)((_WORD)a4 << 12) | 0x98;
  sub_1325F4(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x7E, 0x40000000u);
  sub_1325F4(a1, a3, v8, 0xFEFFFFFF);
  sub_1325F4(a1, a3, v9, 0);
  sub_1325F4(a1, a3, v8, 0xFEFFFFFF);
  sub_1325F4(a1, a3, v9, 0x1000000u);
  sub_136560(a1, a2, a3, a4);
  sub_1325F4(a1, a3, v8, 0xFEFFFFFF);
  sub_1325F4(a1, a3, v9, 0);
  sub_1325F4(a1, a3, v8, 0);
  sub_136350(a1, a2, a3, a4);
  return 0;
}
