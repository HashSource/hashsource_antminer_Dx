int __fastcall get_special_core_reg(int a1)
{
  ...
  logfmt_raw(v20, 0x1000u, 0, "%s...", "get_special_core_reg");
  v15 = 0;
  ...
  do
  {
    ...
    else
    {
      ...
      do
      {
        ...
        __pld(v2);
        v2 += 6;
        logfmt_raw(v20, 0x1000u, 0, "chip %02x core %02x addr %04x, %08x", v10, v11, v12, v13);
        pthread_mutex_unlock(&stru_197BB8);
        zlog(
          g_zc,
...
LABEL_12:
      v19 = 1;
      pthread_mutex_lock(&stru_197BB8);
      logfmt_raw(v20, 0x1000u, 0, "chip %02x core reg %04x, resp_num(%d) is not enough", v15, 81, v16);
      pthread_mutex_unlock(&stru_197BB8);
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_D7_release/build/rootfs/buildroot/tmp/release/build/godminer-origi"
