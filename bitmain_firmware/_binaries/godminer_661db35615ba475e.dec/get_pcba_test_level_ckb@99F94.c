int __fastcall get_pcba_test_level_ckb(int *a1, int *a2)
{
  ...
  if ( v2 )
    goto LABEL_2;
  if ( off_18F50C(a1[30], 52, 0x60000u, &v16) )
  {
...
LABEL_24:
    v8 = *(int *)((char *)&off_165F30[845] + 10 * v2);
    a1[185] = v8;
LABEL_8:
    if ( !v8 )
    {
      ...
      v9 = *(int *)((char *)&off_165F30[845] + 10 * v8);
      a1[185] = v9;
      if ( !v9 )
LABEL_15:
        a1[185] = 5;
    ...
    v26[8] = "chain";
    v26[9] = 5;
    v11 = (char *)off_165F30 + 2 * v10;
    v12 = a1[31];
    v26[10] = 3;
    v13 = (unsigned __int8)v11[3389];
    v14 = (unsigned __int8)v11[3388];
    v26[12] = v12;
    v26[13] = v12 >> 31;
    v26[14] = 0;
    ++dword_197BD4;
