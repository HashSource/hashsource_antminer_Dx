int __fastcall platform_check_repeat_nonce(int *a1, int a2, char *s2)
{
  ...
  int v29; // [sp+64h] [bp-1018h]
  int v30; // [sp+74h] [bp-1008h]
  char v31[4100]; // [sp+78h] [bp-1004h] BYREF
...
LABEL_18:
  ...
  if ( v3 )
  {
    ...
    do
    {
      ...
      v20 = v11;
      v11 += 2;
      sprintf(v20, "%02x", *(unsigned __int8 *)(a1[69] + v7 + v15 - s2));
      v21 = v17;
      v17 += 2;
      sprintf(v21, "%02x", *(unsigned __int8 *)(a1[69] + v23 + v15 - s2));
    }
    while ( v15 != v27 );
  }
  ...
  v22 = a1[31];
  ++dword_197BD4;
  logfmt_raw(v31, 0x1000u, 0, v30, "chain", 5, 3, v29, v22, 0, v30, "asic %d repeat nonce %s %s %s", a2, v26, v24, ptr);
