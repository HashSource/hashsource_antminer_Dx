unsigned int __fastcall sub_9CDCC(unsigned int *a1, char a2, char a3, unsigned int *a4, int a5)
{
  unsigned int v5; // r4
  unsigned int v7; // r6
  unsigned int *v8; // r3
