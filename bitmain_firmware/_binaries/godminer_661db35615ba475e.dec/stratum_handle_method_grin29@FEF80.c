unsigned int __fastcall stratum_handle_method_grin29(int a1, int a2, char arg)
{
  _DWORD *v4; // r0
  _DWORD *v5; // r4
  _DWORD *v6; // r0
              ...
              while ( v109 > v66 )
              {
                ...
                if ( !v73 || strlen(v73) != 64 )
                {
                  ...
                  zlog(
                    ...
                    "dminer-origin_master/frontend/frontend_grin29/frontend_grin29.c",
                    163,
                    "stratum_notify",
                    14,
                    235,
