int __fastcall work_2_packet_ae(int a1, _DWORD *a2, int a3, _DWORD *a4)
{
  ...
  *v10 = *a2;
  ...
  v11 = a2 + 10;
  v12 = a2[11];
  v13 = (_DWORD *)(v5 + 32 * (*(unsigned __int8 *)(v5 + 113920) + 232));
  v14 = a2[12];
  v15 = a2[13];
  *v13 = a2[10];
  v16 = a3 + 5;
  ...
  do
  {
    ...
    *(_BYTE *)(v16 + 3) = v25;
    v29 = aAbcdefghijklmn[(v26 >> 6) & 0x3F];
    v30 = aAbcdefghijklmn[(v26 >> 12) & 0x3F];
    v31 = aAbcdefghijklmn[v26 >> 18];
    v16 += 4;
    *(_BYTE *)(v16 - 2) = v29;
    *(_BYTE *)(v16 - 3) = v30;
    *(_BYTE *)(v16 - 4) = v31;
  ...
  *(_BYTE *)(a3 + 3) = 80;
  ...
  {
    v38 = *v36++;
    v39 = crc_itu_t_table[v38 ^ (v37 >> 8)] ^ ((_WORD)v37 << 8);
    v37 = v39;
  }
  while ( v36 != (unsigned __int8 *)(a3 + 85) );
  *(_BYTE *)(a3 + 86) = v39;
