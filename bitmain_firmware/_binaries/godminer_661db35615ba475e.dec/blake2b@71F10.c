...
LABEL_13:
  ...
  while ( 1 )
  {
    ...
    *(v11 - 216) = v10;
    ...
    if ( v9 == 128 )
    {
      v12 = (unsigned __int64)(v7 + 128) >> 32 != 0;
      v35 = v7 + 128;
      if ( !((unsigned __int64)(v7 + 128) >> 32) )
        v12 = (unsigned int)(v7 + 128) > 0x7F;
      if ( !v12 )
      {
        v11 = (_BYTE *)((unsigned __int64)(v36 + 1) >> 32);
        v9 = ++v36;
      }
      sub_69FD0(v34, 0, (int)v11, v9, v26, v27);
      v7 = v35;
      v9 = 0;
    }
  }
  v35 = v7 + v9;
  v13 = __CFADD__(HIDWORD(v7), HIDWORD(v35));
  if ( __CFADD__(HIDWORD(v7), HIDWORD(v35)) )
    v13 = ++v36;
  if ( v9 <= 0x7F )
    goto LABEL_13;
LABEL_14:
  sub_69FD0(v34, 1, v13, v9, v26, v27);
  v14 = v38;
  if ( v38 )
  {
    v15 = 0;
