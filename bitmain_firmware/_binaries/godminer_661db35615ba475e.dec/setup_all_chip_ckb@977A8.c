int __fastcall setup_all_chip_ckb(int a1)
{
  ...
  *(_DWORD *)(a1 + 224) = 9;
  ...
  v29 = 0;
  v30 = 0;
  (*(void (__fastcall **)(int, int *, int, _DWORD))(a1 + 152))(a1, &v29, 20000, 0);
  v6 = (int)(float)(*(float *)(a1 + 732) - 100.0) / 25;
  if ( v6 > 0 )
  {
    v7 = 25;
    do
...
LABEL_21:
                  ...
                  v15 = sub_15D3C8(25 * (v13 / 0x19), v8);
                  v16 = (float)sub_15D3C8(v15, v23);
                  goto LABEL_22;
                }
...
LABEL_22:
      ...
      zlog(
        ...
        20,
        &v29);
      (*(void (__fastcall **)(int, int *))(a1 + 140))(a1, &v25);
      usleep(0x2710u);
      usleep(0x61A8u);
    }
    while ( 25 * (v6 + 1) != v7 );
  ...
  zlog(
    ...
    &v29);
  v25 = 48;
  v17 = *(void (__fastcall **)(int, int *))(a1 + 140);
  v27 = 1310721;
  v17(a1, &v25);
  *(_DWORD *)(a1 + 228) = 48;
  ...
  zlog(
    ...
    &v29);
  v30 = 0;
  v19 = *(void (__fastcall **)(int, int *, int, _DWORD))(a1 + 152);
  v31 = 5242881;
  v32 = 5120;
  v29 = 1;
  v19(a1, &v29, 20000, 0);
  ...
  zlog(
    ...
    20,
    &v29);
  v20 = *(void (__fastcall **)(int, int *))(a1 + 140);
  v27 = 1310721;
  v25 = 32;
  v20(a1, &v25);
  *(_DWORD *)(a1 + 228) = 32;
