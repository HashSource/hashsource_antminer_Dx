int __fastcall sub_1066C0(_DWORD *a1, int a2, int a3, unsigned int *a4, __int64 a5)
{
  int v7; // r9
  unsigned int v8; // r8
  char v10; // r10
  ...
  switch ( *a1 )
  {
    case 0:
      ...
      if ( hashtable_get((int)a4, s) )
        return -1;
      v13 = hashtable_set(a4, s, (int)dword_190784);
      if ( v13 )
        return -1;
...
LABEL_32:
      v47 = a3 + 1;
      v13 = sub_10087C(v8, a3 + 1, 0, (int (__fastcall *)(char *, int, int))a5, SHIDWORD(a5));
      if ( v13 )
        return -1;
      v19 = *a1;
      if ( (v10 & 0x80) == 0 )
      {
        ...
        while ( 1 )
        {
          ...
          v23 = strlen(v21 + 16);
          sub_100A98((unsigned __int8 *)v21 + 16, v23, (int (__fastcall *)(char *, int, int))a5, SHIDWORD(a5), v8);
          if ( ((int (__fastcall *)(char *, int, _DWORD))a5)(v20, v39, HIDWORD(a5)) )
            return -1;
          v24 = (_DWORD *)*((_DWORD *)v21 + 3);
          v21 = v22;
          if ( sub_1066C0(v24, v8, v47, (int *)a4, (int (__fastcall *)(char *, int, int))a5, SHIDWORD(a5)) )
            return -1;
          if ( !v22 )
          {
            v13 = 0;
            if ( !sub_10087C(v8, v42, 0, (int (__fastcall *)(char *, int, int))a5, SHIDWORD(a5)) )
              goto LABEL_86;
            return -1;
          }
          if ( ((int (__fastcall *)(__int16 *, int, _DWORD))a5)(&word_160080, 1, HIDWORD(a5))
            || sub_10087C(v8, v47, 1, (int (__fastcall *)(char *, int, int))a5, SHIDWORD(a5)) )
          {
            return -1;
          }
          v19 = *a1;
      ...
      while ( v32 );
      qsort(base, (size_t)nmemb, 4u, (__compar_fn_t)sub_100A8C);
      if ( nmemb )
      {
        v49 = v7;
        v34 = v48;
        ...
        while ( 1 )
        {
          ...
          v38 = strlen(v36);
          sub_100A98((unsigned __int8 *)v36, v38, (int (__fastcall *)(char *, int, int))a5, SHIDWORD(a5), v8);
          if ( ((int (__fastcall *)(char *, int, _DWORD))a5)(v41, v39, HIDWORD(a5))
            || sub_1066C0(v37, v8, v47, (int *)a4, (int (__fastcall *)(char *, int, int))a5, SHIDWORD(a5)) )
          {
            break;
          }
          ...
          else if ( sub_10087C(v8, a3, 0, (int (__fastcall *)(char *, int, int))a5, SHIDWORD(a5)) )
          {
            break;
          }
...
LABEL_18:
      ...
      v25 = sub_10087C(v8, a3 + 1, 0, (int (__fastcall *)(char *, int, int))a5, SHIDWORD(a5));
      if ( !v25 )
      {
        v43 = a3;
        v26 = a3 + 1;
        while ( 1 )
        {
          ...
          v13 = sub_1066C0(v27, v8, v26, (int *)a4, (int (__fastcall *)(char *, int, int))a5, SHIDWORD(a5));
          if ( v13 )
            break;
          v28 = v40 - 1 > v25++;
          if ( v28 )
          {
            if ( ((int (__fastcall *)(__int16 *, int, _DWORD))a5)(&word_160080, 1, HIDWORD(a5))
              || sub_10087C(v8, v26, 1, (int (__fastcall *)(char *, int, int))a5, SHIDWORD(a5)) )
            {
              return -1;
            }
          }
          else if ( sub_10087C(v8, v43, 0, (int (__fastcall *)(char *, int, int))a5, SHIDWORD(a5)) )
          {
            return -1;
          }
          if ( v25 == v40 )
    ...
    case 2:
      ...
      return sub_100A98(v15, a1[3], (int (__fastcall *)(char *, int, int))a5, SHIDWORD(a5), v8);
    case 3:
    ...
    case 4:
      v17 = jsonp_dtostr(s, 0x64u, (unsigned __int16)a2 >> 11);
      if ( v17 < 0 )
        return -1;
      return ((int (__fastcall *)(char *, int, _DWORD))a5)(s, v17, HIDWORD(a5));
    case 5:
