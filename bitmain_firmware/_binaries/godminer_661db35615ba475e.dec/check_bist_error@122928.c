  ...
  do
  {
    ...
    if ( v40 )
    {
      ...
      do
      {
        ...
        {
          v16 = (_WORD)v14 << 12;
          v17 = sub_13415C(a1, v39, v16 & 0xF000 | 0x10, (int)v69);
          if ( *(_DWORD *)(a1 + 220) != v17 )
          {
            pthread_mutex_lock(&stru_197BB8);
            logfmt_raw(
              v71,
          ...
          v18 = sub_13415C(a1, v39, v16 & 0xF000 | 0x13, (int)v60);
          v19 = *(_DWORD *)(a1 + 220);
          v20 = v18;
          if ( v19 == v18 )
          {
            ...
            v21 = sub_13415C(a1, v39, v16 & 0xF000 | 0x14, (int)v60);
            v22 = *(_DWORD *)(a1 + 220);
            v23 = v21;
            if ( v22 == v21 )
            {
              ...
              v24 = sub_13415C(a1, v39, v16 & 0xF000 | 0x15, (int)v59);
              v25 = *(_DWORD *)(a1 + 220);
              v26 = v24;
              if ( v25 == v24 )
              {
                  ...
                  do
                  {
                    ...
                    if ( (v28 & 0xE000000) != 0 )
                    {
                      ...
                      zlog(
                        ...
                        v71);
                      memset(s, 0, 0x20u);
                      v30 = sub_13415C(a1, *((unsigned __int8 *)v27 - 11), v47, (int)v60);
                      if ( v30 > 0 )
                      {
                        s[0] = v61 >> 12;
                        if ( v30 != 1 )
                      ...
                      v31 = sub_13415C(a1, *((unsigned __int8 *)v27 - 11), v48, (int)v60);
                      if ( v31 > 0 )
                      {
                        for ( i = 0; i != v31; ++i )
                        {
