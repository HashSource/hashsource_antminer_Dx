int __fastcall sub_2B218(_DWORD *a1, int a2)
{
  _BOOL4 v2; // r4
  int v3; // r10
  int v4; // r9
  ...
  v4 = 0;
  v5 = -1;
  sub_27658(a1, 1, 71, *(const char **)(a2 + 8));
  v30 = json_array();
  v28 = json_object();
  while ( 1 )
  {
...
LABEL_7:
    ...
    if ( !dword_197F38 || (v10 = *(_DWORD *)(reject_reason_map + 4 * ((dword_197F38 - 1) & v7))) == 0 )
    {
LABEL_34:
      dword_197F40 = 0;
      __und(0);
