int __fastcall serdes_initial_seq_2_by_vendor(int a1, int a2, char a3, int a4)
{
  bool v4; // zf
  int v7; // lr
  int v8; // r2
  ...
  zlog(
    ...
    60,
    v22);
  sub_1325F4(a1, a3, v12, 0xDFFFFFFF);
  sub_1325F4(a1, a3, v15, 0);
  sub_1325F4(a1, a3, v12, 0xFFFFFFFB);
  sub_1325F4(a1, a3, v14, 0);
  sub_1325F4(a1, a3, v12, 0xFFFFFFFB);
  sub_1325F4(a1, a3, v13, 0);
  sub_1325F4(a1, a3, v12, 0xFFFBFFFF);
  sub_1325F4(a1, a3, v17, 0);
  sub_1325F4(a1, a3, v12, 0xFFFBFFFF);
  sub_1325F4(a1, a3, v18, 0);
  sub_1325F4(a1, a3, v12, 0xFFF7FFFF);
  sub_1325F4(a1, a3, v19, 0);
  sub_1325F4(a1, a3, v12, 0xFFFFFFDF);
  sub_1325F4(a1, a3, v20, 0);
  sub_1325F4(a1, a3, v12, 0xFBFFFFFF);
  sub_1325F4(a1, a3, v21, 0x4000000u);
  ...
  sub_8F7C8(a1, a3, 144, -1009);
  sub_8F7C8(a1, a3, 145, -2147450879);
  sub_8F7C8(a1, a3, 144, 112);
  sub_8F7C8(a1, a3, 145, -2147450786);
  sub_8F7C8(a1, a3, 144, -258049);
  sub_8F7C8(a1, a3, 145, -2147450879);
  sub_8F7C8(a1, a3, 144, 28672);
  sub_8F7C8(a1, a3, 145, -2147450786);
