        ...
        int a7)
{
  ...
  logfmt_raw((char *)&v28, 0x1000u, 0, "%s...", "serdes_phy_bist_external_0811");
  ...
  if ( a5 )
    ...
    v15 = "clock";
  logfmt_raw((char *)&v28, 0x1000u, 0, "group %d test %d %s...", a7, v26, v15);
  pthread_mutex_unlock(&stru_197BB8);
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_D7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_ma"
...
LABEL_36:
  ...
  V_LOCK();
  logfmt_raw((char *)&v28, 0x1000u, 0, "do not set div_seq with testcase 4");
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_D7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_ma"
...
LABEL_23:
  ...
  do
  {
    while ( 1 )
    {
      ...
      if ( !a7 )
        break;
      sub_4A084(a1, a2, (unsigned __int8)a3, v17);
    ...
    read_rx_debug_reg2_one_lane(a1, a2, a3, 7u);
    sub_8F7C8(a1, (unsigned __int8)a3, 144, -9);
    sub_8F7C8(a1, (unsigned __int8)a3, 145, -2147467263);
    sub_8F7C8(a1, (unsigned __int8)a3, 144, 8);
    sub_8F7C8(a1, (unsigned __int8)a3, 145, -2147467119);
    sub_8F7C8(a1, (unsigned __int8)a3, 144, -1073741825);
    sub_8F7C8(a1, (unsigned __int8)a3, 145, -2147467263);
    sub_8F7C8(a1, (unsigned __int8)a3, 144, 0x40000000);
    sub_8F7C8(a1, (unsigned __int8)a3, 145, -2147467145);
    sub_8F7C8(a1, (unsigned __int8)a3, 144, 0);
    sub_8F7C8(a1, (unsigned __int8)a3, 145, -2147467263);
    usleep((__useconds_t)&loc_F4240);
...
LABEL_27:
  if ( v27 == 4 )
  {
    ...
    do
    {
      ...
      if ( a7 )
      {
        sub_4A084(a1, a2, (unsigned __int8)a3, v24);
        read_rx_debug_reg2_one_lane(a1, a2, a3, 4u);
        read_rx_debug_reg2_one_lane(a1, a2, a3, 7u);
        sub_8F7C8(a1, (unsigned __int8)a3, 144, -9);
        sub_8F7C8(a1, (unsigned __int8)a3, 145, -2147454975);
      ...
      else
      {
        ...
        read_rx_debug_reg2_one_lane(a1, a2, a3, 7u);
        sub_8F7C8(a1, (unsigned __int8)a3, 144, -9);
        sub_8F7C8(a1, (unsigned __int8)a3, 145, v21);
        sub_8F7C8(a1, (unsigned __int8)a3, 144, 8);
        sub_8F7C8(a1, (unsigned __int8)a3, 145, -2147467119);
        sub_8F7C8(a1, (unsigned __int8)a3, 144, -1073741825);
        sub_8F7C8(a1, (unsigned __int8)a3, 145, v21);
