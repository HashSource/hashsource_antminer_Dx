int __fastcall membist0(int a1)
{
  ...
  do
  {
    ...
    v47 = 255;
    v45 = 0;
    (*(void (__fastcall **)(int, int *))(a1 + 144))(a1, &v44);
    ...
    do
    {
      ...
      usleep((__useconds_t)"ead_unregister_cancel");
      usleep((__useconds_t)"ead_unregister_cancel");
      v5 = sub_93DE0(a1, (unsigned __int16)v36, 161, ptr);
      if ( v5 > 0 )
      {
        v6 = ptr + 28;
        v7 = (int)&ptr[12 * v5 + 28];
...
LABEL_10:
      v11 = sub_93DE0(a1, (unsigned __int16)v36, 162, ptr);
      if ( v11 > 0 )
      {
        v12 = ptr + 40;
...
LABEL_16:
      v19 = sub_93DE0(a1, (unsigned __int16)v36, 163, ptr);
      if ( v19 > 0 )
      {
        v20 = ptr + 40;
...
LABEL_22:
  ...
  do
  {
    ...
    strncpy((char *)&dword_196BB4[16 * dword_196BB4[0] + 1], src, v32);
    ++dword_196BB4[0];
  }
  while ( &s[20] != v27 );
LABEL_31:
