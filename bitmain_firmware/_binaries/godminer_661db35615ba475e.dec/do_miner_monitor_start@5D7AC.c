int do_miner_monitor_start()
{
  ...
  if ( v0 > 0 )
  {
    ...
    do
    {
      ...
      if ( !*(_BYTE *)(v3 + 130) )
      {
        do
          sleep(1u);
        while ( !*(_BYTE *)(*(v1 - 1) + 130) );
      }
    }
    while ( v1 != v2 );
  }
  v4 = dword_1916D8;
  v5 = dword_1916D8 + 4096;
  arg = (pthread_t *)dword_1916D8;
  v6 = *(unsigned __int8 *)(dword_1916D8 + 6148);
  if ( *(_BYTE *)(dword_1916D8 + 6148) )
  {
    v93 = 0;
    *(_BYTE *)(dword_1916D8 + 6148) = 0;
    pthread_join(*(_DWORD *)(v4 + 6152), thread_return);
    v94 = *(_DWORD *)(v4 + 6144);
    v126 = v94;
    if ( v94 <= 0 )
    {
  ...
  {
    v7 = *(_DWORD *)(dword_1916D8 + 6144);
    if ( v7 > 0 )
    {
      if ( v7 > 2 )
      {
        v123 = *(_DWORD *)(dword_1916D8 + 6144);
        v8 = (_DWORD *)(dword_1916D8 + 2124);
        v9 = (char *)(dword_1916D8 + 16);
  ...
  v29 = dword_1916DC;
  v30 = dword_1916DC + 4096;
  arga = (pthread_t *)dword_1916DC;
  v31 = *(unsigned __int8 *)(dword_1916DC + 6148);
  ...
  {
    v32 = *(_DWORD *)(dword_1916DC + 6144);
    if ( v32 > 0 )
    {
      if ( v32 > 2 )
      {
        v124 = *(_DWORD *)(dword_1916DC + 6144);
        v33 = (_DWORD *)(dword_1916DC + 2124);
        v34 = (char *)(dword_1916DC + 16);
  ...
  v54 = (pthread_t *)dword_1916D8;
  v55 = *(_DWORD *)(dword_1916D8 + 6144);
  *(_BYTE *)(dword_1916D8 + 6148) = 1;
  if ( v55 > 0 )
  {
  ...
  v59 = (pthread_t *)dword_1916DC;
  v60 = *(_DWORD *)(dword_1916DC + 6144);
  *(_BYTE *)(dword_1916DC + 6148) = 1;
  if ( v60 > 0 )
  {
