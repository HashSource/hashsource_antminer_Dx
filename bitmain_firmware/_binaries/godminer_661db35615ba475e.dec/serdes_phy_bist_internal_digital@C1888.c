int __fastcall serdes_phy_bist_internal_digital(int a1, int a2, unsigned int a3, int a4, unsigned __int8 a5)
{
  ...
  v19 = v8;
  v14 = v12;
  sub_1325F4(a1, a3, v9, 0xFFFFFDF7);
  sub_1325F4(a1, a3, v13, 0x208u);
  ...
  sub_1325F4(a1, a3, v9, 0xFFFFFFF1);
  sub_1325F4(a1, a3, v14, (2 * a5) & 0xE);
  sub_1325F4(a1, a3, v9, 0);
  v23 = 6422529;
  v22 = 0;
  v24 = (unsigned __int8)a3;
  ...
  (*(void (__fastcall **)(int, int *))(a1 + 144))(a1, &v21);
  usleep((__useconds_t)"ead_unregister_cancel");
  sub_1325F4(a1, a3, v9, 0xFFFFFFF7);
  sub_1325F4(a1, a3, v18, 8u);
  sub_1325F4(a1, a3, v9, 0xBFFFFFFF);
  sub_1325F4(a1, a3, v19, 0x40000000u);
  sub_1325F4(a1, a3, v9, 0);
  usleep((__useconds_t)"ead_unregister_cancel");
