int __fastcall get_seedhash_by_block_num(int a1, unsigned __int64 a2)
{
  ...
  memset(s, 0, sizeof(s));
  LODWORD(v4) = sub_15DCAC(a2, 0x7530u);
  v82 = v4;
  if ( v4 )
  {
    v83 = 0;
    do
    {
      ...
      do
      {
        ...
        v31 = (unsigned __int8 *)&unk_16194F;
        HIDWORD(v86[24]) = v28 ^ HIDWORD(v66);
        v32 = (unsigned __int8 *)&unk_161967;
        do
        {
          v34 = *++v32;
          v33 = v34;
        ...
        while ( v31 != (unsigned __int8 *)&unk_161967 );
        v40 = v86[0];
        v41 = v86[2];
      ...
      while ( &unk_161948 != (_UNKNOWN *)(v46 + 8) );
      ++v83;
      s[0] = v86[0];
      s[1] = v86[1];
      s[2] = v86[2];
