int __fastcall sub_133F78(int a1, _BYTE *a2, unsigned int a3)
{
  ...
  int v17; // r5
  int v18; // r12
  int v23; // [sp+2Ch] [bp-14h]
  _BYTE v24[16]; // [sp+30h] [bp-10h] BYREF
  _DWORD v25[2]; // [sp+40h] [bp+0h] BYREF
  int v26; // [sp+48h] [bp+8h]
