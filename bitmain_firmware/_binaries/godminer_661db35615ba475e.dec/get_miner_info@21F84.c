int __fastcall get_miner_info(char *a1)
{
  ...
  {
    v3 = 0;
    for ( i = 0; i != v2; v3 = v7 + sprintf(&a1[v7], "chain%d_badcore=%d;", i, 0) )
    {
      v5 = v3 + sprintf(&a1[v3], "chain%d_voltage=%d;", ++i, 12);
      v6 = v5 + sprintf(&a1[v5], "chain%d_voladded=%d;", i, 0);
      v7 = v6 + sprintf(&a1[v6], "chain%d_basefreq=%d;", i, 0);
    }
    v8 = &a1[v3];
  }
  v9 = &a1[v3 + sprintf(v8, "chainnum=%d;", v2)];
  return sprintf(v9, "version=%s;", g_miner_compiletime);
}
