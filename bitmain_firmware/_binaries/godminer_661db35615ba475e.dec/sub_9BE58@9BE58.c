unsigned int __fastcall sub_9BE58(unsigned int *a1, char a2, char a3, unsigned int *a4)
{
  unsigned int v5; // lr
  unsigned int v6; // r6
  unsigned int v7; // r10
