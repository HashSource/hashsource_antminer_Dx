    ...
    else
    {
      ...
      do
      {
        ...
        if ( v7 > v8 )
          v7 = v8;
        v9 = v7;
        if ( v7 > *(_DWORD *)(*(v3 - 31) + 744) )
          v9 = *(_DWORD *)(*(v3 - 31) + 744);
        if ( v9 > *(_DWORD *)(*(v3 - 30) + 744) )
          v9 = *(_DWORD *)(*(v3 - 30) + 744);
        if ( v9 > *(_DWORD *)(*(v3 - 29) + 744) )
          v9 = *(_DWORD *)(*(v3 - 29) + 744);
        if ( v9 > *(_DWORD *)(*(v3 - 28) + 744) )
          v9 = *(_DWORD *)(*(v3 - 28) + 744);
        if ( v9 > *(_DWORD *)(*(v3 - 27) + 744) )
          v9 = *(_DWORD *)(*(v3 - 27) + 744);
        v10 = v9;
        if ( v9 > *(_DWORD *)(*(v3 - 26) + 744) )
          v10 = *(unsigned int *)(*(v3 - 26) + 744);
        if ( v4 > v10 )
          v4 = (unsigned int)v10;
      }
            ...
            if ( s[96] )
            {
              ...
              if ( v53 )
              {
                logfmt_raw(
                  ...
                  1000LL * (tp.tv_sec - send_job_timer) + (tp.tv_nsec - dword_197E0C) / 1000000);
                pthread_mutex_unlock(&stru_197BB8);
                v32 = 296;
              }
              else
              ...
              v34 = (unsigned __int64)max_timeout_value > qword_190A80[0];
              v35 = (int)&loc_F4240 * (__int64)(tp.tv_sec - send_job_timer) + (tp.tv_nsec - dword_197E0C) / 1000;
              v36 = qword_190A88;
              if ( qword_190A88 < v33 )
                v34 = 2;
              else
