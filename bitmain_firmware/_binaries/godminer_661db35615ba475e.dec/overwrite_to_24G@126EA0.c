int __fastcall overwrite_to_24G(int a1, int a2, int a3, int a4)
{
  ...
  logfmt_raw((char *)&v31, 0x1000u, 0, &unk_16099C, "overwrite_to_24G", a3);
  ...
  v10(a1, &v31);
  usleep((__useconds_t)"ead_unregister_cancel");
  sub_1325F4(a1, a3, v27, 0xFFFCFFFF);
  sub_1325F4(a1, a3, v30, 0x20000u);
  sub_1325F4(a1, a3, v27, 0xFFFFFFFC);
  sub_1325F4(a1, a3, v28, 2u);
  sub_1325F4(a1, a3, v27, 0xFFFCFFFF);
  sub_1325F4(a1, a3, v28, 0x30000u);
  sub_1325F4(a1, a3, v27, 0xFFFCFFFF);
  ...
  v31 = -2147442687;
  (*(void (__fastcall **)(int, int *))(a1 + 144))(a1, &v31);
  usleep((__useconds_t)"ead_unregister_cancel");
  return 0;
}
