unsigned int __fastcall sub_1041EC(int a1, int a2)
{
  _BYTE *v2; // r2
  unsigned int v5; // r5
  bool v6; // zf
...
LABEL_48:
        *(_DWORD *)(a1 + 20) = -2;
        sub_1022F4(a2, (_DWORD *)a1, 5, "unable to decode byte 0x%x", v20);
        goto LABEL_49;
      }
      *(_BYTE *)(a1 + v23 + 8) = 0;
      v33 = *(_DWORD *)(a1 + 16);
...
LABEL_49:
  ...
  v129 = v5;
  strbuffer_append_bytes((const void **)(a1 + 40), &v129, 1u);
  ...
  if ( v5 != 34 )
  {
    ...
    if ( !v10 )
    {
      *(_DWORD *)(a1 + 60) = -1;
      if ( v5 == 45 )
      {
        v88 = sub_102420(a1, a2);
        if ( v88 == 48 )
        {
LABEL_88:
          v39 = sub_102420(a1, a2);
          if ( v39 - 48 > 9 )
            goto LABEL_91;
LABEL_89:
          sub_100758((_DWORD *)a1, v39);
          return *(_DWORD *)(a1 + 60);
        }
        if ( v88 - 48 <= 9 )
          goto LABEL_90;
            ...
            *v42 = 0;
            ...
            if ( *v42 == 34 )
            {
              if ( v43 >= 0 )
                ...
                LOWORD(v105) = 26052;
              HIWORD(v105) = 23;
              sub_1022F4(a2, (_DWORD *)a1, 15, v105);
              return *(_DWORD *)(a1 + 60);
            }
            else
            {
...
LABEL_131:
          ...
          sub_1022F4(a2, (_DWORD *)a1, 15, "real number overflow");
          return *(_DWORD *)(a1 + 60);
        }
      }
      if ( v39 != 46 )
...
LABEL_253:
      ...
      *(_BYTE *)(a1 + 8) = v108;
      ...
      {
        v118 = (*(int (__fastcall **)(_DWORD))a1)(*(_DWORD *)(a1 + 4));
        v119 = *(_BYTE *)(a1 + 8);
        *(_BYTE *)(a1 + 9) = v118;
        v120 = v119 & 0x1F;
        if ( (v118 ^ 0x80u) > 0x3F )
...
LABEL_296:
        ...
        while ( (_BYTE *)(a1 + 8 + v109) != v110 );
        v111 = *(_BYTE *)(a1 + 8);
        v112 = *(unsigned __int8 *)(a1 + 9);
        if ( v109 != 3 )
        {
          v113 = v111 & 7;
          if ( (v112 ^ 0x80u) <= 0x3F )
        ...
        if ( (v112 ^ 0x80u) > 0x3F )
          goto LABEL_294;
        v114 = (v112 & 0x3F) + (v126 << 6);
LABEL_302:
        v115 = *(unsigned __int8 *)(a1 + 10);
        if ( (v115 ^ 0x80u) > 0x3F )
        {
LABEL_294:
          *(_DWORD *)arga = v102;
          *(_DWORD *)(a1 + 20) = -2;
          v102 = -2;
          sub_1022F4(a2, (_DWORD *)a1, 5, "unable to decode byte 0x%x", *(_DWORD *)arga);
          goto LABEL_253;
        }
        v116 = (v115 & 0x3F) + (v114 << 6);
        if ( v109 == 4 )
        {
          v117 = *(unsigned __int8 *)(a1 + 11);
          if ( (v117 ^ 0x80u) > 0x3F )
            goto LABEL_294;
          v116 = (v117 & 0x3F) + (v116 << 6);
          if ( v116 >= 1114112 )
            goto LABEL_294;
        }
        else
      ...
      if ( (unsigned int)(v116 - 55296) >= 0x800 )
      {
        v121 = v116 == 127;
        if ( v116 <= 127 )
          v121 = v109 == 2;
...
LABEL_273:
          ...
          else
          {
            ...
            {
LABEL_266:
              sub_1022F4(a2, (_DWORD *)a1, 8, "invalid Unicode '\\u%04X'", v76);
              goto LABEL_121;
            }
            v77 = i[8];
...
LABEL_265:
                ...
                sub_1022F4(a2, (_DWORD *)a1, 8, v104, *(_DWORD *)arg);
                goto LABEL_121;
              }
              v87 = v85 - 55 + v86;
            }
            ...
            {
              sub_1022F4(a2, (_DWORD *)a1, 8, "invalid Unicode '\\u%04X\\u%04X'", v76, v87);
              goto LABEL_121;
            }
            i += 12;
...
LABEL_163:
    ...
    if ( v49 == -1 )
    {
      sub_1022F4(a2, (_DWORD *)a1, 6, "premature end of input");
      goto LABEL_121;
    }
    if ( v49 > 0x1F )
    {
      ...
      if ( v49 == 92 )
      {
        v50 = sub_102420(a1, a2);
        if ( v50 == 117 )
        {
          v57 = 4;
          v49 = sub_102420(a1, a2);
          while ( 1 )
          {
            v58 = v49 - 48 > 9;
            if ( v49 - 48 > 9 )
...
LABEL_120:
          sub_1022F4(a2, (_DWORD *)a1, 8, "invalid escape");
          goto LABEL_121;
        }
        v51 = v50 == 92;
        if ( v50 != 92 )
  ...
  if ( v49 != 10 )
  {
    if ( utf8_check_first((unsigned __int8)v49) )
    {
      ...
      *(_DWORD *)(a1 + 28) = v100 - 1;
      ...
      {
LABEL_247:
        sub_1022F4(a2, (_DWORD *)a1, 8, "control character 0x%x", v49);
        goto LABEL_121;
      }
    }
    else
  ...
  *(_DWORD *)(a1 + 28) = v97;
  ...
  sub_1022F4(a2, (_DWORD *)a1, 8, "unexpected newline");
LABEL_121:
