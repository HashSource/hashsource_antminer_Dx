int __fastcall check_bist_error_one_lane(int a1, int a2, int a3, int a4)
{
  ...
  int v26; // r0
  int v27; // t1
  int v29; // [sp+0h] [bp-1154h]
  int v30; // [sp+4h] [bp-1150h]
  int v31; // [sp+8h] [bp-114Ch]
  int v32; // [sp+Ch] [bp-1148h]
  int v33; // [sp+10h] [bp-1144h]
  int v34; // [sp+14h] [bp-1140h]
  __int16 v36; // [sp+20h] [bp-1134h]
  int *v37; // [sp+20h] [bp-1134h]
  int v38; // [sp+28h] [bp-112Ch]
  ...
  zlog(
    ...
    v60);
  v36 = v6 << 12;
  v7 = sub_13415C(a1, a3, (unsigned __int16)(v6 << 12) | 0x10, (int)v58);
  if ( *(_DWORD *)(a1 + 220) != v7 )
  {
    v8 = v7;
    pthread_mutex_lock(&stru_197BB8);
  ...
  v9 = sub_13415C(a1, a3, v36 & 0xF000 | 0x13, (int)v49);
  if ( *(_DWORD *)(a1 + 220) != v9 )
  {
    pthread_mutex_lock(&stru_197BB8);
    logfmt_raw(
  ...
  v10 = sub_13415C(a1, a3, v36 & 0xF000 | 0x14, (int)v49);
  if ( *(_DWORD *)(a1 + 220) != v10 )
  {
    pthread_mutex_lock(&stru_197BB8);
    logfmt_raw(
      v60,
  ...
  v12 = sub_13415C(a1, a3, v36 & 0xF000 | 0x15, (int)v48);
  if ( *(_DWORD *)(a1 + 220) != v12 )
  {
    pthread_mutex_lock(&stru_197BB8);
    logfmt_raw(
      v60,
  ...
  if ( v12 > 0 )
  {
    ...
    do
    {
      ...
      if ( (v19 & 0xE000000) != 0 )
      {
        pthread_mutex_lock(&stru_197BB8);
        v34 = v39[v15 / 4 + 9];
        v32 = (*((_DWORD *)v14 - 4) >> 25) & 7;
        v33 = *(_DWORD *)&v48[v15];
        v31 = (unsigned __int8)*(v14 - 19);
        v30 = (unsigned __int8)*(v14 - 20);
        v29 = a4;
        __pld(&v48[v15 + 16]);
        logfmt_raw(
          v60,
  ...
  v20 = sub_13415C(a1, a3, v36 & 0xF000 | 0x16, (int)v49);
  if ( v20 > 0 )
  {
    v39[1] = v50 >> 12;
    if ( v20 != 1 )
  ...
  v21 = sub_13415C(a1, a3, v36 & 0xF000 | 0x17, (int)v49);
  if ( v21 > 0 )
  {
    v22 = v39;
    v23 = v49;
    ...
    do
    {
      v24 = v22[1];
      ++v22;
      v25 = v24 | (*((_DWORD *)v23 + 1) << 20);
      *v22 = v25;
      pthread_mutex_lock(&stru_197BB8);
      v26 = (unsigned __int8)v23[1];
      v27 = (unsigned __int8)*v23;
      v23 += 8;
      logfmt_raw(v60, 0x1000u, 0, "channel %1x, chip_id %02x core_id %02x sample_cnt %08x", a4, v27, v26, v25);
      pthread_mutex_unlock(&stru_197BB8);
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_D7_release/build/rootfs/buildroot/tmp/release/build/godminer-origi"
