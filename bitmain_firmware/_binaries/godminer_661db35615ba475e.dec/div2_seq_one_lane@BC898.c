int __fastcall div2_seq_one_lane(int a1, int a2, int a3, int a4)
{
  ...
  sub_1325F4(a1, a3, (unsigned __int16)a4 | 0x8B, 0xCCCC0000);
  sub_1325F4(a1, a3, (unsigned __int16)a4 | 1, 0xFFFF0000);
  sub_1325F4(a1, a3, (unsigned __int16)a4 | 0x8C, 0xCCCCu);
  sub_1325F4(a1, a3, (unsigned __int16)a4 | 1, (unsigned int)&loc_FFFFC + 3);
  sub_1325F4(a1, a3, (unsigned __int16)a4 | 0x8C, 0xCCC00000);
  sub_1325F4(a1, a3, (unsigned __int16)a4 | 1, 0xFFF00000);
  sub_1325F4(a1, a3, (unsigned __int16)a4 | 0x8D, (unsigned int)&loc_CCCCC);
  sub_1325F4(a1, a3, (unsigned __int16)a4 | 1, 0xFFFFFFu);
  sub_1325F4(a1, a3, (unsigned __int16)a4 | 0x8D, 0xCC000000);
  sub_1325F4(a1, a3, (unsigned __int16)a4 | 1, 0xFF000000);
  sub_1325F4(a1, a3, a4 & 0xF000 | 0x8E, 0xCCCCCCu);
  sub_1325F4(a1, a3, (unsigned __int16)a4 | 1, 0xFFFu);
  sub_1325F4(a1, a3, a4 & 0xF000 | 0x8A, 0xCCCCC000);
  sub_1325F4(a1, a3, (unsigned __int16)a4 | 1, 0xFFFFF000);
  sub_1325F4(a1, a3, (unsigned __int16)a4 | 0x8B, 0xCCCu);
