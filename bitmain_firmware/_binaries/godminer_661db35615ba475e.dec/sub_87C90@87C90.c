int __fastcall sub_87C90(int a1, int a2)
{
  ...
  logfmt_raw(v44, 0x1000u, 0, "get_addr %s chip_no %d", "ChipSetting_get_addr_LTC", a2);
  ...
  else
  {
    ...
    do
    {
      ...
      zlog(
        ...
        v44);
      v9 = *(_DWORD *)(a1 + 180);
      if ( *(_DWORD *)(a1 + 176) == (unsigned __int16)v8 )
        ++v20;
      if ( v9 > 0 )
      {
        v10 = *(unsigned __int8 **)(a1 + 280);
        ...
        if ( *v10 == v11 )
        {
          ...
          v18 = 0;
LABEL_17:
          *(_DWORD *)(*(_DWORD *)(a1 + 284) + v18) |= v17;
          pthread_mutex_lock(&stru_197BB8);
          logfmt_raw(v44, 0x1000u, 0, "detected_chip_bitmask %x", *(_DWORD *)(*(_DWORD *)(a1 + 284) + v18));
          pthread_mutex_unlock(&stru_197BB8);
          zlog(
            g_zc,
