int __fastcall sub_3E1FC(int result, int a2, int a3, int a4, __int64 a5, __int64 a6, __int64 a7, __int64 a8)
{
  int v8; // r5
  int v9; // r10
  int v10; // r4
  ...
  v9 = result + 8 * a4;
  v10 = 8 * a3;
  v11 = (a5 ^ a7) + *(_QWORD *)(result + 16) + *(_QWORD *)(result + 8 * a2);
  ...
  *v12 = v16;
  v12[1] = v17;
  v18 = (a8 ^ a6) + *(_QWORD *)(result + 16);
  *(_DWORD *)(result + 16) = v18 + v16;
  v19 = v18 + __PAIR64__(v17, v16);
  v20 = result + v10;
  *(_DWORD *)(result + 20) = HIDWORD(v19);
  ...
  *v12 = v27;
  v12[1] = v28;
  v29 = (~(*(_DWORD *)(result + 16) | *(_DWORD *)(result + 8 * a3) | v27)
       | *(_DWORD *)(result + 16) & *(_DWORD *)(result + 8 * a3) & ~v27
       | (*(_DWORD *)(result + 16) ^ *(_DWORD *)(result + 8 * a3)) & v27)
      ^ *(_DWORD *)v9;
  v30 = (~(*(_DWORD *)(result + 20) | *(_DWORD *)(v20 + 4) | v28)
       | *(_DWORD *)(result + 20) & *(_DWORD *)(v20 + 4) & ~v28
       | (*(_DWORD *)(result + 20) ^ *(_DWORD *)(v20 + 4)) & v28)
      ^ *(_DWORD *)(v9 + 4);
  *(_DWORD *)v9 = v29;
  *(_DWORD *)(v9 + 4) = v30;
  ...
  *(_DWORD *)v9 = v29
                ^ (*(_DWORD *)(result + 8 * a3)
                 & ~((*(_DWORD *)(result + 16) | v31) ^ v31 & ~*(_DWORD *)(result + 16))
                 ^ v31
                 & ~*(_DWORD *)(result + 16)
                 | *(_DWORD *)(result + 16) & ~(*(_DWORD *)(result + 8 * a3) ^ v31));
