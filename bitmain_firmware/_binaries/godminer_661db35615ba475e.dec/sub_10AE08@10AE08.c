void sub_10AE08()
{
  ...
  else
  {
    ...
    {
      v56 = dword_190E4C;
      v57 = &dword_190E4C[v55];
      do
      {
        v58 = *v56++;
        memset((void *)(v58 + 312), 1, 0x20u);
      }
      while ( v57 != v56 );
    }
    pthread_mutex_lock(&stru_197BB8);
  ...
  if ( v73 )
  {
    ...
    v64 = pthread_create((pthread_t *)&dword_19CF9C, &attr, (void *(*)(void *))watchpool_thread, &dword_19CF98);
