int __fastcall stratum_set_diff_or_target_base(int a1, int a2, _DWORD *a3)
{
  ...
  if ( !*v5 || **v5 != 2 )
  {
    ...
    if ( *v5 )
    {
      if ( *v7 == 3 )
      {
        LODWORD(v11) = sub_15D994(*((_QWORD *)v7 + 1));
        HIDWORD(v11) = v10;
      }
      else
      {
      ...
      if ( v11 != 0.0 )
      {
        ...
        *(double *)(a2 + 1176) = v11;
        ...
        logfmt_raw((char *)v23, 0x1000u, 0, "%s diff from pool: %lf", "stratum_set_diff_or_target_base", v22, v11);
...
LABEL_9:
    pthread_mutex_lock(&stru_197BB8);
    logfmt_raw((char *)v23, 0x1000u, 0, "Stratum set target: invalid parameters");
    pthread_mutex_unlock(&stru_197BB8);
    v8 = 32;
    goto LABEL_10;
  }
  ...
  if ( v13 )
  {
    if ( *v13 == 2 )
    {
      ...
      if ( v14 )
      {
        ...
        {
          V_LOCK();
          logfmt_raw((char *)v23, 0x1000u, 0, "%s target from pool: %s", "stratum_set_diff_or_target_base", v14);
          V_UNLOCK();
          zlog(
            g_zc,
