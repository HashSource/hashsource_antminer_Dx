int __fastcall sub_1510D8(int a1, int a2)
{
  _DWORD *v4; // r4
  _DWORD *v5; // r12
  int *v6; // r2
  ...
  sub_129254((unsigned __int8 *)a1, &v908);
  sub_129254((unsigned __int8 *)(a1 + 2), &v972);
  v4 = &unk_178BF8;
  v5 = &unk_178BF8;
  v6 = &v908;
  v7 = v908 - v972;
  ...
  v21 = 14;
  v22 = 0;
  sub_129254((unsigned __int8 *)(a1 + 1), &v1036);
  v23 = &unk_178C98;
  sub_129254((unsigned __int8 *)(a1 + 3), &v1100);
  v24 = &v908;
  v25 = v1036 - v1100;
  v1036 += v1100;
  v1100 = v25;
  ...
  {
    v405 = (unsigned __int16 *)&unk_178FF6;
    v406 = &v907;
    do
    {
      while ( 1 )
