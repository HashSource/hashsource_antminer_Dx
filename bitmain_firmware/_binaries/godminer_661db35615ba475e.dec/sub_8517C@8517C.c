int __fastcall sub_8517C(int a1, int *a2, _DWORD *a3, int a4)
{
  char v4; // r7
  int v8; // r5
  signed int v10; // r2
  ...
  HIWORD(v20) = 32;
  BYTE1(v20) = a4;
  v8 = (*(int (__fastcall **)(int, int *))(a1 + 140))(a1, &v18);
  if ( v8 )
    return 0;
  usleep(0xC350u);
  v10 = *(_DWORD *)(a1 + 180);
  ...
  v12 = v11;
  HIWORD(v20) = 32;
  (*(void (__fastcall **)(int, int *, signed int, unsigned __int8 *, int *))(a1 + 160))(a1, &v18, v16, v11, &v17);
  v13 = v17;
  if ( v17 == 1 )
  {
    if ( a4 == v12[4] )
