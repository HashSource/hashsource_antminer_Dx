int __fastcall eeprom_write(unsigned int a1, int a2, unsigned __int8 *a3, int a4)
{
  ...
  v6[1] = 1;
  dword_197BD8[2 * a1] = v29;
LABEL_3:
  if ( a4 )
  {
    v31 = &a3[a4];
LABEL_5:
    v8 = dword_197BD8[2 * a1];
    ...
    else
    {
      ...
      else
      {
        if ( dword_197C88 )
        {
          v9 = *(_DWORD *)dword_197C88;
          v10 = *(_DWORD *)dword_197C88 + 4;
          v11 = **(_DWORD ***)dword_197C88;
          while ( v11 != (_DWORD *)v10 )
          {
            ...
            if ( !v16 )
            {
              ...
              zlog(
                ...
                &v35);
              v26 = *a3++;
              v27 = v26 | (a2 << 8) | 0x1000000 | (v23 << 26) | (v24 >> 4 << 20) | (v24 << 15) & 0x70000;
              while ( *(int *)(dword_197C8C + 48) >= 0 )
              {
                usleep(0x1388u);
                if ( !--v25 )
                {
